...
/**
 * This is the item provider adapter for a {@link bonIDE.PreCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PreConditionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PreCondition_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PreCondition_content_feature", "_UI_PreCondition_type"),
				 BonIDEPackage.Literals.PRE_CONDITION__CONTENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((PreCondition)object).getContent();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PreCondition.class)) {
			case BonIDEPackage.PRE_CONDITION__CONTENT:
