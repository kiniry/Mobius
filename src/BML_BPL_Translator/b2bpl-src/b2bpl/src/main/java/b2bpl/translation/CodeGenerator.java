...
public class CodeGenerator implements TranslationConstants {
  ...
  public static String typeAbbrev(BPLType type) {
    return (type == BPLBuiltInType.INT) ? INT_TYPE_ABBREV : REF_TYPE_ABBREV;
  }

  public static String paramVar(int index) {
    return PARAM_VAR_PREFIX + index;
  }

  public static String thisVar() {
    return paramVar(0);
  }

  public static String localVar(int index, JType type) {
    return LOCAL_VAR_PREFIX + index + typeAbbrev(type(type));
  }

  public static String intLocalVar(int index) {
    return LOCAL_VAR_PREFIX + index + INT_TYPE_ABBREV;
  }

  public static String refLocalVar(int index) {
    return LOCAL_VAR_PREFIX + index + REF_TYPE_ABBREV;
  }

  public static String stackVar(int index, JType type) {
    return STACK_VAR_PREFIX + index + typeAbbrev(type(type));
  }

  public static String intStackVar(int index) {
    return STACK_VAR_PREFIX + index + INT_TYPE_ABBREV;
  }

  public static String refStackVar(int index) {
    return STACK_VAR_PREFIX + index + REF_TYPE_ABBREV;
  }

  public static String callResultVar(JType type) {
    return CALL_RESULT_VAR_PREFIX + typeAbbrev(type(type));
  }

  public static String swapVar(JType type) {
