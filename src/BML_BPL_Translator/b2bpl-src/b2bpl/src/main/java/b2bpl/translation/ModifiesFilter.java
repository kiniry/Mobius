 ...
 * contain <i>any</i> of the BML store references of a modifies clause.
 ...
 * @author Ovidio Mallo
 */
public class ModifiesFilter extends CodeGenerator {

  /**
   * The <code>SpecificationTranslator</code> to be used for translating
   * BML specification expressions which may e.g. appear as the index of
   ...
   * passed to the constructor of this class does <i>not</i> contain <i>any</i>
  ...
  private final class Filter implements BMLStoreRefVisitor<BPLExpression> {
     ...
     * field/array access. This is the case if and only if <code>onLhs</code>
     * &gt; 0.
     */
    private int onLhs = 0;
