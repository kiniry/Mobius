...
public interface TranslationContext {
  ...
  /**
   * Triggers the translation of the given <code>type</code> reference and
   * returns a <code>BPLExpression</code> representing that reference.
   *
   * @param type  The type reference to translate.
   * @return      A <code>BPLExpression</code> representing the given type
   *              reference.
   */
  BPLExpression translateTypeReference(JType type);

  /**
   * Triggers the translation of the given <code>field</code> reference and
   * returns a <code>BPLExpression</code> representing that reference.
   *
   * @param field  The field reference to translate.
   * @return       A <code>BPLExpression</code> representing the given field
   *               reference.
   */
  BPLExpression translateFieldReference(BCField field);

  /**
   * Triggers the translation of the given integer <code>literal</code> and
   * returns a <code>BPLExpression</code> representing that literal.
   *
   * @param literal  The integer literal to translate.
   * @return         A <code>BPLExpression</code> representing the given integer
   *                 literal.
   */
  BPLExpression translateIntLiteral(int literal);

  /**
   * Triggers the translation of the given string <code>literal</code> and
   * returns a <code>BPLExpression</code> representing that literal.
   *
   * @param literal  The string literal to translate.
   * @return         A <code>BPLExpression</code> representing the given string
   *                 literal.
   */
  BPLExpression translateStringLiteral(String literal);

  /**
   * Triggers the translation of the given class <code>literal</code> and
   * returns a <code>BPLExpression</code> representing that literal.
   *
   * @param literal  The class literal to translate.
   * @return         A <code>BPLExpression</code> representing the given class
   *                 literal.
   */
