...
/**
 * Contains codes for each printable attribute type and commonly used bit masks
 * to represent sets of attributes that we want retrieve (through
 * getAllAttribute(int mask) methods). TODO w czym te kody sa wykorzystywane?
 * 
