...
public class BCAttributeMap {
	...
	/**
	 * Single annotations count. May be out of date, use getLength() instead!
	 */
	@Deprecated
	private int length;

	/**
	 * Hash map containing lists of annotations for each instruction in the
	 * method.
	 */
	private HashMap<InstructionHandle, SingleList> map;

	/**
	 * Method's attribute used for loading attributes from and saving them to
	 * .class file (to BCEL method).
	 */
	private AssertTable atab;

	/**
	 * Constructor from a method that creates an empty collection.
	 * 
	 * @param m -
	 *            the method.
	 */
	...
	/**
	 * Adds an annotation to the collection (as an last annotation for it's
	 * instruction).
	 * 
	 * @param ica -
	 *            an attribute to be added.
	 */
	 ...
	 * 
	 * @param atype -
	 *            type of annotation (from AType interface),
	 * @param pc -
	 *            current pc number of instruction to add new annotation before,
	 * @param minor -
	 *            minor number of inserted annotation (for annotation ordering
	...
	/**
	 * Adds an annotation with given minor number to the collection.
	 * 
	 * @param ica -
	 *            annotation to be added. Must have set ih (instructionHandle)
	 *            attribute,
	 * @param minor -
	 *            position of annotation within its instruction. Annotation will
	 *            be inserted after last annotation for its instruction with
	 *            less or equal minor number than this parameter.
	 */
	...
	/**
	 * Replaces given annotations from this collection with another one. New
	 * annotation will be placed in the same place as the old one, regardless of
	 * its ih and minor attributes.
	 * 
	 * @param olda -
	 *            annotation to be removed,
	 * @param newa -
	 *            annotation to be inserted in <code>olda</code>'s place.
	 */
	 ...
	 * 
	 * @param ih -
	 *            given instruction handle.
	 * @return SingleList of annotation for given instruction (or an new empty
	 *         list if there are no annotations for given instruction).
	 */
	 ...
	 * 
	 * @param types -
	 *            attribute types mask (from ATypes).
	...
	/**
	 * Replaces current annotation list for given instruction handle with given
	 * one.
	 * 
	 * @param ih -
	 *            instruction whose annotation list should be replaced,
	 * @param sl -
