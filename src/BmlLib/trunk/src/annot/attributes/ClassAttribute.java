...
/**
 * This class represents BML class attributes. Each subclass of this class
 * should have at most one instance for each BCClass.
 * 
 * @author tomekb
 */
public abstract class ClassAttribute extends BCPrintableAttribute {
	...
	/**
	 * Replaces existing attribute of this type in given BCClass with this
	 * attribute.
	 * 
	 * @param bcc -
	 *            BCClass to place this attribute as it's class attribute.
	 */
