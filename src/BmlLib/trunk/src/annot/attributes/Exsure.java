...
/**
 * This class represents method's exception type (throws declaration) with
 * condition in which such exception can be thrown by this method.
 * 
 * @author tomekb
 */
public class Exsure {
	...
	/**
	 * Postcondition that is ensured in case of throwing <code>excType</code>
	 ...
	 *            exception type,
	 * @param postcondition -
	 *            postcondition exsures when <code>excType</code> exception is
	...
	/**
	 * @return Postcondition that is ensured in case of throwing
