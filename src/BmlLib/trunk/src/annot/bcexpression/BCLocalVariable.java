...
/**
 * This class represents method's local variable. One
 * <code>BCLocalVariable</code> per one local variable.
 * 
 * @author tomekb
 */
public class BCLocalVariable extends OldExpression {
	...
	/**
	 * Number (index) of this variable in method <code>m</code>.
	 */
	private int lvar_id;
	 ...
	 * {@link #getLocalVariable(BCMethod, AttributeReader)} intead.
	 * 
	 * @param m -
	 *            initializing method,
	 * @param id -
	 *            number (index) of this local variable in method <code>m</code>,
	 * @param name -
	 *            name of this variable,
	 * @param lvg -
	 *            BCEL's representation of this variable.
	 ...
	 * 
	 * @param m -
	 *            method in with variable has been declared,
	 * @param ar -
	 *            input stream to load from,
	 * @return local variable of index read from <code>ar</code>,
	 * @throws ReadAttributeException -
	 *             if read index is greater or equal local variable count of
	 *             method <code>m</code>.
	 */
	public static BCLocalVariable getLocalVariable(boolean isOld, BCMethod m,
			AttributeReader ar) throws ReadAttributeException {
