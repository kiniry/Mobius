...
/**
 * This class represents return type of an expression. The constructor is
 * protected, so use {@link #getJavaType(String)} or
 * {@link #getJavaBasicType(String)} instead.
 * 
 * @author tomekb
 */
public abstract class JavaType1 extends BCExpression {
	...
	/**
	 * Type are totally diffrent (no type is a subtype of the other).
	 */
	 ...
	 * @param name -
	 *            type name.
	 * @return - instance of JavaType representing type of given
	 *         <code>name</code>.
	 */
	public static JavaType1 getJavaType(String name) {
		if (IDisplayStyle.jt_int.equals(name) || ("I".equals(name)))
			return JavaBasicType.JavaInt;
		if (IDisplayStyle.jt_boolean.equals(name) || ("B".equals(name)))
	 ...
	 * 
	 * @param name -
	 *            type name, as in variable declaration.
	 * @return - instance of JavaType representing type of given
	 *         <code>name</code>.
	 * @throws ReadAttributeException -
	 *             if <code>name</code> parameter is invalid.
	 */
	...
	public static JavaType1 convert(Type t) {
		if (t == Type.BOOLEAN)
			return JavaBasicType.JavaBool;
		if ((t == Type.BYTE) || (t == Type.SHORT) || (t == Type.INT)
				|| (t == Type.LONG))
			return JavaBasicType.JavaInt;
	...
	/**
	 * JavaType has no constructor from AttributeReader, so it doesn't need
	 * pre-superconstructor initializetion.
	 */
	@Override
	protected void init() {
	};
	 ...
	 * @param type -
	 *            type to compare to.
	 * @return <b>{@link #TYPES_UNRELATED}</b> - if neither this type is a
	 *         subtype of given one, nor given type is a subtype of this type,<br>
	 *         <b>{@link #IS_SUBTYPE}</b> - if given type is a subtype of this
	 *         type,<br>
	 *         <b>{@link #IS_SUPERTYPE}</b> - if this type is a subtype of
	 *         given type,<br>
	 *         <b>{@link #TYPES_EQUAL}</b> - if this type is equal to given
	 *         type.
	 */
