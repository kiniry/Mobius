...
/**
 * This interface contains all opcodes in the .class file. These opcodes are
 * used to determine which type of expression should be created and loaded (from
 * BCEL's Unknown attribute's data). They are also stored in these expressions
 * as a connector.
 * 
 * @author tomekb
 */
