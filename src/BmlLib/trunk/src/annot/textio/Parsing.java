...
/**
 * Class used for parsing BML annotations (real parser has been generated by
 * antlr tool to <code>antlr3-generated</code> package). It contains also some
 * methods for String opetarions on BML annotations.
 * 
 * @author tomekb
 */
public class Parsing {
	...
	/**
	 * Shows token list (from lexer) befor parsing each BCPrintableAttribute.
	 * Useful when parser crashes.
	 */
	 ...
	 * 
	 * @param bcc -
	 *            BCClass of all BML annotations to be parsed here.
	 */
	 ...
	 * @param end -
	 *            end line number,
	 * @return substring of <code>code</code>, from line no.
	 *         <code>start</code> to line no. <code>end</code> (including
	 *         both start and end lines).
	 */
	 ...
	 * @param str -
	 *            any String.
	 * @return escaped <code>str</code>, to use as regexp pattern to match
	 *         <code>str</code> literally.
	 */
	 ...
	 * 
	 * @param attr -
	 *            String representation of an BML annotation.
	...
	/**
	 * Removes comment, line-breaks and stray spaces from given BML annotation.
	 * Can be used to compare BML annotation (eg. in parser test).
	 * 
	 * @param attr -
	 *            String representation of an BML annotation.
	 * @return <code>attr</code> with unnessesery characters removed.
	 */
	 ...
	 * 
	 * @param code -
	 *            String representation of one or more BML annotations (after
	 *            line-breaing).
	...
	/**
	 * Parse an BML annotation using parser generated from <code>BML.g3</code>
	 * grammatic.
	 * 
	 * @param m -
	 *            parsing annotation's method (or null for class annotations),
	 * @param ih -
	 *            instructionHandle of parsing annotation,
	 * @param minor -
	 *            minor number of parsing annotation,
	 * @param str -
	 *            new String representation to be parsed (without surrounding
	 *            comment - use {@link #purge(String)} method to remove
	 *            comment),
	 * @return new BCPrintableAttribute parsed from <code>str</code>.
	 * @throws RecognitionException -
	 *             if <code>str</code> isn't correct BML annotation.
	 */
	...
	/**
	 * Perform syntax and (basic) semantics checks of given BML annotation
	 * String.
	 * 
	 * @param m -
	 *            parsing annotation's method (or null for class annotations),
	 ...
	 *            comment - use {@link #purge(String)} method to remove
	 *            comment),
	 * @return true iff <code>str</code> is correct, false otherwise.
	 */
	...
	/**
	 * Parses a whole class. Should be called with
	 * <code>affectBCC = false</code> first (for error-checking) and, if it
	 * returns true, then with <code>affectBcc = true</code> to parse the same
	 * code into it's BCClass. Adding / removing / replacing methods is
	 * currently unsupported.
	 * 
	 * @param code -
	 *            preprocessed class's code to be parsed. Should have all
	 *            bytecode lines and unaffected fragments collapsed to proper
	 *            stubs,
	 * @param affectBcc -
	 *            wether to affect bcclass or not. if it is set to false, parser
	 *            will perform error-check only, without affecting BCClass.
	 * @return wether <code>code</code> is correct String representation for
	 *         current BCClass. Crashes if <code>affectBcc</code> is true and
	 *         given code is incorrect.
	 */
		...
		try {
			...
			if (affectBcc)
				throw new RuntimeException(
						"parsing failed while updating BCClass");
			return false;
		}
		return true;
	}
