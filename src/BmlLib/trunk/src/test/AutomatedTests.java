...
public final class AutomatedTests {
  ...
  private static void parserTest() throws ClassNotFoundException,
    ...
    test(true, 3, "(true || false) && (true || false)");
    test(true, 2, "(((((true || false))) && true))", "(true || false) && true");
    test(false, 3, "true || 3");
    ...
    test(true, 2,
         "true {| \\precondition true \\modifies nothing, everything |}",
    ...
    test(true, 2,
         "true {| \\precondition true \\modifies nothing \\ensures false |}");
    test(false, 2,
         "true {| \\precondition true \\modifies xxx \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies args \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies args, l, args \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies this \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies this.args \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies this.args.l \\ensures false |}");
    test(false, 2,
         "true {| \\precondition true \\modifies .l \\ensures false |}");
    test(false, 2,
         "true {| \\precondition true \\modifies . \\ensures false |}");
    test(
         true,
         2,
         "true {| \\precondition true \\modifies this.args.l, l, this.l \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies this[*] \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies this.args[*] \\ensures false |}");
    ...
    test(true, 2,
         "true {| \\precondition true \\modifies this.args[*][*] \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies args[1] \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies args[2 + 2] \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies args[this.l] \\ensures false |}");
    test(true, 2,
         "true {| \\precondition true \\modifies args[2 .. 3] \\ensures false |}");
    test(
         true,
         2,
         "true {| \\precondition true \\modifies args[2 + 2 .. 3 / 4] \\ensures false |}");
    test(
         true,
         2,
         "true {| \\precondition true \\modifies args[this.l .. this.l + 1] \\ensures false |}");

    //loop specification tests:
    test(true, 4, "", "\\modifies everything \\invariant true \\decreases 1");
    test(true, 4,
         "\\modifies nothing, everything \\invariant args != null \\decreases 2 + 2");
    ...
    test(true, 4,
         "\\modifies old_this.old_args \\invariant true \\decreases l + l");
    test(true, 4,
         "\\modifies nothing \\invariant true \\decreases (l + l) * 3 + this.l");
    test(true, 4,
         "\\modifies this.args[*] \\invariant args != null \\decreases 2 + 2");
    test(true, 4,
         "\\modifies this.args[*], this.l, l \\invariant args != null \\decreases 2 + 2");
    end();
  }
   ...
   */
  private static void test(final boolean ok, final int attr_id,
                           final String newval) throws IOException,
      ClassNotFoundException {
   ...
   */
  private static void test(final boolean ok, final int attr_id, String newval,
    ...
    try {
      ...
      final String code = Parsing.purge(pa.printCode(conf));
