...
public final class Defaults {
	...
	/* @phosphorus added stuff */
	public static final Boolean COLLAPSE_LINE_JML = Boolean.valueOf(false);
	public static final Boolean FOLD_LINE_JML = Boolean.valueOf(true);
	public static final Boolean COLLAPSE_BLOCK_JML = Boolean.valueOf(false);
	public static final Boolean FOLD_BLOCK_JML = Boolean.valueOf(true);
	//end @phosphorus
	...
	private static void doLoop(IPreferenceStore store, int mode) {
		...
		/* @phosphorus added stuff */
		values.put(PreferenceKeys.COLLAPSE_LINE_JML, COLLAPSE_LINE_JML);
		values.put(PreferenceKeys.FOLD_LINE_JML, FOLD_LINE_JML);
		values.put(PreferenceKeys.COLLAPSE_BLOCK_JML, COLLAPSE_BLOCK_JML);
		values.put(PreferenceKeys.FOLD_BLOCK_JML, FOLD_BLOCK_JML);
		// end @phosphorus
