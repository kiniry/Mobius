...
public class GeneralTab implements PreferencesTab {
	...
	private Table createTable(Composite parent) {
		...
		// @phosphorus
		createTableItems(table, "block_jml");
		createTableItems(table, "line_jml");
		// end @phosphorus
	...
	private void createTableItems(Table table, String key) {
		...
		//@phosphorus
		/*
		 * This is a bit of a hack, the reason for it being here
		 * is that I was unable to find where the Strings 
		 * containing the labels for table entries could be set. 
		 * sorry...
		 */
		//if (key.equalsIgnoreCase("block_jml")) {
			//labelText = "Block JML Annotations (/*@ ... @*/)";
		//} else if (key.equalsIgnoreCase("line_jml")) {
			//labelText = "Line JML Annotation Blocks (//@ ...)";
		//}
		// end @phosphorus
