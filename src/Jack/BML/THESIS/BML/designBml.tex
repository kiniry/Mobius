...
\item \textbf{Compactness} and \textbf{Efficiency}\\
      ...
      The second feature refers to that tools supporting BML should not be slowed down by processing
      the BML specification where more particularly we refer to verification condition generators.
      This is an important condition if verification is done  on devices
