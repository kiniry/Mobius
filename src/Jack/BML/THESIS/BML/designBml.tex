...
\item [Java compiler independence ] 
      ...
      % As we shall see later in the coming sections, the debug data plays a role in the compilation of the JML specification into BML.
...
\item [BML corresponds to a partially desugared version of JML]
     ...
     %  This is an important condition if verification is done  on devices with limited resources.
      ...
      BML is designed to correspond to a partially desugared version of JML, namely BML supports a desugared version of the 
      BML behavioral specification cases. We consider that such encoding makes the verification procedure more efficient. 
...
\begin{description}
  \item [\textbf{Line\_Number\_Table} and \textbf{Local\_Variable\_Table}]
       ...
       these attribute is optional \cite{VMSpec}, yet almost all standard non optimizing compilers can optionally generate these data.  
  ...
  \item [Non-optimizing compilation] 
       ...
       compiler.  Note that this is not a major restriction as most of the Java compilers do not support optimizations.
       Of course, this situation may change with the evolution of the Java platform which must be taken in future upgrades
       of BML. We provide a discussion on optimizing compilers in Chapter \ref{conclusion}. 
