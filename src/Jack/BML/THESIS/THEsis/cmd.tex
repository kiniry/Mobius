...
\newcommand{\arrayAccess}[2]{ \mbox{\rm\textbf{arrAcc}}(#1,#2) }  %{\mbox{\rm arrAccess}(#1, #2)}
...
\newcommand{\locVar}[1]{\mbox{\rm{\textbf{lv}}}(#1) }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \newcommand{\class}{\mbox{\rm\texttt{Cl}}{}} % a generalization which stands for any Java class
...
\newcommand{\expression}{\mbox{\rm\textit{E}}^{\scriptsize{\mathcal{A}}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5interpetation%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\evalExp}[2]{[\![#1]\!]_{s_{0}, #2}}%{\Arrowvert #1 \Arrowvert_{s_{0}, #2} }  % evaluation of an expression #1 in  a state configuration #2
...
\newcommand{\interp}[2]{s_{0}, #2 \vDash #1} % interpretation of a predicate  #1 in  a state configuration #2
\newcommand{\interpTwoLines}[2]{ \begin{array}{l}s_{0}, #2  \vDash \\ 
				         #1 
				  \end{array}}
...
\newcommand{\wpSrcExpr}[3]{ \wpName( #1 , #2 )_{#3} }
\newcommand{\wpSrcStmt}[2]{ \wpName( #1 , #2) }
\newcommand{\preSrc}{\mbox{\rm\textsf{Pre}}{}}
\newcommand{\excPostSrc}{\mbox{\rm\textsf{excPost}}}
\newcommand{\excPostSpecSrc}{\mbox{\rm\textsf{excPostSpec}}^{src}{}}
\newcommand{\normalPostSrc}{\mbox{\rm\textsf{Post}}{}}
\newcommand{\exceptionSrc}{\mbox{\rm\textsf{exceptions}}{}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%end wp for source %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
