...
%   \begin{definition}[Definition of function]
%%
...
%%      \end{definition}
 ...
 \begin{frame}\frametitle{Program calculi. Weakest precondition  predicate transformers}
%%    \begin{theorem}[Soundness of the function]
%%       If a method \methodd{} with precondition  \methodd.$Pre$
%%       and postcondition \methodd.$Post$ is such that 
%%       the verification conditions are valid formulas $ \vDash \methodd.Pre \Rightarrow \wpName{\methodd.body}{\methodd.Post } $ 
%%       then the \methodd{} respects its specification in the sense of the upper definition
%%      \end{theorem}    
