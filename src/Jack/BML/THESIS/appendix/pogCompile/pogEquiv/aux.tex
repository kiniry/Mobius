 ...
 \\
	    ...
	    \wpBcSeq{ \compileLabel{s}{\expressionSrc}{e} }{ \phi }{\excPostExpl} \  = \\ 
            \forall v^{'}_1 \ldots v^{'}_k, \left( \begin{array}{l} Q \Rightarrow 
								       ...
								       \subst{\stack{\counter +1}}{ v }\end{array} \right) \end{array} \right)   %\begin{array}{l}
...
and 
forall formulas $ Q, R$ and $k\ge 0$ such that 
$$ \begin{array}{l} \wpSrcExpr{\expressionSrc }{ \psi }{ \excPostExpl}{v} \  = \\
      
              \forall v', v^{'}_1 \ldots v^{'}_k, \left( \begin{array}{l} Q \Rightarrow \left( \begin{array}{l}\psi \subst{v}{v'} \end{array} \right)  \end{array} \right) \subst{v_1}{v^{'}_1 } \ldots \subst{v_k }{ v^{'}_k}
         %\left( \begin{array}{l} Q \Rightarrow \psi   \end{array} \right)
          \wedge 
	  R
...
\wpBcSeq{ \compileLabel{s}{\expressionSrc}{e} }{ \phi }{\excPostExpl} \  = \\ 
            \forall v', v^{'}_1 \ldots v^{'}_k,
                              \left( \begin{array}{l} Q \Rightarrow  
                                         \left( \begin{array}{l} \phi  \subst{\counter}{\counter + 1}  \subst{\stack{\counter +1}}{v'} \end{array} \right)  \end{array} \right) 
      									    \subst{v_1}{v^{'}_1 } \ldots \subst{v_k }{ v^{'}_k}		  
...
\begin{enumerate} 
	...
	\mbox{\rm\comment{From \numConclusion{1} and \numConclusion{2} we apply the induction hypothesis  $k =0$ }} \\		
