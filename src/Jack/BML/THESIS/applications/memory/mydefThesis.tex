...
\newcommand{\loopEndsSet}[1]{\mbox{\rm\texttt{loopEndSet}}(#1)}
\newcommand{\loopSet}[1]{\mbox{\rm\texttt{loopSet}}(#1)}
\newcommand{\loopEntry}[1]{\mbox{\rm\texttt{entry}}(#1)} % predicate that says that the instruction is an entry to a loop
...
\newcommand{\maxIter}[1]{\mbox{\rm\texttt{iter}}(#1)}
\newcommand{\progLoop}[1]{\textit{#1}}
\newcommand{\srcCode}[1]{\texttt{#1}}
\newcommand{\preds}{\mbox{\rm\texttt{preds}}} % predecessors of a given instruction
