...
Note that we could have used  as is done \todo{lilian}, a three valued interpretation for formulas and expressions with an operator for well-definedness over predicates and expressions 
whose interpretation to true would mean that the predicate / expression is not undefined. We however, consider that this only will complicate 
