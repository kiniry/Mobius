...
$$
Note that the evaluation function is partial and  takes as arguments an expression of the assertion language presented in the previous Section 
...
%More generally, we can show that the classical excluded middle still holds in such a formalization. 
