...
\newcommand{\execRel}{ \ \mbox{\rm\textit{succ}} \ } % the execution relation
...
\newcommand{\stateTransWeight}[1]{\stateTrans_{\mbox{\rm\texttt{#1}}}}% execution relation with weights for the correctness
\newcommand{\stateTransTerm}{\Downarrow}
\newcommand{\stateTransTransClos}[1]{\longleftarrow_{#1}}
\newcommand{\stateTransTermWeight}[1]{\Downarrow_{\mbox{\rm\texttt{#1}}} }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%STATE CONFIGURATION%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\expressionSrc}{\mathcal{E}}
