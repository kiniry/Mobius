...
\newcommand{\arrayAccess}[2]{ #1 [#2] }  %{\mbox{\rm arrAccess}(#1, #2)}
...
\newcommand{\RefValuesArr}{\mbox{ \rm RefValArr}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \newcommand{\LoopSpecSet}{\mbox{\rm\textit{LoopSpec}} }
 ...
 \newcommand{\exceptions}{\mbox{\rm \textit{exceptions}}}

\newcommand{\excPostSpec}{\mbox{\rm\textit{excPost}}} % the postcondition that is specified in case the method ends with an exception exc 
\newcommand{\loopSpecTable}{\mbox{\rm\textit{loopSpecS}}}
\newcommand{\normalPost}{\mbox{\rm\textit{normalPost}}}
\newcommand{\pre}{\mbox{\rm\textit{pre}}}
\newcommand{\modif}{\mbox{\rm\textit{modif}}}

%%%%%%%%%%%%%%%%%Loop attributes%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\loopSpec}{\mbox{\rm\textbf{loopSpec}}}

\newcommand{\loopInv}{\mbox{\rm \textit{loopInv}}}
\newcommand{\loopMod}{\mbox{\rm \textit{loopModif}}}
\newcommand{\loopPos}{\mbox{\rm \textit{pos}}}
\newcommand{\loopDecreases}{\mbox{\rm \textit{loopDecreases}}}

%%%%%%%%%%%%%%%%%Intra spec attributes%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\intraSpec}{\mbox{\rm\textbf{assertion}}}
\newcommand{\atIndex}{\mbox{\rm\textit{atIndex}}}
...
\newcommand{\constantPool}{ \mbox{\rm\textbf{Constant\_pool\_table}}}
\newcommand{\localVariableTable}{\mbox{\rm\textbf{Local\_variable\_table}}} 
\newcommand{\lineNumberTable}{\mbox{\rm\textbf{Line\_Number\_Table}}} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%BML%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
\newcommand{\bound}{\mbox{\rm\textit{bv}}}
...
\newcommand{\locations}{\mbox{\rm{locations}}}
\newcommand{\also}{also}
...
\newcommand{\EXC}{\mbox{\rm\texttt{EXC}}} % SPEC the spec variable used in exceptional postconditions to denote the thrown exception object
...
\newcommand{\arrayAccessMod}[2]{#1[#2]}
