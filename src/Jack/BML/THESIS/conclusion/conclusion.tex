...
The current thesis has been done as a preliminary work for the Mobius project and its objective was to 
give the basis for the a bytecode verification framework and to show that it is feasible. The objectives of Mobius (short for Ubiquity, Mobility and Security) 
is to build basis for guaranteeing security and trust in program application which are realistic in the presence of mobile and ubicuous computing. We hope that we have convinced
the reader for the importance of such techniques and in particular the evolution from source verification to low level verification  and the necessity for
human interaction in the verification process. We this would like to conclude the current thesis. 
