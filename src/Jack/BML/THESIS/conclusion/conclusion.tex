...
%\The implementation of the verification condition generator handles currently the following aspects of program verification not described here:
%\begin{description}
%\  \item[Method multiple specification cases] In this case, every specification case (pre and postcondition) is
%\    verified separately 
%\    \item[Handling of aliasing in frame conditions] Although we have discarded here the aspect of aliasing, our implementation does it
%\      \item[Handling of old constructs in specification]
%\	\item[] 
%\\end{description}
...
Next point which can be interesting is to provide a machine checked proof for the soundness result. 
