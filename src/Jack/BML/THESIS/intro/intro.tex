...
\begin{itemize} 
   ...
   \item an algorithm which  generates logical (verification) conditions  from the annotations and the program.
	 ...
	 that the implementation respects its intended behaviour.
...
on the producer site interactive, shown in Fig. \ref{intro:PPO}. As you can see in the figure, we propose that  the producer site
