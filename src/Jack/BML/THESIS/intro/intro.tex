...
% Applications 
Among the programming systems which has gained a lot of popularity in industry is the Java platform of Sun Microsystems. % and the Common Language Runtime (CLR) of Microsoft.  
...
In these scenarios it is necessary to perform the verification  directly on bytecode level. In particular, we propose a bytecode
