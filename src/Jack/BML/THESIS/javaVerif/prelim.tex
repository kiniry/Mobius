...
The specification of the method \lstinline!divide! does not contain the syntactic sugar \jmlKey{normal\_behavior} and
 \jmlKey{exceptional\_behavior} but explicitely specifies the behavior of the method in the two cases. Particularly, it contains now 
...
%\begin{description} 
 % \item [Class invariants] 
        Let us now see how  class invariants   can be expressed as 
