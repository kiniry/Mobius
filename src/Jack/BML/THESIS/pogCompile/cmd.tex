...
\newcommand{\wpi}[3]{ \textrm{wp}^{bc}( #1, #2, #3) }
\newcommand{\pre}{\psi^{pre}}
\newcommand{\normalPost}{\psi^{postN}}
\newcommand{\excPost}{\psi^{bc}_{exc}}
...
% for denoting a weakest precondition over sequence of instructions
\newcommand{\wpBcSeq}[3]{ \textrm{wp}^{bc}( \mbox{ \rm $ #1 $ }, #2, #3) } 
...
\newcommand{\expressionSrcRel}{\mathcal{E}^{srcRel}}
...
\newcommand{\compileRev}[1]{ \ulcorner #1 \urcorner^{-1} }
...
\newcommand{\wpiSrc}[3]{ \textrm{wp}^{src}( \mbox{ \rm $ #1 $ } , #2, #3) }
\newcommand{\preSrc}{\mbox{\rm\textsf{Pre}}^{src}}
\newcommand{\excPostSrc}{\mbox{\rm\textsf{ePost}}^{src}}
\newcommand{\excPostSpecSrc}{\mbox{\rm\textsf{exc}}^{src}}
...
\newcommand{ \freshVar}{ \mbox{\rm\textbf{ref}} }
