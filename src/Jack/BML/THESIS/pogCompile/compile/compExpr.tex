...
We shall first look at Fig. \ref{pogEq:compile:compExpr:def} how expressions are compiled. We can notice that the compilation of
 the constants like constant integers,
\Mytrue, \Myfalse, \Mynull{}  are compiled down to the instruction \push. Note also that the boolean constant  \Mytrue{} and \Myfalse{}
