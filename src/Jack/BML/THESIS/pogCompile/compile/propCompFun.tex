...
\begin{compProp9}[Exception handler property for expressions]\label{compile:prop:compProp9}
  For every statement $\stmt$ which is not a try catch  in method \methodd \  and  its  subexpression
 $\expressionSrc$, i.e. $\substatement{\stmt}{\expressionSrc}$
 we have that 
