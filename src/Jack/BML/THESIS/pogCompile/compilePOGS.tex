...
\\
 \wpBcSeq{  \compileExp{\expressionSrc_2 } {\stack{\counter}} }{  \compile{\normalPostSrc}
     \substitution{ \compileSynt{ \expressionSrc_1} }{  \stack{\counter} }  } { \excPost }  \wedge \Mytrue
 \end{array} $$
...
\comment{from the properties of \mbox{ \rm \textrm{wp}}   and \numConclusion{4}}
...
\comment{ \mbox{ \rm $ \compile{\normalPostSrc}  $} does not contain stack expressions and so does 
\mbox{ \rm $\compile{\normalPostSrc} \substitution{ \compileSynt{ \expressionSrc_1}} {  \compile{\eval{\expressionSrc}} }   $ }  and from \numConclusion{1}  and  \numConclusion{5}  by induction hypthesis we have } 
...
\comment{from \numConclusion{6} we conclude that this case holds }
