...
%$$ \excPostSpecSrc :  \texttt{ ExceptionTypes } \longrightarrow  Predicate $$ 
...
\begin{itemize}
	     ...
	     \wpiSrc{\expressionSrc_1 }{ 
			    ...
			    \phantom{ wpiSrc\expressionSrc_2 } \left\{ \begin{array}{l}
			      \expressionSrc_1  \neq \mbox{ \rm \Mynull }  \Rightarrow     \\
					  ...
					  \Myspace   \Myspace \forall \ m \in m. \mod \\ %, \forall \mbox{\rm\texttt{r}} \\
 ...
 where \  \compileSrcSpec{ \expressionSrc_1.m( \expressionSrc_2)  } = \freshVar 
            \end{array} $$	 
...
where
\begin{itemize}
  \item $\invariant$ is the invariant of the loop
    \item $  m_i .  i = 1 .. k  $ are the locations that may be modified by a loop
\end{itemize}
