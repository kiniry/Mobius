...
\begin{itemize}
       \item compositional statement
	     ...
	     \wpStmt{   \compileLabel{s}{ \stmt_1 ;  \stmt_2    }{e}}{\psi}{\excPostExpl} = \\
	      ...
	      \comment{definition of the \wpName{} over compiled statements} \\
	      \numConclusion{1} \ \wpStmt{   \compileLabel{s}{\stmt_1}{e'} }{  \wpStmt{  \compileLabel{e'+1}{\stmt_2}{e} }{   \psi }{\excPostExpl }    }{\excPostExpl}  \\\\
	      ...
	      \numConclusion{2} \    \wpStmt{  \compileLabel{e'+1}{\stmt_2}{e} }{   \psi }{\excPostExpl } = \wpi{}{\methodd}{\ins{e'+1}} \\\\
		...
		\comment{from   \numConclusion{1},  \numConclusion{2} and   \numConclusion{3}  we get that }	\\							   
			\wpStmt{   \compileLabel{s}{\stmt_1}{e'} }{  \wpStmt{  \compileLabel{e'+1}{\stmt_2}{e} }{   \psi }{\excPostExpl }    }{\excPostExpl} = 
			\wpi{}{\methodd}{\ins{s}}\\
	    ...
	    %\begin{longtable}{>{$}c<{$}}
	     ...
	     \wpStmt{   \compileLabel{s}{ \begin{array}{l} \Myif \ (\expressionSrcRel) \\
			...
			\comment{definition of the compiler} \\\\
				...
				\end{array}  }{\psi}{\excPostExpl} = \\\\
          \comment{definition of the \wpName{} over compiled expressions} \\\\
				...
				\mbox{\rm\comment{From Property  \ref{compile:prop:compProp8}  } } \\
                               	\end{array}$$
				  $$ \begin{array}{l}
                                \numConclusion{1.7} \forall \mbox{\rm\texttt{Exc}}, \ \methodd.\getExcPost(\mbox{\rm\texttt{Exc}}, e ) =  
                                                                                   \methodd.\getExcPost(\mbox{\rm\texttt{Exc}}, e'' )  \\
