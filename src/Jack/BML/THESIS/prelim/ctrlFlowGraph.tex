...
\begin{figure}[ht!]
$$ 
   \begin{array}{l} \frac{ \methodd.\body[j] = \ifCond \ k  } { \methodd.\body[j] \execRel \methodd.\body[k]  }\\\\
...
\caption{\sc Definition of the execution relation between bytecode instructions in a control flow graph}
\label{defEdge}
\end{figure}
%\end{defEdge}
