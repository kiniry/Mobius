 ...
 will be used later in Chapter \ref{wpGeneral} for the definition of the verification condition generator.
...
\begin{description} 
  ...
  \item [errors] The exception mechanism in Java is provided with two kind of exceptions: exceptions from which 
	...
	state of the JVM. Thus, we omit here this aspect of JVM.
