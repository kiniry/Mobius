		...
		\item Let's $\tt{i_{pc_n}}$ =\arithOp\\
			...
			\begin{array}{l}
			 ...
			 \end{array}  (\conf{\state{n}})$$\\
				...
				$$ \wpi{ next(\ins{{\pc_n }} )} {\pc_n+1 }{\methodd}
			 ( \conf{\state{n} 
			 		\begin{array}{l}
			 			\substitution{\topStack}{\topStack - 1} \\
			 			\substitution { \stack{\topStack - 1} }{\stack{\topStack} \ op \  \stack{\topStack -1}} 
				...
				\comment{ from the operational semantics of \arithOp  } \\ 
			...
			%	$ \wpi{i_{pc_{\state{n}+ 1}}}{\instrPost{i_{pc_{\state{n}+ 1}}}}{ \methodd} (\state{n + 1})$ \\
