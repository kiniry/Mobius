...
\begin{enumerate} 
	...
	\item  $\new  \ \clazz $ 
	        $$ \begin{array}{l}  
			  ...
			  \mbox{\rm\comment{definition of the wp function} } \\
			 \equiv \\  
			\interpTwoLines{	\typeof{\referenceOnly} = \type{\clazz} \Rightarrow \\ \inter{i}{i+1} 
			\begin{array}{l} 
		       ...
		       \end{array} } {\config{\heap }{\counterOnly }{\stackOnly }{\locVarOnly }{\pc }} \\
                       \mbox{\rm\comment{from lemmas \ref{substCntr},  \ref{substStack} and \ref{substHeap} and the operational semantics of the instruction \new }} \\  
...
\item  $\ins{\pc } = \putfield   \ \fieldd $ \\
		    ...
		    \end{array}	$$
                   \begin{enumerate}
		           \item the dereferenced reference on the stack top is \Mynull \ and an exception handler starting at instruction $k$ exists for \NullPointerExc \ 
			          and $\ins{s} $ is in its scope   
			           $$ \begin{array}{l}   
			...
			\subst{\stack{0}}{\referenceOnly} \\
                       ...
                       \end{array} } {\config{\heap }{\counterOnly }{\stackOnly }{\locVarOnly }{\pc }} \\
		       	\mbox{\rm \comment{ from lemmas \ref{substCntr},  \ref{newHeap}  and the operational semantics of  \putfield  }}\\
		 ...
		 \item the reference on the stack top is \Mynull \ and and the exception thrown is not handled.
			   ...
			   \subtype{\fieldd.\declaredIn}{ \mbox{ \rm \texttt{Exc}}} } }    \\
                    \end{array} }{ \config{\heap }{\counterOnly }{\stackOnly }{\locVarOnly }{\pc } }   \\  
		 	\mbox{\rm \textit{\{ from lemmas   \ref{substStack}, \ref{substHeap}   and the operational semantics of \putfield }}\\
		...
		\mbox{\rm\comment{from lemmas \ref{substCntr} and \ref{substStack}} }	 \\
                 ...
                 \interpTwoLines{ \begin{array}{l}
                                    ...
                                    {     state_n 
                                              \begin{array}{l}      
					                \subst{\counter}{\counter + 1}\\
							\subst{\stackOnly{\counter + 1} }{ \locVar{i}  }
...
\mbox{\rm \comment{we can get from the last formulation}}\\
  \numConclusion{1} \ %\begin{array}{l}
					       ...
					       \end{array}  
                              ...
                              \\
                 \numConclusion{2}               \interpTwoLines{ \invariant \Rightarrow \wpi{\ins{\pc_{n+1}}}{\pc_{n+1}}{\methodd} }
                                     {state_n  \begin{array}{l} 
                                                      \subst{\counter}{\counter +1}\\
						      \subst{  \stack{ \counter  + 1}}{\locVar{i}} 
					       \end{array}  
   ...
   % \end{array} 
\mbox{\rm \comment{ from \numConclusion{1}  and \numConclusion{2}  }}\\
  \interp{ \wpi{\ins{\pc_{n+1}}}{\pc_{n+1}}{\methodd} }{state_n  \begin{array}{l} 
                                                     \subst{\counter}{\counter +1} \\
						     \subst{  \stack{ \counter  + 1}}{\locVar{i}} 
					       \end{array}  
                                    }\\
