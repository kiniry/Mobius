...
initial state $s_{0} =\config{\heap_{0}  }{ 0 }{\lbrack \ \rbrack }{\locVarOnly }{ 0 } $ 
 ...
 \begin{itemize}
	 ...
	 \item all methods in \Program{} at level \level{k - 1} are correct w.r.t. their specification
...
that all methods at level \level{k -1} are correct w.r.t. their specification.
...
Let us have a program \Program{} and a method \methodd{} in \Program.
If  all methods in \Program{} at level  \level{k -1} are correct w.r.t. their specification 
