...
Then if the method \methodd{} terminates, i.e. there terminates execution in a
 state $s_n$,  $\methodd : s_0  \stateTransTermWeight{k} s_n $. 
Let all method executions with maximal call depth smaller or equal \mbox{\rm\texttt{k -1}} are correct w.r.t. their specification.
