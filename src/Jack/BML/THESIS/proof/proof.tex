...
Our first concern in this section is to establish that the rules for single bytecode instructions have the following property:
...
Proof:
\textit{ 
As we want to prove that method \methodd{} respects its specification we have
