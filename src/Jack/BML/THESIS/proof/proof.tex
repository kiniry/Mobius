...
initial state $s_{0} =\config{\heap_{0}  }{ 0 }{\lbrack \ \rbrack }{\locVarOnly }{ 0 } $ 
 ...
 \begin{itemize}
	 ...
	 \item  methods with maximal execution depth smaller or equal $ k - 1 $ are correct w.r.t. their specification
...
Then if the method \methodd{} terminates, i.e. there exists a  state $s_n$,  $\methodd : s_0  \stateTransTermWeight{k} s_n   $ 
