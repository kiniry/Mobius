...
we have to see under what conditions a single method is correct at a level \level{k}. The greater 
  part of the proof is concentrated on this. Remind that a method correctness at level  \level{k} means 
