...
\chapter{Equivalence between Java source and bytecode proof Obligations}\label{pogEquiv}
       %\input{pogCompile/cmdPogComp.tex}
  ...
  %    \input bytecode/bcLang.tex
       ...
       %\input{pogCompile/compile/compCtrlStmt.tex}
...
\chapter{A Low-Footprint Java-to-Native Compilation Scheme Using Formal Methods}
      ...
      %\input{applications/optimCompiler/preciseness} 
      ...
      %\input{applications/optimCompiler/conclusion} 
