...
$$
  \begin{array}{l}
       ...
       \Rightarrow \mbox{\rm\texttt{n}}.\normalPost \subst{\result}{\boundVar}
         ...
         \end{array}\right)
          \Rightarrow
          \mbox{\rm\texttt{n}}.\excPostSpec(\mbox{\rm\texttt{Exc}}) \subst{\EXC}{\boundVar}  , \\
...
and values of the local variables. As explained above, we the first condition expresses the fact that
the precondition of the overriding method is stronger than the precondition it
overrides. This is the so called contravariant rule.
...
The second  condition expresses the fact that the normal postcondition of the
 overriding method is stronger than than the postcondition specified in the
  method it overrides. We quantify over the postcond
 Finally, the third formula represents a series of
  ...
  the overriding method must respect the condition of the overriden method.  
