...
\item  object creation and manipulation 
	\begin{enumerate}
		...
		\typeof{\referenceOnly} = \type{\clazz} \Rightarrow \\
		   \Myspace 	\begin{array}{l}   \inter{i}{i+1} \\
		                                   \subst{ \counter}{ \counter + 1 } \\
		  ...
		  counter is incremented, the stack top is substituted by a fresh reference variable \referenceOnly \ and the fields for the 
...
{ \mbox{\rm\texttt{n} }. \numArgs }                                                                                                	\end{array}  \Rightarrow \\ 
					 ...
					 \Myspace \forall \bound_i (  \\ 
						 \Myspace \Myspace \mbox{\rm\texttt{n} }.\excPostSpec ( \mbox{\rm\texttt{n} }.\exceptions[j]) \subst{\EXC }{\bound_i } \Rightarrow \\ 
                                                 \Myspace\Myspace\Myspace  \methodd.\excPostSpec(i,   \methodd.\exceptions[j] )\subst{\EXC }{\bound_i }    ) ) \\
						 \Myspace \wedge \\
