...
forall   ST,    
  ( forall v , (   (~ In v lVar)  ->  ( getVarValAtState z v ) = ( ST v)  ))   ->
 ( wpMod(stmt , fun st   => let (s, sAux) := st in
       ...
       fun st => 
		...
		(p_and  (  (p_forallv (fun x => (p_implies 
                  ...
                  ( p_and                         
                   ( p_forallsAux (fun sAux => (p_foralls ( fun s => ( 
                   (p_implies 
...
(* destruct H2. *)
assert (h := IHHexec1 _ _ H6 (H1 stateAux s  H0    H n)).
simpl in h.
