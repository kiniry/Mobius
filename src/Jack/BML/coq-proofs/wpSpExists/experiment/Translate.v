...
Fixpoint translate (pre : assertion ) (st :stmt) {struct st}: tripleT stmt  assertion listP  :=
 ...
 |  (If z e bT bF) =>
    ...
    (  triple ( If z e btT btF)  SP annex)
