...
The overall objective is to allow a client to trust a code produced by an untrusted code producer. This approach is especially suitable
 ...
 The framework is presented in Fig.~\ref{architecture}; note that certificates are not yet implemented and thus are presented using 
\todo{special font, change the figure} 
