...
describing the field; $\counter$ and \stack{\ArithExpr} which  stand for the stack counter and an element on the stack at position \ArithExpr. These expressions do not appear in the precondition and postcondition specification of a method. Later we shall see how they are used.
...
This attribute is important for the next phase of the JML compilation.
