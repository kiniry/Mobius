...
\newcommand{\expression}{\texttt{expression} }
...
\newcommand{\fieldAccess}[1]{\texttt{Class.fieldName(#1)}}
\newcommand{\arrayAccess}[2]{#1[#2] }

\newcommand{\result}{\jmlKey{$\backslash$result}}
\newcommand{\old}[1]{\jmlKey{$\backslash$old(#1)}}
\newcommand{\typeof}[1]{\jmlKey{$\backslash$typeof(#1)}}
