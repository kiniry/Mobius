...
for every instruction \instr{ins} in method \method~ which may terminate exceptionally with exception \texttt{Exc} the exceptional function
 $\excPost$ (Fig.\ref{instrWP}) returns the \wpi \ predicate of the exceptional handler protecting \instr{ins} from \texttt{Exc} if such a handler exists.
