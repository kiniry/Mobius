...
The contribution of this material is that it provides a framework for establishing trust between a client and a code producer when the producer source code is not available.
More generally, it can be applied to scenarios where the code producer has to implement or to fulfill some client requirements.
Those requirements can be, for example, sufficient to ensure some security properties since they are defined in an high level language.
