...
At fig.~\ref{instrWP} the rule for \instr{putField} substitutes the corresponding field function with an overriding function. The definition of overriding expression is given at fig.~\ref{override}.
