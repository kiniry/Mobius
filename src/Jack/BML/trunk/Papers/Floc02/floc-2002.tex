...
Finally, we briefly present the tool \modtool~and our experiences in
the process of checking the assignable specifications we had
previously stated in the case study\cite{CatanoH02a}. We have
implemented \modtool, by reusing the syntactical analyzer of \jml~and
providing an implementation of the rules we presented in
Section~\ref{sec-syn-met-che-ass-cla} as statical methods.
