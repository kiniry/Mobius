...
specification of the application and although they could have been
found by hand, using a tool like Esc/Java give us the certainty all
...
The \texttt{Annee} class represents a \textit{year}. This class
declares two
