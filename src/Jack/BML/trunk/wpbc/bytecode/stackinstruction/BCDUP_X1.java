...
public class BCDUP_X1 extends BCInstruction implements BCStackInstruction  {
	...
	public Formula wp(Formula _normal_Postcondition, ExsuresTable _exc_Postcondition) {
		...
		wp = wp.substitute(new Stack(Expression.getCOUNTER_PLUS_1()), new Stack(Expression.COUNTER));
		wp = wp.substitute(new Stack(Expression.COUNTER), new Stack(Expression.getCOUNTER_MINUS_1()) );
