...
% security property encoded by the PA.
...
%\end{center}
%\caption{PA fragment to illustrate set-annotation
...
% with the partial PA in Figure~\ref{FigExample}, after the translation
% it is monitored with the total PA in Figure~\ref{FigCompletePA}.
...
%the PA displayed in Figure~\ref{FigAnnotGenExample}, where \texttt{x}
...
%that the guards are now legal JML expressions, as all PA variables
