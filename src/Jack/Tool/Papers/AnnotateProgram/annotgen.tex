...
\marginnote{\small This is specific of the second step, not general.}
...
\marginnote{\small Should we add the condition on ghost variables?}
...
\marginnote{\small To be strict, in the \preset we add an \Assert}
