...
% initial control point should be on the set of declared control points or that
% guards depend only on the value of the declared variables.
...
\end{array}
\]
% AT: Note that actions should be lists
...
% This is temporary, until completed_alt.eps is commited
