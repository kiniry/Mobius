...
use. They are extended finite state machines particularly suited for monitoring,
because transitions can depend on the state of the monitored program.
We call them Property Automata (PA).
...
\(\bot\) is used to denote the outcome of an expression that results in an
exception.
