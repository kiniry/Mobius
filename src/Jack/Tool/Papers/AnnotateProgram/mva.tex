...
\end{array}}
\]
\marginnote{ AT: Why is \NullPointer defined as RunTimeException ? MH: To be more abstract.}
...
\end{inparaenum}.
\marginnote{AT: This are not all the requirements, for instance it is not said that the
     ...
     For a complete English description see the comments I added to MVA. MH: rephrased}
