...
program. A distinction is made between normal and exceptional
...
\end{array}
\]
% AT: Why is \NullPointer defined as RunTimeException ?
...
\textsf{super}.
% AT: We don't need super for our formalization
...
\item a set of special MVA variable declarations, to describe % AT: why special?
...
% AT: The last sentence repetitive
...
\end{inparaenum}.
% AT: This are not all the requirements, for instance it is not said that the
%     initial control point should be on the set of declared control points or
%     that guards depend only on the value of the declared variables.
%     I think that don't want to enuntiate all the requirements precisesly in
%     English but then we should say it. We can say that these are the most
%     important requirements.
%     For a complete English description see the comments I added to MVA.
...
% AT: See the correctness criterion for the completion function I wrote in MVA
...
% TODO: This should be adapted to the new example
...
\begin{figure}[t]
\begin{center}
\epsfig{file=completed_alt.eps, width=4cm}
\end{center}
