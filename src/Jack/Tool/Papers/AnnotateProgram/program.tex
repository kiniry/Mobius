...
program semantics ignores these statements, where the annotated program
...
instantiations of the semantics parameters; % (presented in rule
format); the other instantiations are similar. The relation \gammain
