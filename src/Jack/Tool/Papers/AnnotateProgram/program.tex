...
the first expression argument is a side-effect free expression.}. The semantics
will apply them appropriately.
...
% evaluated.
Since annotated or monitored programs and/or their states
...
\etp{P}{e, \sigma_1}{v, \tau} \qquad
\pif{\tau.\pstate.\ex = \bot}{\sigma_2 = \tau}{\sigma_2 = \tau (\gvs.n := v)}\\
\hline
...
Fig~\ref{FigAnnotatedSem}? If so why don't we refer to it? We should make
clear that this is a parameter to the semantics}
