...
Section~\ref{SecImplem}). % AT: I guess that we won't have an implementation section
% AT: Should we mention our lack of of formalization for object creation?
%     It is strange to see Throw without any argument, we should consider
%     adding as exception as a possible extension
...
% AT: Consider rephrasing the next to last sentence by starting with the subject
%     and then the verb: Pre- and postconditionsa in different ... are functions
%     to allow the use of ....
...
% AT: What is the difference between \beta and \deltaassert?
...
\end{array}
\]
% AT: Did you omit the gvs on purpose?
%     If its is an APState then then the mapping should be prog_state..program
