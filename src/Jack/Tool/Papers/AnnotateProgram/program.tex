...
\marginnote{Should we discuss consequences of restrictions? Probably no space}
...
\noindent where
% This is a simplified version of on_method_PA in MonitoredProgram
\[
{\small
\begin{array}{rcl}
...
%% This example does not add much is a bit disconnected with the
%% previous text
...
%As mentioned above, the syntax and semantics for PA and programming
