...
\subsection{Definition of the basic weakest precondition calculus used on the Advices}
...
\subsection{Definition of the compilation of the Aspects to a predicate transformer}
