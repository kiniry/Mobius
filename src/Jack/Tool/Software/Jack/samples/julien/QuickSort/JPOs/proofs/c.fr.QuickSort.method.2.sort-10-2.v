...
Lemma l: 
   ...
   exists l_j112 : t_int,
     ...
     intelements (f_tab this) l_j112 = intelements_4 (f_tab this) l_i112.
Proof with autoJ.
...
elim(H25 l_i); [intros | split; j_omega].
destruct H26.
rewrite <- H27.
elim (H21 x); [intros | split; j_omega].
destruct H29.
exists x0.
repeat split; j_omega; auto.
solveInc.
eassert(h := (hyp10 (f_tab this) _ l_i _)); auto; 
[unfold not; intros| idtac]; auto.
j_omega.
rewrite h.
destrJlt(l_i <= l_right40_3); subst.
