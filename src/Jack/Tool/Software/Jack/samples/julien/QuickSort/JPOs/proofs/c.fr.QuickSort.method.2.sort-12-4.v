...
Lemma l: 
   ...
   exists l_j106 : t_int,
     ...
     intelements (f_tab this) l_j106 = intelements_6 (f_tab this) l_i106.
Proof with autoJ.
(* Write your proof here *)
intros l_i94.
startJack.
subst.
destruct (classic (l_i94 <= l_right40_3 - 1)).
elim (H19 l_i94); [intros | split; j_omega].
destruct H20.
rewrite <- H21.
destruct H20.
elim (H16 x); [intros | split; j_omega].
exists x0...
solveInc.
eassert(h := (hyp8 (f_tab this) _ l_i94 _)); auto;
[unfold not; intros; j_omega | idtac].
rewrite h.
elim (H16 l_i94); [intros | split; j_omega].
exists x...
