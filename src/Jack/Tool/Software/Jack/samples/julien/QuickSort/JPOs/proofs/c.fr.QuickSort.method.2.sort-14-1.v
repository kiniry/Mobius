...
Lemma l: 
   ...
   t_int ->
   l_lo <= l_i0 /\ l_i0 < l_left40_3 ->
   intelements_7 (f_tab this) l_i0 <= intelements_7 (f_tab this) l_left40_3.
Proof with autoJ.
(* Write your proof here *)
startJack.
subst.
eassert (h1 := (hyp5 (f_tab this) _ l_hi _)); auto; [unfold not; intros; j_omega | idtac].
rewrite H15.
rewrite h1.
eassert(h2 := (H12 l_i0 _ _ _)); auto.
rewrite hyp2; auto; [idtac | unfold not; intros; subst; j_omega].
rewrite hyp6; auto; unfold not; intros; subst; j_omega.
