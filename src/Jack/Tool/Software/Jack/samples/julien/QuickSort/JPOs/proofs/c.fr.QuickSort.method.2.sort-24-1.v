...
Open Scope J_Scope.
Section JackProof.
Variable intelements_10 : REFERENCES -> t_int.
Variable shortelements_3 : REFERENCES -> t_short.
Variable byteelements_3 : REFERENCES -> t_byte.
Variable booleanelements_3 : REFERENCES -> bool.
Variable charelements_3 : REFERENCES -> t_char.
Variable refelements_3 : REFERENCES -> REFERENCES.
Variable newObject_10 : REFERENCES.
...
Hypothesis req1 : ((((f_tab this <> null /\ 0 <= l_lo) /\
            ...
            true = true.
Hypothesis hyp1 : ~ instances newObject_10.
Hypothesis hyp2 : newObject_10 <> null.
...
Hypothesis hyp9 : forall T184 : REFERENCES,
