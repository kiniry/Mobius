...
Hypothesis hyp2 : interval 0 (j_sub (arraylength (f_tab this)) 1) l_right40_0.
Hypothesis hyp3 : f_tab this <> null.
Hypothesis hyp4 : l_left40_1 < l_right40_0.
...
Hypothesis hyp12 : intelements (f_tab this) l_hi <=
             intelements_19 (f_tab this) l_right40_0.
Hypothesis hyp13 : ~
             intelements_19 (f_tab this) l_left40_1 <=
             intelements (f_tab this) l_hi.
Hypothesis hyp14 : (((l_left40_1 <= l_right40_0 /\ l_right40_0 <= l_right40_2) /\
               l_right40_0 <= l_hi) /\
              (forall l_k69 : t_int,
...
Lemma l: 
   forall l_k70 : t_int,
   l_right40_0 - 1 < l_k70 /\ l_k70 <= l_hi ->
   intelements (f_tab this) l_hi <= intelements_19 (f_tab this) l_k70.
Proof with autoJ.
(* Write your proof here *)
intros l_k.
startJack.
destrJlt(l_right40_0 <= l_k).
subst...
