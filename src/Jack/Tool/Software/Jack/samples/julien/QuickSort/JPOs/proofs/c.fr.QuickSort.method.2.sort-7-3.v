...
Hypothesis hyp11 : 0 < l_left40_3.
Hypothesis hyp12 : forall T110 : REFERENCES,
...
Hypothesis hyp14 : ((forall l_i0 : t_int,
               t_int ->
               t_int ->
               l_lo <= l_i0 /\ l_i0 < l_left40_3 ->
...
Hypothesis hyp20 : (((((l_lo <= l_left40_3 /\ l_left40_3 <= l_right40_3) /\
                 l_right40_3 <= l_hi) /\
                (forall l_m : t_int,
...
Lemma l: 
   forall x21 : REFERENCES,
   ~ singleton REFERENCES (f_tab this) x21 ->
   forall x22 : t_int,
   instances x21 -> intelements_6 x21 x22 = intelements x21 x22.
Proof with autoJ.
