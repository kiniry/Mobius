...
Hypothesis hyp11 : forall T110 : REFERENCES,
...
Lemma l: 
   ...
   l_i0 < l_j111 ->
   intelements_6 (f_tab this) l_i0 <= intelements_6 (f_tab this) l_j111.
Proof with autoJ.
(* Write your proof here *)
intros l_i h l_j.
startJack.
subst...
destruct (classic (l_i < l_right40_3)); 
destruct (classic (l_j < l_right40_3)); j_omega.
destrJlt (l_j <= l_right40_3).
solveInc.
destrJlt (l_right40_3 <= l_j).
j_omega...
subst...
