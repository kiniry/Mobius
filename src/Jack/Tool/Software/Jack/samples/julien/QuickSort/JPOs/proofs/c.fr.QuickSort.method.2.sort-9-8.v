...
Hypothesis hyp13 : forall T170 : REFERENCES,
...
Hypothesis hyp15 : l_left34_2 < l_right34_2.
Hypothesis hyp16 : f_tab this <> null.
Hypothesis hyp17 : ~
             intelements (f_tab this) l_hi <=
             intelements_17 (f_tab this) l_right34_1.
Hypothesis hyp18 : (forall l_k62 : t_int,
...
Hypothesis hyp19 : ((l_left34_1 <= l_right34_1 /\ l_right34_1 <= l_hi) /\
              (forall l_k56 : t_int,
...
Hypothesis hyp20 : ~
             intelements_17 (f_tab this) l_left34_1 <=
             intelements (f_tab this) l_hi.
Hypothesis hyp21 : (l_lo <= l_left34_1 /\ l_left34_1 <= l_right34_2) /\
             (forall l_k50 : t_int,
              l_lo <= l_k50 /\ l_k50 < l_left34_1 ->
              intelements_17 (f_tab this) l_k50 <=
              intelements (f_tab this) l_hi).
Hypothesis hyp22 : ((((l_lo <= l_left34_2 /\ l_left34_2 <= l_right34_2) /\
                l_right34_2 <= l_hi) /\
               (forall l_m : t_int,
