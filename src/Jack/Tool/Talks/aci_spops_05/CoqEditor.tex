...
\nextslide{Some Screenshots (1)}
\begin{center}
\includegraphics[width=0.80 \linewidth]{coqeditor.ps}
\end{center}

\nextslide{Some Screenshots (2)}
\begin{center}
\includegraphics[width=0.73 \linewidth]{coqeditor1.ps}
\end{center}
\nextslide{Some Screenshots (3)}
\begin{center}
\includegraphics[width=0.53 \linewidth]{coqeditor2.ps}
\end{center}