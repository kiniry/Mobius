...
\item But does not directly consider method specification
...
\frame{
\begin{itemize}
\item Visible state semantics: \alert{all} invariants of \alert{all}
...
\frame{
 ...
 \item Spread read-only capacities guarantees data race freeness
