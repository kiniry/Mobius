...
%%%---%Sect.~\ref{sec-syn-met-che-ass-cla}.
%%%---
...
%%%---%found.
%%%---
%%%---%Sect.~\ref{abo-jml-cla-use} gives a general overview of the class
%%%---%for handling Abstract syntax trees coming with
%%%---%\jml. Sect.~\ref{sub-sec-cla-ast-con} summarizes the implementation
%%%---%of the class \texttt{ASTContext} which is in charge of figuring out
%%%---%context of method declarations. Sect.~\ref{sub-sec-the-cla-ass}
%%%---%presents the class \texttt{Assignable}, which implement our
%%%---%syntactical rules. Finally, Sect. ~\ref{sub-sec-usi-the-too}
...
presented in Sect.~\ref{sec-syn-met-che-ass-cla}. This class uses the 
