...
a confirmation is send back to the bank.
...
loyalty points for doing certain purchases, and these points can be
...
composed of a decimal part and a integer part,
