...
\medskip\\
\Blue{joint work with Mariela Pavlova, Gilles Barthe, Lilian Burdy \& Jean-Louis Lanet}}
...
\item Consequences:
  \begin{itemize}
     ...
     \item Connections with automatic provers (B prover, Simplify)
  \end{itemize}
\end{itemize}
\end{slide}
}
...
\textbf{public void m() \{
   ...
   \Blue{// will require TRANS == 0}
   JCSystem.beginTransaction();
   \Blue{// TRANS modified, ensures TRANS == 1}
   ...
   \Blue{// will require TRANS == 1}
   JSSystem.commitTransaction();
   \Blue{// TRANS modified, ensures TRANS == 0}
   ...
   \}}
\end{alltt}
\end{slide}
