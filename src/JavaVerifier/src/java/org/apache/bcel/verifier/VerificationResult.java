...
public class VerificationResult {
    ...
    /**
     * Returns the method in which the verification failed. It returns -1 in
     * case the verification failed outside any method.
     *
     * @return the method for which the verification failed, -1 in case the
    ...
    /**
     * Returns the instruction label at which the verification failed. This
     * is meaningful only in case the verification failed inside of a method.
     * It returns -1 in case the verification failed outside any method.
     *
     * @return the instruction label at which the verification failed or
     *   -1 in case the verification failed outside of any method
     */
