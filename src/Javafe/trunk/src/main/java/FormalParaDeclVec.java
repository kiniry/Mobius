 ...
 ** $Id: FormalParaDeclVec.j 1928 2006-05-19 12:43:10Z chalin $
 **
 ** DO NOT EDIT!!<p>
 **/
 ...
 *
 *
 * By Default, FormalParaDeclVec's may not contain nulls.  If the ability to
...
public class  FormalParaDeclVec {
    ...
    private /*@ spec_public non_null*/ FormalParaDecl[] elements;
    //@ invariant (\forall int i; (0<=i && i<count) ==> elements[i]!=null);
    //@ invariant \typeof(elements) == \type(FormalParaDecl[]);
    ...
    //@ ensures \result!=null;
    //@ ensures \fresh(\result);
    public static FormalParaDeclVec make(Vector vec) {
	int sz = vec.size();
    ...
    public static FormalParaDeclVec popFromStackVector(/*@non_null*/ StackVector s) {
