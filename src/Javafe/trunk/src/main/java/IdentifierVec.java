 ...
 ** $Id: IdentifierVec.j 1928 2006-05-19 12:43:10Z chalin $
 **
 ** DO NOT EDIT!!<p>
 **/
 ...
 *
 *
 * By Default, IdentifierVec's may not contain nulls.  If the ability to
...
public class  IdentifierVec {
    ...
    private /*@ spec_public non_null*/ Identifier[] elements;
    //@ invariant (\forall int i; (0<=i && i<count) ==> elements[i]!=null);
    //@ invariant \typeof(elements) == \type(Identifier[]);
    ...
    //@ pure
    private IdentifierVec(Identifier[] els) {
    ...
    //@ ensures \result!=null;
    //@ ensures \fresh(\result);
    public static IdentifierVec make(int count) { 
    ...
    //@ ensures \result!=null;
    //@ ensures \fresh(\result);
    public static IdentifierVec make(Vector vec) {
	int sz = vec.size();
    ...
    //@ ensures \fresh(\result);
    public static IdentifierVec make(Identifier[] els) {
    ...
    public static IdentifierVec popFromStackVector(/*@non_null*/ StackVector s) {
    ...
    //@ ensures \result!=null;					// @@@@
    //@ pure
    public final Identifier elementAt(int index)
    ...
    //@ requires 0<=index && index<count;
    //@ requires x!=null;					// @@@@
    public final void setElementAt(Identifier x, int  index) 
	/*throws ArrayIndexOutOfBoundsException*/ {
	if (index < 0 || index >= count)
	    throw new ArrayIndexOutOfBoundsException(index);
	elements[index] = x;
  ...
  public final void addElement(Identifier x) {
  ...
  //@ requires x!=null;						// @@@@
  //@ modifies count;
  public final boolean removeElement(Identifier x) {
    for( int i=0; i<count; i++ ) {
      if( elements[i] == x ) {
	  int ct=count;
  ...
  //@ modifies count,elements;
  //@ ensures count==\old(count)+1;
  public final void insertElementAt(Identifier obj, int index) {
    if( count == elements.length ) {
      Identifier[] newElements = new Identifier[ 2*(elements.length==0 ?
					      2 : elements.length) ];
      //@ set newElements.owner = this;
  ...
  public final void append(IdentifierVec vec) {
