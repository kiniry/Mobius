...
// Generated boilerplate constructors:
  ...
  protected InterfaceDecl(int modifiers, ModifierPragmaVec pmodifiers, /*@ non_null @*/ Identifier id, /*@ non_null @*/ TypeNameVec superInterfaces, TypeModifierPragmaVec tmodifiers, /*@ non_null @*/ TypeDeclElemVec elems, int loc, int locId, int locOpenBrace, int locCloseBrace) {
...
// Generated boilerplate methods:
  ...
  public final void accept(/*@ non_null */ Visitor v) { v.visitInterfaceDecl(this); }

  public final /*@ non_null */ Object accept(/*@ non_null */ VisitorArgResult v, Object o) {return v.visitInterfaceDecl(this, o); }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ InterfaceDecl make(int modifiers, ModifierPragmaVec pmodifiers, /*@ non_null @*/ Identifier id, /*@ non_null @*/ TypeNameVec superInterfaces, TypeModifierPragmaVec tmodifiers, /*@ non_null @*/ TypeDeclElemVec elems, int loc, int locId, int locOpenBrace, int locCloseBrace) {
     InterfaceDecl result = new InterfaceDecl(modifiers, pmodifiers, id, superInterfaces, tmodifiers, elems, loc, locId, locOpenBrace, locCloseBrace);
     result.postMake();
     return result;
  }
}
