...
resulting BML representation (the specification in BML can conatin
...
body. The annotation should be added to the vertex \textit{c}. In the
...
are interested in. We try to figure out if the this instruction can
...
\item Loop interchange:\\
  ...
  way.
\item Code-motion:\\
  Some part of the loop body may be moved before the loop. The
  invariant content might describe the
\end{itemize}
