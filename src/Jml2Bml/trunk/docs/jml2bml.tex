...
concept. One simply provides new implementation of a translation rule and registers it in the manager.
...
environment~\cite{Jack}.  However, BML specification language and the
