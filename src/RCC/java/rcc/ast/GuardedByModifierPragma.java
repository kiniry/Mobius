...
public class GuardedByModifierPragma extends ModifierPragma {
    ...
    public int getEndLoc() {
        if (expressions.size() == 0) return super.getEndLoc();
    ...
    protected GuardedByModifierPragma(/* @ non_null @ */ExprVec expressions,
        int loc) {
    ...
    public final/* @non_null */String toString() {
        return "[GuardedByModifierPragma" + " expressions = "
            + this.expressions + " loc = " + this.loc + "]";
    }
    ...
    public final void accept(javafe.ast.Visitor v) {
        if (v instanceof Visitor)
            ((Visitor) v).visitGuardedByModifierPragma(this);
    }

    public final Object accept(javafe.ast.VisitorArgResult v, Object o) {
        if (v instanceof VisitorArgResult)
            return ((VisitorArgResult) v).visitGuardedByModifierPragma(this, o);
        else
            return null;
    }
    ...
    // @ ensures \result != null;
    public static GuardedByModifierPragma make(
