...
public class TagConstants extends GeneratedTags {
    ...
    /*
     * TODO These should be renamed to have RCC as a prefix. For example,
     *      READONLY hides a tag in JavaFE.
     */
    ...
    public static final int LASTRCCKEYWORDTAG = GHOST + 1;

    // // Tags for RCC/Java checks
    public static final int FIRSTRCCCHECKTAG = LASTRCCKEYWORDTAG;
    ...
    public static final int CHK_AS_ASSUME = LASTRCCCHECKTAG;
