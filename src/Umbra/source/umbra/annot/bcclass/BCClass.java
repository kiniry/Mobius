...
import umbra.annot.bcclass.attributes.ClassInvariant;
//import umbra.annot.bcclass.attributes.HistoryConstraints;
...
public class BCClass {
	private LinkedList<BCMethod> methods;
...
//		initializeMethods();
	...
	public void initializeMethods() throws ReadAttributeException {
		try {
