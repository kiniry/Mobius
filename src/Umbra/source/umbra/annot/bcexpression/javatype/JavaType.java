 ...
 *
 */
package umbra.annot.bcexpression.javatype;
...
import umbra.annot.bcexpression.jml.JML_CONST_TYPE;
...
//	public static final JavaBasicType  JavaDOUBLE = new JavaBasicType(Type.DOUBLE);
	...
	public static JavaType getJavaType(String typeName) {
		...
		return null; //getJavaRefType(typeName);
	}
	...
	public static JavaType getJavaType(Type _type) {
		...
		return null; //getJavaRefType(_type);
	}
...
/*	*//**
	...
	*/
	...
	/**
	 * @return the corresponding bcel type wrapped by this class
	 */
