...
import umbra.annot.bcclass.attributes.Exsures;
import umbra.annot.bcclass.attributes.ExsuresTable;
import umbra.annot.bcclass.attributes.LoopSpecification;
import umbra.annot.bcclass.attributes.MethodSpecification;
import umbra.annot.bcclass.attributes.ModifiesSet;
import umbra.annot.bcclass.attributes.Postcondition;
import umbra.annot.bcclass.attributes.SecondConstantPool;
import umbra.annot.bcclass.attributes.SingleLoopSpecification;
import umbra.annot.bcclass.attributes.SpecificationCase;
import umbra.annot.bcexpression.ArithmeticExpression;
import umbra.annot.bcexpression.ArrayAccessExpression;
...
import umbra.annot.bcexpression.Variable;
...
import umbra.annot.constants.BCConstant;
import umbra.annot.constants.BCConstantFieldRef;
import umbra.annot.constants.BCConstantUtf8;
...
import umbra.annot.formula.UnknownFormula;
import umbra.annot.modifexpression.AllArrayElem;
import umbra.annot.modifexpression.ArrayElemFromTo;
import umbra.annot.modifexpression.Everything;
import umbra.annot.modifexpression.ModifiesArray;
import umbra.annot.modifexpression.ModifiesDOT;
import umbra.annot.modifexpression.ModifiesExpression;
import umbra.annot.modifexpression.ModifiesIdent;
import umbra.annot.modifexpression.ModifiesLocalVariable;
import umbra.annot.modifexpression.Nothing;
import umbra.annot.modifexpression.SingleIndex;
import umbra.annot.modifexpression.SpecArray;
import umbra.annot.modifexpression.UnknownArray;
import umbra.annot.modifexpression.UnknownModifies;
...
//	// }
	...
	public static String printAttribute(Unknown privateAttr,
			BCClass _clazz, BCLocalVariable[] _localVariables) throws ReadAttributeException {
		return readAttribute(privateAttr, _clazz, localVariables).printCode();
	}
}
