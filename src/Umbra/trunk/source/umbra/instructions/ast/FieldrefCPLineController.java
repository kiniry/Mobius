...
public class FieldrefCPLineController extends CPLineController {
   ...
   */
  public FieldrefCPLineController(final String a_line_text, final String an_entry_type) {
  ...
  public final boolean correct() {
    ...
    res = res &&my_parser.swallowSingleMnemonic(BytecodeStrings.FIELDREF_CP_ENTRY_KEYWORD);
    res = res && my_parser.swallowWhitespace();
