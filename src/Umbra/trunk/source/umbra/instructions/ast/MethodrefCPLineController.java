...
/**
 * This is a class that represents CONSTANT_Methodref_info constant
 * pool entry line controller.
 * @author Tomasz Olejniczak (to236111@students.mimuw.edu.pl)
 * @version a-01
 *
 */
public class MethodrefCPLineController extends CPLineController {

  /**
   * This creates an instance of a bytecode line handle to handle
   * constant pool entry of the type CONSTANT_Methodref_info.
   *
   * @param a_line_text the string representation of the line text
   * @param an_entry_type the string "Methodref", ignored parameter
  ...
  */
  private int getClassReference() {
    ...
    my_parser.swallowSingleMnemonic(BytecodeStrings.METHODREF_CP_ENTRY_KEYWORD);
    my_parser.swallowWhitespace();
   ...
   * <br> <br>
   * TODO (236111) fixme: NoSuchConstanError generated by this method
   * has 0 at first position (class index) no matter what is its real value
   *
