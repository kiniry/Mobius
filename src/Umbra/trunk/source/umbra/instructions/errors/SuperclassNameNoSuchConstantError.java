 ...
 * from java class as superclass name index.
 *
 * @author Tomasz Olejniczak (to236111@students.mimuw.edu.pl)
 * @version a-01
 *
 */
public class SuperclassNameNoSuchConstantError extends NoSuchConstantError {
   ...
   * caused the error
   */
  public SuperclassNameNoSuchConstantError(final int a_constant) {
    super();
  ...
  public String[] getCauses() {
    return new String[] {"Superlass name index"};
  }
  ...
  public String getShortErrorMessage() {
    return super.getErrorMessage() + " (superclass name index)";
  }
