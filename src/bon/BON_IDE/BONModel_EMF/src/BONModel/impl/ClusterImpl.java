 ...
 * <ul>
 *   <li>{@link BONModel.impl.ClusterImpl#getContents <em>Contents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClusterImpl extends StaticAbstractionImpl implements Cluster {
	...
	protected EClass eStaticClass() {
		return BONModelPackage.Literals.CLUSTER;
	}
	...
	public EList<StaticAbstraction> getContents() {
		if (contents == null) {
			contents = new EObjectResolvingEList<StaticAbstraction>(StaticAbstraction.class, this, BONModelPackage.CLUSTER__CONTENTS);
		}
		return contents;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BONModelPackage.CLUSTER__CONTENTS:
				return getContents();
		}
