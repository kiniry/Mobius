...
public class ThinResizableCompartmentFigure extends ResizableCompartmentFigure {

	public ThinResizableCompartmentFigure(String compartmentTitle, IMapMode mm) {
