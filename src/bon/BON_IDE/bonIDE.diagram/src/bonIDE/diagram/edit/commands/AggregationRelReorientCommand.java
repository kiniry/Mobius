 ...
 * @generated
 */
public class AggregationRelReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AggregationRelReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof bonIDE.AggregationRel) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return bonIDE.diagram.edit.policies.BonideBaseItemSemanticEditPolicy.LinkConstraints.canExistAggregationRel_4002
	 ...
	 * @generated
	 */
	protected bonIDE.AggregationRel getLink() {
		return (bonIDE.AggregationRel) getElementToEdit();
	}
