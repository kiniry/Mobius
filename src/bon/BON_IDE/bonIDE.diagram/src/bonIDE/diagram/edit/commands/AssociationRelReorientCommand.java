 ...
 * @generated
 */
public class AssociationRelReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AssociationRelReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof bonIDE.AssociationRel) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return bonIDE.diagram.edit.policies.BonideBaseItemSemanticEditPolicy.LinkConstraints.canExistAssociationRel_4003
	 ...
	 * @generated
	 */
	protected bonIDE.AssociationRel getLink() {
		return (bonIDE.AssociationRel) getElementToEdit();
	}
