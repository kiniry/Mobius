 ...
 * @generated
 */
public class BONClassParentsEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BONClassParentsEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = bonIDE.diagram.providers.BonideParserProvider.getParser(
					...
					bonIDE.diagram.part.BonideVisualIDRegistry
							.getType(bonIDE.diagram.edit.parts.BONClassParentsEditPart.VISUAL_ID));
		}
		return parser;
	}
