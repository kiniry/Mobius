 ...
 * @generated
 */
public class ClusterName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClusterName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = bonIDE.diagram.providers.BonideParserProvider.getParser(
					bonIDE.diagram.providers.BonideElementTypes.Cluster_3001, getParserElement(),
