 ...
 * @generated
 */
public class FeatureArgumentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FeatureArgumentNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = bonIDE.diagram.providers.BonideParserProvider.getParser(
					...
					bonIDE.diagram.part.BonideVisualIDRegistry.getType(bonIDE.diagram.edit.parts.FeatureArgumentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
