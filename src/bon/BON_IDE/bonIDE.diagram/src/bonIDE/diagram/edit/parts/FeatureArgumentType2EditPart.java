 ...
 * @generated
 */
public class FeatureArgumentType2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FeatureArgumentType2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = bonIDE.diagram.providers.BonideParserProvider.getParser(
					...
					bonIDE.diagram.part.BonideVisualIDRegistry
							.getType(bonIDE.diagram.edit.parts.FeatureArgumentType2EditPart.VISUAL_ID));
		}
		return parser;
	}
