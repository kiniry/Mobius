 ...
 * @generated
 */
public class PostConditionContentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PostConditionContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = bonIDE.diagram.providers.BonideParserProvider.getParser(
					...
					bonIDE.diagram.part.BonideVisualIDRegistry
							.getType(bonIDE.diagram.edit.parts.PostConditionContentEditPart.VISUAL_ID));
		}
		return parser;
	}
