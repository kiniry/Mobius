 ...
 * @generated
 */
public class PreConditionContentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PreConditionContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = bonIDE.diagram.providers.BonideParserProvider.getParser(
					...
					bonIDE.diagram.part.BonideVisualIDRegistry
							.getType(bonIDE.diagram.edit.parts.PreConditionContentEditPart.VISUAL_ID));
		}
		return parser;
	}
