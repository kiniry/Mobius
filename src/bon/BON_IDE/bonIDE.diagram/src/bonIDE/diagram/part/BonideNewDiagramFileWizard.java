 ...
 * @generated
 */
public class BonideNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	private bonIDE.diagram.part.ModelElementSelectionPage diagramRootElementSelectionPage;
	 ...
	 * @generated
	 */
	public BonideNewDiagramFileWizard(URI domainModelURI,
			EObject diagramRoot,
		...
		myFileCreationPage.setFileName(bonIDE.diagram.part.BonideDiagramEditorUtil.getUniqueFileName(
				filePath, fileName, "bonide_diagram")); //$NON-NLS-1$
	...
	public boolean performFinish() {
		...
		bonIDE.diagram.part.BonideDiagramEditorUtil.setCharset(diagramFile);
		...
		try {
			...
			bonIDE.diagram.part.BonideDiagramEditorPlugin.getInstance().logError("Unable to open editor", ex); //$NON-NLS-1$
		}
		return true;
	}
	 ...
	 * @generated
	 */
	private static class DiagramRootElementSelectionPage extends bonIDE.diagram.part.ModelElementSelectionPage {
		...
		protected String getSelectionTitle() {
			return bonIDE.diagram.part.Messages.BonideNewDiagramFileWizard_RootSelectionPageSelectionTitle;
		}
		...
		protected boolean validatePage() {
			if (selectedModelElement == null) {
				setErrorMessage(bonIDE.diagram.part.Messages.BonideNewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
