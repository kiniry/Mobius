...
/**
 * This is the item provider adapter for a {@link bonIDE.Cluster} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClusterItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addExpandedHeightPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BonIDEPackage.Literals.CLUSTER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCollapsedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cluster_collapsed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cluster_collapsed_feature", "_UI_Cluster_type"),
				 BonIDEPackage.Literals.CLUSTER__COLLAPSED,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Expanded Height feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addExpandedHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cluster_expandedHeight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cluster_expandedHeight_feature", "_UI_Cluster_type"),
				 BonIDEPackage.Literals.CLUSTER__EXPANDED_HEIGHT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BonIDEPackage.Literals.CLUSTER__CONTENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BonIDEPackage.Literals.CLUSTER__CONTENTS,
