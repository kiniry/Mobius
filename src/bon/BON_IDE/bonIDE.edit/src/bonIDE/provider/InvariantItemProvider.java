...
/**
 * This is the item provider adapter for a {@link bonIDE.Invariant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InvariantItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Invariant_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Invariant_content_feature", "_UI_Invariant_type"),
				 BonIDEPackage.Literals.INVARIANT__CONTENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Invariant)object).getContent();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Invariant.class)) {
			case BonIDEPackage.INVARIANT__CONTENT:
