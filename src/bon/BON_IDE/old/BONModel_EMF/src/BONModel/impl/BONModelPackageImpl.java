...
public class BONModelPackageImpl extends EPackageImpl implements BONModelPackage {
	 ...
	 * @generated
	 */
	private EClass singleStateAssertionEClass = null;
	 ...
	 * @generated
	 */
	private EClass doubleStateAssertionEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getStaticAbstraction_Name() {
		return (EAttribute)staticAbstractionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getClass_Invariant() {
	 ...
	 * @generated
	 */
	public EReference getCall_Feature() {
	 ...
	 * @generated
	 */
	public EReference getCall_Entity() {
	 ...
	 * @generated
	 */
	public EAttribute getFeature_PreConditionString() {
	 ...
	 * @generated
	 */
	public EAttribute getFeature_PostConditionString() {
	 ...
	 * @generated
	 */
	public EReference getFeature_PostCondition() {
	 ...
	 * @generated
	 */
	public EReference getFeature_PreCondition() {
	 ...
	 * @generated
	 */
	public EReference getChainedCall_Chain() {
	 ...
	 * @generated
	 */
	public EAttribute getExpression_Contents() {
	 ...
	 * @generated
	 */
	public EClass getSingleStateAssertion() {
		return singleStateAssertionEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getDoubleStateAssertion() {
		return doubleStateAssertionEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(staticAbstractionEClass, STATIC_ABSTRACTION__NAME);
		...
		createEReference(classEClass, CLASS__INVARIANT);
		createEReference(classEClass, CLASS__FEATURES);

		callEClass = createEClass(CALL);
		createEReference(callEClass, CALL__ARGUMENTS);
		createEReference(callEClass, CALL__FEATURE);
		createEReference(callEClass, CALL__ENTITY);
		...
		createEReference(featureEClass, FEATURE__POST_CONDITION);
		createEReference(featureEClass, FEATURE__PRE_CONDITION);
		createEReference(featureEClass, FEATURE__PARAMETERS);
		createEAttribute(featureEClass, FEATURE__PRE_CONDITION_STRING);
		createEAttribute(featureEClass, FEATURE__POST_CONDITION_STRING);
		...
		createEReference(chainedCallEClass, CHAINED_CALL__CHAIN);

		expressionEClass = createEClass(EXPRESSION);
		createEReference(expressionEClass, EXPRESSION__RESULT_TYPE);
		createEAttribute(expressionEClass, EXPRESSION__CONTENTS);

		booleanExpressionEClass = createEClass(BOOLEAN_EXPRESSION);

		assertionEClass = createEClass(ASSERTION);

		singleStateAssertionEClass = createEClass(SINGLE_STATE_ASSERTION);

		doubleStateAssertionEClass = createEClass(DOUBLE_STATE_ASSERTION);
	...
	public void initializePackageContents() {
		...
		assertionEClass.getESuperTypes().add(this.getBooleanExpression());
		singleStateAssertionEClass.getESuperTypes().add(this.getAssertion());
		doubleStateAssertionEClass.getESuperTypes().add(this.getAssertion());
		...
		initEAttribute(getStaticAbstraction_Name(), ecorePackage.getEString(), "name", null, 0, 1, StaticAbstraction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClass_Invariant(), this.getDoubleStateAssertion(), null, "invariant", null, 0, 1, BONModel.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCall_Feature(), this.getFeature(), null, "feature", null, 0, 1, Call.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCall_Entity(), this.getEntity(), null, "entity", null, 0, 1, Call.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = addEOperation(callEClass, ecorePackage.getEBooleanObject(), "isValid", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getClass_(), "aClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getFeature_PostCondition(), this.getDoubleStateAssertion(), null, "postCondition", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFeature_PreCondition(), this.getSingleStateAssertion(), null, "preCondition", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFeature_PreConditionString(), ecorePackage.getEString(), "preConditionString", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_PostConditionString(), ecorePackage.getEString(), "postConditionString", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = addEOperation(featureEClass, null, "rename", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getChainedCall_Chain(), this.getCall(), null, "chain", null, 0, 1, ChainedCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(expressionEClass, Expression.class, "Expression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExpression_ResultType(), this.getClass_(), null, "resultType", null, 0, 1, Expression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExpression_Contents(), ecorePackage.getEString(), "contents", null, 0, -1, Expression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(booleanExpressionEClass, BooleanExpression.class, "BooleanExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(assertionEClass, Assertion.class, "Assertion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(singleStateAssertionEClass, SingleStateAssertion.class, "SingleStateAssertion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(doubleStateAssertionEClass, DoubleStateAssertion.class, "DoubleStateAssertion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
