 ...
 *   <li>{@link BONModel.impl.ClassImpl#getInvariant <em>Invariant</em>}</li>
...
public class ClassImpl extends StaticAbstractionImpl implements BONModel.Class {
	 ...
	 * @ordered
	 */
	protected DoubleStateAssertion invariant;
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, BONModelPackage.CLASS__FEATURES);
		}
		return features;
	}
	 ...
	 * @generated
	 */
	public DoubleStateAssertion getInvariant() {
		if (invariant != null && invariant.eIsProxy()) {
			InternalEObject oldInvariant = (InternalEObject)invariant;
			invariant = (DoubleStateAssertion)eResolveProxy(oldInvariant);
			if (invariant != oldInvariant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BONModelPackage.CLASS__INVARIANT, oldInvariant, invariant));
			}
		}
		return invariant;
	}
	 ...
	 * @generated
	 */
	public DoubleStateAssertion basicGetInvariant() {
		return invariant;
	}
	 ...
	 * @generated
	 */
	public void setInvariant(DoubleStateAssertion newInvariant) {
		DoubleStateAssertion oldInvariant = invariant;
		invariant = newInvariant;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BONModelPackage.CLASS__INVARIANT, oldInvariant, invariant));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BONModelPackage.CLASS__ALL_NAMES:
				return getAllNames();
			case BONModelPackage.CLASS__INVARIANT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case BONModelPackage.CLASS__ALL_NAMES:
				...
				return;
			case BONModelPackage.CLASS__INVARIANT:
				setInvariant((DoubleStateAssertion)newValue);
				return;
			case BONModelPackage.CLASS__FEATURES:
				getFeatures().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case BONModelPackage.CLASS__ALL_NAMES:
				...
				return;
			case BONModelPackage.CLASS__INVARIANT:
				setInvariant((DoubleStateAssertion)null);
				return;
			case BONModelPackage.CLASS__FEATURES:
				getFeatures().clear();
				return;
