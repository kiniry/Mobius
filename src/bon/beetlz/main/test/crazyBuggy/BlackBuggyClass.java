...
public class  BlackBuggyClass {
  ...
  //  @ensures numbers[0] != 0; 
  //  @ensures numbers[1] == 0;
  public String one(/*@ non_null @*/ String eins,/*@ non_null @*/ String zwei){return null;}
  ...
  public /*@ pure @*/ YellowBuggyClass three(boolean eins, boolean zwei, boolean drei){return null;}

  //  (int) uno % (int) duo = 0; not supported
  //  @requires +uno > 0;
