...
public class SWTResourceManager {
  ...
  public static Font getFont(String name, int size, int style, boolean strikeout, boolean underline) {
    String fontName = name + "|" + size + "|" + style + "|" + strikeout + "|" + underline; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
  ...
  public static Image getImage(String url) {
    try {
      ...
      System.err.println("SWTResourceManager.getImage: Error getting image "+url+", "+e); //$NON-NLS-1$ //$NON-NLS-2$
      return null;
    }
  }
