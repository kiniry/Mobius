...
// Aliases: [-p, --print]
   ...
   */
  static enum  Print {
    SYSO("SYSO"),    TXT("TXT"),    DOT("DOT"),    HTML("HTML"),    NEWHTML("NEWHTML"),    DIC("DIC"),    IIG("IIG"),    ICG("ICG"),    CL("CL"),    PICG("PICG"),    PIIG("PIIG"),    TEX("TEX");
     ...
     * @param s one of the following strings: [SYSO, TXT, DOT, HTML, NEWHTML, DIC, IIG, ICG, CL, PICG, PIIG, TEX]
