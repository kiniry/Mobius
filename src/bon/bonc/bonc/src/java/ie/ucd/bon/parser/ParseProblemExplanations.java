...
public class ParseProblemExplanations {
  ...
  private static String getExplanationForMethodName(String methodName, Throwable t) {
  ...
  private static String getExplanationForMethodNameWithExpecting(String methodName, Throwable t, String expecting) {
    if (explanationMap == null) {
      initialiseExplanationMap();
    }
  ...
  private static void initialiseExplanationMap() {
