...
feature -- Initialization
	...
	make (a_name: STRING; 
				...
				a_part: STRING;
				some_entries: SCENARIO_ENTRIES) is
			-- Initialize `Current'.
		require
			a_name /= Void
			an_explanation /= Void
...
feature -- Element change
	...
	set_entries (some_entries: SCENARIO_ENTRIES) is
		do
	...
	add_entries (some_entries: SCENARIO_ENTRIES) is
		do
	...
	add_entry (an_entry: SCENARIO_ENTRY) is
		do
...
feature -- Removal
	...
	remove_entries (some_entries: SCENARIO_ENTRIES) is
		do
	...
	remove_entry (an_entry: SCENARIO_ENTRY) is
		do
