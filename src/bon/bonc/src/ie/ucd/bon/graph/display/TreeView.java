...
public class TreeView extends Display {
  ...
  public static JComponent demo(InputStream is, final String label) {
    Tree t = null;
    try {
  ...
  public static JComponent demo(final Tree t, final String label) {
  ...
  public static class NodeTextColorAction extends ColorAction {
    ...
    public NodeTextColorAction(String group) {
      super(group, VisualItem.TEXTCOLOR, ColorLib.rgb(255,0,0));
    }

    public int getColor(VisualItem item) {
      if (item.canGet("cluster", String.class) && item.getBoolean("cluster")) {
        return ColorLib.rgb(0, 0, 0);
      } else if (item.canGet("class", String.class) && item.getBoolean("class")) {
        return ColorLib.rgb(0, 0, 255);
      } else if (item.canGet("system", String.class) && item.getBoolean("system")) {
