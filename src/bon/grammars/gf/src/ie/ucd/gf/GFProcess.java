...
public class GFProcess {
  ...
  private static final String ENGLISH = "CitizenlibEng.gfo";
  private static final String BON = "CitizenlibBON.gfo";
  ...
  /**
   * Imports the English and BON languages
   * @throws IOException
   */

	public void importLanguages() throws IOException {
		  enterCommand("i " + ENGLISH);
		  enterCommand("i " + BON);
	  }
