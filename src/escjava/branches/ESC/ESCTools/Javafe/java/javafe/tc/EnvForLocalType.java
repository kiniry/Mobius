...
public class EnvForLocalType extends Env implements/*privately*/ Cloneable {
    ...
    public void display() {
	parent.display();
	System.out.println("[[ extended with local type binding of "
	    + decl.id.toString() + " to " + TypeSig.getSig(decl) + " ]]");
    }
}
