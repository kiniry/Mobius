...
// Generated boilerplate constructors:
   ...
   /**
    ** Construct a raw RestoreFromCmd whose class invariant(s) have not
    ** yet been established.  It is the caller's job to
    ** initialize the returned node's fields so that any
    ** class invariants hold.
    **/
   //@ requires I_will_establish_invariants_afterwards
   protected RestoreFromCmd() {}    //@ nowarn Invariant,NonNullInit
...
// Generated boilerplate methods:
   ...
   public final int getTag() {
      return TagConstants.RESTOREFROMCMD;
   }

   public final void accept(javafe.ast.Visitor v) { 
      if (v instanceof Visitor) ((Visitor)v).visitRestoreFromCmd(this);
   }

   public final Object accept(javafe.ast.VisitorArgResult v, Object o) { 
      if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitRestoreFromCmd(this, o); else return null;
   }
   ...
   //@ ensures \result!=null
   public static RestoreFromCmd make(/*@non_null*/ VariableAccess v, /*@non_null*/ Expr rhs) {
      //@ set I_will_establish_invariants_afterwards = true
      RestoreFromCmd result = new RestoreFromCmd();
      result.v = v;
      result.rhs = rhs;
      return result;
   }
