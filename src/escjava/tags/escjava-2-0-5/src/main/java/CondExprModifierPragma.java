...
// Generated boilerplate constructors:
    ...
    //@ ensures this.cond == cond;
    protected CondExprModifierPragma(int tag, /*@ non_null @*/ Expr expr, int loc, /*@ non_null @*/ Expr cond) {
       this.tag = tag;
       this.expr = expr;
       this.loc = loc;
       this.cond = cond;
...
// Generated boilerplate methods:
    ...
    public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
        if (v instanceof Visitor) ((Visitor)v).visitCondExprModifierPragma(this);
    }

    public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
        if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitCondExprModifierPragma(this, o); else return null;
    }
    ...
    //@ ensures \result != null;
    public static /*@ non_null */ CondExprModifierPragma make(int tag, /*@ non_null @*/ Expr expr, int loc, /*@ non_null @*/ Expr cond) {
       CondExprModifierPragma result = new CondExprModifierPragma(tag, expr, loc, cond);
       return result;
    }
}
