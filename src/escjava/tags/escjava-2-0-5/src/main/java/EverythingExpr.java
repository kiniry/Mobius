...
// Generated boilerplate constructors:
  ...
  protected EverythingExpr(int loc) {
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.EVERYTHINGEXPR;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitEverythingExpr(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitEverythingExpr(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ EverythingExpr make(int loc) {
     EverythingExpr result = new EverythingExpr(loc);
     return result;
  }
}
