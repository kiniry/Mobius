...
// Generated boilerplate constructors:
    ...
    protected ExprModifierPragma(int tag, /*@ non_null @*/ Expr expr, int loc) {
       this.tag = tag;
       this.expr = expr;
       this.loc = loc;
    }
...
// Generated boilerplate methods:
    ...
    //@ ensures \result != null;
    public static /*@ non_null */ ExprModifierPragma make(int tag, /*@ non_null @*/ Expr expr, int loc) {
       ExprModifierPragma result = new ExprModifierPragma(tag, expr, loc);
       return result;
    }
}
