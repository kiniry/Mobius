...
// Generated boilerplate constructors:
  ...
  protected IdExprDeclPragma(int tag, /*@ non_null @*/ Identifier id, /*@ non_null @*/ Expr expr, int modifiers, int loc, int locId) {
     this.tag = tag;
     this.id = id;
     this.expr = expr;
...
// Generated boilerplate methods:
  ...
  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitIdExprDeclPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitIdExprDeclPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ IdExprDeclPragma make(int tag, /*@ non_null @*/ Identifier id, /*@ non_null @*/ Expr expr, int modifiers, int loc, int locId) {
     IdExprDeclPragma result = new IdExprDeclPragma(tag, id, expr, modifiers, loc, locId);
     return result;
  }
}
