...
// Generated boilerplate constructors:
  ...
  protected IdentifierModifierPragma(int tag, /*@ non_null @*/ Identifier id, int loc) {
     this.tag = tag;
     this.id = id;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.IDENTIFIERMODIFIERPRAGMA;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitIdentifierModifierPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitIdentifierModifierPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ IdentifierModifierPragma make(int tag, /*@ non_null @*/ Identifier id, int loc) {
     IdentifierModifierPragma result = new IdentifierModifierPragma(tag, id, loc);
     return result;
  }
}
