...
// Generated boilerplate constructors:
  ...
  protected ModelProgamModifierPragma(int tag, int loc) {
     this.tag = tag;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final /*@non_null*/String toString() {
     return "[ModelProgamModifierPragma"
        + " tag = " + this.tag
        + " loc = " + this.loc
        + "]";
  }
  ...
  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitModelProgamModifierPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitModelProgamModifierPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ModelProgamModifierPragma make(int tag, int loc) {
     ModelProgamModifierPragma result = new ModelProgamModifierPragma(tag, loc);
     return result;
  }
}
