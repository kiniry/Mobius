...
// Generated boilerplate constructors:
  ...
  protected NamedExprDeclPragma(int tag, /*@ non_null @*/ Expr expr, /*@ non_null @*/ Expr target, int modifiers, int loc) {
     this.tag = tag;
     this.expr = expr;
     this.target = target;
...
// Generated boilerplate methods:
  ...
  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitNamedExprDeclPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitNamedExprDeclPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ NamedExprDeclPragma make(int tag, /*@ non_null @*/ Expr expr, /*@ non_null @*/ Expr target, int modifiers, int loc) {
     NamedExprDeclPragma result = new NamedExprDeclPragma(tag, expr, target, modifiers, loc);
     return result;
  }
}
