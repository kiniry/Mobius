...
// Generated boilerplate constructors:
  ...
  protected RefinePragma(/*@ non_null @*/ String filename, int loc) {
...
// Generated boilerplate methods:
  ...
  public final /*@ non_null */ Object childAt(int index) {
     ...
     if (index == 0) return this.filename;
     else index--;
  ...
  public final int getTag() {
     return TagConstants.REFINEPRAGMA;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitRefinePragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitRefinePragma(this, o); else return null;
  }

  public void check() {
     if (this.filename == null) throw new RuntimeException();
  }

  //@ ensures \result != null;
  public static /*@ non_null */ RefinePragma make(/*@ non_null @*/ String filename, int loc) {
     RefinePragma result = new RefinePragma(filename, loc);
     return result;
  }
}
