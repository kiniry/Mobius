...
public class SetCompExpr extends Expr
{
  ...
  public /*@ non_null @*/ FormalParaDecl fp;
...
// Generated boilerplate constructors:
  ...
  protected SetCompExpr(/*@ non_null @*/ Type type, /*@ non_null @*/ FormalParaDecl fp, /*@ non_null @*/ Expr expr) {
     this.type = type;
     this.fp = fp;
     this.expr = expr;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.SETCOMPEXPR;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitSetCompExpr(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitSetCompExpr(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SetCompExpr make(/*@ non_null @*/ Type type, /*@ non_null @*/ FormalParaDecl fp, /*@ non_null @*/ Expr expr) {
     SetCompExpr result = new SetCompExpr(type, fp, expr);
     return result;
  }
}
