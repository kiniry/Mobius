...
// Generated boilerplate constructors:
  ...
  protected SimpleStmtPragma(int tag, int loc) {
     this.tag = tag;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SimpleStmtPragma make(int tag, int loc) {
     SimpleStmtPragma result = new SimpleStmtPragma(tag, loc);
     return result;
  }
}
