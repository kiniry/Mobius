...
// Generated boilerplate constructors:
    ...
    protected VarDeclModifierPragma(int tag, /*@ non_null @*/ LocalVarDecl decl, int loc, int locId) {
       this.tag = tag;
       this.decl = decl;
       this.loc = loc;
       this.locId = locId;
...
// Generated boilerplate methods:
    ...
    public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
        if (v instanceof Visitor) ((Visitor)v).visitVarDeclModifierPragma(this);
    }

    public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
        if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitVarDeclModifierPragma(this, o); else return null;
    }
    ...
    //@ ensures \result != null;
    public static /*@ non_null */ VarDeclModifierPragma make(int tag, /*@ non_null @*/ LocalVarDecl decl, int loc, int locId) {
       VarDeclModifierPragma result = new VarDeclModifierPragma(tag, decl, loc, locId);
       return result;
    }
}
