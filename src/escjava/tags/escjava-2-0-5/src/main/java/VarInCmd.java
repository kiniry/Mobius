...
// Generated boilerplate constructors:
  ...
  //@ ensures this.v == v;
  //@ ensures this.g == g;
  protected VarInCmd(/*@ non_null @*/ GenericVarDeclVec v, /*@ non_null @*/ GuardedCmd g) {
     super();
     this.v = v;
     this.g = g;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ VarInCmd make(/*@ non_null @*/ GenericVarDeclVec v, /*@ non_null @*/ GuardedCmd g) {
     VarInCmd result = new VarInCmd(v, g);
     return result;
  }
}
