...
public abstract class VisitorArgResult extends javafe.ast.VisitorArgResult {
  ...
  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitMapType(MapType x, Object o);
  ...
  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitTidExpr(TidExpr x, Object o);

  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitMainExpr(MainExpr x, Object o);

  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitWitnessExpr(WitnessExpr x, Object o);
  ...
  //@ requires x!=null
  //@ ensures \result!=null
  public Object visitYieldCmd(YieldCmd x, Object o) {
    return visitGuardedCmd(x, o);
  }
  ...
  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitParamExprModifierPragma(ParamExprModifierPragma x, Object o);
  ...
  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitPerformsModifierPragma(PerformsModifierPragma x, Object o);

  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitPerformsStmt(PerformsStmt x, Object o);

  //@ requires x!=null
  //@ ensures \result!=null
  public Object visitPerformsAction(PerformsAction x, Object o) {
    return visitPerformsStmt(x, o);
  }

  //@ requires x!=null
  //@ ensures \result!=null
  public Object visitPerformsChoice(PerformsChoice x, Object o) {
    return visitPerformsStmt(x, o);
  }

  //@ requires x!=null
  //@ ensures \result!=null
  public Object visitPerformsSequence(PerformsSequence x, Object o) {
    return visitPerformsStmt(x, o);
  }

  //@ requires x!=null
  //@ ensures \result!=null
  public abstract Object visitExprsModifierPragma(ExprsModifierPragma x, Object o);
