...
public class Options extends javafe.SrcToolOptions
{
  ...
  final String[][] escPrivateOptionData = {
    ...
    { "-PrintGuardedCommands, -pgc", 
      "Print the guarded commands" },
    { "-PrettyPrintVC, -ppvc", 
      "Pretty-print verification conditions" },
    { "-pxLog <filename>", 
    ...
    { "-PrintVC, -pvc", 
      "Print the generated VC.  See also -ppvc." },
    { "-wpnxw <number>", 
      "TBD" },
    { "-NamePCSize <number>", 
      "TBD" },
    ...
    { "-NoEPeepOpt", 
      "Turns off peephold optimization for expressions." },
    { "-NoGCPeepOpt", 
    ...
    { "-PvsProof"
      ,
      "Writes the transcription of the proof into pvs format to '$ESCTOOLS/Escjava/' ."},
    { "-nvcg",
      "Use the new verification conditions generator"},
    { "-pErr",
      "Print errors generated by the vcg"},
    { "-pWarn",
      "Print warnings generated by the vcg"},
    { "-pInfo",
      "Print informations generated by the vcg"},
    { "-pSimplify",
      "Write the proof for simplify generated by the new verification condition generator to a file."},
    { "-pPvs",
      "Write the proof for pvs generated by the new verification condition generator to a file."},
    { "-pCoq",
      "Write the proof for coq generated by the new verification condition generator to a file."},
    { "-pColors",
    ...
    { "-vc2dot",
      "Output the gc tree in dot format"}, 
    { "-pToDot",
      "Output the translation of the gc tree in dot format"}
    //$$
  };
  ...
  public int processOption(String option, String[] args, int offset) 
    ...
    else if (option.equals("-psimplify")){
      pSimplify = true;

      return offset;
    }
    else if (option.equals("-ppvs")){
      pPvs = true;
	...
	*/
	  ...
	  for ( ; i < s.length; i++){
		  ...
		  throw new UsageError("Argument to the option '" + option +"' not recognized : '"+s+"', skipping it");
	...
	throw new UsageError("Option " + option +
      ...
      return offset;
    } else if (option.equals("-nonnullelements") ||
	       option.equals("-nne")) {
      nne = true;
      return offset+1;
