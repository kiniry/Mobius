...
/* Copyright 2007, 2008, Systems Research Group, University College Dublin, 
 * Ireland */
...
public class Options extends javafe.SrcToolOptions {
    ...
    final String[][] escPrivateOptionData = {
            ...
            {   "-platform <type> {version}",
            	"specify an alternative java platform e.g. JavaCard or MIDP; default is Java (J2SE) 1.4"},
            {   "-svcg <prover>",
    ...
    private final String[] supportedProvers = { simplifyName, sammyName, 
        harveyName, cvc3Name };
    ...
    public static final String JAVACARD_PLATFORM = "JavaCard";
    public static final String MIDP_PLATFORM = "MIDP";
    private final String[] supportedPlatforms = { JAVA_PLATFORM, 
        JAVACARD_PLATFORM, MIDP_PLATFORM};
    private final String[] defaultPlatform = { JAVA_PLATFORM };
    
    // Supported Platform Versions
    private final String[][] supportedPlatformVersions = { 
        {JAVA_PLATFORM, "1.2", "1.3", "1.4"},
        {JAVACARD_PLATFORM, "2.0"},
        {MIDP_PLATFORM, "1.0"}};
