...
// Generated boilerplate constructors:
  ...
  /**
   ** Construct a raw SubGetsCmd whose class invariant(s) have not
   ** yet been established.  It is the caller's job to
   ** initialize the returned node's fields so that any
   ** class invariants hold.
   **/
  //@ requires I_will_establish_invariants_afterwards
  protected SubGetsCmd() {}    //@ nowarn Invariant,NonNullInit
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.SUBGETSCMD;
  }

  public final void accept(javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitSubGetsCmd(this);
  }

  public final Object accept(javafe.ast.VisitorArgResult v, Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitSubGetsCmd(this, o); else return null;
  }
  ...
  //@ ensures \result!=null
  public static SubGetsCmd make(/*@non_null*/ VariableAccess v, /*@non_null*/ Expr rhs, /*@non_null*/ Expr index) {
     //@ set I_will_establish_invariants_afterwards = true
     SubGetsCmd result = new SubGetsCmd();
     result.v = v;
     result.rhs = rhs;
     result.index = index;
     return result;
