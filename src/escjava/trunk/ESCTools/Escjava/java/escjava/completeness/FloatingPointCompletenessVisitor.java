/**
 * $Id: ModificationSoundnessVisitor.java,v 1.1 2007/07/24 08:46:36 dcochran Exp $
 *
 * @title "Abstract Syntax Tree Visitor for warning about incompleteness due to floating point arithmetic"
 * @description "Walks through an AST and finds any cases where floating point arithmetic is specified. 
 *               It then adds a warning to ErrorSet about this"
 * @see "ESCJava Users Manual, Appendix C.0.2"
 */

package escjava.completeness;
...
public class FloatingPointCompletenessVisitor extends ASTVisitor {

  public static final String FLOATING_POINT_INCOMPLETENESS_WARNING = "The semantics of floating point arithmetic are incomplete.";
  ...
  public void visitLiteralExpr(/*@ non_null */ LiteralExpr x) {
     ...
     switch (x.getTag()) {
       ...
       case TagConstants.FLOATINGSUB:   
          ...
          ErrorSet.warning(x.getStartLoc(), FLOATING_POINT_INCOMPLETENESS_WARNING);
     }
