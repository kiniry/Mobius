...
// Generated boilerplate constructors:
  ...
  /**
   ** Construct a raw FieldDecl whose class invariant(s) have not
   ** yet been established.  It is the caller's job to
   ** initialize the returned node's fields so that any
   ** class invariants hold.
   **/
  //@ requires I_will_establish_invariants_afterwards
  protected FieldDecl() {}    //@ nowarn Invariant,NonNullInit
...
// Generated boilerplate methods:
  ...
  public final void accept(Visitor v) { v.visitFieldDecl(this); }

  public final Object accept(VisitorArgResult v, Object o) {return v.visitFieldDecl(this, o); }
  ...
  //@ ensures \result!=null
  public static FieldDecl make(int modifiers, ModifierPragmaVec pmodifiers, /*@non_null*/ Identifier id, /*@non_null*/ Type type, int locId, VarInit init, int locAssignOp) {
