...
//@ ensures RES!=null
   public Object visitCompilationUnit(CompilationUnit y, Object o) {
      ...
      Name _temppkgName = (Name)(x.pkgName == null ? null : x.pkgName.accept(this, o));
      ...
      for (int i = 0; i < x.lexicalPragmas.size(); i++) {
         _templexicalPragmas.insertElementAt((LexicalPragma)x.lexicalPragmas.elementAt(i).accept(this,o),i);
      } 
   }
      ...
      for (int i = 0; i < x.imports.size(); i++) {
         _tempimports.insertElementAt((ImportDecl)x.imports.elementAt(i).accept(this,o),i);
      } 
   }
      ...
      for (int i = 0; i < x.elems.size(); i++) {
         _tempelems.insertElementAt((TypeDecl)x.elems.elementAt(i).accept(this,o),i);
      } 
   }
      x.elems = _tempelems; 
return finish(x,o);
...
//@ ensures RES!=null
   public Object visitSingleTypeImportDecl(SingleTypeImportDecl y, Object o) {
      ...
      TypeName _temptypeName = (TypeName)(x.typeName == null ? null : x.typeName.accept(this, o));
...
//@ ensures RES!=null
   public Object visitClassDecl(ClassDecl y, Object o) {
      ...
      for (int i = 0; i < x.pmodifiers.size(); i++) {
         _temppmodifiers.insertElementAt((ModifierPragma)x.pmodifiers.elementAt(i).accept(this,o),i);
      } 
   }
      ...
      for (int i = 0; i < x.tmodifiers.size(); i++) {
         _temptmodifiers.insertElementAt((TypeModifierPragma)x.tmodifiers.elementAt(i).accept(this,o),i);
      } 
   }
      ...
      for (int i = 0; i < x.superInterfaces.size(); i++) {
         _tempsuperInterfaces.insertElementAt((TypeName)x.superInterfaces.elementAt(i).accept(this,o),i);
      } 
   }
      ...
      for (int i = 0; i < x.elems.size(); i++) {
         _tempelems.insertElementAt((TypeDeclElem)x.elems.elementAt(i).accept(this,o),i);
      } 
   }
      x.elems = _tempelems; 
      TypeName _tempsuperClass = (TypeName)(x.superClass == null ? null : x.superClass.accept(this, o));
...
//@ ensures RES!=null
   public Object visitConstructorDecl(ConstructorDecl y, Object o) {
      ...
      for (int i = 0; i < x.raises.size(); i++) {
         _tempraises.insertElementAt((TypeName)x.raises.elementAt(i).accept(this,o),i);
      } 
   }
      x.raises = _tempraises; 
      BlockStmt _tempbody = (BlockStmt)(x.body == null ? null : x.body.accept(this, o));
      x.body = _tempbody; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitMethodDecl(MethodDecl y, Object o) {
      ...
      BlockStmt _tempbody = (BlockStmt)(x.body == null ? null : x.body.accept(this, o));
      x.body = _tempbody; 
      Type _tempreturnType = (Type)(x.returnType == null ? null : x.returnType.accept(this, o));
...
//@ ensures RES!=null
   public Object visitInitBlock(InitBlock y, Object o) {
      ...
      x.pmodifiers = _temppmodifiers; 
      BlockStmt _tempblock = (BlockStmt)(x.block == null ? null : x.block.accept(this, o));
      x.block = _tempblock; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitLocalVarDecl(LocalVarDecl y, Object o) {
      ...
      x.type = _temptype; 
      VarInit _tempinit = (VarInit)(x.init == null ? null : x.init.accept(this, o));
      x.init = _tempinit; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitBlockStmt(BlockStmt y, Object o) {
      ...
      for (int i = 0; i < x.stmts.size(); i++) {
         _tempstmts.insertElementAt((Stmt)x.stmts.elementAt(i).accept(this,o),i);
      } 
   }
      x.stmts = _tempstmts; 
return finish(x,o);
...
//@ ensures RES!=null
   public Object visitVarDeclStmt(VarDeclStmt y, Object o) {
      ...
      LocalVarDecl _tempdecl = (LocalVarDecl)(x.decl == null ? null : x.decl.accept(this, o));
      x.decl = _tempdecl; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitClassDeclStmt(ClassDeclStmt y, Object o) {
      ...
      ClassDecl _tempdecl = (ClassDecl)(x.decl == null ? null : x.decl.accept(this, o));
      x.decl = _tempdecl; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitSynchronizeStmt(SynchronizeStmt y, Object o) {
      ...
      Expr _tempexpr = (Expr)(x.expr == null ? null : x.expr.accept(this, o));
      x.expr = _tempexpr; 
      BlockStmt _tempstmt = (BlockStmt)(x.stmt == null ? null : x.stmt.accept(this, o));
      x.stmt = _tempstmt; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitForStmt(ForStmt y, Object o) {
      ...
      for (int i = 0; i < x.forInit.size(); i++) {
         _tempforInit.insertElementAt((Stmt)x.forInit.elementAt(i).accept(this,o),i);
      } 
   }
      ...
      for (int i = 0; i < x.forUpdate.size(); i++) {
         _tempforUpdate.insertElementAt((Expr)x.forUpdate.elementAt(i).accept(this,o),i);
      } 
   }
...
//@ ensures RES!=null
   public Object visitTryFinallyStmt(TryFinallyStmt y, Object o) {
      ...
      Stmt _temptryClause = (Stmt)(x.tryClause == null ? null : x.tryClause.accept(this, o));
      x.tryClause = _temptryClause; 
      Stmt _tempfinallyClause = (Stmt)(x.finallyClause == null ? null : x.finallyClause.accept(this, o));
...
//@ ensures RES!=null
   public Object visitTryCatchStmt(TryCatchStmt y, Object o) {
      ...
      for (int i = 0; i < x.catchClauses.size(); i++) {
         _tempcatchClauses.insertElementAt((CatchClause)x.catchClauses.elementAt(i).accept(this,o),i);
      } 
   }
...
//@ ensures RES!=null
   public Object visitConstructorInvocation(ConstructorInvocation y, Object o) {
      ...
      Expr _tempenclosingInstance = (Expr)(x.enclosingInstance == null ? null : x.enclosingInstance.accept(this, o));
      ...
      for (int i = 0; i < x.args.size(); i++) {
         _tempargs.insertElementAt((Expr)x.args.elementAt(i).accept(this,o),i);
      } 
   }
      x.args = _tempargs; 
return finish(x,o);
...
//@ ensures RES!=null
   public Object visitCatchClause(CatchClause y, Object o) {
      ...
      FormalParaDecl _temparg = (FormalParaDecl)(x.arg == null ? null : x.arg.accept(this, o));
      x.arg = _temparg; 
      BlockStmt _tempbody = (BlockStmt)(x.body == null ? null : x.body.accept(this, o));
      x.body = _tempbody; 
return finish(x,o);
...
//@ ensures RES!=null
   public Object visitArrayInit(ArrayInit y, Object o) {
      ...
      for (int i = 0; i < x.elems.size(); i++) {
         _tempelems.insertElementAt((VarInit)x.elems.elementAt(i).accept(this,o),i);
      } 
   }
      x.elems = _tempelems; 
return finish(x,o);
...
//@ ensures RES!=null
   public Object visitThisExpr(ThisExpr y, Object o) {
      ...
      Type _tempclassPrefix = (Type)(x.classPrefix == null ? null : x.classPrefix.accept(this, o));
...
//@ ensures RES!=null
   public Object visitArrayRefExpr(ArrayRefExpr y, Object o) {
      ...
      Expr _temparray = (Expr)(x.array == null ? null : x.array.accept(this, o));
      x.array = _temparray; 
      Expr _tempindex = (Expr)(x.index == null ? null : x.index.accept(this, o));
      x.index = _tempindex; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitNewInstanceExpr(NewInstanceExpr y, Object o) {
      ...
      Expr _tempenclosingInstance = (Expr)(x.enclosingInstance == null ? null : x.enclosingInstance.accept(this, o));
      x.enclosingInstance = _tempenclosingInstance; 
      TypeName _temptype = (TypeName)(x.type == null ? null : x.type.accept(this, o));
      x.type = _temptype; 
      ExprVec _tempargs;
      if (x.args == null) {
         _tempargs = null; 
      ...
      x.args = _tempargs; 
      ClassDecl _tempanonDecl = (ClassDecl)(x.anonDecl == null ? null : x.anonDecl.accept(this, o));
...
//@ ensures RES!=null
   public Object visitNewArrayExpr(NewArrayExpr y, Object o) {
      ...
      for (int i = 0; i < x.dims.size(); i++) {
         _tempdims.insertElementAt((Expr)x.dims.elementAt(i).accept(this,o),i);
      } 
   }
      x.dims = _tempdims; 
      ArrayInit _tempinit = (ArrayInit)(x.init == null ? null : x.init.accept(this, o));
      x.init = _tempinit; 
...
//@ ensures RES!=null
   public Object visitBinaryExpr(BinaryExpr y, Object o) {
      ...
      x.left = _templeft; 
      Expr _tempright = (Expr)(x.right == null ? null : x.right.accept(this, o));
      x.right = _tempright; 
return finish(x,o);
   }
...
//@ ensures RES!=null
   public Object visitFieldAccess(FieldAccess y, Object o) {
      ...
      ObjectDesignator _tempod = (ObjectDesignator)(x.od == null ? null : x.od.accept(this, o));
      x.od = _tempod; 
return finish(x,o);
   }
