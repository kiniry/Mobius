...
public class EqualityVisitorSuper extends VisitorArgResult {
    ...
    public Object visitCompilationUnit(CompilationUnit y, Object o) {
        ...
        x = x
            && (y.pkgName == null && z.pkgName == null || (y.pkgName != null
                && z.pkgName != null && ((Boolean) (y.pkgName.accept(
                this,
                z.pkgName))).booleanValue()));
        if (!(y.lexicalPragmas == null && z.lexicalPragmas == null)) {
            if (y.lexicalPragmas != null && z.lexicalPragmas != null
                && (z.lexicalPragmas.size() == y.lexicalPragmas.size())) {
                for (int i = 0; i < z.lexicalPragmas.size(); i++) {
                    x = x
                        && ((Boolean) z.lexicalPragmas.elementAt(i).accept(
                            this,
                            y.lexicalPragmas.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        if (!(y.imports == null && z.imports == null)) {
            if (y.imports != null && z.imports != null
                && (z.imports.size() == y.imports.size())) {
                for (int i = 0; i < z.imports.size(); i++) {
                    x = x
                        && ((Boolean) z.imports.elementAt(i).accept(
                            this,
                            y.imports.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        if (!(y.elems == null && z.elems == null)) {
            if (y.elems != null && z.elems != null
                && (z.elems.size() == y.elems.size())) {
                for (int i = 0; i < z.elems.size(); i++) {
                    x = x
                        && ((Boolean) z.elems.elementAt(i).accept(
                            this,
                            y.elems.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
    ...
    public Object visitSingleTypeImportDecl(SingleTypeImportDecl y, Object o) {
        ...
        x = x
            && (y.typeName == null && z.typeName == null || (y.typeName != null
                && z.typeName != null && ((Boolean) (y.typeName.accept(
                this,
                z.typeName))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitClassDecl(ClassDecl y, Object o) {
        ...
        if (!(y.pmodifiers == null && z.pmodifiers == null)) {
            if (y.pmodifiers != null && z.pmodifiers != null
                && (z.pmodifiers.size() == y.pmodifiers.size())) {
                for (int i = 0; i < z.pmodifiers.size(); i++) {
                    x = x
                        && ((Boolean) z.pmodifiers.elementAt(i).accept(
                            this,
                            y.pmodifiers.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        if (!(y.tmodifiers == null && z.tmodifiers == null)) {
            if (y.tmodifiers != null && z.tmodifiers != null
                && (z.tmodifiers.size() == y.tmodifiers.size())) {
                for (int i = 0; i < z.tmodifiers.size(); i++) {
                    x = x
                        && ((Boolean) z.tmodifiers.elementAt(i).accept(
                            this,
                            y.tmodifiers.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        if (!(y.superInterfaces == null && z.superInterfaces == null)) {
            if (y.superInterfaces != null && z.superInterfaces != null
                && (z.superInterfaces.size() == y.superInterfaces.size())) {
                for (int i = 0; i < z.superInterfaces.size(); i++) {
                    x = x
                        && ((Boolean) z.superInterfaces.elementAt(i).accept(
                            this,
                            y.superInterfaces.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        x = x
            && (y.superClass == null && z.superClass == null || (y.superClass != null
                && z.superClass != null && ((Boolean) (y.superClass.accept(
                this,
                z.superClass))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitConstructorDecl(ConstructorDecl y, Object o) {
        ...
        if (!(y.args == null && z.args == null)) {
            if (y.args != null && z.args != null
                && (z.args.size() == y.args.size())) {
                for (int i = 0; i < z.args.size(); i++) {
                    x = x
                        && ((Boolean) z.args.elementAt(i).accept(
                            this,
                            y.args.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        if (!(y.raises == null && z.raises == null)) {
            if (y.raises != null && z.raises != null
                && (z.raises.size() == y.raises.size())) {
                for (int i = 0; i < z.raises.size(); i++) {
                    x = x
                        && ((Boolean) z.raises.elementAt(i).accept(
                            this,
                            y.raises.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        x = x
            && (y.body == null && z.body == null || (y.body != null
                && z.body != null && ((Boolean) (y.body.accept(this, z.body))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitMethodDecl(MethodDecl y, Object o) {
        ...
        x = x && (z.id == y.id);
        x = x
            && (y.returnType == null && z.returnType == null || (y.returnType != null
                && z.returnType != null && ((Boolean) (y.returnType.accept(
                this,
                z.returnType))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitInitBlock(InitBlock y, Object o) {
        ...
        x = x
            && (y.block == null && z.block == null || (y.block != null
                && z.block != null && ((Boolean) (y.block.accept(this, z.block))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitLocalVarDecl(LocalVarDecl y, Object o) {
        ...
        x = x && (z.id == y.id);
        x = x
            && (y.type == null && z.type == null || (y.type != null
                && z.type != null && ((Boolean) (y.type.accept(this, z.type))).booleanValue()));
        x = x
            && (y.init == null && z.init == null || (y.init != null
                && z.init != null && ((Boolean) (y.init.accept(this, z.init))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitBlockStmt(BlockStmt y, Object o) {
        ...
        if (!(y.stmts == null && z.stmts == null)) {
            if (y.stmts != null && z.stmts != null
                && (z.stmts.size() == y.stmts.size())) {
                for (int i = 0; i < z.stmts.size(); i++) {
                    x = x
                        && ((Boolean) z.stmts.elementAt(i).accept(
                            this,
                            y.stmts.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
    ...
    public Object visitSwitchStmt(SwitchStmt y, Object o) {
        ...
        x = x
            && (y.expr == null && z.expr == null || (y.expr != null
                && z.expr != null && ((Boolean) (y.expr.accept(this, z.expr))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitVarDeclStmt(VarDeclStmt y, Object o) {
        ...
        x = x
            && (y.decl == null && z.decl == null || (y.decl != null
                && z.decl != null && ((Boolean) (y.decl.accept(this, z.decl))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitWhileStmt(WhileStmt y, Object o) {
        ...
        x = x
            && (y.expr == null && z.expr == null || (y.expr != null
                && z.expr != null && ((Boolean) (y.expr.accept(this, z.expr))).booleanValue()));
        x = x
            && (y.stmt == null && z.stmt == null || (y.stmt != null
                && z.stmt != null && ((Boolean) (y.stmt.accept(this, z.stmt))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitIfStmt(IfStmt y, Object o) {
        ...
        x = x
            && (y.expr == null && z.expr == null || (y.expr != null
                && z.expr != null && ((Boolean) (y.expr.accept(this, z.expr))).booleanValue()));
        x = x
            && (y.thn == null && z.thn == null || (y.thn != null
                && z.thn != null && ((Boolean) (y.thn.accept(this, z.thn))).booleanValue()));
        x = x
            && (y.els == null && z.els == null || (y.els != null
                && z.els != null && ((Boolean) (y.els.accept(this, z.els))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitForStmt(ForStmt y, Object o) {
        ...
        if (!(y.forInit == null && z.forInit == null)) {
            if (y.forInit != null && z.forInit != null
                && (z.forInit.size() == y.forInit.size())) {
                for (int i = 0; i < z.forInit.size(); i++) {
                    x = x
                        && ((Boolean) z.forInit.elementAt(i).accept(
                            this,
                            y.forInit.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        x = x
            && (y.test == null && z.test == null || (y.test != null
                && z.test != null && ((Boolean) (y.test.accept(this, z.test))).booleanValue()));
        if (!(y.forUpdate == null && z.forUpdate == null)) {
            if (y.forUpdate != null && z.forUpdate != null
                && (z.forUpdate.size() == y.forUpdate.size())) {
                for (int i = 0; i < z.forUpdate.size(); i++) {
                    x = x
                        && ((Boolean) z.forUpdate.elementAt(i).accept(
                            this,
                            y.forUpdate.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
    ...
    public Object visitTryFinallyStmt(TryFinallyStmt y, Object o) {
        ...
        x = x
            && (y.tryClause == null && z.tryClause == null || (y.tryClause != null
                && z.tryClause != null && ((Boolean) (y.tryClause.accept(
                this,
                z.tryClause))).booleanValue()));
        x = x
            && (y.finallyClause == null && z.finallyClause == null || (y.finallyClause != null
                && z.finallyClause != null && ((Boolean) (y.finallyClause.accept(
                this,
                z.finallyClause))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitTryCatchStmt(TryCatchStmt y, Object o) {
        ...
        if (!(y.catchClauses == null && z.catchClauses == null)) {
            if (y.catchClauses != null && z.catchClauses != null
                && (z.catchClauses.size() == y.catchClauses.size())) {
                for (int i = 0; i < z.catchClauses.size(); i++) {
                    x = x
                        && ((Boolean) z.catchClauses.elementAt(i).accept(
                            this,
                            y.catchClauses.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
    ...
    public Object visitConstructorInvocation(ConstructorInvocation y, Object o) {
        ...
        x = x
            && (y.enclosingInstance == null && z.enclosingInstance == null || (y.enclosingInstance != null
                && z.enclosingInstance != null && ((Boolean) (y.enclosingInstance.accept(
                this,
                z.enclosingInstance))).booleanValue()));
        if (!(y.args == null && z.args == null)) {
            if (y.args != null && z.args != null
                && (z.args.size() == y.args.size())) {
                for (int i = 0; i < z.args.size(); i++) {
    ...
    public Object visitCatchClause(CatchClause y, Object o) {
        ...
        x = x
            && (y.arg == null && z.arg == null || (y.arg != null
                && z.arg != null && ((Boolean) (y.arg.accept(this, z.arg))).booleanValue()));
        x = x
            && (y.body == null && z.body == null || (y.body != null
                && z.body != null && ((Boolean) (y.body.accept(this, z.body))).booleanValue()));
        return new Boolean(x);
    ...
    public Object visitThisExpr(ThisExpr y, Object o) {
        ...
        x = x
            && (y.classPrefix == null && z.classPrefix == null || (y.classPrefix != null
                && z.classPrefix != null && ((Boolean) (y.classPrefix.accept(
                this,
                z.classPrefix))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitLiteralExpr(LiteralExpr y, Object o) {
        ...
        x = x && (z.tag == y.tag);
        x = x
            && ((z.value == null && y.value == null) || (z.value != null
                && y.value != null && z.value.equals(y.value)));
        return new Boolean(x);
    }
    ...
    public Object visitArrayRefExpr(ArrayRefExpr y, Object o) {
        ...
        x = x
            && (y.array == null && z.array == null || (y.array != null
                && z.array != null && ((Boolean) (y.array.accept(this, z.array))).booleanValue()));
        x = x
            && (y.index == null && z.index == null || (y.index != null
                && z.index != null && ((Boolean) (y.index.accept(this, z.index))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitNewInstanceExpr(NewInstanceExpr y, Object o) {
        ...
        x = x
            && (y.anonDecl == null && z.anonDecl == null || (y.anonDecl != null
                && z.anonDecl != null && ((Boolean) (y.anonDecl.accept(
                this,
                z.anonDecl))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitNewArrayExpr(NewArrayExpr y, Object o) {
        ...
        if (!(y.dims == null && z.dims == null)) {
            if (y.dims != null && z.dims != null
                && (z.dims.size() == y.dims.size())) {
                for (int i = 0; i < z.dims.size(); i++) {
                    x = x
                        && ((Boolean) z.dims.elementAt(i).accept(
                            this,
                            y.dims.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
        ...
        if (!(y.locOpenBrackets == null && z.locOpenBrackets == null)) {
            if (y.locOpenBrackets != null && z.locOpenBrackets != null
                && z.locOpenBrackets.length == y.locOpenBrackets.length) {
    ...
    public Object visitBinaryExpr(BinaryExpr y, Object o) {
        ...
        x = x && (z.op == y.op);
        x = x
            && (y.left == null && z.left == null || (y.left != null
                && z.left != null && ((Boolean) (y.left.accept(this, z.left))).booleanValue()));
        x = x
            && (y.right == null && z.right == null || (y.right != null
                && z.right != null && ((Boolean) (y.right.accept(this, z.right))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitAmbiguousVariableAccess(
        ...
        x = x
            && (y.name == null && z.name == null || (y.name != null
                && z.name != null && ((Boolean) (y.name.accept(this, z.name))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitFieldAccess(FieldAccess y, Object o) {
        ...
        x = x
            && (y.od == null && z.od == null || (y.od != null && z.od != null && ((Boolean) (y.od.accept(
                this,
                z.od))).booleanValue()));
        x = x && (z.id == y.id);
        return new Boolean(x);
    ...
    public Object visitAmbiguousMethodInvocation(
        ...
        Boolean _tmp = (Boolean) prep(y, o);
        if (_tmp != null) return _tmp;
        if (!(o instanceof AmbiguousMethodInvocation))
    ...
    public Object visitArrayType(ArrayType y, Object o) {
        ...
        x = x
            && (y.elemType == null && z.elemType == null || (y.elemType != null
                && z.elemType != null && ((Boolean) (y.elemType.accept(
                this,
                z.elemType))).booleanValue()));
        return new Boolean(x);
    }
    ...
    public Object visitCompoundName(CompoundName y, Object o) {
        ...
        if (!(y.locIds == null && z.locIds == null)) {
            if (y.locIds != null && z.locIds != null
                && z.locIds.length == y.locIds.length) {
        ...
        if (!(y.locDots == null && z.locDots == null)) {
            if (y.locDots != null && z.locDots != null
                && z.locDots.length == y.locDots.length) {
    ...
    public Object visitHoldsStmtPragma(HoldsStmtPragma y, Object o) {
        ...
        if (!(y.expressions == null && z.expressions == null)) {
            if (y.expressions != null && z.expressions != null
                && (z.expressions.size() == y.expressions.size())) {
                for (int i = 0; i < z.expressions.size(); i++) {
                    x = x
                        && ((Boolean) z.expressions.elementAt(i).accept(
                            this,
                            y.expressions.elementAt(i))).booleanValue();
                }
            } else {
                x = false;
            }
    ...
    public Object visitArrayGuardModifierPragma(
        ...
        Boolean _tmp = (Boolean) prep(y, o);
        if (_tmp != null) return _tmp;
        if (!(o instanceof ArrayGuardModifierPragma))
            return new Boolean(false);
        boolean x = true;
