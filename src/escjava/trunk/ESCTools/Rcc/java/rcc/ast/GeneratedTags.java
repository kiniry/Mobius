...
public class GeneratedTags extends javafe.tc.TagConstants {
    ...
    static public/* @ non_null @ */String toString(int tag) {
        switch (tag) {
        case HOLDSSTMTPRAGMA:
            return "HOLDSSTMTPRAGMA";
        case REQUIRESMODIFIERPRAGMA:
            return "REQUIRESMODIFIERPRAGMA";
        case GUARDEDBYMODIFIERPRAGMA:
            return "GUARDEDBYMODIFIERPRAGMA";
        case THREADLOCALSTATUSPRAGMA:
            return "THREADLOCALSTATUSPRAGMA";
        case READONLYMODIFIERPRAGMA:
            return "READONLYMODIFIERPRAGMA";
        case ARRAYGUARDMODIFIERPRAGMA:
            return "ARRAYGUARDMODIFIERPRAGMA";
        case NOWARNPRAGMA:
            return "NOWARNPRAGMA";
        case GENERICARGUMENTPRAGMA:
            return "GENERICARGUMENTPRAGMA";
        case GENERICPARAMETERPRAGMA:
            return "GENERICPARAMETERPRAGMA";
        case GHOSTDECLPRAGMA:
