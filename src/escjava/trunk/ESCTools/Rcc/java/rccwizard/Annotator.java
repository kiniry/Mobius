...
public class Annotator {
    ...
    public Annotator(/* @ non_null */String placement, int loc,
    /* @ non_null */String id,
    ...
    public void put(/* @ non_null */String pragma, String comment) {
        ...
        outputSuggestion(placement, loc, id, pragmaPrefix + pragma, c);
    }

    // @ requires loc != Location.NULL;
    private static void outputSuggestion(
        /* @ non_null */String placement,
        int loc,
        /* @ non_null */String id,
        /* @ non_null */String pragma,
        /* @ non_null */String comment) {
        System.out.println("nofile 1 1 Null " + "<rccwizard:" + comment + "> "
            + Location.toFileName(loc) + ' ' + placement + ' '
