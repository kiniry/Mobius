...
Table~\ref{tab:KOA_System_Summary} summarizes the size (grossly in
number of classes and methods), complexity (non-commenting size of
...
% Add discussion of Simplify and moves on that front.
\end{itemize}
