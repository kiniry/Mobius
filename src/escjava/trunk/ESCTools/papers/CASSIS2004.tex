...
and data artifacts (\eg candidate and vote files); no source code
...
datastructures and algorithms.  It was decided that, due to the
...
the JavaNCSS tool version 20.40.  Assertions were approximately
counted by simply counting the number of uses of appropriate core
specification keywords (requires, ensures, invariant, non_null, in,
set, and modifies).
...
GUI state machine due to the requirements of the client (the
government), as the vote couting process is highly serialized.
