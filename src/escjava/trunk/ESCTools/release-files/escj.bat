...
@echo on
"%JAVA%"  -Dsimplify=%ESCJ_SIMPLIFY% -classpath "%ESCJAVA_ROOT%\esctools2.jar;%ESCJAVA_ROOT%\Utils\BCEL\bcel-5.2\bcel-5.2.jar;%ESCJAVA_ROOT%\Utils\Javafe\Javafe2.0.5.jar" escjava.Main -classpath   %ESCJAVA_ROOT%\jmlspecs.jar -classpath . %ESCJ_STDARGS% %ESCJ_ARGS%