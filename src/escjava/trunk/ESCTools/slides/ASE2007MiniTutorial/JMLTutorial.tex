...
\lstinputlisting[linerange={2-2,4-6,8-12}]{examples/Interval.java}
\end{frame}

%\begin{frame}<beamer>[fragile]
%\frametitle{My Solution: Interval's Constructor}

%\lstinputlisting[linerange={9-15}]{examples/Interval.jml}
%\end{frame}

\begin{frame}<beamer>[fragile]
\frametitle{My Solution: Method contains}

\lstinputlisting[linerange={15-18}]{examples/Interval.jml}
\end{frame}
