...
\lstinputlisting[linerange={16-30}]{examples/SortedInts2.java}
\end{frame}

\begin{frame}<beamer>[fragile]
\frametitle{Revised SortedInts Using Owner (ESC/Java2)}
...
\begin{frame}
\frametitle{Multiple Specification Cases}
\lstinputlisting{examples/Aging.java}
\end{frame}
