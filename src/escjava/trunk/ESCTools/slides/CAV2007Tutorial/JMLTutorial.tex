...
\lstset{language=[JML]Java,basicstyle=\ttfamily,commentstyle=\ttfamily,
        keywordstyle=\bfseries,keywordstyle={[2]\bfseries\color{violet!80!black}}
       }
...
\begin{itemize}
\item
Leavens and Cheon, \href{ftp://ftp.cs.iastate.edu/pub/leavens/JML/jmldbc.pdf}{``Design by Contract with JML''}

\item
Burdy, \emph{et al.\/}, \href{http://dx.doi.org/10.1007/s10009-004-0167-4}{``An overview of JML tools and applications''}

\item
Leavens, Baker, and Ruby, \href{http://doi.acm.org/10.1145/1127878.1127884}{``Preliminary Design of JML''}

\item
Leavens, \emph{et al.\/}, \href{http://www.jmlspecs.org/jmlrefman/jmlrefman_toc.html}{``JML Reference Manual''}
\end{itemize}
...
\item
\lstinline[mathescape=true]!(\forall T x; $E_1$; $E_2$)!
~~ = ~~ $(\forall x \in T : E_1 \Rightarrow E_2)$
\end{itemize}
\end{frame}
