...
Private \code{spec\_public} fields are allowed in public specs, eg:
...
{\rm Exposing private details is ugly, of course.
A nicer, but more advanced alternative in JML is to
 use public \code{\red model} fields to represent 
(abstract away from) private implementation details.}
...
Alternative to stop  ESC/Java2 complaining:
add an assumption:
\begin{alltt}\code{ 
    ...
...
when you're still trying to discover hidden assumptions,
or when ESC/Java2's reasoning power is too weak.
