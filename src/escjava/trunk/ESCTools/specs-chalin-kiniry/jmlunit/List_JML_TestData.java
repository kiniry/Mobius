 ...
 */
public abstract class List_JML_TestData
  extends junit.framework.TestCase
{
  /** Initialize this class. */
  public List_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for List");
  }
  ...
  {
    return vListStrategy.iterator();
  }

  /** The strategy for generating test data of type List. */
