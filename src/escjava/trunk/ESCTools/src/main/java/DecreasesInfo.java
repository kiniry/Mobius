...
public class DecreasesInfo extends ASTNode {
  ...
  public /*@ non_null @*/ Expr f;

  // a local variable storing the previous value of expr "f"
  public /*@ non_null @*/ VariableAccess fOld;
...
// Generated boilerplate constructors:
  ...
  //@ ensures this.locStart == locStart;
  //@ ensures this.locEnd == locEnd;
  //@ ensures this.f == f;
  //@ ensures this.fOld == fOld;
  protected DecreasesInfo(int locStart, int locEnd, /*@ non_null @*/ Expr f, /*@ non_null @*/ VariableAccess fOld) {
...
// Generated boilerplate methods:
  ...
  public final /*@ non_null */ Object childAt(int index) {
     ...
     if (index == 0) return this.f;
     else index--;

     if (index == 0) return this.fOld;
     else index--;
  ...
  public final int getTag() {
     return TagConstants.DECREASESINFO;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitDecreasesInfo(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitDecreasesInfo(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ DecreasesInfo make(int locStart, int locEnd, /*@ non_null @*/ Expr f, /*@ non_null @*/ VariableAccess fOld) {
     DecreasesInfo result = new DecreasesInfo(locStart, locEnd, f, fOld);
     return result;
  }
}
