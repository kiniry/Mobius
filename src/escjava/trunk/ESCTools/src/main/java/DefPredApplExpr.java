...
// Generated boilerplate constructors:
    ...
    protected DefPredApplExpr(/*@ non_null @*/ Identifier predId, /*@ non_null @*/ ExprVec args) {
       this.predId = predId;
       this.args = args;
    }
...
// Generated boilerplate methods:
    ...
    //@ ensures \result != null;
    public static /*@ non_null */ DefPredApplExpr make(/*@ non_null @*/ Identifier predId, /*@ non_null @*/ ExprVec args) {
       DefPredApplExpr result = new DefPredApplExpr(predId, args);
       return result;
    }
}
