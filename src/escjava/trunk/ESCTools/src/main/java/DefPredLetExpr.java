...
// Generated boilerplate constructors:
    ...
    //@ ensures this.preds == preds;
    //@ ensures this.body == body;
    protected DefPredLetExpr(/*@ non_null @*/ DefPredVec preds, /*@ non_null @*/ Expr body) {
       this.preds = preds;
       this.body = body;
    }
...
// Generated boilerplate methods:
    ...
    //@ ensures \result != null;
    public static /*@ non_null */ DefPredLetExpr make(/*@ non_null @*/ DefPredVec preds, /*@ non_null @*/ Expr body) {
       DefPredLetExpr result = new DefPredLetExpr(preds, body);
       return result;
    }
}
