...
// Generated boilerplate constructors:
  ...
  protected ExprCmd(int cmd, /*@ non_null @*/ Expr pred, int loc) {
     super();
     this.cmd = cmd;
     this.pred = pred;
     this.loc = loc;
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ExprCmd make(int cmd, /*@ non_null @*/ Expr pred, int loc) {
     ExprCmd result = new ExprCmd(cmd, pred, loc);
     return result;
  }
}
