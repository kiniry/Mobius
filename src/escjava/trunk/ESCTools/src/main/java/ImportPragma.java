...
{
  public /*@ non_null @*/ ImportDecl decl;
...
// Generated boilerplate constructors:
  ...
  protected ImportPragma(/*@ non_null @*/ ImportDecl decl, int loc) {
     this.decl = decl;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.IMPORTPRAGMA;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitImportPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitImportPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ImportPragma make(/*@ non_null @*/ ImportDecl decl, int loc) {
     ImportPragma result = new ImportPragma(decl, loc);
     return result;
  }
}
