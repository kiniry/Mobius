...
// Generated boilerplate constructors:
  ...
  //@ ensures this.locHotspot == locHotspot;
  //@ ensures this.oldmap == oldmap;
  //@ ensures this.invariants == invariants;
  //@ ensures this.decreases == decreases;
  //@ ensures this.skolemConstants == skolemConstants;
  //@ ensures this.predicates == predicates;
  //@ ensures this.tempVars == tempVars;
  //@ ensures this.guard == guard;
  //@ ensures this.body == body;
  protected LoopCmd(int locStart, int locEnd, int locHotspot, /*@ non_null @*/ Hashtable oldmap, /*@ non_null @*/ ConditionVec invariants, /*@ non_null @*/ DecreasesInfoVec decreases, /*@ non_null @*/ LocalVarDeclVec skolemConstants, /*@ non_null @*/ ExprVec predicates, /*@ non_null @*/ GenericVarDeclVec tempVars, /*@ non_null @*/ GuardedCmd guard, /*@ non_null @*/ GuardedCmd body) {
     super();
     this.locStart = locStart;
     this.locEnd = locEnd;
     this.locHotspot = locHotspot;
     this.oldmap = oldmap;
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ LoopCmd make(int locStart, int locEnd, int locHotspot, /*@ non_null @*/ Hashtable oldmap, /*@ non_null @*/ ConditionVec invariants, /*@ non_null @*/ DecreasesInfoVec decreases, /*@ non_null @*/ LocalVarDeclVec skolemConstants, /*@ non_null @*/ ExprVec predicates, /*@ non_null @*/ GenericVarDeclVec tempVars, /*@ non_null @*/ GuardedCmd guard, /*@ non_null @*/ GuardedCmd body) {
     LoopCmd result = new LoopCmd(locStart, locEnd, locHotspot, oldmap, invariants, decreases, skolemConstants, predicates, tempVars, guard, body);
     return result;
  }
}
