...
{
  public /*@ non_null @*/ ConstructorDecl decl;

  public int loc;

  public /*@ non_null @*/ SimpleName id;
...
// Generated boilerplate constructors:
  ...
  //@ ensures this.id == id;
  protected ModelConstructorDeclPragma(/*@ non_null @*/ ConstructorDecl decl, int loc, /*@ non_null @*/ SimpleName id) {
     this.decl = decl;
     this.loc = loc;
     this.id = id;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.MODELCONSTRUCTORDECLPRAGMA;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitModelConstructorDeclPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitModelConstructorDeclPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ModelConstructorDeclPragma make(/*@ non_null @*/ ConstructorDecl decl, int loc, /*@ non_null @*/ SimpleName id) {
     ModelConstructorDeclPragma result = new ModelConstructorDeclPragma(decl, loc, id);
     return result;
  }
}
