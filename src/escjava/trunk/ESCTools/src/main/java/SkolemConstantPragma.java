...
// Generated boilerplate constructors:
  ...
  //@ ensures this.decls == decls;
  //@ ensures this.sloc == sloc;
  //@ ensures this.eloc == eloc;
  protected SkolemConstantPragma(/*@ non_null @*/ LocalVarDeclVec decls, int sloc, int eloc) {
     this.decls = decls;
     this.sloc = sloc;
     this.eloc = eloc;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SkolemConstantPragma make(/*@ non_null @*/ LocalVarDeclVec decls, int sloc, int eloc) {
     SkolemConstantPragma result = new SkolemConstantPragma(decls, sloc, eloc);
     return result;
  }
}
