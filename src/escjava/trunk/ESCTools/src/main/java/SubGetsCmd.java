...
// Generated boilerplate constructors:
  ...
  protected SubGetsCmd(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs, /*@ non_null @*/ Expr index) {
     super(v, rhs);
     this.index = index;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SubGetsCmd make(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs, /*@ non_null @*/ Expr index) {
     SubGetsCmd result = new SubGetsCmd(v, rhs, index);
     return result;
  }
}
