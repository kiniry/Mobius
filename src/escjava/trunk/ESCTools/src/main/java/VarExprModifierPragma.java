...
// Generated boilerplate constructors:
    ...
    protected VarExprModifierPragma(int tag, /*@ non_null @*/ GenericVarDecl arg, /*@ non_null @*/ Expr expr, int loc) {
       this.tag = tag;
       this.arg = arg;
       this.expr = expr;
       this.loc = loc;
...
// Generated boilerplate methods:
    ...
    //@ ensures \result != null;
    public static /*@ non_null */ VarExprModifierPragma make(int tag, /*@ non_null @*/ GenericVarDecl arg, /*@ non_null @*/ Expr expr, int loc) {
       VarExprModifierPragma result = new VarExprModifierPragma(tag, arg, expr, loc);
       return result;
    }
}
