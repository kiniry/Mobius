...
public class AbstractDistributedTestSuite  extends TestSuite {
    ...
    */
	...
	@param serverIndex The position of this server in the list
	@param numberOfServers The total number of servers available for distributed testing
    */
    /*@ public behavior
      @	  requires serverIndex < numberOfServers;
