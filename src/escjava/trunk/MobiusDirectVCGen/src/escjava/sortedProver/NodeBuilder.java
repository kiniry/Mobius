...
public abstract class NodeBuilder
{
	...
	public static Hashtable symbolsById = new Hashtable();
	private static Hashtable sortsByName = new Hashtable();
	public static int currentSymbol = 1;
	
	public static final Sort sortPred   = registerSort("PRED",   null);
	public static final Sort sortAny    = registerSort("any",    null);
	public static final Sort sortValue  = registerSort("value",  sortAny);
	public static final Sort sortBool   = registerSort("bool",   sortValue);
	public static final Sort sortInt    = registerSort("int",    sortValue);
	public static final Sort sortReal   = registerSort("real",   sortValue);
	public static final Sort sortRef 	 = registerSort("ref",    sortValue);
	public static final Sort sortMap    = registerSort("map",    sortRef);
	public static final Sort sortString = sortRef;
		
	protected static Hashtable fnSymbolsByTag = new Hashtable();
	
	public final Sort[] emptySorts = new Sort[0];
	public final SAny[] emptyArgs = new SAny[0];
	
	// Registration and generic stuff
	public static Sort registerSort(String name, /*@ nullable @*/Sort superSort)
	{
	...
	public static  Sort registerMapSort(Sort mapFrom, Sort mapTo, Sort superSort)
	{
	...
	public static Sort registerMapSort(Sort mapFrom, Sort mapTo)
	{
		return registerMapSort(mapFrom, mapTo, sortMap);
	}
	
	//@ requires \nonnullelements(args);
	public static  PredSymbol registerPredSymbol(String name, Sort[] args)
	{
		return registerPredSymbol(name, args, 0);		
	}
	
	//@ requires \nonnullelements(args);
	public static  PredSymbol registerPredSymbol(String name, Sort[] args, int tag)
	{
	...
	//@ requires \nonnullelements(args);
	public static FnSymbol registerFnSymbol(String name, Sort[] args, Sort ret_type)
	{
		return registerFnSymbol(name, args, ret_type, 0);
	}
	
	//@ requires \nonnullelements(args);
	public static FnSymbol registerFnSymbol(String name, Sort[] args, Sort ret_type, int tag)
	{
