...
const AssertFalseTest.Field0 : name;
...
axiom !IsStaticField(AssertFalseTest.Field0);
axiom IsDirectlyModifiableField(AssertFalseTest.Field0);
axiom (DeclType(AssertFalseTest.Field0) == AssertFalseTest);
axiom (AsRefField(AssertFalseTest.Field0, F) == AssertFalseTest.Field0);
axiom (F <: F);
...
implementation F..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block1207;
  ...
  $$block1224~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == F)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1224~b;
  $$block1224~b: $Heap := $Heap[this, $inv := F]; goto $$block1224~a;
...
axiom (AssertFalseTest <: AssertFalseTest);
axiom ($BaseClass(AssertFalseTest) == System.Object);
axiom ((AssertFalseTest <: $BaseClass(AssertFalseTest)) && (AsDirectSubClass(AssertFalseTest, $BaseClass(AssertFalseTest)) == AssertFalseTest));
axiom (!$IsImmutable(AssertFalseTest) && ($AsMutable(AssertFalseTest) == AssertFalseTest));
axiom (forall $U : name :: {($U <: AssertFalseTest)} (($U <: AssertFalseTest) ==> ($U == AssertFalseTest)));
procedure AssertFalseTest.Test0(this : ref);
...
implementation AssertFalseTest.Test0(this : ref) {
  var stack0o : ref;
  entry: assume $IsNotNull(this, AssertFalseTest); goto $$entry~c;
  $$entry~c: assume ($Heap[this, $allocated] == true); goto block1496;
  block1496: goto block1513;
  block1513: assert false; return;
...
procedure AssertFalseTest.Test1(this : ref);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
...
implementation AssertFalseTest.Test1(this : ref) {
  var local0 : ref where $Is(local0, AssertFalseTest);
  var stack0o : ref;
  var stack1s : struct;
  var stack1o : ref;
  var temp0 : exposeVersionType;
  entry: assume $IsNotNull(this, AssertFalseTest); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto block2295;
  block2295: goto block2363;
  block2363: local0 := this; goto $$block2363~j;
  $$block2363~j: stack0o := local0; goto $$block2363~i;
  $$block2363~i: havoc stack1s; goto $$block2363~h;
  $$block2363~h: assume $IsTokenForType(stack1s, AssertFalseTest); goto $$block2363~g;
  $$block2363~g: stack1o := TypeObject(AssertFalseTest); goto $$block2363~f;
  $$block2363~f: assert (stack0o != null); goto $$block2363~e;
  $$block2363~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: AssertFalseTest)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block2363~d;
  $$block2363~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block2363~c;
  $$block2363~c: havoc temp0; goto $$block2363~b;
  $$block2363~b: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block2363~a;
  $$block2363~a: assume IsHeap($Heap); goto block2380;
  block2380: assert false; return;
...
procedure AssertFalseTest.Test2(this : ref);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
...
implementation AssertFalseTest.Test2(this : ref) {
  var local0 : ref where $Is(local0, AssertFalseTest);
  var stack0o : ref;
  var stack1s : struct;
  var stack1o : ref;
  ...
  entry: assume $IsNotNull(this, AssertFalseTest); goto $$entry~e;
  $$entry~e: assume ($Heap[this, $allocated] == true); goto block3128;
  block3128: goto block3196;
  block3196: local0 := this; goto $$block3196~j;
  $$block3196~j: stack0o := local0; goto $$block3196~i;
  $$block3196~i: havoc stack1s; goto $$block3196~h;
  $$block3196~h: assume $IsTokenForType(stack1s, AssertFalseTest); goto $$block3196~g;
  $$block3196~g: stack1o := TypeObject(AssertFalseTest); goto $$block3196~f;
  $$block3196~f: assert (stack0o != null); goto $$block3196~e;
  $$block3196~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: AssertFalseTest)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block3196~d;
  $$block3196~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block3196~c;
  $$block3196~c: havoc temp0; goto $$block3196~b;
  $$block3196~b: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block3196~a;
  $$block3196~a: assume IsHeap($Heap); goto block3213;
  ...
  $$block3230~a: stack0i := 10; goto true3230to3264, false3230to3247;
  true3230to3264: assume (i >= stack0i); goto block3264;
  false3230to3247: assume (i < stack0i); goto block3247;
  block3264: assert false; return;
  block3247: local2 := i; goto $$block3247~d;
  $$block3247~d: stack0i := 1; goto $$block3247~c;
  $$block3247~c: stack0i := (local2 + stack0i); goto $$block3247~b;
  $$block3247~b: i := stack0i; goto $$block3247~a;
  $$block3247~a: stack0i := local2; goto block3230;
  block3230$LoopPreheader: $Heap$block3230$LoopPreheader := $Heap; goto block3230;
  
}

procedure AssertFalseTest.Test3(this : ref);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
...
implementation AssertFalseTest.Test3(this : ref) {
  var local0 : ref where $Is(local0, AssertFalseTest);
  var stack0o : ref;
  var stack1s : struct;
  var stack1o : ref;
  ...
  var stack50000o : ref;
  var local2 : int where InRange(local2, System.Int32);
  var $Heap$block4267$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, AssertFalseTest); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto block4165;
  block4165: goto block4233;
  block4233: local0 := this; goto $$block4233~j;
  $$block4233~j: stack0o := local0; goto $$block4233~i;
  $$block4233~i: havoc stack1s; goto $$block4233~h;
  $$block4233~h: assume $IsTokenForType(stack1s, AssertFalseTest); goto $$block4233~g;
  $$block4233~g: stack1o := TypeObject(AssertFalseTest); goto $$block4233~f;
  $$block4233~f: assert (stack0o != null); goto $$block4233~e;
  $$block4233~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: AssertFalseTest)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block4233~d;
  $$block4233~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block4233~c;
  ...
  block4250: i := 0; goto block4267$LoopPreheader;
  block4267: assume (((forall $o : ref :: (($Heap$block4267$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block4267$LoopPreheader[$ot, $allocated] == true) && ($Heap$block4267$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block4267$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block4267$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block4267$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block4267~d;
  $$block4267~d: assume (forall $o : ref :: ((($Heap$block4267$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block4267$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block4267$LoopPreheader[$o, $allocated] != true))); goto $$block4267~c;
  $$block4267~c: assume (forall $o : ref :: ((($Heap$block4267$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block4267~b;
  $$block4267~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block4267$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block4267$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block4267$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block4267~a;
  $$block4267~a: stack0i := 10; goto true4267to4301, false4267to4284;
  true4267to4301: assume (i >= stack0i); goto block4301;
  false4267to4284: assume (i < stack0i); goto block4284;
  block4301: assert false; return;
  block4284: havoc stack50000o; goto $$block4284~o;
  $$block4284~o: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == F)); goto $$block4284~n;
  $$block4284~n: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block4284~m;
  $$block4284~m: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block4284~l;
  $$block4284~l: assert (stack50000o != null); goto $$block4284~k;
  $$block4284~k: call F..ctor(stack50000o); goto $$block4284~j;
  $$block4284~j: stack0o := stack50000o; goto $$block4284~i;
  $$block4284~i: assert (this != null); goto $$block4284~h;
  $$block4284~h: assert (!($Heap[this, $inv] <: AssertFalseTest) || ($Heap[this, $localinv] == System.Object)); goto $$block4284~g;
  $$block4284~g: $Heap := $Heap[this, AssertFalseTest.Field0 := stack0o]; goto $$block4284~f;
  $$block4284~f: assume IsHeap($Heap); goto $$block4284~e;
  $$block4284~e: local2 := i; goto $$block4284~d;
  $$block4284~d: stack0i := 1; goto $$block4284~c;
  $$block4284~c: stack0i := (local2 + stack0i); goto $$block4284~b;
  $$block4284~b: i := stack0i; goto $$block4284~a;
  $$block4284~a: stack0i := local2; goto block4267;
  block4267$LoopPreheader: $Heap$block4267$LoopPreheader := $Heap; goto block4267;
  
}

procedure AssertFalseTest..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == AssertFalseTest)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(AssertFalseTest <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation AssertFalseTest..ctor(this : ref) {
  entry: assume $IsNotNull(this, AssertFalseTest); goto $$entry~i;
  ...
  $$entry~g: assume ($Heap[this, AssertFalseTest.Field0] == null); goto block5049;
  block5049: goto block5066;
  block5066: assert (this != null); goto $$block5066~f;
  $$block5066~f: call System.Object..ctor(this); goto $$block5066~e;
  $$block5066~e: assert (this != null); goto $$block5066~d;
  $$block5066~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block5066~c;
  $$block5066~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == AssertFalseTest)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block5066~b;
  $$block5066~b: $Heap := $Heap[this, $inv := AssertFalseTest]; goto $$block5066~a;
