...
implementation Cell..ctor(this : ref) {
  ...
  $$entry~a: assume ($Heap[this, Cell.x] == 0); goto block2788;
  block2788: goto block2805;
  block2805: goto block2822;
  block2822: goto block2839;
  block2839: assert (this != null); goto $$block2839~a;
  $$block2839~a: call System.Object..ctor(this); goto block2856;
  block2856: goto block2873;
  block2873: goto block3077;
  ...
  $$block3094~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Cell)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3094~b;
  $$block3094~b: $Heap := $Heap[this, $inv := Cell]; goto $$block3094~a;
...
procedure Cell.DoStuff$Cell(cell$in : ref where $Is(cell$in, Cell));
  ...
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old((($o != cell$in) || !($typeof(cell$in) <: DeclType($f))))) && old((($o != cell$in) || ($f != $exposeVersion)))) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
...
implementation Cell.DoStuff$Cell(cell$in : ref) {
  ...
  entry: cell := cell$in; goto block3332;
...
implementation Cell.Main() {
  ...
  block3723: stack0o := cell1; goto $$block3723~a;
  $$block3723~a: call Cell.DoStuff$Cell(stack0o); goto block3740;
  block3740: assert ($Heap[cell1, Cell.x] == 0); goto block3893;
