...
implementation Bag.SpecSharp.CheckInvariant$System.Boolean(this : ref, throwException$in : bool) returns ($result : bool) {
  ...
  $$entry~a: throwException := throwException$in; goto block4726;
  block4726: goto block4743;
  block4743: stack0i := 0; goto $$block4743~b;
  $$block4743~b: assert (this != null); goto $$block4743~a;
  $$block4743~a: stack1i := $Heap[this, Bag.count]; goto true4743to4794, false4743to4760;
  true4743to4794: assume (stack0i > stack1i); goto block4794;
  false4743to4760: assume (stack0i <= stack1i); goto block4760;
  block4794: goto block4811;
  block4760: assert (this != null); goto $$block4760~e;
  $$block4760~e: stack0i := $Heap[this, Bag.count]; goto $$block4760~d;
  $$block4760~d: assert (this != null); goto $$block4760~c;
  $$block4760~c: stack1o := $Heap[this, Bag.elems]; goto $$block4760~b;
  $$block4760~b: assert (stack1o != null); goto $$block4760~a;
  $$block4760~a: stack1i := $Length(stack1o); goto true4760to4794, false4760to4777;
  true4760to4794: assume (stack0i > stack1i); goto block4794;
  false4760to4777: assume (stack0i <= stack1i); goto block4777;
  block4777: goto block4913;
  block4811: stack0b := throwException; goto true4811to4862, false4811to4828;
  true4811to4862: assume !stack0b; goto block4862;
  false4811to4828: assume stack0b; goto block4828;
  block4862: return.value := false; goto block4964;
  block4828: assume false; goto $$block4828~i;
  $$block4828~i: havoc stack50000o; goto $$block4828~h;
  $$block4828~h: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException)); goto $$block4828~g;
  $$block4828~g: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block4828~f;
  $$block4828~f: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block4828~e;
  $$block4828~e: assert (stack50000o != null); goto $$block4828~d;
  $$block4828~d: call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o); goto $$block4828~c;
  $$block4828~c: stack0o := stack50000o; goto $$block4828~b;
  $$block4828~b: assert (stack0o != null); goto $$block4828~a;
  $$block4828~a: assume false; return;
  block4913: goto block4930;
  block4930: goto block4947;
  block4964: goto block4981;
  block4947: return.value := true; goto block4964;
  block4981: SS$Display.Return.Local := return.value; goto $$block4981~b;
  $$block4981~b: stack0b := return.value; goto $$block4981~a;
  $$block4981~a: $result := stack0b; return;
...
implementation Bag..ctor$System.Int32.array(this : ref, initialElements$in : ref) {
  ...
  $$entry~c: assume ($Heap[this, Bag.count] == 0); goto block5406;
  block5406: goto block5423;
  block5423: goto block5440;
  block5440: goto block5457;
  block5457: goto block5474;
  block5474: assert (initialElements != null); goto $$block5474~e;
  $$block5474~e: stack0i := $Length(initialElements); goto $$block5474~d;
  $$block5474~d: assert (this != null); goto $$block5474~c;
  $$block5474~c: assert (!($Heap[this, $inv] <: Bag) || ($Heap[this, $localinv] == System.Object)); goto $$block5474~b;
  $$block5474~b: $Heap := $Heap[this, Bag.count := stack0i]; goto $$block5474~a;
  $$block5474~a: assume IsHeap($Heap); goto block5491;
  block5491: assert (initialElements != null); goto $$block5491~j;
  $$block5491~j: stack0i := $Length(initialElements); goto $$block5491~i;
  $$block5491~i: assert (0 <= stack0i); goto $$block5491~h;
  $$block5491~h: havoc e; goto $$block5491~g;
  $$block5491~g: assume (($Heap[e, $allocated] == false) && ($Length(e) == stack0i)); goto $$block5491~f;
  $$block5491~f: assume $IsNotNull(e, ValueArray(System.Int32, 1)); goto $$block5491~e;
  $$block5491~e: assume (($Heap[e, $ownerRef] == e) && ($Heap[e, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block5491~d;
  $$block5491~d: assume ((($Heap[e, $inv] == ValueArray(System.Int32, 1)) && ($Heap[e, $localinv] == ValueArray(System.Int32, 1))) && ((($Heap[e, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[e, $ownerRef], $inv] <: $Heap[e, $ownerFrame])) || ($Heap[$Heap[e, $ownerRef], $localinv] == $BaseClass($Heap[e, $ownerFrame])))); goto $$block5491~c;
  $$block5491~c: assume (forall $i : int :: (ValueArrayGet($Heap[e, $elements], $i) == 0)); goto $$block5491~b;
  $$block5491~b: $Heap := $Heap[e, $allocated := true]; goto $$block5491~a;
  $$block5491~a: assume IsHeap($Heap); goto block5508;
  block5508: stack0o := e; goto $$block5508~l;
  $$block5508~l: assert (stack0o != null); goto $$block5508~k;
  $$block5508~k: stack0o := stack0o; goto $$block5508~j;
  $$block5508~j: stack1i := 0; goto $$block5508~i;
  $$block5508~i: assert (initialElements != null); goto $$block5508~h;
  $$block5508~h: call System.Array.CopyTo$System.Array$notnull$System.Int32$.Virtual.$(initialElements, stack0o, stack1i); goto $$block5508~g;
  $$block5508~g: stack0o := e; goto $$block5508~f;
  $$block5508~f: assert (stack0o != null); goto $$block5508~e;
  $$block5508~e: stack0o := stack0o; goto $$block5508~d;
  $$block5508~d: assert (this != null); goto $$block5508~c;
  $$block5508~c: assert (!($Heap[this, $inv] <: Bag) || ($Heap[this, $localinv] == System.Object)); goto $$block5508~b;
  $$block5508~b: $Heap := $Heap[this, Bag.elems := stack0o]; goto $$block5508~a;
  $$block5508~a: assume IsHeap($Heap); goto block5525;
  block5525: assert (this != null); goto $$block5525~a;
  $$block5525~a: call System.Object..ctor(this); goto block5644;
  block5644: goto block5661;
  block5661: goto block5678;
  block5678: goto block5695;
  block5695: temp0 := this; goto $$block5695~f;
  $$block5695~f: assert (temp0 != null); goto $$block5695~e;
  $$block5695~e: assert (($Heap[temp0, $inv] == System.Object) && ($Heap[temp0, $localinv] == $typeof(temp0))); goto $$block5695~d;
  $$block5695~d: assert ((0 <= $Heap[temp0, Bag.count]) && ($Heap[temp0, Bag.count] <= $Length($Heap[temp0, Bag.elems]))); goto $$block5695~c;
  $$block5695~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == temp0)) && ($Heap[$p, $ownerFrame] == Bag)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block5695~b;
  $$block5695~b: $Heap := $Heap[temp0, $inv := Bag]; goto $$block5695~a;
  $$block5695~a: assume IsHeap($Heap); return;
...
implementation Bag..ctor$System.Int32.array$notnull$System.Int32$System.Int32(this : ref, initialElements$in : ref, start$in : int, howMany$in : int) {
  ...
  $$entry~g: assume ($Heap[this, Bag.count] == 0); goto block6596;
  block6596: goto block7021;
  block7021: goto block7038;
  block7038: goto block7055;
  block7055: goto block7072;
  block7072: goto block7089;
  block7089: assert (this != null); goto $$block7089~c;
  $$block7089~c: assert (!($Heap[this, $inv] <: Bag) || ($Heap[this, $localinv] == System.Object)); goto $$block7089~b;
  $$block7089~b: $Heap := $Heap[this, Bag.count := howMany]; goto $$block7089~a;
  $$block7089~a: assume IsHeap($Heap); goto block7106;
  block7106: stack0i := howMany; goto $$block7106~i;
  $$block7106~i: assert (0 <= stack0i); goto $$block7106~h;
  $$block7106~h: havoc e; goto $$block7106~g;
  $$block7106~g: assume (($Heap[e, $allocated] == false) && ($Length(e) == stack0i)); goto $$block7106~f;
  $$block7106~f: assume $IsNotNull(e, ValueArray(System.Int32, 1)); goto $$block7106~e;
  $$block7106~e: assume (($Heap[e, $ownerRef] == e) && ($Heap[e, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block7106~d;
  $$block7106~d: assume ((($Heap[e, $inv] == ValueArray(System.Int32, 1)) && ($Heap[e, $localinv] == ValueArray(System.Int32, 1))) && ((($Heap[e, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[e, $ownerRef], $inv] <: $Heap[e, $ownerFrame])) || ($Heap[$Heap[e, $ownerRef], $localinv] == $BaseClass($Heap[e, $ownerFrame])))); goto $$block7106~c;
  $$block7106~c: assume (forall $i : int :: (ValueArrayGet($Heap[e, $elements], $i) == 0)); goto $$block7106~b;
  $$block7106~b: $Heap := $Heap[e, $allocated := true]; goto $$block7106~a;
  $$block7106~a: assume IsHeap($Heap); goto block7123;
  block7123: stack0o := initialElements; goto $$block7123~n;
  $$block7123~n: stack1i := start; goto $$block7123~m;
  $$block7123~m: stack2o := e; goto $$block7123~l;
  $$block7123~l: assert (stack2o != null); goto $$block7123~k;
  $$block7123~k: stack2o := stack2o; goto $$block7123~j;
  $$block7123~j: stack3i := 0; goto $$block7123~i;
  $$block7123~i: stack4i := (start + howMany); goto $$block7123~h;
  $$block7123~h: call System.Array.Copy$System.Array$notnull$System.Int32$System.Array$notnull$System.Int32$System.Int32(stack0o, stack1i, stack2o, stack3i, stack4i); goto $$block7123~g;
  $$block7123~g: stack0o := e; goto $$block7123~f;
  $$block7123~f: assert (stack0o != null); goto $$block7123~e;
  $$block7123~e: stack0o := stack0o; goto $$block7123~d;
  $$block7123~d: assert (this != null); goto $$block7123~c;
  $$block7123~c: assert (!($Heap[this, $inv] <: Bag) || ($Heap[this, $localinv] == System.Object)); goto $$block7123~b;
  $$block7123~b: $Heap := $Heap[this, Bag.elems := stack0o]; goto $$block7123~a;
  $$block7123~a: assume IsHeap($Heap); goto block7140;
  block7140: assert (this != null); goto $$block7140~a;
  $$block7140~a: call System.Object..ctor(this); goto block7259;
  block7259: goto block7276;
  block7276: goto block7293;
  block7293: goto block7310;
  block7310: temp0 := this; goto $$block7310~f;
  $$block7310~f: assert (temp0 != null); goto $$block7310~e;
  $$block7310~e: assert (($Heap[temp0, $inv] == System.Object) && ($Heap[temp0, $localinv] == $typeof(temp0))); goto $$block7310~d;
  $$block7310~d: assert ((0 <= $Heap[temp0, Bag.count]) && ($Heap[temp0, Bag.count] <= $Length($Heap[temp0, Bag.elems]))); goto $$block7310~c;
  $$block7310~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == temp0)) && ($Heap[$p, $ownerFrame] == Bag)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block7310~b;
  $$block7310~b: $Heap := $Heap[temp0, $inv := Bag]; goto $$block7310~a;
  $$block7310~a: assume IsHeap($Heap); return;
...
implementation Bag.RemoveMin(this : ref) returns ($result : int) {
  ...
  var stack0o : ref;
  var stack1i : int;
  var local8806 : int where InRange(local8806, System.Int32);
  var stack2o : ref;
  var stack3i : int;
  var stack2i : int;
  var local8857 : int where InRange(local8857, System.Int32);
  ...
  var $Heap$block8415$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, Bag); goto $$entry~m;
  $$entry~m: assume ($Heap[this, $allocated] == true); goto block8143;
  block8143: goto block8347;
  block8347: goto block8364;
  block8364: m := int#2147483647; goto block8381;
  block8381: mindex := 0; goto block8398;
  block8398: i := 0; goto block8415$LoopPreheader;
  block8415: assume (((forall $o : ref :: (($Heap$block8415$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block8415$LoopPreheader[$ot, $allocated] == true) && ($Heap$block8415$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block8415$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block8415$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block8415$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block8415~e;
  $$block8415~e: assume (forall $o : ref :: ((($Heap$block8415$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block8415$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block8415$LoopPreheader[$o, $allocated] != true))); goto $$block8415~d;
  $$block8415~d: assume (forall $o : ref :: ((($Heap$block8415$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block8415~c;
  $$block8415~c: assert (forall $o : ref :: ((($o != null) && ($Heap$block8415$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block8415$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block8415$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block8415~b;
  $$block8415~b: assert (this != null); goto $$block8415~a;
  $$block8415~a: stack0i := $Heap[this, Bag.count]; goto true8415to8551, false8415to8432;
  true8415to8551: assume (i >= stack0i); goto block8551;
  false8415to8432: assume (i < stack0i); goto block8432;
  block8551: goto block8568;
  block8432: assert (this != null); goto $$block8432~f;
  $$block8432~f: stack0o := $Heap[this, Bag.elems]; goto $$block8432~e;
  $$block8432~e: stack1i := i; goto $$block8432~d;
  $$block8432~d: assert (stack0o != null); goto $$block8432~c;
  $$block8432~c: assert (0 <= stack1i); goto $$block8432~b;
  $$block8432~b: assert (stack1i < $Length(stack0o)); goto $$block8432~a;
  $$block8432~a: stack0i := ValueArrayGet($Heap[stack0o, $elements], stack1i); goto true8432to8466, false8432to8449;
  true8432to8466: assume (stack0i >= m); goto block8466;
  false8432to8449: assume (stack0i < m); goto block8449;
  block8466: goto block8483;
  block8449: mindex := i; goto $$block8449~g;
  $$block8449~g: assert (this != null); goto $$block8449~f;
  $$block8449~f: stack0o := $Heap[this, Bag.elems]; goto $$block8449~e;
  $$block8449~e: stack1i := i; goto $$block8449~d;
  $$block8449~d: assert (stack0o != null); goto $$block8449~c;
  $$block8449~c: assert (0 <= stack1i); goto $$block8449~b;
  $$block8449~b: assert (stack1i < $Length(stack0o)); goto $$block8449~a;
  $$block8449~a: m := ValueArrayGet($Heap[stack0o, $elements], stack1i); goto block8466;
  block8568: assert (this != null); goto $$block8568~h;
  $$block8568~h: local8806 := $Heap[this, Bag.count]; goto $$block8568~g;
  $$block8568~g: stack0i := 1; goto $$block8568~f;
  $$block8568~f: stack0i := (local8806 - stack0i); goto $$block8568~e;
  $$block8568~e: assert (this != null); goto $$block8568~d;
  $$block8568~d: assert (!($Heap[this, $inv] <: Bag) || ($Heap[this, $localinv] == System.Object)); goto $$block8568~c;
  $$block8568~c: $Heap := $Heap[this, Bag.count := stack0i]; goto $$block8568~b;
  $$block8568~b: assume IsHeap($Heap); goto $$block8568~a;
  $$block8568~a: stack0i := local8806; goto block8585;
  block8483: goto block8500;
  block8585: assert (this != null); goto $$block8585~o;
  $$block8585~o: stack0o := $Heap[this, Bag.elems]; goto $$block8585~n;
  $$block8585~n: stack1i := mindex; goto $$block8585~m;
  $$block8585~m: assert (this != null); goto $$block8585~l;
  $$block8585~l: stack2o := $Heap[this, Bag.elems]; goto $$block8585~k;
  $$block8585~k: assert (this != null); goto $$block8585~j;
  $$block8585~j: stack3i := $Heap[this, Bag.count]; goto $$block8585~i;
  $$block8585~i: assert (stack2o != null); goto $$block8585~h;
  $$block8585~h: assert (0 <= stack3i); goto $$block8585~g;
  $$block8585~g: assert (stack3i < $Length(stack2o)); goto $$block8585~f;
  $$block8585~f: stack2i := ValueArrayGet($Heap[stack2o, $elements], stack3i); goto $$block8585~e;
  $$block8585~e: assert (stack0o != null); goto $$block8585~d;
  $$block8585~d: assert (0 <= stack1i); goto $$block8585~c;
  $$block8585~c: assert (stack1i < $Length(stack0o)); goto $$block8585~b;
  $$block8585~b: $Heap := $Heap[stack0o, $elements := ValueArraySet($Heap[stack0o, $elements], stack1i, stack2i)]; goto $$block8585~a;
  $$block8585~a: assume IsHeap($Heap); goto block8602;
  block8500: local8857 := i; goto $$block8500~d;
  $$block8500~d: stack0i := 1; goto $$block8500~c;
  $$block8500~c: stack0i := (local8857 + stack0i); goto $$block8500~b;
  $$block8500~b: i := stack0i; goto $$block8500~a;
  $$block8500~a: stack0i := local8857; goto block8517;
  block8602: return.value := m; goto block8619;
  block8517: goto block8534;
  block8619: goto block8636;
  block8534: goto block8415;
  block8636: SS$Display.Return.Local := return.value; goto $$block8636~b;
  $$block8636~b: stack0i := return.value; goto $$block8636~a;
  $$block8636~a: $result := stack0i; return;
  block8415$LoopPreheader: $Heap$block8415$LoopPreheader := $Heap; goto block8415;
...
implementation Bag.Add$System.Int32(this : ref, x$in : int) {
  ...
  var stack4o : ref;
  var stack4i : int;
  var local9826 : int where InRange(local9826, System.Int32);
  entry: assume $IsNotNull(this, Bag); goto $$entry~o;
  $$entry~o: assume ($Heap[this, $allocated] == true); goto $$entry~n;
  $$entry~n: x := x$in; goto block9299;
  block9299: goto block9503;
  block9503: goto block9520;
  block9520: assert (this != null); goto $$block9520~e;
  $$block9520~e: stack0i := $Heap[this, Bag.count]; goto $$block9520~d;
  $$block9520~d: assert (this != null); goto $$block9520~c;
  $$block9520~c: stack1o := $Heap[this, Bag.elems]; goto $$block9520~b;
  $$block9520~b: assert (stack1o != null); goto $$block9520~a;
  $$block9520~a: stack1i := $Length(stack1o); goto true9520to9571, false9520to9537;
  true9520to9571: assume (stack0i != stack1i); goto block9571;
  false9520to9537: assume (stack0i == stack1i); goto block9537;
  block9571: goto block9588;
  block9537: stack0i := 2; goto $$block9537~n;
  $$block9537~n: assert (this != null); goto $$block9537~m;
  $$block9537~m: stack1o := $Heap[this, Bag.elems]; goto $$block9537~l;
  $$block9537~l: assert (stack1o != null); goto $$block9537~k;
  $$block9537~k: stack1i := $Length(stack1o); goto $$block9537~j;
  $$block9537~j: stack0i := (stack0i * stack1i); goto $$block9537~i;
  $$block9537~i: assert (0 <= stack0i); goto $$block9537~h;
  $$block9537~h: havoc b; goto $$block9537~g;
  $$block9537~g: assume (($Heap[b, $allocated] == false) && ($Length(b) == stack0i)); goto $$block9537~f;
  $$block9537~f: assume $IsNotNull(b, ValueArray(System.Int32, 1)); goto $$block9537~e;
  $$block9537~e: assume (($Heap[b, $ownerRef] == b) && ($Heap[b, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block9537~d;
  $$block9537~d: assume ((($Heap[b, $inv] == ValueArray(System.Int32, 1)) && ($Heap[b, $localinv] == ValueArray(System.Int32, 1))) && ((($Heap[b, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[b, $ownerRef], $inv] <: $Heap[b, $ownerFrame])) || ($Heap[$Heap[b, $ownerRef], $localinv] == $BaseClass($Heap[b, $ownerFrame])))); goto $$block9537~c;
  $$block9537~c: assume (forall $i : int :: (ValueArrayGet($Heap[b, $elements], $i) == 0)); goto $$block9537~b;
  $$block9537~b: $Heap := $Heap[b, $allocated := true]; goto $$block9537~a;
  $$block9537~a: assume IsHeap($Heap); goto block9554;
  block9554: assert (this != null); goto $$block9554~m;
  $$block9554~m: stack0o := $Heap[this, Bag.elems]; goto $$block9554~l;
  $$block9554~l: stack1i := 0; goto $$block9554~k;
  $$block9554~k: stack2o := b; goto $$block9554~j;
  $$block9554~j: stack3i := 0; goto $$block9554~i;
  $$block9554~i: assert (this != null); goto $$block9554~h;
  $$block9554~h: stack4o := $Heap[this, Bag.elems]; goto $$block9554~g;
  $$block9554~g: assert (stack4o != null); goto $$block9554~f;
  $$block9554~f: stack4i := $Length(stack4o); goto $$block9554~e;
  $$block9554~e: call System.Array.Copy$System.Array$notnull$System.Int32$System.Array$notnull$System.Int32$System.Int32(stack0o, stack1i, stack2o, stack3i, stack4i); goto $$block9554~d;
  $$block9554~d: assert (this != null); goto $$block9554~c;
  $$block9554~c: assert (!($Heap[this, $inv] <: Bag) || ($Heap[this, $localinv] == System.Object)); goto $$block9554~b;
  $$block9554~b: $Heap := $Heap[this, Bag.elems := b]; goto $$block9554~a;
  $$block9554~a: assume IsHeap($Heap); goto block9571;
  block9588: goto block9605;
  block9605: assert (this != null); goto $$block9605~h;
  $$block9605~h: stack0o := $Heap[this, Bag.elems]; goto $$block9605~g;
  $$block9605~g: assert (this != null); goto $$block9605~f;
  $$block9605~f: stack1i := $Heap[this, Bag.count]; goto $$block9605~e;
  $$block9605~e: assert (stack0o != null); goto $$block9605~d;
  $$block9605~d: assert (0 <= stack1i); goto $$block9605~c;
  $$block9605~c: assert (stack1i < $Length(stack0o)); goto $$block9605~b;
  $$block9605~b: $Heap := $Heap[stack0o, $elements := ValueArraySet($Heap[stack0o, $elements], stack1i, x)]; goto $$block9605~a;
  $$block9605~a: assume IsHeap($Heap); goto block9622;
  block9622: assert (this != null); goto $$block9622~h;
  $$block9622~h: local9826 := $Heap[this, Bag.count]; goto $$block9622~g;
  $$block9622~g: stack0i := 1; goto $$block9622~f;
  $$block9622~f: stack0i := (local9826 + stack0i); goto $$block9622~e;
  $$block9622~e: assert (this != null); goto $$block9622~d;
  $$block9622~d: assert (!($Heap[this, $inv] <: Bag) || ($Heap[this, $localinv] == System.Object)); goto $$block9622~c;
  $$block9622~c: $Heap := $Heap[this, Bag.count := stack0i]; goto $$block9622~b;
  $$block9622~b: assume IsHeap($Heap); goto $$block9622~a;
  $$block9622~a: stack0i := local9826; goto block9639;
...
implementation Bag..cctor() {
  entry: goto block10319;
  block10319: goto block10438;
