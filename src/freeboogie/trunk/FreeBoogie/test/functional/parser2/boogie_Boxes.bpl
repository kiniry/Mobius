...
implementation Boxes`2.M$System.Int32(this : ref, x$in : int) returns ($result : int) {
  ...
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: x := x$in; goto block1343;
  block1343: goto block1360;
  block1360: havoc stack0o; goto $$block1360~j;
  $$block1360~j: assume (Box(x, stack0o) == stack0o); goto $$block1360~i;
  $$block1360~i: assume (UnboxedType(stack0o) == System.Int32); goto $$block1360~h;
  $$block1360~h: assume $IsNotNull(stack0o, System.Object); goto $$block1360~g;
  $$block1360~g: assume ($Heap[stack0o, $allocated] == true); goto $$block1360~f;
  $$block1360~f: assume (((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))); goto $$block1360~e;
  $$block1360~e: o := stack0o; goto $$block1360~d;
  $$block1360~d: assert (UnboxedType(o) == System.Int32); goto $$block1360~c;
  $$block1360~c: stack0i := Unbox(o); goto $$block1360~b;
  $$block1360~b: y := stack0i; goto $$block1360~a;
  $$block1360~a: return.value := y; goto block1377;
  block1377: SS$Display.Return.Local := return.value; goto $$block1377~b;
  $$block1377~b: stack0i := return.value; goto $$block1377~a;
  $$block1377~a: $result := stack0i; return;
...
implementation Boxes`2.N$System.Int32(this : ref, x$in : int) returns ($result : bool) {
  ...
  var o : ref where $Is(o, System.Object);
  var stack0b : bool;
  var y : bool where true;
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: x := x$in; goto block1683;
  block1683: goto block1700;
  block1700: havoc stack0o; goto $$block1700~j;
  $$block1700~j: assume (Box(x, stack0o) == stack0o); goto $$block1700~i;
  $$block1700~i: assume (UnboxedType(stack0o) == System.Int32); goto $$block1700~h;
  $$block1700~h: assume $IsNotNull(stack0o, System.Object); goto $$block1700~g;
  $$block1700~g: assume ($Heap[stack0o, $allocated] == true); goto $$block1700~f;
  $$block1700~f: assume (((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))); goto $$block1700~e;
  $$block1700~e: o := stack0o; goto $$block1700~d;
  $$block1700~d: assert (UnboxedType(o) == System.Boolean); goto $$block1700~c;
  $$block1700~c: stack0b := Unbox(o); goto $$block1700~b;
  $$block1700~b: y := stack0b; goto $$block1700~a;
  $$block1700~a: return.value := y; goto block1717;
  block1717: SS$Display.Return.Local := return.value; goto $$block1717~b;
  $$block1717~b: stack0b := return.value; goto $$block1717~a;
  $$block1717~a: $result := stack0b; return;
...
implementation Boxes`2.P0$Boxes`2..type.parameter.T(this : ref, x$in : ref) returns ($result : ref) {
  var x : ref where $Is(x, Boxes`2..type.parameter.T);
  var stack0o : ref;
  var o : ref where $Is(o, System.Object);
  var y : ref where $Is(y, Boxes`2..type.parameter.T);
  var return.value : ref where $Is(return.value, Boxes`2..type.parameter.T);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, Boxes`2..type.parameter.T);
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto $$entry~e;
  $$entry~e: x := x$in; goto block2023;
  block2023: goto block2040;
  block2040: havoc stack0o; goto $$block2040~g;
  $$block2040~g: assume (Box(x, stack0o) == stack0o); goto $$block2040~f;
  $$block2040~f: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.T); goto $$block2040~e;
  $$block2040~e: o := stack0o; goto $$block2040~d;
  $$block2040~d: assert (UnboxedType(o) <: Boxes`2..type.parameter.T); goto $$block2040~c;
  $$block2040~c: stack0o := Unbox(o); goto $$block2040~b;
  $$block2040~b: y := stack0o; goto $$block2040~a;
  $$block2040~a: return.value := y; goto block2057;
  block2057: SS$Display.Return.Local := return.value; goto $$block2057~b;
  $$block2057~b: stack0o := return.value; goto $$block2057~a;
  $$block2057~a: $result := stack0o; return;
...
implementation Boxes`2.P1$Boxes`2..type.parameter.U(this : ref, x$in : ref) returns ($result : ref) {
  var x : ref where $Is(x, Boxes`2..type.parameter.U);
  var stack0o : ref;
  var o : ref where $Is(o, System.Object);
  var y : ref where $Is(y, Boxes`2..type.parameter.T);
  var return.value : ref where $Is(return.value, Boxes`2..type.parameter.T);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, Boxes`2..type.parameter.T);
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~h;
  $$entry~h: assume ($Heap[this, $allocated] == true); goto $$entry~g;
  $$entry~g: x := x$in; goto block2363;
  block2363: goto block2380;
  block2380: havoc stack0o; goto $$block2380~g;
  $$block2380~g: assume (Box(x, stack0o) == stack0o); goto $$block2380~f;
  $$block2380~f: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.U); goto $$block2380~e;
  $$block2380~e: o := stack0o; goto $$block2380~d;
  $$block2380~d: assert (UnboxedType(o) <: Boxes`2..type.parameter.T); goto $$block2380~c;
  $$block2380~c: stack0o := Unbox(o); goto $$block2380~b;
  $$block2380~b: y := stack0o; goto $$block2380~a;
  $$block2380~a: return.value := y; goto block2397;
  block2397: SS$Display.Return.Local := return.value; goto $$block2397~b;
  $$block2397~b: stack0o := return.value; goto $$block2397~a;
  $$block2397~a: $result := stack0o; return;
...
implementation Boxes`2.P2$Boxes`2..type.parameter.U(this : ref, x$in : ref) returns ($result : ref) {
  ...
  var return.value : ref where $Is(return.value, Boxes`2..type.parameter.T);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, Boxes`2..type.parameter.T);
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~j;
  $$entry~j: assume ($Heap[this, $allocated] == true); goto $$entry~i;
  $$entry~i: x := x$in; goto block2703;
  block2703: goto block2720;
  block2720: havoc stack0o; goto $$block2720~f;
  $$block2720~f: assume (Box(x, stack0o) == stack0o); goto $$block2720~e;
  $$block2720~e: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.U); goto $$block2720~d;
  $$block2720~d: assert (UnboxedType(stack0o) <: Boxes`2..type.parameter.T); goto $$block2720~c;
  $$block2720~c: stack0o := Unbox(stack0o); goto $$block2720~b;
  $$block2720~b: y := stack0o; goto $$block2720~a;
  $$block2720~a: return.value := y; goto block2737;
  block2737: SS$Display.Return.Local := return.value; goto $$block2737~b;
  $$block2737~b: stack0o := return.value; goto $$block2737~a;
  $$block2737~a: $result := stack0o; return;
...
implementation Boxes`2.Q$System.Int32(this : ref, x$in : int) returns ($result : ref) {
  ...
  var return.value : ref where $Is(return.value, Boxes`2..type.parameter.T);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, Boxes`2..type.parameter.T);
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~l;
  $$entry~l: assume ($Heap[this, $allocated] == true); goto $$entry~k;
  $$entry~k: x := x$in; goto block3026;
  block3026: goto block3043;
  block3043: havoc stack0o; goto $$block3043~j;
  $$block3043~j: assume (Box(x, stack0o) == stack0o); goto $$block3043~i;
  $$block3043~i: assume (UnboxedType(stack0o) == System.Int32); goto $$block3043~h;
  $$block3043~h: assume $IsNotNull(stack0o, System.Object); goto $$block3043~g;
  $$block3043~g: assume ($Heap[stack0o, $allocated] == true); goto $$block3043~f;
  $$block3043~f: assume (((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))); goto $$block3043~e;
  $$block3043~e: o := stack0o; goto $$block3043~d;
  $$block3043~d: assert (UnboxedType(o) <: Boxes`2..type.parameter.T); goto $$block3043~c;
  $$block3043~c: stack0o := Unbox(o); goto $$block3043~b;
  $$block3043~b: y := stack0o; goto $$block3043~a;
  $$block3043~a: return.value := y; goto block3060;
  block3060: SS$Display.Return.Local := return.value; goto $$block3060~b;
  $$block3060~b: stack0o := return.value; goto $$block3060~a;
  $$block3060~a: $result := stack0o; return;
...
implementation Boxes`2.R$Boxes`2..type.parameter.T$notnull(this : ref, x$in : ref) returns ($result : bool) {
  var x : ref where $IsNotNull(x, Boxes`2..type.parameter.T);
  var stack0o : ref;
  var o : ref where $Is(o, System.Object);
  var stack0b : bool;
  var y : bool where true;
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~n;
  $$entry~n: assume ($Heap[this, $allocated] == true); goto $$entry~m;
  $$entry~m: x := x$in; goto block3451;
  block3451: goto block3553;
  block3553: havoc stack0o; goto $$block3553~g;
  $$block3553~g: assume (Box(x, stack0o) == stack0o); goto $$block3553~f;
  $$block3553~f: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.T); goto $$block3553~e;
  $$block3553~e: o := stack0o; goto $$block3553~d;
  $$block3553~d: assert (UnboxedType(o) == System.Boolean); goto $$block3553~c;
  $$block3553~c: stack0b := Unbox(o); goto $$block3553~b;
  $$block3553~b: y := stack0b; goto $$block3553~a;
  $$block3553~a: return.value := y; goto block3570;
...
implementation Boxes`2.S0$Boxes`2..type.parameter.T(this : ref, x$in : ref) returns ($result : bool) {
  ...
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~p;
  $$entry~p: assume ($Heap[this, $allocated] == true); goto $$entry~o;
  $$entry~o: x := x$in; goto block3995;
  block3995: goto block4012;
  block4012: havoc stack0o; goto $$block4012~c;
  $$block4012~c: assume (Box(x, stack0o) == stack0o); goto $$block4012~b;
  $$block4012~b: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.T); goto $$block4012~a;
  $$block4012~a: stack0o := BoxTester(stack0o, System.Boolean); goto true4012to4063, false4012to4029;
  true4012to4063: assume (stack0o == null); goto block4063;
  false4012to4029: assume (stack0o != null); goto block4029;
  block4063: return.value := false; goto block4097;
  block4029: havoc stack0o; goto $$block4029~f;
  $$block4029~f: assume (Box(x, stack0o) == stack0o); goto $$block4029~e;
  $$block4029~e: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.T); goto $$block4029~d;
  $$block4029~d: assert (UnboxedType(stack0o) == System.Boolean); goto $$block4029~c;
  $$block4029~c: stack0b := Unbox(stack0o); goto $$block4029~b;
  $$block4029~b: y := stack0b; goto $$block4029~a;
  $$block4029~a: return.value := y; goto block4097;
  block4097: SS$Display.Return.Local := return.value; goto $$block4097~b;
  $$block4097~b: stack0b := return.value; goto $$block4097~a;
  $$block4097~a: $result := stack0b; return;
...
implementation Boxes`2.S1$Boxes`2..type.parameter.T(this : ref, x$in : ref) returns ($result : bool) {
  ...
  var stack0i : int;
  var y : int where InRange(y, System.Int32);
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~r;
  $$entry~r: assume ($Heap[this, $allocated] == true); goto $$entry~q;
  $$entry~q: x := x$in; goto block4607;
  block4607: goto block4624;
  block4624: havoc stack0o; goto $$block4624~g;
  $$block4624~g: assume (Box(x, stack0o) == stack0o); goto $$block4624~f;
  $$block4624~f: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.T); goto $$block4624~e;
  $$block4624~e: o := stack0o; goto $$block4624~d;
  $$block4624~d: havoc stack0o; goto $$block4624~c;
  $$block4624~c: assume (Box(x, stack0o) == stack0o); goto $$block4624~b;
  $$block4624~b: assume (UnboxedType(stack0o) == Boxes`2..type.parameter.T); goto $$block4624~a;
  $$block4624~a: stack0o := BoxTester(stack0o, System.Boolean); goto true4624to4743, false4624to4641;
  true4624to4743: assume (stack0o == null); goto block4743;
  false4624to4641: assume (stack0o != null); goto block4641;
  block4743: return.value := false; goto block4777;
  block4641: stack0o := null; goto true4641to4743, false4641to4658;
  true4641to4743: assume (o == stack0o); goto block4743;
  false4641to4658: assume (o != stack0o); goto block4658;
  block4658: assert (UnboxedType(o) == System.Int32); goto $$block4658~c;
  $$block4658~c: stack0i := Unbox(o); goto $$block4658~b;
  $$block4658~b: y := stack0i; goto $$block4658~a;
  $$block4658~a: stack0i := 8; goto true4658to4692, false4658to4675;
  block4777: SS$Display.Return.Local := return.value; goto $$block4777~b;
  $$block4777~b: stack0b := return.value; goto $$block4777~a;
  $$block4777~a: $result := stack0b; return;
  true4658to4692: assume (y < stack0i); goto block4692;
  false4658to4675: assume (y >= stack0i); goto block4675;
  block4692: stack0b := true; goto block4709;
  block4675: stack0b := false; goto block4709;
  block4709: return.value := stack0b; goto block4777;
...
implementation Boxes`2.A(this : ref) returns ($result : ref) {
  var stack50000o : ref;
  var stack0o : ref;
  var b : ref where $Is(b, Boxes`2...System.Int32`~`System.Int32);
  ...
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~s;
  $$entry~s: assume ($Heap[this, $allocated] == true); goto block5780;
  block5780: goto block5797;
  block5797: havoc stack50000o; goto $$block5797~h;
  $$block5797~h: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Boxes`2...System.Int32`~`System.Int32)); goto $$block5797~g;
  $$block5797~g: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block5797~f;
  $$block5797~f: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block5797~e;
  $$block5797~e: assert (stack50000o != null); goto $$block5797~d;
  $$block5797~d: call Boxes`2...System.Int32`~`System.Int32..ctor(stack50000o); goto $$block5797~c;
  $$block5797~c: stack0o := stack50000o; goto $$block5797~b;
  $$block5797~b: b := stack0o; goto $$block5797~a;
  $$block5797~a: return.value := b; goto block5814;
  block5814: SS$Display.Return.Local := return.value; goto $$block5814~b;
  $$block5814~b: stack0o := return.value; goto $$block5814~a;
  $$block5814~a: $result := stack0o; return;
...
implementation Boxes`2..ctor(this : ref) {
  entry: assume $IsNotNull(this, Boxes`2); goto $$entry~u;
  $$entry~u: assume ($Heap[this, $allocated] == true); goto $$entry~t;
  $$entry~t: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block6120;
  block6120: goto block6137;
  block6137: assert (this != null); goto $$block6137~f;
  $$block6137~f: call System.Object..ctor(this); goto $$block6137~e;
  $$block6137~e: assert (this != null); goto $$block6137~d;
  $$block6137~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block6137~c;
  $$block6137~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Boxes`2)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6137~b;
  $$block6137~b: $Heap := $Heap[this, $inv := Boxes`2]; goto $$block6137~a;
  $$block6137~a: assume IsHeap($Heap); return;
...
implementation XYZ.Main() {
  var stack50000o : ref;
  var stack0o : ref;
  var b : ref where $Is(b, Boxes`2...System.Boolean`~`System.Boolean);
  var stack0b : bool;
  entry: goto block6341;
  block6341: goto block6358;
  block6358: havoc stack50000o; goto $$block6358~m;
  $$block6358~m: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Boxes`2...System.Boolean`~`System.Boolean)); goto $$block6358~l;
  $$block6358~l: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block6358~k;
  $$block6358~k: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block6358~j;
  $$block6358~j: assert (stack50000o != null); goto $$block6358~i;
  $$block6358~i: call Boxes`2...System.Boolean`~`System.Boolean..ctor(stack50000o); goto $$block6358~h;
  $$block6358~h: stack0o := stack50000o; goto $$block6358~g;
  $$block6358~g: b := stack0o; goto $$block6358~f;
  $$block6358~f: stack0b := false; goto $$block6358~e;
  $$block6358~e: assert (b != null); goto $$block6358~d;
  $$block6358~d: call stack0b := Boxes`2...System.Boolean`~`System.Boolean.R$System.Boolean(b, stack0b); goto $$block6358~c;
  $$block6358~c: stack0b := false; goto $$block6358~b;
  $$block6358~b: assert (b != null); goto $$block6358~a;
  $$block6358~a: call stack0b := Boxes`2...System.Boolean`~`System.Boolean.S1$System.Boolean(b, stack0b); return;
...
implementation XYZ..ctor(this : ref) {
  entry: assume $IsNotNull(this, XYZ); goto $$entry~w;
  $$entry~w: assume ($Heap[this, $allocated] == true); goto $$entry~v;
  $$entry~v: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block6732;
  block6732: goto block6749;
  block6749: assert (this != null); goto $$block6749~f;
  $$block6749~f: call System.Object..ctor(this); goto $$block6749~e;
  $$block6749~e: assert (this != null); goto $$block6749~d;
  $$block6749~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block6749~c;
  $$block6749~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == XYZ)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6749~b;
  $$block6749~b: $Heap := $Heap[this, $inv := XYZ]; goto $$block6749~a;
  $$block6749~a: assume IsHeap($Heap); return;
