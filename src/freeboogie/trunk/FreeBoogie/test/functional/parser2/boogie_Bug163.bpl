...
const S2 : name;
const S1 : name;
axiom !IsStaticField(S2.x);
axiom IsDirectlyModifiableField(S2.x);
axiom (forall $U : name :: {($U <: S1)} (($U <: S1) ==> ($U == S1)));
procedure S1.Foo(this$in : struct) returns (this$out : struct, $result : struct where true);
...
implementation S1.Foo(this$in : struct) returns (this$out : struct, $result : struct) {
  var this : struct where true;
  var return.value : struct where true;
  var SS$Display.Return.Local : struct where true;
  var stack0s : struct;
  entry: this := this$in; goto block2380;
  block2380: goto block2397;
  block2397: return.value := this; goto block2414;
  block2414: goto block2431;
  block2431: SS$Display.Return.Local := return.value; goto $$block2431~c;
  $$block2431~c: stack0s := return.value; goto $$block2431~b;
  $$block2431~b: this$out := this; goto $$block2431~a;
  $$block2431~a: $result := stack0s; return;
  
}

axiom (forall $U : name :: {($U <: S2)} (($U <: S2) ==> ($U == S2)));
procedure S2.Foo$S2(this$in : struct, s$in : struct where true) returns (this$out : struct, $result : int where InRange($result, System.Int32));
...
implementation S2.Foo$S2(this$in : struct, s$in : struct) returns (this$out : struct, $result : int) {
  var this : struct where true;
  ...
  $$entry~a: s := s$in; goto block2669;
  block2669: goto block2686;
  block2686: havoc stack0o; goto $$block2686~a;
  $$block2686~a: return.value := $StructGet(s, S2.x); goto block2703;
  block2703: goto block2720;
  block2720: SS$Display.Return.Local := return.value; goto $$block2720~c;
  $$block2720~c: stack0i := return.value; goto $$block2720~b;
  $$block2720~b: this$out := this; goto $$block2720~a;
  $$block2720~a: $result := stack0i; return;
