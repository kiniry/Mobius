...
axiom (Cast <: Cast);
axiom ($BaseClass(Cast) == System.Object);
axiom ((Cast <: $BaseClass(Cast)) && (AsDirectSubClass(Cast, $BaseClass(Cast)) == Cast));
axiom (!$IsImmutable(Cast) && ($AsMutable(Cast) == Cast));
procedure Cast.P$System.Object(this : ref, o$in : ref where $Is(o$in, System.Object)) returns ($result : ref where $Is($result, RefArray(System.Object, 1)));
  ...
  free ensures $Is($result, RefArray(System.Object, 1));
...
implementation Cast.P$System.Object(this : ref, o$in : ref) returns ($result : ref) {
  var o : ref where $Is(o, System.Object);
  var stack0o : ref;
  var a : ref where $Is(a, RefArray(System.Object, 1));
  var return.value : ref where $Is(return.value, RefArray(System.Object, 1));
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, RefArray(System.Object, 1));
  entry: assume $IsNotNull(this, Cast); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: o := o$in; goto block4131;
  block4131: goto block4148;
  block4148: assume (o != null); goto block4301;
  block4301: goto block4318;
  block4318: assert $Is(o, RefArray(System.Object, 1)); goto $$block4318~b;
  $$block4318~b: stack0o := o; goto $$block4318~a;
  $$block4318~a: a := stack0o; goto block4335;
  block4335: return.value := a; goto block4352;
  block4352: goto block4369;
  block4369: SS$Display.Return.Local := return.value; goto $$block4369~b;
  $$block4369~b: stack0o := return.value; goto $$block4369~a;
  $$block4369~a: $result := stack0o; return;
...
procedure Cast.Q$System.Object(this : ref, o$in : ref where $Is(o$in, System.Object)) returns ($result : ref where $Is($result, System.Object));
  free requires ($Heap[o$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires ((o$in == null) || (((($Heap[o$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[o$in, $ownerRef], $inv] <: $Heap[o$in, $ownerFrame])) || ($Heap[$Heap[o$in, $ownerRef], $localinv] == $BaseClass($Heap[o$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[o$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[o$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
...
implementation Cast.Q$System.Object(this : ref, o$in : ref) returns ($result : ref) {
  var o : ref where $Is(o, System.Object);
  var stack0o : ref;
  var stack0b : bool;
  ...
  entry: assume $IsNotNull(this, Cast); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: o := o$in; goto block4794;
  block4794: goto block4811;
  block4811: stack0o := null; goto true4811to4862, false4811to4828;
  true4811to4862: assume (o == stack0o); goto block4862;
  false4811to4828: assume (o != stack0o); goto block4828;
  block4862: goto block4879;
  block4828: assert $Is(o, System.String); goto $$block4828~b;
  $$block4828~b: stack0o := o; goto $$block4828~a;
  $$block4828~a: s := stack0o; goto block4845;
  block4879: goto block4896;
  block4845: return.value := s; goto block4913;
  block4896: return.value := o; goto block4913;
  block4913: goto block4930;
  block4930: SS$Display.Return.Local := return.value; goto $$block4930~b;
  $$block4930~b: stack0o := return.value; goto $$block4930~a;
  $$block4930~a: $result := stack0o; return;
  
}

procedure Cast.M$System.String$System.String$notnull(this : ref, s0$in : ref where $Is(s0$in, System.String), s1$in : ref where $IsNotNull(s1$in, System.String)) returns ($result : ref where $Is($result, System.String));
  free requires ($Heap[s0$in, $allocated] == true);
  free requires ($Heap[s1$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires ((s0$in == null) || (((($Heap[s0$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[s0$in, $ownerRef], $inv] <: $Heap[s0$in, $ownerFrame])) || ($Heap[$Heap[s0$in, $ownerRef], $localinv] == $BaseClass($Heap[s0$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[s0$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[s0$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  requires (((($Heap[s1$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[s1$in, $ownerRef], $inv] <: $Heap[s1$in, $ownerFrame])) || ($Heap[$Heap[s1$in, $ownerRef], $localinv] == $BaseClass($Heap[s1$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[s1$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[s1$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
...
implementation Cast.M$System.String$System.String$notnull(this : ref, s0$in : ref, s1$in : ref) returns ($result : ref) {
  var s0 : ref where $Is(s0, System.String);
  var s1 : ref where $IsNotNull(s1, System.String);
  var s2 : ref where $Is(s2, System.String);
  var o : ref where $Is(o, System.Object);
  var stack0o : ref;
  var s : ref where $Is(s, System.String);
  ...
  entry: assume $IsNotNull(this, Cast); goto $$entry~g;
  $$entry~g: assume ($Heap[this, $allocated] == true); goto $$entry~f;
  $$entry~f: s0 := s0$in; goto $$entry~e;
  $$entry~e: s1 := s1$in; goto block5474;
  block5474: goto block5678;
  block5678: goto block5695;
  block5695: s2 := $stringLiteral1; goto block5712;
  block5712: goto block5729;
  block5729: goto block5746;
  block5746: o := s0; goto $$block5746~k;
  $$block5746~k: assert $Is(o, System.String); goto $$block5746~j;
  $$block5746~j: stack0o := o; goto $$block5746~i;
  $$block5746~i: s := stack0o; goto $$block5746~h;
  $$block5746~h: o := s1; goto $$block5746~g;
  $$block5746~g: assert $Is(o, System.String); goto $$block5746~f;
  $$block5746~f: stack0o := o; goto $$block5746~e;
  $$block5746~e: s := stack0o; goto $$block5746~d;
  $$block5746~d: o := s2; goto $$block5746~c;
  $$block5746~c: assert $Is(o, System.String); goto $$block5746~b;
  $$block5746~b: stack0o := o; goto $$block5746~a;
  $$block5746~a: s := stack0o; goto block5763;
  block5763: return.value := s; goto block5780;
  block5780: goto block5797;
  block5797: SS$Display.Return.Local := return.value; goto $$block5797~b;
  $$block5797~b: stack0o := return.value; goto $$block5797~a;
  $$block5797~a: $result := stack0o; return;
  
}

procedure Cast.N0$System.String$System.Char.array(this : ref, s0$in : ref where $Is(s0$in, System.String), cc$in : ref where $Is(cc$in, ValueArray(System.Char, 1)));
  free requires ($Heap[s0$in, $allocated] == true);
  free requires ($Heap[cc$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires ((s0$in == null) || (((($Heap[s0$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[s0$in, $ownerRef], $inv] <: $Heap[s0$in, $ownerFrame])) || ($Heap[$Heap[s0$in, $ownerRef], $localinv] == $BaseClass($Heap[s0$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[s0$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[s0$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  requires ((cc$in == null) || (((($Heap[cc$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[cc$in, $ownerRef], $inv] <: $Heap[cc$in, $ownerFrame])) || ($Heap[$Heap[cc$in, $ownerRef], $localinv] == $BaseClass($Heap[cc$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[cc$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[cc$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation Cast.N0$System.String$System.Char.array(this : ref, s0$in : ref, cc$in : ref) {
  var s0 : ref where $Is(s0, System.String);
  var cc : ref where $Is(cc, ValueArray(System.Char, 1));
  var s1 : ref where $Is(s1, System.String);
  var stack0o : ref;
  var stack50000o : ref;
  var s2 : ref where $Is(s2, System.String);
  var o2 : ref where $Is(o2, System.Object);
  entry: assume $IsNotNull(this, Cast); goto $$entry~j;
  $$entry~j: assume ($Heap[this, $allocated] == true); goto $$entry~i;
  $$entry~i: s0 := s0$in; goto $$entry~h;
  $$entry~h: cc := cc$in; goto block6817;
  block6817: goto block6834;
  block6834: s1 := $stringLiteral1; goto block6851;
  block6851: stack0o := cc; goto $$block6851~h;
  $$block6851~h: havoc stack50000o; goto $$block6851~g;
  $$block6851~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == System.String)); goto $$block6851~f;
  $$block6851~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block6851~e;
  $$block6851~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block6851~d;
  $$block6851~d: assert (stack50000o != null); goto $$block6851~c;
  $$block6851~c: call System.String..ctor$System.Char.array(stack50000o, stack0o); goto $$block6851~b;
  $$block6851~b: stack0o := stack50000o; goto $$block6851~a;
  $$block6851~a: s2 := stack0o; goto block6868;
  block6868: o2 := s2; goto block6885;
  block6885: assert (s0 != o2); goto block7038;
  block7038: goto block7055;
  block7055: assert (s1 != o2); goto block7208;
  block7208: goto block7225;
  block7225: assert (s1 != null); goto block7378;
  block7378: goto block7395;
  block7395: assert (s2 != null); goto block7548;
...
procedure System.String..ctor$System.Char.array(this : ref, value$in : ref where $Is(value$in, ValueArray(System.Char, 1)));
  ...
  modifies $Heap;
  ensures ((value$in == null) ==> ($StringLength(this) == 0));
  ensures ((value$in != null) ==> ($StringLength(this) == $Length(value$in)));
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.String)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(System.String <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

procedure Cast.N1$System.String(this : ref, s0$in : ref where $Is(s0$in, System.String)) returns ($result : ref where $Is($result, System.String));
  free requires ($Heap[s0$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires ((s0$in == null) || (((($Heap[s0$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[s0$in, $ownerRef], $inv] <: $Heap[s0$in, $ownerFrame])) || ($Heap[$Heap[s0$in, $ownerRef], $localinv] == $BaseClass($Heap[s0$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[s0$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[s0$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
...
implementation Cast.N1$System.String(this : ref, s0$in : ref) returns ($result : ref) {
  var s0 : ref where $Is(s0, System.String);
  var s1 : ref where $Is(s1, System.String);
  var o0 : ref where $Is(o0, System.Object);
  var o1 : ref where $Is(o1, System.Object);
  var stack0o : ref;
  var return.value : ref where $Is(return.value, System.String);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, System.String);
  entry: assume $IsNotNull(this, Cast); goto $$entry~l;
  $$entry~l: assume ($Heap[this, $allocated] == true); goto $$entry~k;
  $$entry~k: s0 := s0$in; goto block8177;
  block8177: goto block8194;
  block8194: s1 := $stringLiteral1; goto block8211;
  block8211: o0 := s0; goto block8228;
  block8228: o1 := s1; goto block8245;
  block8245: assert (o0 != o1); goto block8398;
  block8398: goto block8415;
  block8415: return.value := s1; goto block8432;
  block8432: goto block8449;
  block8449: SS$Display.Return.Local := return.value; goto $$block8449~b;
  $$block8449~b: stack0o := return.value; goto $$block8449~a;
  $$block8449~a: $result := stack0o; return;
  
}

procedure Cast.R$System.Object$System.Int32(this : ref, o$in : ref where $Is(o$in, System.Object), choice$in : int where InRange(choice$in, System.Int32)) returns ($result : ref where $Is($result, System.Object));
  free requires ($Heap[o$in, $allocated] == true);
  free requires true;
  requires (o$in == null);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
...
implementation Cast.R$System.Object$System.Int32(this : ref, o$in : ref, choice$in : int) returns ($result : ref) {
  var o : ref where $Is(o, System.Object);
  var choice : int where InRange(choice, System.Int32);
  var stack0i : int;
  var stack0b : bool;
  var stack0o : ref;
  var s : ref where $Is(s, System.String);
  var a : ref where $Is(a, RefArray(System.Object, 1));
  var j : ref where $Is(j, J);
  var return.value : ref where $Is(return.value, System.Object);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, System.Object);
  entry: assume $IsNotNull(this, Cast); goto $$entry~o;
  $$entry~o: assume ($Heap[this, $allocated] == true); goto $$entry~n;
  $$entry~n: o := o$in; goto $$entry~m;
  $$entry~m: choice := choice$in; goto block9197;
  block9197: goto block9401;
  block9401: goto block9418;
  block9418: stack0i := 0; goto true9418to9486, false9418to9435;
  true9418to9486: assume (choice != stack0i); goto block9486;
  false9418to9435: assume (choice == stack0i); goto block9435;
  block9486: stack0i := 1; goto true9486to9554, false9486to9503;
  block9435: assert $Is(o, System.String); goto $$block9435~b;
  $$block9435~b: stack0o := o; goto $$block9435~a;
  $$block9435~a: s := stack0o; goto block9452;
  true9486to9554: assume (choice != stack0i); goto block9554;
  false9486to9503: assume (choice == stack0i); goto block9503;
  block9554: assert $Is(o, J); goto $$block9554~b;
  $$block9554~b: stack0o := o; goto $$block9554~a;
  $$block9554~a: j := stack0o; goto block9571;
  block9503: assert $Is(o, RefArray(System.Object, 1)); goto $$block9503~b;
  $$block9503~b: stack0o := o; goto $$block9503~a;
  $$block9503~a: a := stack0o; goto block9520;
  block9452: return.value := s; goto block9622;
  block9520: return.value := a; goto block9622;
  block9571: return.value := j; goto block9622;
...
procedure Cast..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Cast)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Cast <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation Cast..ctor(this : ref) {
  entry: assume $IsNotNull(this, Cast); goto $$entry~q;
  $$entry~q: assume ($Heap[this, $allocated] == true); goto $$entry~p;
  $$entry~p: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block9945;
  block9945: goto block9962;
  block9962: goto block9979;
  block9979: assert (this != null); goto $$block9979~a;
  $$block9979~a: call System.Object..ctor(this); goto block9996;
  block9996: goto block10013;
  block10013: assert (this != null); goto $$block10013~d;
  $$block10013~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block10013~c;
  $$block10013~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Cast)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block10013~b;
  $$block10013~b: $Heap := $Heap[this, $inv := Cast]; goto $$block10013~a;
  $$block10013~a: assume IsHeap($Heap); return;
...
axiom (((forall heap : <x>[ref, name]x :: {heap[$stringLiteral1, $allocated]} (IsHeap(heap) ==> heap[$stringLiteral1, $allocated])) && $IsNotNull($stringLiteral1, System.String)) && ($StringLength($stringLiteral1) == 5));
