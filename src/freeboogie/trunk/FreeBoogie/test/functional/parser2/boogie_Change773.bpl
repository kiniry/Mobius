...
const Test1 : name;
axiom (Test1 <: Test1);
axiom ($BaseClass(Test1) == System.Object);
axiom ((Test1 <: $BaseClass(Test1)) && (AsDirectSubClass(Test1, $BaseClass(Test1)) == Test1));
axiom (!$IsImmutable(Test1) && ($AsMutable(Test1) == Test1));
axiom (forall $U : name :: {($U <: Test1)} (($U <: Test1) ==> ($U == Test1)));
procedure Test1.Foo$System.Int32.array$notnull$System.Object$notnull(xs$in : ref where $IsNotNull(xs$in, ValueArray(System.Int32, 1)), o$in : ref where $IsNotNull(o$in, System.Object));
...
implementation Test1.Foo$System.Int32.array$notnull$System.Object$notnull(xs$in : ref, o$in : ref) {
  var xs : ref where $IsNotNull(xs, ValueArray(System.Int32, 1));
  var o : ref where $IsNotNull(o, System.Object);
  var stack0b : bool;
  var b : bool where true;
  var stack0o : ref;
  var stack1i : int;
  var i : int where InRange(i, System.Int32);
  entry: xs := xs$in; goto $$entry~a;
  $$entry~a: o := o$in; goto block2618;
  block2618: goto block2635;
  block2635: goto true2635to2669, false2635to2652;
  true2635to2669: assume (xs == o); goto block2669;
  false2635to2652: assume (xs != o); goto block2652;
  block2669: goto block2686;
  block2652: stack0b := false; goto block2703;
  block2686: stack0b := true; goto block2703;
  block2703: goto block2720;
  block2720: b := stack0b; goto block2737;
  block2737: stack0o := xs; goto $$block2737~e;
  $$block2737~e: stack1i := 1; goto $$block2737~d;
  $$block2737~d: assert (stack0o != null); goto $$block2737~c;
  $$block2737~c: assert (0 <= stack1i); goto $$block2737~b;
  $$block2737~b: assert (stack1i < $Length(stack0o)); goto $$block2737~a;
  $$block2737~a: i := ValueArrayGet($Heap[stack0o, $elements], stack1i); goto block2754;
...
procedure Test1..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Test1)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Test1 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation Test1..ctor(this : ref) {
  entry: assume $IsNotNull(this, Test1); goto $$entry~c;
  $$entry~c: assume ($Heap[this, $allocated] == true); goto $$entry~b;
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3026;
  block3026: goto block3043;
  block3043: goto block3060;
  block3060: assert (this != null); goto $$block3060~a;
  $$block3060~a: call System.Object..ctor(this); goto block3077;
  block3077: goto block3094;
  block3094: assert (this != null); goto $$block3094~d;
  $$block3094~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3094~c;
  $$block3094~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test1)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3094~b;
  $$block3094~b: $Heap := $Heap[this, $inv := Test1]; goto $$block3094~a;
  $$block3094~a: assume IsHeap($Heap); return;
...
implementation Test2.Foo() {
  var stack0i : int;
  var xs : ref where $Is(xs, ValueArray(System.Int32, 1));
  var stack0o : ref;
  var stack1i : int;
  var i : int where InRange(i, System.Int32);
  entry: goto block3281;
  block3281: goto block3298;
  block3298: stack0i := 4; goto $$block3298~i;
  $$block3298~i: assert (0 <= stack0i); goto $$block3298~h;
  $$block3298~h: havoc xs; goto $$block3298~g;
  $$block3298~g: assume (($Heap[xs, $allocated] == false) && ($Length(xs) == stack0i)); goto $$block3298~f;
  $$block3298~f: assume $IsNotNull(xs, ValueArray(System.Int32, 1)); goto $$block3298~e;
  $$block3298~e: assume (($Heap[xs, $ownerRef] == xs) && ($Heap[xs, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3298~d;
  $$block3298~d: assume ((($Heap[xs, $inv] == ValueArray(System.Int32, 1)) && ($Heap[xs, $localinv] == ValueArray(System.Int32, 1))) && ((($Heap[xs, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[xs, $ownerRef], $inv] <: $Heap[xs, $ownerFrame])) || ($Heap[$Heap[xs, $ownerRef], $localinv] == $BaseClass($Heap[xs, $ownerFrame])))); goto $$block3298~c;
  $$block3298~c: assume (forall $i : int :: (ValueArrayGet($Heap[xs, $elements], $i) == 0)); goto $$block3298~b;
  $$block3298~b: $Heap := $Heap[xs, $allocated := true]; goto $$block3298~a;
  $$block3298~a: assume IsHeap($Heap); goto block3315;
  block3315: stack0o := xs; goto $$block3315~e;
  $$block3315~e: stack1i := 1; goto $$block3315~d;
  $$block3315~d: assert (stack0o != null); goto $$block3315~c;
  $$block3315~c: assert (0 <= stack1i); goto $$block3315~b;
  $$block3315~b: assert (stack1i < $Length(stack0o)); goto $$block3315~a;
  $$block3315~a: i := ValueArrayGet($Heap[stack0o, $elements], stack1i); goto block3332;
...
implementation Test2..ctor(this : ref) {
  ...
  $$entry~d: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3519;
  block3519: goto block3536;
  block3536: goto block3553;
  block3553: assert (this != null); goto $$block3553~a;
  $$block3553~a: call System.Object..ctor(this); goto block3570;
  block3570: goto block3587;
  block3587: assert (this != null); goto $$block3587~d;
  $$block3587~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3587~c;
  $$block3587~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test2)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3587~b;
  $$block3587~b: $Heap := $Heap[this, $inv := Test2]; goto $$block3587~a;
  $$block3587~a: assume IsHeap($Heap); return;
