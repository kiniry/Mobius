...
const Test7 : name;
function #S.Foo($$unnamed~fb : <x>[ref, name]x, $$unnamed~fa : struct) returns ($$unnamed~fc : bool);
...
implementation S.Foo(this$in : struct) returns ($result : bool) {
  ...
  var stack0b : bool;
  entry: this := this$in; goto block2465;
  block2465: goto block2482;
  block2482: return.value := true; goto block2499;
  block2499: goto block2516;
  block2516: SS$Display.Return.Local := return.value; goto $$block2516~b;
  $$block2516~b: stack0b := return.value; goto $$block2516~a;
  $$block2516~a: $result := stack0b; return;
...
procedure Test7.Bar$S(s$in : struct where true);
  free requires IsAllocated($Heap, s$in);
  requires #S.Foo($Heap, s$in);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation Test7.Bar$S(s$in : struct) {
  var s : struct where true;
  entry: s := s$in; goto block2992;
  block2992: goto block3196;
...
implementation Test7..ctor(this : ref) {
  entry: assume $IsNotNull(this, Test7); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3451;
  ...
  $$block3519~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test7)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3519~b;
  $$block3519~b: $Heap := $Heap[this, $inv := Test7]; goto $$block3519~a;
