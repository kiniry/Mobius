...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2431;
  block2431: goto block2448;
  block2448: assert (this != null); goto $$block2448~g;
  $$block2448~g: stack0o := $Heap[this, Chunker.src]; goto $$block2448~f;
  $$block2448~f: assert (this != null); goto $$block2448~e;
  $$block2448~e: stack1i := $Heap[this, Chunker.n]; goto $$block2448~d;
  $$block2448~d: assert (this != null); goto $$block2448~c;
  $$block2448~c: stack2i := $Heap[this, Chunker.ChunkSize]; goto $$block2448~b;
  $$block2448~b: assert (stack0o != null); goto $$block2448~a;
  $$block2448~a: call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i); goto block2465;
  block2465: assert (this != null); goto $$block2465~i;
  $$block2465~i: stack0i := $Heap[this, Chunker.n]; goto $$block2465~h;
  $$block2465~h: assert (this != null); goto $$block2465~g;
  $$block2465~g: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block2465~f;
  $$block2465~f: stack0i := (stack0i + stack1i); goto $$block2465~e;
  $$block2465~e: assert (this != null); goto $$block2465~d;
  $$block2465~d: havoc temp0; goto $$block2465~c;
  $$block2465~c: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block2465~b;
  $$block2465~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block2465~a;
  $$block2465~a: assume IsHeap($Heap); goto block2482;
  block2482: return.value := s; goto block2499;
  block2499: goto block2516;
  block2516: SS$Display.Return.Local := return.value; goto $$block2516~b;
  $$block2516~b: stack0o := return.value; goto $$block2516~a;
  $$block2516~a: $result := stack0o; return;
...
implementation Chunker..ctor$System.String$System.Int32(this : ref, source$in : ref, chunkSize$in : int) {
  ...
  entry: assume $IsNotNull(this, Chunker); goto $$entry~h;
  ...
  $$entry~f: source := source$in; goto $$entry~e;
  $$entry~e: chunkSize := chunkSize$in; goto $$entry~d;
  $$entry~d: assume ($Heap[this, Chunker.src] == null); goto $$entry~c;
  $$entry~c: assume ($Heap[this, Chunker.ChunkSize] == 0); goto $$entry~b;
  $$entry~b: assume ($Heap[this, Chunker.n] == 0); goto block2873;
  block2873: goto block2890;
  block2890: goto block2907;
  block2907: goto block2924;
  block2924: assert (this != null); goto $$block2924~a;
  $$block2924~a: call System.Object..ctor(this); goto block2941;
  block2941: assert (this != null); goto $$block2941~o;
  $$block2941~o: havoc temp0; goto $$block2941~n;
  $$block2941~n: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block2941~m;
  $$block2941~m: $Heap := $Heap[this, Chunker.src := source]; goto $$block2941~l;
  $$block2941~l: assume IsHeap($Heap); goto $$block2941~k;
  $$block2941~k: assert (this != null); goto $$block2941~j;
  $$block2941~j: havoc temp1; goto $$block2941~i;
  $$block2941~i: $Heap := $Heap[this, $exposeVersion := temp1]; goto $$block2941~h;
  $$block2941~h: $Heap := $Heap[this, Chunker.ChunkSize := chunkSize]; goto $$block2941~g;
  $$block2941~g: assume IsHeap($Heap); goto $$block2941~f;
  $$block2941~f: stack0i := 0; goto $$block2941~e;
  $$block2941~e: assert (this != null); goto $$block2941~d;
  $$block2941~d: havoc temp2; goto $$block2941~c;
  $$block2941~c: $Heap := $Heap[this, $exposeVersion := temp2]; goto $$block2941~b;
  $$block2941~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block2941~a;
  $$block2941~a: assume IsHeap($Heap); goto block2958;
  block2958: goto block2975;
  block2975: assert (this != null); goto $$block2975~d;
  $$block2975~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2975~c;
  $$block2975~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2975~b;
  $$block2975~b: $Heap := $Heap[this, $inv := Chunker]; goto $$block2975~a;
  $$block2975~a: assume IsHeap($Heap); return;
