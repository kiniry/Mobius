...
procedure Chunker.NextChunk(this : ref) returns ($result : ref where $Is($result, System.String));
...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  entry: assume $IsNotNull(this, Chunker); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2754;
  block2754: goto block2771;
  block2771: assert (this != null); goto $$block2771~g;
  $$block2771~g: stack0o := $Heap[this, Chunker.src]; goto $$block2771~f;
  $$block2771~f: assert (this != null); goto $$block2771~e;
  $$block2771~e: stack1i := $Heap[this, Chunker.n]; goto $$block2771~d;
  $$block2771~d: assert (this != null); goto $$block2771~c;
  $$block2771~c: stack2i := $Heap[this, Chunker.ChunkSize]; goto $$block2771~b;
  $$block2771~b: assert (stack0o != null); goto $$block2771~a;
  $$block2771~a: call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i); goto block2788;
  block2788: assert (this != null); goto $$block2788~i;
  $$block2788~i: stack0i := $Heap[this, Chunker.n]; goto $$block2788~h;
  $$block2788~h: assert (this != null); goto $$block2788~g;
  $$block2788~g: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block2788~f;
  $$block2788~f: stack0i := (stack0i + stack1i); goto $$block2788~e;
  $$block2788~e: assert (this != null); goto $$block2788~d;
  $$block2788~d: havoc temp0; goto $$block2788~c;
  $$block2788~c: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block2788~b;
  $$block2788~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block2788~a;
  $$block2788~a: assume IsHeap($Heap); goto block2805;
  block2805: return.value := s; goto block2822;
  block2822: goto block2839;
  block2839: SS$Display.Return.Local := return.value; goto $$block2839~b;
  $$block2839~b: stack0o := return.value; goto $$block2839~a;
  $$block2839~a: $result := stack0o; return;
...
implementation Chunker..ctor$System.String$System.Int32(this : ref, source$in : ref, chunkSize$in : int) {
  var source : ref where $Is(source, System.String);
  ...
  entry: assume $IsNotNull(this, Chunker); goto $$entry~g;
  ...
  $$entry~e: source := source$in; goto $$entry~d;
  $$entry~d: chunkSize := chunkSize$in; goto $$entry~c;
  $$entry~c: assume ($Heap[this, Chunker.ChunkSize] == 0); goto $$entry~b;
  $$entry~b: assume ($Heap[this, Chunker.n] == 0); goto block3196;
  block3196: goto block3213;
  block3213: goto block3230;
  block3230: goto block3247;
  block3247: assert (this != null); goto $$block3247~a;
  $$block3247~a: call System.Object..ctor(this); goto block3264;
  block3264: stack0o := source; goto $$block3264~r;
  $$block3264~r: assert (stack0o != null); goto $$block3264~q;
  $$block3264~q: stack0o := stack0o; goto $$block3264~p;
  $$block3264~p: assert (this != null); goto $$block3264~o;
  $$block3264~o: havoc temp0; goto $$block3264~n;
  $$block3264~n: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block3264~m;
  $$block3264~m: $Heap := $Heap[this, Chunker.src := stack0o]; goto $$block3264~l;
  $$block3264~l: assume IsHeap($Heap); goto $$block3264~k;
  $$block3264~k: assert (this != null); goto $$block3264~j;
  $$block3264~j: havoc temp1; goto $$block3264~i;
  $$block3264~i: $Heap := $Heap[this, $exposeVersion := temp1]; goto $$block3264~h;
  $$block3264~h: $Heap := $Heap[this, Chunker.ChunkSize := chunkSize]; goto $$block3264~g;
  $$block3264~g: assume IsHeap($Heap); goto $$block3264~f;
  $$block3264~f: stack0i := 0; goto $$block3264~e;
  $$block3264~e: assert (this != null); goto $$block3264~d;
  $$block3264~d: havoc temp2; goto $$block3264~c;
  $$block3264~c: $Heap := $Heap[this, $exposeVersion := temp2]; goto $$block3264~b;
  $$block3264~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block3264~a;
  $$block3264~a: assume IsHeap($Heap); goto block3281;
  block3281: goto block3298;
  block3298: assert (this != null); goto $$block3298~d;
  $$block3298~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3298~c;
  $$block3298~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3298~b;
  $$block3298~b: $Heap := $Heap[this, $inv := Chunker]; goto $$block3298~a;
