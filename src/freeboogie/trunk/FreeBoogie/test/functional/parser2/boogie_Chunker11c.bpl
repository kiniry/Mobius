...
axiom (forall $U : name :: {($U <: Chunker)} (($U <: Chunker) ==> ($U == Chunker)));
...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  block5661: temp0 := this; goto $$block5661~g;
  ...
  $$block5661~e: $Heap := $Heap[temp0, $inv := System.Object]; goto $$block5661~d;
  ...
  block6307: assert (temp0 != null); goto $$block6307~f;
  $$block6307~f: assert (($Heap[temp0, $inv] == System.Object) && ($Heap[temp0, $localinv] == $typeof(temp0))); goto $$block6307~e;
  ...
  $$block6307~b: $Heap := $Heap[temp0, $inv := Chunker]; goto $$block6307~a;
