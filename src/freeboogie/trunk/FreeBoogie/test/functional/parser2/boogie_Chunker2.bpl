...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2499;
  block2499: goto block2516;
  block2516: assert (this != null); goto $$block2516~g;
  $$block2516~g: stack0o := $Heap[this, Chunker.src]; goto $$block2516~f;
  $$block2516~f: assert (this != null); goto $$block2516~e;
  $$block2516~e: stack1i := $Heap[this, Chunker.n]; goto $$block2516~d;
  $$block2516~d: assert (this != null); goto $$block2516~c;
  $$block2516~c: stack2i := $Heap[this, Chunker.ChunkSize]; goto $$block2516~b;
  $$block2516~b: assert (stack0o != null); goto $$block2516~a;
  $$block2516~a: call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i); goto block2533;
  block2533: assert (this != null); goto $$block2533~i;
  $$block2533~i: stack0i := $Heap[this, Chunker.n]; goto $$block2533~h;
  $$block2533~h: assert (this != null); goto $$block2533~g;
  $$block2533~g: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block2533~f;
  $$block2533~f: stack0i := (stack0i + stack1i); goto $$block2533~e;
  $$block2533~e: assert (this != null); goto $$block2533~d;
  $$block2533~d: havoc temp0; goto $$block2533~c;
  $$block2533~c: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block2533~b;
  $$block2533~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block2533~a;
  $$block2533~a: assume IsHeap($Heap); goto block2550;
  block2550: return.value := s; goto block2567;
  block2567: goto block2584;
  block2584: SS$Display.Return.Local := return.value; goto $$block2584~b;
  $$block2584~b: stack0o := return.value; goto $$block2584~a;
  $$block2584~a: $result := stack0o; return;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this : ref, source$in : ref, chunkSize$in : int) {
  ...
  block3451: assert (this != null); goto $$block3451~a;
  $$block3451~a: call System.Object..ctor(this); goto block3468;
  block3468: assert (this != null); goto $$block3468~o;
  $$block3468~o: havoc temp0; goto $$block3468~n;
  $$block3468~n: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block3468~m;
  $$block3468~m: $Heap := $Heap[this, Chunker.src := source]; goto $$block3468~l;
  $$block3468~l: assume IsHeap($Heap); goto $$block3468~k;
  $$block3468~k: assert (this != null); goto $$block3468~j;
  $$block3468~j: havoc temp1; goto $$block3468~i;
  $$block3468~i: $Heap := $Heap[this, $exposeVersion := temp1]; goto $$block3468~h;
  $$block3468~h: $Heap := $Heap[this, Chunker.ChunkSize := chunkSize]; goto $$block3468~g;
  $$block3468~g: assume IsHeap($Heap); goto $$block3468~f;
  $$block3468~f: stack0i := 0; goto $$block3468~e;
  $$block3468~e: assert (this != null); goto $$block3468~d;
  $$block3468~d: havoc temp2; goto $$block3468~c;
  $$block3468~c: $Heap := $Heap[this, $exposeVersion := temp2]; goto $$block3468~b;
  $$block3468~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block3468~a;
  $$block3468~a: assume IsHeap($Heap); goto block3485;
  block3485: goto block3502;
  block3502: assert (this != null); goto $$block3502~d;
  $$block3502~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3502~c;
  $$block3502~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3502~b;
  $$block3502~b: $Heap := $Heap[this, $inv := Chunker]; goto $$block3502~a;
