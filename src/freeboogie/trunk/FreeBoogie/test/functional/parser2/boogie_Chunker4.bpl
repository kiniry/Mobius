...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block3128;
  block3128: goto block3145;
  block3145: assert (this != null); goto $$block3145~g;
  $$block3145~g: stack0o := $Heap[this, Chunker.src]; goto $$block3145~f;
  $$block3145~f: assert (this != null); goto $$block3145~e;
  $$block3145~e: stack1i := $Heap[this, Chunker.n]; goto $$block3145~d;
  $$block3145~d: assert (this != null); goto $$block3145~c;
  $$block3145~c: stack2i := $Heap[this, Chunker.ChunkSize]; goto $$block3145~b;
  $$block3145~b: assert (stack0o != null); goto $$block3145~a;
  $$block3145~a: call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i); goto block3162;
  block3162: assert (this != null); goto $$block3162~i;
  $$block3162~i: stack0i := $Heap[this, Chunker.n]; goto $$block3162~h;
  $$block3162~h: assert (this != null); goto $$block3162~g;
  $$block3162~g: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block3162~f;
  $$block3162~f: stack0i := (stack0i + stack1i); goto $$block3162~e;
  $$block3162~e: assert (this != null); goto $$block3162~d;
  $$block3162~d: havoc temp0; goto $$block3162~c;
  $$block3162~c: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block3162~b;
  $$block3162~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block3162~a;
  $$block3162~a: assume IsHeap($Heap); goto block3179;
  block3179: stack0o := s; goto $$block3179~b;
  $$block3179~b: assert (stack0o != null); goto $$block3179~a;
  $$block3179~a: return.value := stack0o; goto block3196;
  block3196: goto block3400;
  block3400: goto block3417;
  block3417: SS$Display.Return.Local := return.value; goto $$block3417~b;
  $$block3417~b: stack0o := return.value; goto $$block3417~a;
  $$block3417~a: $result := stack0o; return;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this : ref, source$in : ref, chunkSize$in : int) {
  ...
  $$entry~b: assume ($Heap[this, Chunker.n] == 0); goto block4080;
  block4080: goto block4284;
  block4284: goto block4301;
  block4301: goto block4318;
  block4318: goto block4335;
  block4335: goto block4352;
  block4352: assert (this != null); goto $$block4352~p;
  $$block4352~p: havoc temp0; goto $$block4352~o;
  $$block4352~o: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block4352~n;
  $$block4352~n: $Heap := $Heap[this, Chunker.src := source]; goto $$block4352~m;
  $$block4352~m: assume IsHeap($Heap); goto $$block4352~l;
  $$block4352~l: assert (this != null); goto $$block4352~k;
  $$block4352~k: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block4352~j;
  $$block4352~j: $Heap := $Heap[this, Chunker.ChunkSize := chunkSize]; goto $$block4352~i;
  $$block4352~i: assume IsHeap($Heap); goto $$block4352~h;
  $$block4352~h: stack0i := 0; goto $$block4352~g;
  $$block4352~g: assert (this != null); goto $$block4352~f;
  $$block4352~f: havoc temp1; goto $$block4352~e;
  $$block4352~e: $Heap := $Heap[this, $exposeVersion := temp1]; goto $$block4352~d;
  $$block4352~d: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block4352~c;
  $$block4352~c: assume IsHeap($Heap); goto $$block4352~b;
  $$block4352~b: assert (this != null); goto $$block4352~a;
  $$block4352~a: call System.Object..ctor(this); goto block4369;
  block4369: goto block4386;
  block4386: assert (this != null); goto $$block4386~d;
  $$block4386~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4386~c;
  $$block4386~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4386~b;
  $$block4386~b: $Heap := $Heap[this, $inv := Chunker]; goto $$block4386~a;
  $$block4386~a: assume IsHeap($Heap); return;
