...
axiom (forall $oi : ref, $h : <x>[ref, name]x :: {($h[$oi, $inv] <: Chunker)} (((IsHeap($h) && ($h[$oi, $inv] <: Chunker)) && ($h[$oi, $localinv] != System.Object)) ==> (0 <= $h[$oi, Chunker.n])));
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this : ref, throwException$in : bool) returns ($result : bool) {
  ...
  $$entry~a: throwException := throwException$in; goto block3366;
  block3366: goto block3383;
  block3383: stack0i := 0; goto $$block3383~b;
  $$block3383~b: assert (this != null); goto $$block3383~a;
  $$block3383~a: stack1i := $Heap[this, Chunker.n]; goto true3383to3502, false3383to3400;
  true3383to3502: assume (stack0i <= stack1i); goto block3502;
  false3383to3400: assume (stack0i > stack1i); goto block3400;
  block3502: goto block3519;
  block3400: stack0b := throwException; goto true3400to3451, false3400to3417;
  true3400to3451: assume !stack0b; goto block3451;
  false3400to3417: assume stack0b; goto block3417;
  block3451: return.value := false; goto block3553;
  block3417: assume false; goto $$block3417~i;
  $$block3417~i: havoc stack50000o; goto $$block3417~h;
  $$block3417~h: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException)); goto $$block3417~g;
  $$block3417~g: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3417~f;
  $$block3417~f: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3417~e;
  $$block3417~e: assert (stack50000o != null); goto $$block3417~d;
  $$block3417~d: call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o); goto $$block3417~c;
  $$block3417~c: stack0o := stack50000o; goto $$block3417~b;
  $$block3417~b: assert (stack0o != null); goto $$block3417~a;
  $$block3417~a: assume false; return;
  block3519: goto block3536;
  block3553: goto block3570;
  block3536: return.value := true; goto block3553;
...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  $$entry~c: assume ($Heap[this, $allocated] == true); goto block4352;
  block4352: goto block4556;
  block4556: goto block4573;
  block4573: assert (this != null); goto $$block4573~g;
  $$block4573~g: stack0o := $Heap[this, Chunker.src]; goto $$block4573~f;
  $$block4573~f: assert (this != null); goto $$block4573~e;
  $$block4573~e: stack1i := $Heap[this, Chunker.n]; goto $$block4573~d;
  $$block4573~d: assert (this != null); goto $$block4573~c;
  $$block4573~c: stack2i := $Heap[this, Chunker.ChunkSize]; goto $$block4573~b;
  $$block4573~b: assert (stack0o != null); goto $$block4573~a;
  $$block4573~a: call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i); goto block4590;
  block4590: assert (this != null); goto $$block4590~h;
  $$block4590~h: stack0i := $Heap[this, Chunker.n]; goto $$block4590~g;
  $$block4590~g: assert (this != null); goto $$block4590~f;
  $$block4590~f: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block4590~e;
  $$block4590~e: stack0i := (stack0i + stack1i); goto $$block4590~d;
  $$block4590~d: assert (this != null); goto $$block4590~c;
  $$block4590~c: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block4590~b;
  $$block4590~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block4590~a;
  $$block4590~a: assume IsHeap($Heap); goto block4607;
  block4607: stack0o := s; goto $$block4607~b;
  $$block4607~b: assert (stack0o != null); goto $$block4607~a;
  $$block4607~a: return.value := stack0o; goto block4624;
  block4624: goto block4828;
  block4828: goto block4845;
  block4845: SS$Display.Return.Local := return.value; goto $$block4845~b;
  $$block4845~b: stack0o := return.value; goto $$block4845~a;
  $$block4845~a: $result := stack0o; return;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this : ref, source$in : ref, chunkSize$in : int) {
  ...
  $$entry~d: assume ($Heap[this, Chunker.n] == 0); goto block5593;
  block5593: goto block5797;
  block5797: goto block5814;
  block5814: goto block5831;
  block5831: goto block5848;
  block5848: goto block5865;
  block5865: assert (this != null); goto $$block5865~m;
  $$block5865~m: havoc temp0; goto $$block5865~l;
  $$block5865~l: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block5865~k;
  $$block5865~k: $Heap := $Heap[this, Chunker.src := source]; goto $$block5865~j;
  $$block5865~j: assume IsHeap($Heap); goto $$block5865~i;
  $$block5865~i: assert (this != null); goto $$block5865~h;
  $$block5865~h: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block5865~g;
  $$block5865~g: $Heap := $Heap[this, Chunker.ChunkSize := chunkSize]; goto $$block5865~f;
  $$block5865~f: assume IsHeap($Heap); goto $$block5865~e;
  $$block5865~e: stack0i := 0; goto $$block5865~d;
  $$block5865~d: assert (this != null); goto $$block5865~c;
  $$block5865~c: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block5865~b;
  $$block5865~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block5865~a;
  $$block5865~a: assume IsHeap($Heap); goto block5882;
  block5882: assert (this != null); goto $$block5882~a;
  $$block5882~a: call System.Object..ctor(this); goto block6001;
  block6001: goto block6018;
  block6018: goto block6035;
  block6035: goto block6052;
  block6052: temp1 := this; goto $$block6052~f;
  $$block6052~f: assert (temp1 != null); goto $$block6052~e;
  $$block6052~e: assert (($Heap[temp1, $inv] == System.Object) && ($Heap[temp1, $localinv] == $typeof(temp1))); goto $$block6052~d;
  $$block6052~d: assert (0 <= $Heap[temp1, Chunker.n]); goto $$block6052~c;
  $$block6052~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == temp1)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6052~b;
  $$block6052~b: $Heap := $Heap[temp1, $inv := Chunker]; goto $$block6052~a;
  $$block6052~a: assume IsHeap($Heap); return;
...
implementation Chunker..cctor() {
  entry: goto block6766;
  block6766: goto block6885;
