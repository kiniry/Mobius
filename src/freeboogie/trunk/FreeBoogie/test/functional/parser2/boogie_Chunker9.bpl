...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this : ref, throwException$in : bool) returns ($result : bool) {
  ...
  $$entry~a: throwException := throwException$in; goto block3706;
  block3706: goto block3723;
  block3723: stack0i := 0; goto $$block3723~b;
  $$block3723~b: assert (this != null); goto $$block3723~a;
  $$block3723~a: stack1i := $Heap[this, Chunker.ChunkSize]; goto true3723to3842, false3723to3740;
  true3723to3842: assume (stack0i < stack1i); goto block3842;
  false3723to3740: assume (stack0i >= stack1i); goto block3740;
  block3842: goto block3859;
  block3740: stack0b := throwException; goto true3740to3791, false3740to3757;
  true3740to3791: assume !stack0b; goto block3791;
  false3740to3757: assume stack0b; goto block3757;
  block3791: return.value := false; goto block4097;
  block3757: assume false; goto $$block3757~i;
  $$block3757~i: havoc stack50000o; goto $$block3757~h;
  $$block3757~h: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException)); goto $$block3757~g;
  $$block3757~g: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3757~f;
  $$block3757~f: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3757~e;
  $$block3757~e: assert (stack50000o != null); goto $$block3757~d;
  $$block3757~d: call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o); goto $$block3757~c;
  $$block3757~c: stack0o := stack50000o; goto $$block3757~b;
  $$block3757~b: assert (stack0o != null); goto $$block3757~a;
  $$block3757~a: assume false; return;
  ...
  $$block3876~a: stack1i := $Heap[this, Chunker.n]; goto true3876to3927, false3876to3893;
  true3876to3927: assume (stack0i > stack1i); goto block3927;
  false3876to3893: assume (stack0i <= stack1i); goto block3893;
  block3927: goto block3944;
  block3893: assert (this != null); goto $$block3893~e;
  $$block3893~e: stack0i := $Heap[this, Chunker.n]; goto $$block3893~d;
  $$block3893~d: assert (this != null); goto $$block3893~c;
  $$block3893~c: stack1o := $Heap[this, Chunker.src]; goto $$block3893~b;
  $$block3893~b: assert (stack1o != null); goto $$block3893~a;
  $$block3893~a: stack1i := $StringLength(stack1o); goto true3893to3927, false3893to3910;
  block4114: SS$Display.Return.Local := return.value; goto $$block4114~b;
  $$block4114~b: stack0b := return.value; goto $$block4114~a;
  $$block4114~a: $result := stack0b; return;
  true3893to3927: assume (stack0i > stack1i); goto block3927;
  false3893to3910: assume (stack0i <= stack1i); goto block3910;
  block3910: goto block4046;
  ...
  block3995: return.value := false; goto block4097;
  ...
  block4080: return.value := true; goto block4097;
...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  $$entry~c: assume ($Heap[this, $allocated] == true); goto block4981;
  block4981: goto block5185;
  block5185: goto block5202;
  block5202: goto block5219;
  block5219: assert (this != null); goto $$block5219~h;
  $$block5219~h: stack0i := $Heap[this, Chunker.n]; goto $$block5219~g;
  $$block5219~g: assert (this != null); goto $$block5219~f;
  $$block5219~f: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block5219~e;
  $$block5219~e: stack0i := (stack0i + stack1i); goto $$block5219~d;
  $$block5219~d: assert (this != null); goto $$block5219~c;
  $$block5219~c: stack1o := $Heap[this, Chunker.src]; goto $$block5219~b;
  $$block5219~b: assert (stack1o != null); goto $$block5219~a;
  $$block5219~a: stack1i := $StringLength(stack1o); goto true5219to5270, false5219to5236;
  true5219to5270: assume (stack0i > stack1i); goto block5270;
  false5219to5236: assume (stack0i <= stack1i); goto block5236;
  block5270: assert (this != null); goto $$block5270~e;
  $$block5270~e: stack0o := $Heap[this, Chunker.src]; goto $$block5270~d;
  $$block5270~d: assert (this != null); goto $$block5270~c;
  $$block5270~c: stack1i := $Heap[this, Chunker.n]; goto $$block5270~b;
  $$block5270~b: assert (stack0o != null); goto $$block5270~a;
  $$block5270~a: call s := System.String.Substring$System.Int32(stack0o, stack1i); goto block5287;
  block5236: assert (this != null); goto $$block5236~g;
  $$block5236~g: stack0o := $Heap[this, Chunker.src]; goto $$block5236~f;
  $$block5236~f: assert (this != null); goto $$block5236~e;
  $$block5236~e: stack1i := $Heap[this, Chunker.n]; goto $$block5236~d;
  $$block5236~d: assert (this != null); goto $$block5236~c;
  $$block5236~c: stack2i := $Heap[this, Chunker.ChunkSize]; goto $$block5236~b;
  $$block5236~b: assert (stack0o != null); goto $$block5236~a;
  $$block5236~a: call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i); goto block5253;
  block5253: goto block5287;
  block5287: goto block5304;
  block5304: assert (this != null); goto $$block5304~h;
  $$block5304~h: stack0i := $Heap[this, Chunker.n]; goto $$block5304~g;
  $$block5304~g: assert (this != null); goto $$block5304~f;
  $$block5304~f: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block5304~e;
  $$block5304~e: stack0i := (stack0i + stack1i); goto $$block5304~d;
  $$block5304~d: assert (this != null); goto $$block5304~c;
  $$block5304~c: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block5304~b;
  $$block5304~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block5304~a;
  $$block5304~a: assume IsHeap($Heap); goto block5321;
  block5321: stack0o := s; goto $$block5321~b;
  $$block5321~b: assert (stack0o != null); goto $$block5321~a;
  $$block5321~a: return.value := stack0o; goto block5338;
  block5338: goto block5542;
  block5542: goto block5559;
  block5559: SS$Display.Return.Local := return.value; goto $$block5559~b;
  $$block5559~b: stack0o := return.value; goto $$block5559~a;
  $$block5559~a: $result := stack0o; return;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this : ref, source$in : ref, chunkSize$in : int) {
  ...
  $$entry~d: assume ($Heap[this, Chunker.n] == 0); goto block6358;
  block6358: goto block6664;
  block6664: goto block6681;
  block6681: goto block6698;
  block6698: goto block6715;
  block6715: goto block6732;
  block6732: assert (this != null); goto $$block6732~l;
  $$block6732~l: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block6732~k;
  $$block6732~k: $Heap := $Heap[this, Chunker.src := source]; goto $$block6732~j;
  $$block6732~j: assume IsHeap($Heap); goto $$block6732~i;
  $$block6732~i: assert (this != null); goto $$block6732~h;
  $$block6732~h: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block6732~g;
  $$block6732~g: $Heap := $Heap[this, Chunker.ChunkSize := chunkSize]; goto $$block6732~f;
  $$block6732~f: assume IsHeap($Heap); goto $$block6732~e;
  $$block6732~e: stack0i := 0; goto $$block6732~d;
  $$block6732~d: assert (this != null); goto $$block6732~c;
  $$block6732~c: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block6732~b;
  $$block6732~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block6732~a;
  $$block6732~a: assume IsHeap($Heap); goto block6749;
  block6749: assert (this != null); goto $$block6749~a;
  $$block6749~a: call System.Object..ctor(this); goto block6868;
  block6868: goto block6885;
  block6885: goto block6902;
  block6902: goto block6919;
  block6919: temp0 := this; goto $$block6919~g;
  $$block6919~g: assert (temp0 != null); goto $$block6919~f;
  $$block6919~f: assert (($Heap[temp0, $inv] == System.Object) && ($Heap[temp0, $localinv] == $typeof(temp0))); goto $$block6919~e;
  $$block6919~e: assert (0 < $Heap[temp0, Chunker.ChunkSize]); goto $$block6919~d;
  $$block6919~d: assert ((0 <= $Heap[temp0, Chunker.n]) && ($Heap[temp0, Chunker.n] <= $StringLength($Heap[temp0, Chunker.src]))); goto $$block6919~c;
  $$block6919~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == temp0)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6919~b;
  $$block6919~b: $Heap := $Heap[temp0, $inv := Chunker]; goto $$block6919~a;
  $$block6919~a: assume IsHeap($Heap); return;
...
implementation Chunker..cctor() {
  entry: goto block7633;
  block7633: goto block7752;
  block7752: goto block7769;
