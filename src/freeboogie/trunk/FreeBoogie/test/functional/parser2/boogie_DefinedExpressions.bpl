...
axiom (DefinedExpressions <: DefinedExpressions);
axiom ($BaseClass(DefinedExpressions) == System.Object);
axiom ((DefinedExpressions <: $BaseClass(DefinedExpressions)) && (AsDirectSubClass(DefinedExpressions, $BaseClass(DefinedExpressions)) == DefinedExpressions));
axiom (!$IsImmutable(DefinedExpressions) && ($AsMutable(DefinedExpressions) == DefinedExpressions));
procedure DefinedExpressions.Division$System.Int32(this : ref, den$in : int where InRange(den$in, System.Int32)) returns ($result : int where InRange($result, System.Int32));
  free requires true;
...
implementation DefinedExpressions.Division$System.Int32(this : ref, den$in : int) returns ($result : int) {
  var den : int where InRange(den, System.Int32);
  var stack0i : int;
  ...
  entry: assume $IsNotNull(this, DefinedExpressions); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: den := den$in; goto block3570;
  block3570: goto block3587;
  block3587: stack0i := 5; goto $$block3587~c;
  $$block3587~c: assert (den != 0); goto $$block3587~b;
  $$block3587~b: stack0i := (stack0i / den); goto $$block3587~a;
  $$block3587~a: return.value := stack0i; goto block3604;
  block3604: goto block3621;
  block3621: SS$Display.Return.Local := return.value; goto $$block3621~b;
  $$block3621~b: stack0i := return.value; goto $$block3621~a;
  $$block3621~a: $result := stack0i; return;
  
}

axiom (forall $U : name :: {($U <: System.Boolean)} (($U <: System.Boolean) ==> ($U == System.Boolean)));
procedure DefinedExpressions.Division$System.Boolean$System.Int32.array$notnull(this : ref, b$in : bool where true, a$in : ref where $IsNotNull(a$in, ValueArray(System.Int32, 1))) returns ($result : int where InRange($result, System.Int32));
  free requires true;
...
implementation DefinedExpressions.Division$System.Boolean$System.Int32.array$notnull(this : ref, b$in : bool, a$in : ref) returns ($result : int) {
  ...
  var return.value : int where InRange(return.value, System.Int32);
  var SS$Display.Return.Local : int where InRange(SS$Display.Return.Local, System.Int32);
  entry: assume $IsNotNull(this, DefinedExpressions); goto $$entry~e;
  $$entry~e: assume ($Heap[this, $allocated] == true); goto $$entry~d;
  $$entry~d: b := b$in; goto $$entry~c;
  $$entry~c: a := a$in; goto block4216;
  block4216: goto block4420;
  block4420: goto block4437;
  block4437: stack0b := b; goto true4437to4488, false4437to4454;
  true4437to4488: assume !stack0b; goto block4488;
  false4437to4454: assume stack0b; goto block4454;
  block4488: stack0i := 2; goto $$block4488~d;
  $$block4488~d: assert (a != null); goto $$block4488~c;
  $$block4488~c: stack1i := $Length(a); goto $$block4488~b;
  $$block4488~b: stack0i := (stack0i + stack1i); goto $$block4488~a;
  $$block4488~a: return.value := stack0i; goto block4539;
  block4454: stack0i := 5; goto $$block4454~f;
  $$block4454~f: stack1o := $stringLiteral0; goto $$block4454~e;
  $$block4454~e: assert (stack1o != null); goto $$block4454~d;
  $$block4454~d: stack1i := $StringLength(stack1o); goto $$block4454~c;
  $$block4454~c: assert (stack1i != 0); goto $$block4454~b;
  $$block4454~b: stack0i := (stack0i / stack1i); goto $$block4454~a;
  $$block4454~a: return.value := stack0i; goto block4539;
  block4539: goto block4556;
  block4556: SS$Display.Return.Local := return.value; goto $$block4556~b;
  $$block4556~b: stack0i := return.value; goto $$block4556~a;
  $$block4556~a: $result := stack0i; return;
...
procedure DefinedExpressions.Modulo$System.Int32(this : ref, den$in : int where InRange(den$in, System.Int32)) returns ($result : int where InRange($result, System.Int32));
  free requires true;
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation DefinedExpressions.Modulo$System.Int32(this : ref, den$in : int) returns ($result : int) {
  var den : int where InRange(den, System.Int32);
  var stack0i : int;
  var return.value : int where InRange(return.value, System.Int32);
  var SS$Display.Return.Local : int where InRange(SS$Display.Return.Local, System.Int32);
  entry: assume $IsNotNull(this, DefinedExpressions); goto $$entry~g;
  $$entry~g: assume ($Heap[this, $allocated] == true); goto $$entry~f;
  $$entry~f: den := den$in; goto block4879;
  block4879: goto block4896;
  block4896: stack0i := 5; goto $$block4896~c;
  $$block4896~c: assert (den != 0); goto $$block4896~b;
  $$block4896~b: stack0i := (stack0i % den); goto $$block4896~a;
  $$block4896~a: return.value := stack0i; goto block4913;
  block4913: goto block4930;
  block4930: SS$Display.Return.Local := return.value; goto $$block4930~b;
  $$block4930~b: stack0i := return.value; goto $$block4930~a;
  $$block4930~a: $result := stack0i; return;
  
}

procedure DefinedExpressions.Modulo$System.Boolean$System.Int32.array$notnull(this : ref, b$in : bool where true, a$in : ref where $IsNotNull(a$in, ValueArray(System.Int32, 1))) returns ($result : int where InRange($result, System.Int32));
  free requires true;
  free requires ($Heap[a$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires (((($Heap[a$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[a$in, $ownerRef], $inv] <: $Heap[a$in, $ownerFrame])) || ($Heap[$Heap[a$in, $ownerRef], $localinv] == $BaseClass($Heap[a$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[a$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[a$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
...
implementation DefinedExpressions.Modulo$System.Boolean$System.Int32.array$notnull(this : ref, b$in : bool, a$in : ref) returns ($result : int) {
  var b : bool where true;
  var a : ref where $IsNotNull(a, ValueArray(System.Int32, 1));
  var stack0b : bool;
  var stack0i : int;
  ...
  var return.value : int where InRange(return.value, System.Int32);
  var SS$Display.Return.Local : int where InRange(SS$Display.Return.Local, System.Int32);
  entry: assume $IsNotNull(this, DefinedExpressions); goto $$entry~j;
  $$entry~j: assume ($Heap[this, $allocated] == true); goto $$entry~i;
  $$entry~i: b := b$in; goto $$entry~h;
  $$entry~h: a := a$in; goto block5474;
  block5474: goto block5678;
  block5678: goto block5695;
  block5695: stack0b := b; goto true5695to5746, false5695to5712;
  true5695to5746: assume !stack0b; goto block5746;
  false5695to5712: assume stack0b; goto block5712;
  block5746: stack0i := 1; goto $$block5746~d;
  $$block5746~d: assert (a != null); goto $$block5746~c;
  $$block5746~c: stack1i := $Length(a); goto $$block5746~b;
  $$block5746~b: stack0i := (stack0i + stack1i); goto $$block5746~a;
  $$block5746~a: return.value := stack0i; goto block5797;
  block5712: stack0i := 5; goto $$block5712~f;
  $$block5712~f: stack1o := $stringLiteral0; goto $$block5712~e;
  $$block5712~e: assert (stack1o != null); goto $$block5712~d;
  $$block5712~d: stack1i := $StringLength(stack1o); goto $$block5712~c;
  $$block5712~c: assert (stack1i != 0); goto $$block5712~b;
  $$block5712~b: stack0i := (stack0i % stack1i); goto $$block5712~a;
  $$block5712~a: return.value := stack0i; goto block5797;
  block5797: goto block5814;
  block5814: SS$Display.Return.Local := return.value; goto $$block5814~b;
  $$block5814~b: stack0i := return.value; goto $$block5814~a;
  $$block5814~a: $result := stack0i; return;
  
}

procedure DefinedExpressions..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == DefinedExpressions)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(DefinedExpressions <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation DefinedExpressions..ctor(this : ref) {
  entry: assume $IsNotNull(this, DefinedExpressions); goto $$entry~l;
  $$entry~l: assume ($Heap[this, $allocated] == true); goto $$entry~k;
  $$entry~k: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block6069;
  block6069: goto block6086;
  block6086: goto block6103;
  block6103: assert (this != null); goto $$block6103~a;
  $$block6103~a: call System.Object..ctor(this); goto block6120;
  block6120: goto block6137;
  block6137: assert (this != null); goto $$block6137~d;
  $$block6137~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block6137~c;
  $$block6137~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == DefinedExpressions)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6137~b;
  $$block6137~b: $Heap := $Heap[this, $inv := DefinedExpressions]; goto $$block6137~a;
