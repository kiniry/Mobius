...
const D : name;
function #C.Foo($$unnamed~fb : <x>[ref, name]x, $$unnamed~fa : ref) returns ($$unnamed~fc : int);
function ##C.Foo($$unnamed~fd : exposeVersionType) returns ($$unnamed~fe : int);
axiom !IsStaticField(C.x);
axiom IsDirectlyModifiableField(C.x);
axiom (DeclType(C.x) == C);
axiom (AsRangeField(C.x, System.Int32) == C.x);
axiom !IsStaticField(A.c);
axiom IsDirectlyModifiableField(A.c);
axiom (DeclType(A.c) == A);
axiom (AsNonNullRefField(A.c, C) == A.c);
axiom !IsStaticField(D.x);
axiom IsDirectlyModifiableField(D.x);
axiom (DeclType(D.x) == D);
axiom (AsRangeField(D.x, System.Int32) == D.x);
function #D.Foo($$unnamed~fg : <x>[ref, name]x, $$unnamed~ff : ref) returns ($$unnamed~fh : int);
function ##D.Foo($$unnamed~fi : exposeVersionType) returns ($$unnamed~fj : int);
axiom (C <: C);
...
implementation C.Foo(this : ref) returns ($result : int) {
  ...
  block1360: assert (this != null); goto $$block1360~a;
  $$block1360~a: return.value := $Heap[this, C.x]; goto block1377;
...
procedure C.Unsound(this : ref);
  ...
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old((($o != this) || ($f != C.x)))) && old((($o != this) || ($f != $exposeVersion)))) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: (((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv])) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode]));
  

implementation C.Unsound(this : ref) {
  var stack0o : ref;
  var stack0i : int;
  var temp0 : exposeVersionType;
  entry: assume $IsNotNull(this, C); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto block1768;
  block1768: goto block1785;
  block1785: assume (#C.Foo($Heap, this) == 5); goto block1870;
  block1870: stack0i := 6; goto $$block1870~f;
  $$block1870~f: assert (this != null); goto $$block1870~e;
  $$block1870~e: havoc temp0; goto $$block1870~d;
  $$block1870~d: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block1870~c;
  $$block1870~c: $Heap := $Heap[this, C.x := stack0i]; goto $$block1870~b;
  $$block1870~b: assume IsHeap($Heap); goto $$block1870~a;
  $$block1870~a: assert (#C.Foo($Heap, this) == 5); goto block1955;
  block1955: return;
...
implementation C..ctor(this : ref) {
  ...
  $$entry~c: assume ($Heap[this, C.x] == 0); goto block2312;
  block2312: goto block2329;
  block2329: assert (this != null); goto $$block2329~f;
  $$block2329~f: call System.Object..ctor(this); goto $$block2329~e;
  $$block2329~e: assert (this != null); goto $$block2329~d;
  $$block2329~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2329~c;
  $$block2329~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == C)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2329~b;
  $$block2329~b: $Heap := $Heap[this, $inv := C]; goto $$block2329~a;
  $$block2329~a: assume IsHeap($Heap); return;
...
procedure A.Unsound(this : ref);
  ...
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old((($o != $Heap[this, A.c]) || ($f != C.x)))) && old(((($o != $Heap[this, A.c]) || ($f != $exposeVersion)) && (($o != this) || ($f != $exposeVersion))))) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: (((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv])) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode]));
  

implementation A.Unsound(this : ref) {
  var stack0o : ref;
  var stack1i : int;
  var temp0 : exposeVersionType;
  entry: assume $IsNotNull(this, A); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto block2669;
  block2669: goto block2686;
  block2686: assume (#C.Foo($Heap, $Heap[this, A.c]) == 5); goto block2771;
  block2771: assert (this != null); goto $$block2771~h;
  $$block2771~h: stack0o := $Heap[this, A.c]; goto $$block2771~g;
  $$block2771~g: stack1i := 6; goto $$block2771~f;
  $$block2771~f: assert (stack0o != null); goto $$block2771~e;
  $$block2771~e: havoc temp0; goto $$block2771~d;
  $$block2771~d: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block2771~c;
  $$block2771~c: $Heap := $Heap[stack0o, C.x := stack1i]; goto $$block2771~b;
  $$block2771~b: assume IsHeap($Heap); goto $$block2771~a;
  $$block2771~a: assert (#C.Foo($Heap, $Heap[this, A.c]) == 5); goto block2856;
  block2856: return;
...
implementation A..ctor(this : ref) {
  ...
  $$entry~g: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3230;
  block3230: goto block3247;
  block3247: havoc stack50000o; goto $$block3247~r;
  $$block3247~r: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == C)); goto $$block3247~q;
  $$block3247~q: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3247~p;
  $$block3247~p: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3247~o;
  $$block3247~o: assert (stack50000o != null); goto $$block3247~n;
  $$block3247~n: call C..ctor(stack50000o); goto $$block3247~m;
  $$block3247~m: stack0o := stack50000o; goto $$block3247~l;
  $$block3247~l: assert (this != null); goto $$block3247~k;
  $$block3247~k: havoc temp0; goto $$block3247~j;
  $$block3247~j: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block3247~i;
  $$block3247~i: $Heap := $Heap[this, A.c := stack0o]; goto $$block3247~h;
  $$block3247~h: assume IsHeap($Heap); goto $$block3247~g;
  $$block3247~g: assert (this != null); goto $$block3247~f;
  $$block3247~f: call System.Object..ctor(this); goto $$block3247~e;
  ...
  $$block3247~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == A)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3247~b;
  $$block3247~b: $Heap := $Heap[this, $inv := A]; goto $$block3247~a;
...
axiom (forall $oi : ref, $h : <x>[ref, name]x :: {($h[$oi, $inv] <: D)} (((IsHeap($h) && ($h[$oi, $inv] <: D)) && ($h[$oi, $localinv] != System.Object)) ==> ($h[$oi, D.x] >= 0)));
axiom (forall $U : name :: {($U <: System.Boolean)} (($U <: System.Boolean) ==> ($U == System.Boolean)));
procedure D.SpecSharp.CheckInvariant$System.Boolean(this : ref, throwException$in : bool where true) returns ($result : bool where true);
  free requires true;
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation D.SpecSharp.CheckInvariant$System.Boolean(this : ref, throwException$in : bool) returns ($result : bool) {
  ...
  entry: assume $IsNotNull(this, D); goto $$entry~j;
  $$entry~j: assume ($Heap[this, $allocated] == true); goto $$entry~i;
  $$entry~i: throwException := throwException$in; goto block3604;
  block3604: goto block3621;
  block3621: assert (this != null); goto $$block3621~b;
  $$block3621~b: stack0i := $Heap[this, D.x]; goto $$block3621~a;
  $$block3621~a: stack1i := 0; goto true3621to3723, false3621to3638;
  true3621to3723: assume (stack0i >= stack1i); goto block3723;
  false3621to3638: assume (stack0i < stack1i); goto block3638;
  block3723: local0 := true; goto block3740;
  ...
  block3689: local0 := false; goto block3740;
  ...
  block3740: SS$Display.Return.Local := local0; goto $$block3740~b;
  $$block3740~b: stack0b := local0; goto $$block3740~a;
  $$block3740~a: $result := stack0b; return;
...
axiom (forall $Heap : <x>[ref, name]x, this : ref :: {#D.Foo($Heap, this)} ((IsHeap($Heap) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))) ==> InRange(#D.Foo($Heap, this), System.Int32)));
axiom (forall $Heap : <x>[ref, name]x, this : ref :: {#D.Foo($Heap, this)} (((((((this != null) && ($typeof(this) <: D)) && ($Heap[this, $inv] == $typeof(this))) && ($Heap[this, $localinv] == $typeof(this))) && IsHeap($Heap)) && ($Heap[this, $allocated] == true)) ==> (#D.Foo($Heap, this) == ##D.Foo($Heap[this, $exposeVersion]))));
procedure D.Foo(this : ref) returns ($result : int where InRange($result, System.Int32));
  requires (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))));
  free requires ($AsPureObject(this) == this);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  ...
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures ($Heap == old($Heap));
  free ensures ($result == #D.Foo($Heap, this));
  ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} ((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: (((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv])) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode]));
...
implementation D.Foo(this : ref) returns ($result : int) {
  var return.value : int where InRange(return.value, System.Int32);
  var SS$Display.Return.Local : int where InRange(SS$Display.Return.Local, System.Int32);
  var stack0i : int;
  entry: assume $IsNotNull(this, D); goto $$entry~k;
  $$entry~k: assume ($Heap[this, $allocated] == true); goto block4267;
  block4267: goto block4369;
  block4369: assert (this != null); goto $$block4369~a;
  $$block4369~a: return.value := $Heap[this, D.x]; goto block4386;
  block4386: SS$Display.Return.Local := return.value; goto $$block4386~b;
  $$block4386~b: stack0i := return.value; goto $$block4386~a;
  $$block4386~a: $result := stack0i; return;
  
}

procedure D.Unsound(this : ref);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
...
implementation D.Unsound(this : ref) {
  var stack0o : ref;
  var stack0i : int;
  entry: assume $IsNotNull(this, D); goto $$entry~l;
  $$entry~l: assume ($Heap[this, $allocated] == true); goto block4913;
  block4913: goto block5015;
  block5015: assume (#D.Foo($Heap, this) == 5); goto block5100;
  block5100: stack0i := 6; goto $$block5100~e;
  $$block5100~e: assert (this != null); goto $$block5100~d;
  $$block5100~d: assert (!($Heap[this, $inv] <: D) || ($Heap[this, $localinv] == System.Object)); goto $$block5100~c;
  $$block5100~c: $Heap := $Heap[this, D.x := stack0i]; goto $$block5100~b;
  $$block5100~b: assume IsHeap($Heap); goto $$block5100~a;
  $$block5100~a: assert (#D.Foo($Heap, this) == 5); goto block5185;
  block5185: return;
...
implementation D..ctor(this : ref) {
  ...
  $$entry~m: assume ($Heap[this, D.x] == 0); goto block5661;
  block5661: goto block5678;
  block5678: assert (this != null); goto $$block5678~a;
  $$block5678~a: call System.Object..ctor(this); goto block5746;
  block5746: temp0 := this; goto $$block5746~f;
  $$block5746~f: assert (temp0 != null); goto $$block5746~e;
  $$block5746~e: assert (($Heap[temp0, $inv] == System.Object) && ($Heap[temp0, $localinv] == $typeof(temp0))); goto $$block5746~d;
  $$block5746~d: assert ($Heap[temp0, D.x] >= 0); goto $$block5746~c;
  $$block5746~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == temp0)) && ($Heap[$p, $ownerFrame] == D)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block5746~b;
  $$block5746~b: $Heap := $Heap[temp0, $inv := D]; goto $$block5746~a;
  $$block5746~a: assume IsHeap($Heap); return;
...
implementation D..cctor() {
  entry: goto block6307;
  block6307: goto block6358;
  block6358: return;
