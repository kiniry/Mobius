...
implementation Test.Method(this : ref) {
  var local2907 : ref where $Is(local2907, Test);
  var stack0o : ref;
  var stack1s : struct;
  var stack1o : ref;
  ...
  var $Heap$block2686$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, Test); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2601;
  block2601: goto block2669;
  block2669: local2907 := this; goto $$block2669~j;
  $$block2669~j: stack0o := local2907; goto $$block2669~i;
  $$block2669~i: havoc stack1s; goto $$block2669~h;
  $$block2669~h: assume $IsTokenForType(stack1s, Test); goto $$block2669~g;
  $$block2669~g: stack1o := TypeObject(Test); goto $$block2669~f;
  $$block2669~f: assert (stack0o != null); goto $$block2669~e;
  $$block2669~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: Test)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block2669~d;
  $$block2669~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block2669~c;
  $$block2669~c: havoc temp0; goto $$block2669~b;
  $$block2669~b: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block2669~a;
  $$block2669~a: assume IsHeap($Heap); goto block2686$LoopPreheader;
  block2686: assume (((forall $o : ref :: (($Heap$block2686$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block2686$LoopPreheader[$ot, $allocated] == true) && ($Heap$block2686$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block2686$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block2686$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block2686$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block2686~i;
  $$block2686~i: assume (forall $o : ref :: ((($Heap$block2686$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block2686$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block2686$LoopPreheader[$o, $allocated] != true))); goto $$block2686~h;
  $$block2686~h: assume (forall $o : ref :: ((($Heap$block2686$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block2686~g;
  $$block2686~g: assert (forall $o : ref :: ((($o != null) && ($Heap$block2686$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block2686$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block2686$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block2686~f;
  $$block2686~f: stack0i := 1; goto $$block2686~e;
  $$block2686~e: assert (this != null); goto $$block2686~d;
  $$block2686~d: havoc temp1; goto $$block2686~c;
  $$block2686~c: $Heap := $Heap[this, $exposeVersion := temp1]; goto $$block2686~b;
  $$block2686~b: $Heap := $Heap[this, Test.x := stack0i]; goto $$block2686~a;
  $$block2686~a: assume IsHeap($Heap); goto block2703;
  block2703: goto block2686;
  block2686$LoopPreheader: $Heap$block2686$LoopPreheader := $Heap; goto block2686;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~b: assume ($Heap[this, Test.x] == 0); goto block3060;
  block3060: goto block3077;
  block3077: stack0i := 0; goto $$block3077~e;
  $$block3077~e: assert (this != null); goto $$block3077~d;
  $$block3077~d: havoc temp0; goto $$block3077~c;
  $$block3077~c: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block3077~b;
  $$block3077~b: $Heap := $Heap[this, Test.x := stack0i]; goto $$block3077~a;
  $$block3077~a: assume IsHeap($Heap); goto block3094;
  block3094: assert (this != null); goto $$block3094~a;
  $$block3094~a: call System.Object..ctor(this); goto block3111;
  block3111: goto block3128;
  block3128: assert (this != null); goto $$block3128~d;
  $$block3128~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3128~c;
  $$block3128~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3128~b;
  $$block3128~b: $Heap := $Heap[this, $inv := Test]; goto $$block3128~a;
