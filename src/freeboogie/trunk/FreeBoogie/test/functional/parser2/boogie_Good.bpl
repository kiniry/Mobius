...
const Cell : name;
axiom !IsStaticField(Cell.x);
axiom IsDirectlyModifiableField(Cell.x);
axiom (DeclType(Cell.x) == Cell);
axiom (AsRangeField(Cell.x, System.Int32) == Cell.x);
axiom (Cell <: Cell);
...
implementation Cell..ctor(this : ref) {
  ...
  $$entry~a: assume ($Heap[this, Cell.x] == 0); goto block2771;
  block2771: goto block2788;
  block2788: goto block2805;
  block2805: goto block2822;
  block2822: assert (this != null); goto $$block2822~a;
  $$block2822~a: call System.Object..ctor(this); goto block2839;
  block2839: goto block2856;
  block2856: goto block3060;
  block3060: goto block3077;
  block3077: assert (this != null); goto $$block3077~d;
  $$block3077~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3077~c;
  $$block3077~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Cell)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3077~b;
  $$block3077~b: $Heap := $Heap[this, $inv := Cell]; goto $$block3077~a;
  $$block3077~a: assume IsHeap($Heap); return;
...
procedure Cell.DoStuff$Cell(cell$in : ref where $Is(cell$in, Cell));
  free requires ($Heap[cell$in, $allocated] == true);
  requires ((cell$in == null) || (((($Heap[cell$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[cell$in, $ownerRef], $inv] <: $Heap[cell$in, $ownerFrame])) || ($Heap[$Heap[cell$in, $ownerRef], $localinv] == $BaseClass($Heap[cell$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[cell$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[cell$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
...
implementation Cell.DoStuff$Cell(cell$in : ref) {
  var cell : ref where $Is(cell, Cell);
  entry: cell := cell$in; goto block3315;
...
implementation Cell.Main() {
  var stack50000o : ref;
  var stack0o : ref;
  var cell1 : ref where $Is(cell1, Cell);
  var cell2 : ref where $Is(cell2, Cell);
  entry: goto block3689;
  block3689: goto block3706;
  block3706: havoc stack50000o; goto $$block3706~g;
  $$block3706~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Cell)); goto $$block3706~f;
  $$block3706~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3706~e;
  $$block3706~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3706~d;
  $$block3706~d: assert (stack50000o != null); goto $$block3706~c;
  $$block3706~c: call Cell..ctor(stack50000o); goto $$block3706~b;
  $$block3706~b: stack0o := stack50000o; goto $$block3706~a;
  $$block3706~a: cell1 := stack0o; goto block3723;
  block3723: havoc stack50000o; goto $$block3723~g;
  $$block3723~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Cell)); goto $$block3723~f;
  $$block3723~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3723~e;
  $$block3723~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3723~d;
  $$block3723~d: assert (stack50000o != null); goto $$block3723~c;
  $$block3723~c: call Cell..ctor(stack50000o); goto $$block3723~b;
  $$block3723~b: stack0o := stack50000o; goto $$block3723~a;
  $$block3723~a: cell2 := stack0o; goto block3740;
  block3740: stack0o := cell1; goto $$block3740~a;
  $$block3740~a: call Cell.DoStuff$Cell(stack0o); goto block3757;
  block3757: assert ($Heap[cell2, Cell.x] == 0); goto block3910;
