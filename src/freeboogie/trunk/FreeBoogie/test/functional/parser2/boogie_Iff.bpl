...
implementation Iff.M$System.Boolean$System.Boolean(this : ref, x$in : bool, y$in : bool) returns ($result : bool) {
  var x : bool where true;
  var y : bool where true;
  var stack0b : bool;
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  entry: assume $IsNotNull(this, Iff); goto $$entry~c;
  $$entry~c: assume ($Heap[this, $allocated] == true); goto $$entry~b;
  $$entry~b: x := x$in; goto $$entry~a;
  $$entry~a: y := y$in; goto block1479;
  block1479: goto block1632;
  block1632: goto true1632to1666, false1632to1649;
  true1632to1666: assume (x == y); goto block1666;
  false1632to1649: assume (x != y); goto block1649;
  block1666: stack0b := true; goto block1683;
  block1649: stack0b := false; goto block1683;
  block1683: return.value := stack0b; goto block1785;
  block1785: SS$Display.Return.Local := return.value; goto $$block1785~b;
  $$block1785~b: stack0b := return.value; goto $$block1785~a;
  $$block1785~a: $result := stack0b; return;
...
implementation Iff.P$System.Boolean$System.Boolean(this : ref, x$in : bool, y$in : bool) returns ($result : bool) {
  ...
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  entry: assume $IsNotNull(this, Iff); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto $$entry~e;
  $$entry~e: x := x$in; goto $$entry~d;
  $$entry~d: y := y$in; goto block3723;
  block3723: goto block3740;
  block3740: goto true3740to3774, false3740to3757;
  true3740to3774: assume (x == y); goto block3774;
  false3740to3757: assume (x != y); goto block3757;
  block3774: stack0b := true; goto block3791;
  block3757: stack0b := false; goto block3791;
  block3791: b := stack0b; goto true3791to3825, false3791to3808;
  true3791to3825: assume (b == x); goto block3825;
  false3791to3808: assume (b != x); goto block3808;
  block3825: stack0b := true; goto block3842;
  block3808: stack0b := false; goto block3842;
  block3842: b := stack0b; goto $$block3842~a;
  $$block3842~a: assert (b == y); goto block3927;
  block3927: goto true3927to3961, false3927to3944;
  true3927to3961: assume (b == b); goto block3961;
  false3927to3944: assume (b != b); goto block3944;
  block3961: stack0b := true; goto block3978;
  block3944: stack0b := false; goto block3978;
  block3978: goto true3978to4012, false3978to3995;
  true3978to4012: assume (b != y); goto block4012;
  false3978to3995: assume (b == y); goto block3995;
  block4012: stack1b := true; goto block4029;
  block3995: stack1b := false; goto block4029;
  block4029: goto true4029to4063, false4029to4046;
  true4029to4063: assume (stack0b == stack1b); goto block4063;
  false4029to4046: assume (stack0b != stack1b); goto block4046;
  block4063: stack0b := true; goto block4080;
  block4046: stack0b := false; goto block4080;
  block4080: b := stack0b; goto $$block4080~a;
  $$block4080~a: assert !b; goto block4216;
  block4216: goto true4216to4301, false4216to4233;
  true4216to4301: assume b; goto block4301;
  false4216to4233: assume !b; goto block4233;
  block4301: goto true4301to4335, false4301to4318;
  block4233: stack0b := x; goto true4233to4267, false4233to4250;
  true4233to4267: assume !stack0b; goto block4267;
  false4233to4250: assume stack0b; goto block4250;
  block4267: stack0b := true; goto block4284;
  block4250: stack0b := y; goto block4284;
  true4301to4335: assume (y == x); goto block4335;
  false4301to4318: assume (y != x); goto block4318;
  block4335: stack0b := true; goto block4352;
  block4318: stack0b := false; goto block4352;
  block4284: goto block4352;
  block4352: b := stack0b; goto $$block4352~a;
  $$block4352~a: stack0b := b; goto true4352to4437, false4352to4369;
  true4352to4437: assume !stack0b; goto block4437;
  false4352to4369: assume stack0b; goto block4369;
  block4437: stack0b := false; goto block4454;
  block4369: stack0b := y; goto true4369to4403, false4369to4386;
  true4369to4403: assume !stack0b; goto block4403;
  false4369to4386: assume stack0b; goto block4386;
  block4403: stack0b := true; goto block4420;
  block4386: stack0b := x; goto block4420;
  block4454: b := stack0b; goto $$block4454~a;
  $$block4454~a: assert ((b == x) == y); goto block4590;
  block4420: goto block4454;
  block4590: stack0b := x; goto $$block4590~b;
  $$block4590~b: stack1b := y; goto $$block4590~a;
  $$block4590~a: stack2b := b; goto true4590to4624, false4590to4607;
  true4590to4624: assume (y == x); goto block4624;
  false4590to4607: assume (y != x); goto block4607;
  block4624: stack3b := true; goto block4641;
  block4607: stack3b := false; goto block4641;
  block4641: goto true4641to4675, false4641to4658;
  true4641to4675: assume (stack2b == stack3b); goto block4675;
  false4641to4658: assume (stack2b != stack3b); goto block4658;
  block4675: stack2b := true; goto block4692;
  block4658: stack2b := false; goto block4692;
  block4692: goto true4692to4726, false4692to4709;
  true4692to4726: assume (stack1b == stack2b); goto block4726;
  false4692to4709: assume (stack1b != stack2b); goto block4709;
  block4726: stack1b := true; goto block4743;
  block4709: stack1b := false; goto block4743;
  block4743: goto true4743to4777, false4743to4760;
  true4743to4777: assume (stack0b == stack1b); goto block4777;
  false4743to4760: assume (stack0b != stack1b); goto block4760;
  block4777: stack0b := true; goto block4794;
  block4760: stack0b := false; goto block4794;
  block4794: return.value := stack0b; goto block5253;
  block5253: SS$Display.Return.Local := return.value; goto $$block5253~b;
  $$block5253~b: stack0b := return.value; goto $$block5253~a;
  $$block5253~a: $result := stack0b; return;
...
implementation Iff.Q$System.Boolean$System.Boolean(this : ref, x$in : bool, y$in : bool) returns ($result : bool) {
  ...
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  entry: assume $IsNotNull(this, Iff); goto $$entry~i;
  $$entry~i: assume ($Heap[this, $allocated] == true); goto $$entry~h;
  $$entry~h: x := x$in; goto $$entry~g;
  $$entry~g: y := y$in; goto block8534;
  block8534: goto block8551;
  block8551: goto true8551to8585, false8551to8568;
  true8551to8585: assume (x == y); goto block8585;
  false8551to8568: assume (x != y); goto block8568;
  block8585: stack0b := true; goto block8602;
  block8568: stack0b := false; goto block8602;
  block8602: b := stack0b; goto true8602to8636, false8602to8619;
  true8602to8636: assume (b == x); goto block8636;
  false8602to8619: assume (b != x); goto block8619;
  block8636: stack0b := true; goto block8653;
  block8619: stack0b := false; goto block8653;
  block8653: b := stack0b; goto $$block8653~a;
  $$block8653~a: assert (b == y); goto block8738;
  block8738: goto true8738to8772, false8738to8755;
  true8738to8772: assume (b == b); goto block8772;
  false8738to8755: assume (b != b); goto block8755;
  block8772: stack0b := true; goto block8789;
  block8755: stack0b := false; goto block8789;
  block8789: goto true8789to8823, false8789to8806;
  true8789to8823: assume (b != y); goto block8823;
  false8789to8806: assume (b == y); goto block8806;
  block8823: stack1b := true; goto block8840;
  block8806: stack1b := false; goto block8840;
  block8840: goto true8840to8874, false8840to8857;
  true8840to8874: assume (stack0b == stack1b); goto block8874;
  false8840to8857: assume (stack0b != stack1b); goto block8857;
  block8874: stack0b := true; goto block8891;
  block8857: stack0b := false; goto block8891;
  block8891: b := stack0b; goto $$block8891~a;
  $$block8891~a: assert !b; goto block9027;
  block9027: goto true9027to9112, false9027to9044;
  true9027to9112: assume b; goto block9112;
  false9027to9044: assume !b; goto block9044;
  block9112: goto true9112to9146, false9112to9129;
  block9044: stack0b := x; goto true9044to9078, false9044to9061;
  true9112to9146: assume (y == x); goto block9146;
  false9112to9129: assume (y != x); goto block9129;
  block9146: stack0b := true; goto block9163;
  block9129: stack0b := false; goto block9163;
  true9044to9078: assume !stack0b; goto block9078;
  false9044to9061: assume stack0b; goto block9061;
  block9078: stack0b := true; goto block9095;
  block9061: stack0b := b; goto block9095;
  block9163: b := stack0b; goto $$block9163~a;
  $$block9163~a: stack0b := b; goto true9163to9197, false9163to9180;
  true9163to9197: assume !stack0b; goto block9197;
  false9163to9180: assume stack0b; goto block9180;
  block9197: stack0b := y; goto block9214;
  block9180: stack0b := true; goto block9214;
  block9095: goto block9163;
  block9214: b := stack0b; goto $$block9214~a;
  $$block9214~a: stack0b := b; goto true9214to9299, false9214to9231;
  true9214to9299: assume !stack0b; goto block9299;
  false9214to9231: assume stack0b; goto block9231;
  block9299: stack0b := false; goto block9316;
  block9231: stack0b := y; goto true9231to9265, false9231to9248;
  true9231to9265: assume !stack0b; goto block9265;
  false9231to9248: assume stack0b; goto block9248;
  block9265: stack0b := true; goto block9282;
  block9248: stack0b := x; goto block9282;
  block9316: b := stack0b; goto $$block9316~a;
  $$block9316~a: assert ((b == x) == y); goto block9452;
  block9452: stack0b := x; goto $$block9452~b;
  $$block9452~b: stack1b := y; goto $$block9452~a;
  $$block9452~a: stack2b := b; goto true9452to9486, false9452to9469;
  true9452to9486: assume (y == x); goto block9486;
  false9452to9469: assume (y != x); goto block9469;
  block9486: stack3b := true; goto block9503;
  block9469: stack3b := false; goto block9503;
  block9282: goto block9316;
  block9503: goto true9503to9537, false9503to9520;
  true9503to9537: assume (stack2b == stack3b); goto block9537;
  false9503to9520: assume (stack2b != stack3b); goto block9520;
  block9537: stack2b := true; goto block9554;
  block9520: stack2b := false; goto block9554;
  block9554: goto true9554to9588, false9554to9571;
  true9554to9588: assume (stack1b == stack2b); goto block9588;
  false9554to9571: assume (stack1b != stack2b); goto block9571;
  block9588: stack1b := true; goto block9605;
  block9571: stack1b := false; goto block9605;
  block9605: goto true9605to9639, false9605to9622;
  true9605to9639: assume (stack0b == stack1b); goto block9639;
  false9605to9622: assume (stack0b != stack1b); goto block9622;
  block9639: stack0b := true; goto block9656;
  block9622: stack0b := false; goto block9656;
  block9656: return.value := stack0b; goto block9860;
  block9860: SS$Display.Return.Local := return.value; goto $$block9860~b;
  $$block9860~b: stack0b := return.value; goto $$block9860~a;
  $$block9860~a: $result := stack0b; return;
...
implementation Iff.R$System.Boolean$System.Boolean(this : ref, x$in : bool, y$in : bool) returns ($result : bool) {
  ...
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  entry: assume $IsNotNull(this, Iff); goto $$entry~l;
  $$entry~l: assume ($Heap[this, $allocated] == true); goto $$entry~k;
  $$entry~k: x := x$in; goto $$entry~j;
  $$entry~j: y := y$in; goto block12495;
  block12495: goto block12512;
  block12512: stack0b := y; goto true12512to12546, false12512to12529;
  true12512to12546: assume !stack0b; goto block12546;
  false12512to12529: assume stack0b; goto block12529;
  block12546: stack0b := true; goto block12563;
  block12529: stack0b := x; goto block12563;
  block12563: goto true12563to12648, false12563to12580;
  true12563to12648: assume !stack0b; goto block12648;
  false12563to12580: assume stack0b; goto block12580;
  block12648: stack0b := false; goto block12665;
  block12580: stack0b := x; goto true12580to12614, false12580to12597;
  true12580to12614: assume !stack0b; goto block12614;
  false12580to12597: assume stack0b; goto block12597;
  block12614: stack0b := true; goto block12631;
  block12597: stack0b := y; goto block12631;
  block12665: b := stack0b; goto $$block12665~a;
  $$block12665~a: assert ((b == x) == y); goto block12801;
  block12801: stack0b := x; goto true12801to12835, false12801to12818;
  true12801to12835: assume (y == b); goto block12835;
  false12801to12818: assume (y != b); goto block12818;
  block12835: stack1b := true; goto block12852;
  block12818: stack1b := false; goto block12852;
  block12631: goto block12665;
  block12852: goto true12852to12886, false12852to12869;
  true12852to12886: assume (stack0b == stack1b); goto block12886;
  false12852to12869: assume (stack0b != stack1b); goto block12869;
  block12886: stack0b := true; goto block12903;
  block12869: stack0b := false; goto block12903;
  block12903: return.value := stack0b; goto block13107;
  block13107: SS$Display.Return.Local := return.value; goto $$block13107~b;
  $$block13107~b: stack0b := return.value; goto $$block13107~a;
  $$block13107~a: $result := stack0b; return;
...
implementation Iff..ctor(this : ref) {
  entry: assume $IsNotNull(this, Iff); goto $$entry~n;
  $$entry~n: assume ($Heap[this, $allocated] == true); goto $$entry~m;
  $$entry~m: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block13991;
  block13991: goto block14008;
  block14008: assert (this != null); goto $$block14008~f;
  $$block14008~f: call System.Object..ctor(this); goto $$block14008~e;
  $$block14008~e: assert (this != null); goto $$block14008~d;
  $$block14008~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block14008~c;
  $$block14008~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Iff)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block14008~b;
  $$block14008~b: $Heap := $Heap[this, $inv := Iff]; goto $$block14008~a;
  $$block14008~a: assume IsHeap($Heap); return;
