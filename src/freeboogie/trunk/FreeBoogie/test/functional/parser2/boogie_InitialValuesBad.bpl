...
procedure Cell..ctor(this : ref);
  ...
  modifies $Heap;
  ensures ($Heap[this, Cell.Value] == 1);
...
implementation Cell..ctor(this : ref) {
  var stack0o : ref;
  var local3604 : int where InRange(local3604, System.Int32);
  var stack0i : int;
  ...
  $$entry~a: assume ($Heap[this, Cell.Value] == 0); goto block2941;
  block2941: goto block2958;
  block2958: goto block2975;
  block2975: goto block2992;
  block2992: assert (this != null); goto $$block2992~a;
  $$block2992~a: call System.Object..ctor(this); goto block3009;
  block3009: assert ($Heap[this, Cell.Value] == 1); goto block3162;
  block3162: goto block3179;
  block3179: assert (this != null); goto $$block3179~h;
  $$block3179~h: local3604 := $Heap[this, Cell.Value]; goto $$block3179~g;
  $$block3179~g: stack0i := 1; goto $$block3179~f;
  $$block3179~f: stack0i := (local3604 + stack0i); goto $$block3179~e;
  $$block3179~e: assert (this != null); goto $$block3179~d;
  $$block3179~d: assert (!($Heap[this, $inv] <: Cell) || ($Heap[this, $localinv] == System.Object)); goto $$block3179~c;
  $$block3179~c: $Heap := $Heap[this, Cell.Value := stack0i]; goto $$block3179~b;
  $$block3179~b: assume IsHeap($Heap); goto $$block3179~a;
  $$block3179~a: stack0i := local3604; goto block3196;
  block3196: goto block3213;
  block3213: goto block3417;
  block3417: goto block3434;
  block3434: assert (this != null); goto $$block3434~d;
  $$block3434~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3434~c;
  $$block3434~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Cell)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3434~b;
  $$block3434~b: $Heap := $Heap[this, $inv := Cell]; goto $$block3434~a;
  $$block3434~a: assume IsHeap($Heap); return;
...
implementation Test.Main() {
  ...
  entry: goto block3910;
  block3910: goto block3927;
  block3927: havoc stack50000o; goto $$block3927~g;
  $$block3927~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Cell)); goto $$block3927~f;
  $$block3927~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3927~e;
  $$block3927~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3927~d;
  $$block3927~d: assert (stack50000o != null); goto $$block3927~c;
  $$block3927~c: call Cell..ctor(stack50000o); goto $$block3927~b;
  $$block3927~b: stack0o := stack50000o; goto $$block3927~a;
  $$block3927~a: cell := stack0o; goto block3944;
  block3944: assert ($Heap[cell, Cell.Value] == 1); goto block4097;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~d: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block4318;
  block4318: goto block4335;
  block4335: goto block4352;
  block4352: assert (this != null); goto $$block4352~a;
  ...
  $$block4386~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4386~b;
  $$block4386~b: $Heap := $Heap[this, $inv := Test]; goto $$block4386~a;
