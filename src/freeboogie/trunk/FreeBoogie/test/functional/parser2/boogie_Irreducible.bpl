...
procedure Test.Irreducible$System.Int32(this : ref, x$in : int where InRange(x$in, System.Int32)) returns ($result : int where InRange($result, System.Int32));
  free requires true;
...
implementation Test.Irreducible$System.Int32(this : ref, x$in : int) returns ($result : int) {
  var x : int where InRange(x, System.Int32);
  var stack0i : int;
  var stack0b : bool;
  var $Heap$block2635$LoopPreheader : <x>[ref, name]x;
  var $Heap$block2669$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, Test); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: x := x$in; goto block2516;
  block2516: goto block2533;
  block2533: stack0i := 0; goto true2533to2584, false2533to2550;
  true2533to2584: assume (x <= stack0i); goto block2584;
  false2533to2550: assume (x > stack0i); goto block2550;
  block2584: goto block2669$LoopPreheader;
  block2550: goto block2635$LoopPreheader;
  block2635: assume (((forall $o : ref :: (($Heap$block2635$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block2635$LoopPreheader[$ot, $allocated] == true) && ($Heap$block2635$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block2635$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block2635$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block2635$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block2635~f;
  $$block2635~f: assume (forall $o : ref :: ((($Heap$block2635$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block2635$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block2635$LoopPreheader[$o, $allocated] != true))); goto $$block2635~e;
  $$block2635~e: assume (forall $o : ref :: ((($Heap$block2635$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block2635~d;
  $$block2635~d: assert (forall $o : ref :: ((($o != null) && ($Heap$block2635$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block2635$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block2635$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block2635~c;
  $$block2635~c: stack0i := 1; goto $$block2635~b;
  $$block2635~b: stack0i := (x + stack0i); goto $$block2635~a;
  $$block2635~a: x := stack0i; goto block2652;
  block2669: assume (((forall $o : ref :: (($Heap$block2669$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block2669$LoopPreheader[$ot, $allocated] == true) && ($Heap$block2669$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block2669$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block2669$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block2669$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block2669~f;
  $$block2669~f: assume (forall $o : ref :: ((($Heap$block2669$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block2669$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block2669$LoopPreheader[$o, $allocated] != true))); goto $$block2669~e;
  $$block2669~e: assume (forall $o : ref :: ((($Heap$block2669$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block2669~d;
  $$block2669~d: assert (forall $o : ref :: ((($o != null) && ($Heap$block2669$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block2669$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block2669$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block2669~c;
  $$block2669~c: stack0i := 5; goto $$block2669~b;
  $$block2669~b: stack0i := (x + stack0i); goto $$block2669~a;
  $$block2669~a: x := stack0i; goto block2686;
  block2652: goto block2669;
  block2686: goto block2635;
  block2635$LoopPreheader: $Heap$block2635$LoopPreheader := $Heap; goto block2635;
  block2669$LoopPreheader: $Heap$block2669$LoopPreheader := $Heap; goto block2669;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~c: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2941;
  block2941: goto block2958;
  block2958: goto block2975;
  block2975: assert (this != null); goto $$block2975~a;
  $$block2975~a: call System.Object..ctor(this); goto block2992;
  block2992: goto block3009;
  block3009: assert (this != null); goto $$block3009~d;
  $$block3009~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3009~c;
  $$block3009~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3009~b;
  $$block3009~b: $Heap := $Heap[this, $inv := Test]; goto $$block3009~a;
