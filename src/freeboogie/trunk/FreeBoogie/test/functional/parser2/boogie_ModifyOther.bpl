...
axiom !IsStaticField(Test.a);
axiom IsDirectlyModifiableField(Test.a);
axiom (AsRepField(Test.a, Test) == Test.a);
axiom (DeclType(Test.a) == Test);
axiom (AsNonNullRefField(Test.a, A) == Test.a);
axiom (A <: A);
...
implementation A..ctor(this : ref) {
  ...
  $$entry~a: assume ($Heap[this, A.X] == 0); goto block2533;
  block2533: goto block2550;
  block2550: stack0i := 0; goto $$block2550~d;
  $$block2550~d: assert (this != null); goto $$block2550~c;
  $$block2550~c: assert (!($Heap[this, $inv] <: A) || ($Heap[this, $localinv] == System.Object)); goto $$block2550~b;
  $$block2550~b: $Heap := $Heap[this, A.X := stack0i]; goto $$block2550~a;
  $$block2550~a: assume IsHeap($Heap); goto block2567;
  block2567: assert (this != null); goto $$block2567~a;
  $$block2567~a: call System.Object..ctor(this); goto block2584;
  block2584: goto block2601;
  block2601: assert (this != null); goto $$block2601~d;
  $$block2601~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2601~c;
  $$block2601~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == A)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2601~b;
  $$block2601~b: $Heap := $Heap[this, $inv := A]; goto $$block2601~a;
  $$block2601~a: assume IsHeap($Heap); return;
...
procedure Test.Modify(this : ref);
...
implementation Test.Modify(this : ref) {
  var stack0o : ref;
  var i : int where InRange(i, System.Int32);
  var stack0i : int;
  var stack0b : bool;
  var local3791 : ref where $Is(local3791, A);
  var stack1s : struct;
  var stack1o : ref;
  var temp0 : exposeVersionType;
  var local3825 : int where InRange(local3825, System.Int32);
  var $Heap$block3485$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, Test); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto block3230;
  block3230: goto block3298;
  block3298: assume ((((($Heap[$Heap[this, Test.a], $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[$Heap[this, Test.a], $ownerRef], $inv] <: $Heap[$Heap[this, Test.a], $ownerFrame])) || ($Heap[$Heap[$Heap[this, Test.a], $ownerRef], $localinv] == $BaseClass($Heap[$Heap[this, Test.a], $ownerFrame]))) && ($Heap[$Heap[this, Test.a], $inv] == $typeof($Heap[this, Test.a]))) && ($Heap[$Heap[this, Test.a], $localinv] == $typeof($Heap[this, Test.a]))); goto block3451;
  block3451: goto block3468;
  block3468: i := 0; goto block3485$LoopPreheader;
  block3485: assume (((forall $o : ref :: (($Heap$block3485$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block3485$LoopPreheader[$ot, $allocated] == true) && ($Heap$block3485$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block3485$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block3485$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block3485$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block3485~d;
  $$block3485~d: assume (forall $o : ref :: ((($Heap$block3485$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block3485$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block3485$LoopPreheader[$o, $allocated] != true))); goto $$block3485~c;
  $$block3485~c: assume (forall $o : ref :: ((($Heap$block3485$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block3485~b;
  $$block3485~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block3485$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block3485$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block3485$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block3485~a;
  $$block3485~a: stack0i := 10; goto true3485to3638, false3485to3502;
  true3485to3638: assume (i >= stack0i); goto block3638;
  false3485to3502: assume (i < stack0i); goto block3502;
  block3638: goto block3655;
  block3502: assert (this != null); goto $$block3502~k;
  $$block3502~k: local3791 := $Heap[this, Test.a]; goto $$block3502~j;
  $$block3502~j: stack0o := local3791; goto $$block3502~i;
  $$block3502~i: havoc stack1s; goto $$block3502~h;
  $$block3502~h: assume $IsTokenForType(stack1s, A); goto $$block3502~g;
  $$block3502~g: stack1o := TypeObject(A); goto $$block3502~f;
  $$block3502~f: assert (stack0o != null); goto $$block3502~e;
  $$block3502~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: A)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block3502~d;
  $$block3502~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block3502~c;
  $$block3502~c: havoc temp0; goto $$block3502~b;
  $$block3502~b: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block3502~a;
  $$block3502~a: assume IsHeap($Heap); goto block3519;
  block3655: goto block3672;
  block3519: assert (this != null); goto $$block3519~e;
  $$block3519~e: stack0o := $Heap[this, Test.a]; goto $$block3519~d;
  $$block3519~d: assert (stack0o != null); goto $$block3519~c;
  $$block3519~c: assert (!($Heap[stack0o, $inv] <: A) || ($Heap[stack0o, $localinv] == System.Object)); goto $$block3519~b;
  $$block3519~b: $Heap := $Heap[stack0o, A.X := i]; goto $$block3519~a;
  $$block3519~a: assume IsHeap($Heap); goto block3689;
  block3672: return;
  block3689: stack0o := local3791; goto $$block3689~h;
  $$block3689~h: havoc stack1s; goto $$block3689~g;
  $$block3689~g: assume $IsTokenForType(stack1s, A); goto $$block3689~f;
  $$block3689~f: stack1o := TypeObject(A); goto $$block3689~e;
  $$block3689~e: assert (stack0o != null); goto $$block3689~d;
  $$block3689~d: assert ($Heap[stack0o, $localinv] == System.Object); goto $$block3689~c;
  $$block3689~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == stack0o)) && ($Heap[$p, $ownerFrame] == A)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3689~b;
  $$block3689~b: $Heap := $Heap[stack0o, $localinv := $typeof(stack0o)]; goto $$block3689~a;
  $$block3689~a: assume IsHeap($Heap); goto block3570;
  block3570: goto block3587;
  block3587: local3825 := i; goto $$block3587~d;
  $$block3587~d: stack0i := 1; goto $$block3587~c;
  $$block3587~c: stack0i := (local3825 + stack0i); goto $$block3587~b;
  $$block3587~b: i := stack0i; goto $$block3587~a;
  $$block3587~a: stack0i := local3825; goto block3604;
  block3604: goto block3621;
  block3621: goto block3485;
  block3485$LoopPreheader: $Heap$block3485$LoopPreheader := $Heap; goto block3485;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~e: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3927;
  block3927: goto block3944;
  block3944: havoc stack50000o; goto $$block3944~l;
  $$block3944~l: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == A)); goto $$block3944~k;
  $$block3944~k: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3944~j;
  $$block3944~j: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3944~i;
  $$block3944~i: assert (stack50000o != null); goto $$block3944~h;
  $$block3944~h: call A..ctor(stack50000o); goto $$block3944~g;
  $$block3944~g: stack0o := stack50000o; goto $$block3944~f;
  $$block3944~f: assert (this != null); goto $$block3944~e;
  $$block3944~e: assert (!($Heap[this, $inv] <: Test) || ($Heap[this, $localinv] == System.Object)); goto $$block3944~d;
  $$block3944~d: assert (($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || (($Heap[stack0o, $ownerRef] == this) && ($Heap[stack0o, $ownerFrame] == Test))); goto $$block3944~c;
  $$block3944~c: $Heap := $Heap[this, Test.a := stack0o]; goto $$block3944~b;
  $$block3944~b: call $UpdateOwnersForRep(this, Test, stack0o); goto $$block3944~a;
  $$block3944~a: assume IsHeap($Heap); goto block3961;
  block3961: assert (this != null); goto $$block3961~a;
  $$block3961~a: call System.Object..ctor(this); goto block3978;
  block3978: goto block3995;
  block3995: assert (this != null); goto $$block3995~d;
  $$block3995~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3995~c;
  $$block3995~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3995~b;
  $$block3995~b: $Heap := $Heap[this, $inv := Test]; goto $$block3995~a;
  $$block3995~a: assume IsHeap($Heap); return;
