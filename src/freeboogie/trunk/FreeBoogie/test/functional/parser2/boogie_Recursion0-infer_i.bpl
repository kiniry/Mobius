...
const Recursion0 : name;
axiom (Recursion0 <: Recursion0);
axiom ($BaseClass(Recursion0) == System.Object);
axiom ((Recursion0 <: $BaseClass(Recursion0)) && (AsDirectSubClass(Recursion0, $BaseClass(Recursion0)) == Recursion0));
axiom (!$IsImmutable(Recursion0) && ($AsMutable(Recursion0) == Recursion0));
axiom (forall $U : name :: {($U <: Recursion0)} (($U <: Recursion0) ==> ($U == Recursion0)));
procedure Recursion0.SomeIterations$System.Int32(this : ref, y$in : int where InRange(y$in, System.Int32));
  free requires true;
...
implementation Recursion0.SomeIterations$System.Int32(this : ref, y$in : int) {
  var y : int where InRange(y, System.Int32);
  var v : int where InRange(v, System.Int32);
  var stack0i : int;
  var factorial : int where InRange(factorial, System.Int32);
  var stack0o : ref;
  entry: assume $IsNotNull(this, Recursion0); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: y := y$in; goto block1241;
  block1241: goto block1258;
  block1258: v := 3; goto $$block1258~d;
  $$block1258~d: stack0i := v; goto $$block1258~c;
  $$block1258~c: assert (this != null); goto $$block1258~b;
  $$block1258~b: call factorial := Recursion0.fact$System.Int32(this, stack0i); goto $$block1258~a;
  $$block1258~a: assert (factorial >= 0); goto block1343;
  block1343: return;
  
}

procedure Recursion0.fact$System.Int32(this : ref, i$in : int where InRange(i$in, System.Int32)) returns ($result : int where InRange($result, System.Int32));
  free requires true;
  requires (i$in >= 0);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
...
implementation Recursion0.fact$System.Int32(this : ref, i$in : int) returns ($result : int) {
  ...
  entry: assume $IsNotNull(this, Recursion0); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: i := i$in; goto block1955;
  block1955: goto block2057;
  block2057: stack0i := 0; goto true2057to2091, false2057to2074;
  true2057to2091: assume (i != stack0i); goto block2091;
  false2057to2074: assume (i == stack0i); goto block2074;
  block2091: stack0i := 1; goto $$block2091~e;
  $$block2091~e: stack0i := (i - stack0i); goto $$block2091~d;
  $$block2091~d: assert (this != null); goto $$block2091~c;
  $$block2091~c: call stack0i := Recursion0.fact$System.Int32(this, stack0i); goto $$block2091~b;
  $$block2091~b: stack0i := (i * stack0i); goto $$block2091~a;
  $$block2091~a: returnValue := stack0i; goto block2108;
  block2074: returnValue := 0; goto block2108;
  block2108: assert (returnValue >= 0); goto block2193;
  block2193: return.value := returnValue; goto block2295;
  block2295: SS$Display.Return.Local := return.value; goto $$block2295~b;
  $$block2295~b: stack0i := return.value; goto $$block2295~a;
  $$block2295~a: $result := stack0i; return;
  
}

procedure Recursion0..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Recursion0)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Recursion0 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation Recursion0..ctor(this : ref) {
  entry: assume $IsNotNull(this, Recursion0); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto $$entry~e;
  $$entry~e: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2856;
  block2856: goto block2873;
  block2873: assert (this != null); goto $$block2873~f;
  $$block2873~f: call System.Object..ctor(this); goto $$block2873~e;
  $$block2873~e: assert (this != null); goto $$block2873~d;
  $$block2873~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2873~c;
  $$block2873~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Recursion0)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2873~b;
  $$block2873~b: $Heap := $Heap[this, $inv := Recursion0]; goto $$block2873~a;
  $$block2873~a: assume IsHeap($Heap); return;
