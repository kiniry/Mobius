...
const C.f : name;
const C : name;
function #C.M($$unnamed~fb : <x>[ref, name]x, $$unnamed~fa : ref) returns ($$unnamed~fc : ref);
axiom !IsStaticField(C.f);
axiom IsDirectlyModifiableField(C.f);
axiom (DeclType(C.f) == C);
axiom (AsRangeField(C.f, System.Int32) == C.f);
axiom (C <: C);
...
axiom (forall $Heap : <x>[ref, name]x, this : ref :: {#C.M($Heap, this)} ((IsHeap($Heap) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))) ==> ((($Heap[#C.M($Heap, this), $allocated] == true) && $Is(#C.M($Heap, this), System.Object)) && ((#C.M($Heap, this) == null) || (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[#C.M($Heap, this), $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[#C.M($Heap, this), $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))))));
procedure C.M(this : ref) returns ($result : ref where $Is($result, System.Object));
...
implementation C.M(this : ref) returns ($result : ref) {
  var stack50000o : ref;
  var stack0o : ref;
  ...
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1190;
  block1190: goto block1207;
  block1207: havoc stack50000o; goto $$block1207~g;
  $$block1207~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == System.Object)); goto $$block1207~f;
  $$block1207~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block1207~e;
  $$block1207~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block1207~d;
  $$block1207~d: assert (stack50000o != null); goto $$block1207~c;
  $$block1207~c: call System.Object..ctor(stack50000o); goto $$block1207~b;
  $$block1207~b: stack0o := stack50000o; goto $$block1207~a;
  $$block1207~a: return.value := stack0o; goto block1224;
  block1224: SS$Display.Return.Local := return.value; goto $$block1224~b;
  $$block1224~b: stack0o := return.value; goto $$block1224~a;
  $$block1224~a: $result := stack0o; return;
...
procedure C.O(this : ref) returns ($result : ref where $IsNotNull($result, C));
...
implementation C.O(this : ref) returns ($result : ref) {
  var stack50000o : ref;
  var stack0o : ref;
  var return.value : ref where $Is(return.value, C);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, C);
  entry: assume $IsNotNull(this, C); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto block1513;
  block1513: goto block1530;
  block1530: havoc stack50000o; goto $$block1530~g;
  $$block1530~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == C)); goto $$block1530~f;
  $$block1530~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block1530~e;
  $$block1530~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block1530~d;
  $$block1530~d: assert (stack50000o != null); goto $$block1530~c;
  $$block1530~c: call C..ctor(stack50000o); goto $$block1530~b;
  $$block1530~b: stack0o := stack50000o; goto $$block1530~a;
  $$block1530~a: return.value := stack0o; goto block1547;
  block1547: SS$Display.Return.Local := return.value; goto $$block1547~b;
  $$block1547~b: stack0o := return.value; goto $$block1547~a;
  $$block1547~a: $result := stack0o; return;
...
procedure C.P(this : ref) returns ($result : ref where $Is($result, C));
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
  free ensures $Is($result, C);
...
implementation C.P(this : ref) returns ($result : ref) {
  ...
  $$entry~c: assume ($Heap[this, $allocated] == true); goto block1836;
  block1836: goto block1853;
  block1853: assert (this != null); goto $$block1853~h;
  $$block1853~h: call c := C.O$.Virtual.$(this); goto $$block1853~g;
  $$block1853~g: stack0i := 5; goto $$block1853~f;
  $$block1853~f: assert (c != null); goto $$block1853~e;
  $$block1853~e: havoc temp0; goto $$block1853~d;
  $$block1853~d: $Heap := $Heap[c, $exposeVersion := temp0]; goto $$block1853~c;
  $$block1853~c: $Heap := $Heap[c, C.f := stack0i]; goto $$block1853~b;
  $$block1853~b: assume IsHeap($Heap); goto $$block1853~a;
  $$block1853~a: return.value := c; goto block1870;
  block1870: SS$Display.Return.Local := return.value; goto $$block1870~b;
  $$block1870~b: stack0o := return.value; goto $$block1870~a;
  $$block1870~a: $result := stack0o; return;
  
}

procedure C.O$.Virtual.$(this : ref) returns ($result : ref where $IsNotNull($result, C));
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
...
implementation C..ctor(this : ref) {
  ...
  $$entry~d: assume ($Heap[this, C.f] == 0); goto block2142;
  block2142: goto block2159;
  block2159: assert (this != null); goto $$block2159~f;
  $$block2159~f: call System.Object..ctor(this); goto $$block2159~e;
  $$block2159~e: assert (this != null); goto $$block2159~d;
  $$block2159~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2159~c;
  $$block2159~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == C)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2159~b;
  $$block2159~b: $Heap := $Heap[this, $inv := C]; goto $$block2159~a;
  $$block2159~a: assume IsHeap($Heap); return;
