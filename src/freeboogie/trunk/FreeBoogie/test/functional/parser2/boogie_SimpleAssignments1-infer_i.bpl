...
const SimpleAssignments1 : name;
const System.IConvertible : name;
axiom (SimpleAssignments1 <: SimpleAssignments1);
axiom ($BaseClass(SimpleAssignments1) == System.Object);
axiom ((SimpleAssignments1 <: $BaseClass(SimpleAssignments1)) && (AsDirectSubClass(SimpleAssignments1, $BaseClass(SimpleAssignments1)) == SimpleAssignments1));
axiom (!$IsImmutable(SimpleAssignments1) && ($AsMutable(SimpleAssignments1) == SimpleAssignments1));
axiom (forall $U : name :: {($U <: SimpleAssignments1)} (($U <: SimpleAssignments1) ==> ($U == SimpleAssignments1)));
procedure SimpleAssignments1.M$System.Int32(this : ref, val$in : int where InRange(val$in, System.Int32));
  free requires true;
...
implementation SimpleAssignments1.M$System.Int32(this : ref, val$in : int) {
  ...
  var d : int where InRange(d, System.Int32);
  entry: assume $IsNotNull(this, SimpleAssignments1); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: val := val$in; goto block1513;
  block1513: goto block1530;
  block1530: a := 3; goto $$block1530~a;
  $$block1530~a: stack0i := 0; goto true1530to1564, false1530to1547;
  true1530to1564: assume (val <= stack0i); goto block1564;
  false1530to1547: assume (val > stack0i); goto block1547;
  block1564: stack0i := 13; goto $$block1564~d;
  $$block1564~d: stack1i := 5; goto $$block1564~c;
  $$block1564~c: stack1i := (stack1i + a); goto $$block1564~b;
  $$block1564~b: stack0i := (stack0i * stack1i); goto $$block1564~a;
  $$block1564~a: b := stack0i; goto block1581;
  block1547: stack0i := 2; goto $$block1547~c;
  $$block1547~c: stack0i := (stack0i + a); goto $$block1547~b;
  $$block1547~b: stack0i := (0 - stack0i); goto $$block1547~a;
  $$block1547~a: b := stack0i; goto block1581;
  block1581: assert ((-5 <= b) && (b <= 104)); goto block1700;
  block1700: stack0i := (a * b); goto $$block1700~b;
  $$block1700~b: c := stack0i; goto $$block1700~a;
  $$block1700~a: assert ((-15 <= c) && (c <= 312)); goto block1819;
  block1819: stack0i := (c - c); goto $$block1819~b;
  $$block1819~b: d := stack0i; goto $$block1819~a;
  $$block1819~a: assert (d == 0); goto block1904;
  block1904: return;
...
procedure SimpleAssignments1..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == SimpleAssignments1)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(SimpleAssignments1 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation SimpleAssignments1..ctor(this : ref) {
  entry: assume $IsNotNull(this, SimpleAssignments1); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2601;
  block2601: goto block2618;
  block2618: assert (this != null); goto $$block2618~f;
  $$block2618~f: call System.Object..ctor(this); goto $$block2618~e;
  $$block2618~e: assert (this != null); goto $$block2618~d;
  $$block2618~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2618~c;
  $$block2618~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == SimpleAssignments1)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2618~b;
  $$block2618~b: $Heap := $Heap[this, $inv := SimpleAssignments1]; goto $$block2618~a;
  $$block2618~a: assume IsHeap($Heap); return;
