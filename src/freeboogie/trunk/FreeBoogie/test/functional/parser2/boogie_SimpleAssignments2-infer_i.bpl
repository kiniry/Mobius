...
const SimpleAssignments2 : name;
axiom (SimpleAssignments2 <: SimpleAssignments2);
axiom ($BaseClass(SimpleAssignments2) == System.Object);
axiom ((SimpleAssignments2 <: $BaseClass(SimpleAssignments2)) && (AsDirectSubClass(SimpleAssignments2, $BaseClass(SimpleAssignments2)) == SimpleAssignments2));
axiom (!$IsImmutable(SimpleAssignments2) && ($AsMutable(SimpleAssignments2) == SimpleAssignments2));
axiom (forall $U : name :: {($U <: SimpleAssignments2)} (($U <: SimpleAssignments2) ==> ($U == SimpleAssignments2)));
procedure SimpleAssignments2.DivisionByZero(this : ref) returns ($result : int where InRange($result, System.Int32));
...
implementation SimpleAssignments2.DivisionByZero(this : ref) returns ($result : int) {
  var zero : int where InRange(zero, System.Int32);
  var stack0i : int;
  ...
  entry: assume $IsNotNull(this, SimpleAssignments2); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1156;
  block1156: goto block1173;
  block1173: zero := 0; goto $$block1173~e;
  $$block1173~e: stack0i := 1; goto $$block1173~d;
  $$block1173~d: assert (zero != 0); goto $$block1173~c;
  $$block1173~c: stack0i := (stack0i / zero); goto $$block1173~b;
  $$block1173~b: x := stack0i; goto $$block1173~a;
  $$block1173~a: return.value := x; goto block1190;
  block1190: SS$Display.Return.Local := return.value; goto $$block1190~b;
  $$block1190~b: stack0i := return.value; goto $$block1190~a;
  $$block1190~a: $result := stack0i; return;
  
}

procedure SimpleAssignments2..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == SimpleAssignments2)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(SimpleAssignments2 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation SimpleAssignments2..ctor(this : ref) {
  entry: assume $IsNotNull(this, SimpleAssignments2); goto $$entry~c;
  $$entry~c: assume ($Heap[this, $allocated] == true); goto $$entry~b;
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block1479;
  block1479: goto block1496;
  block1496: assert (this != null); goto $$block1496~f;
  $$block1496~f: call System.Object..ctor(this); goto $$block1496~e;
  $$block1496~e: assert (this != null); goto $$block1496~d;
  $$block1496~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block1496~c;
  $$block1496~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == SimpleAssignments2)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1496~b;
  $$block1496~b: $Heap := $Heap[this, $inv := SimpleAssignments2]; goto $$block1496~a;
  $$block1496~a: assume IsHeap($Heap); return;
