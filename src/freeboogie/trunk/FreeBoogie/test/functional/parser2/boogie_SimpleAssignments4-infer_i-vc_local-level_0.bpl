...
axiom (SimpleAssignment4 <: SimpleAssignment4);
axiom ($BaseClass(SimpleAssignment4) == System.Object);
axiom ((SimpleAssignment4 <: $BaseClass(SimpleAssignment4)) && (AsDirectSubClass(SimpleAssignment4, $BaseClass(SimpleAssignment4)) == SimpleAssignment4));
axiom (!$IsImmutable(SimpleAssignment4) && ($AsMutable(SimpleAssignment4) == SimpleAssignment4));
axiom (forall $U : name :: {($U <: SimpleAssignment4)} (($U <: SimpleAssignment4) ==> ($U == SimpleAssignment4)));
procedure SimpleAssignment4.Rigoletto$System.Int32(this : ref, Input$in : int where InRange(Input$in, System.Int32));
  free requires true;
...
implementation SimpleAssignment4.Rigoletto$System.Int32(this : ref, Input$in : int) {
  var Input : int where InRange(Input, System.Int32);
  var stack0i : int;
  var stack0b : bool;
  var x : int where InRange(x, System.Int32);
  var y : int where InRange(y, System.Int32);
  var stack0o : ref;
  entry: assume $IsNotNull(this, SimpleAssignment4); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: Input := Input$in; goto block1343;
  block1343: goto block1360;
  block1360: stack0i := 223; goto true1360to1394, false1360to1377;
  true1360to1394: assume (Input >= stack0i); goto block1394;
  false1360to1377: assume (Input < stack0i); goto block1377;
  block1394: x := 20; goto block1411;
  block1377: x := -10; goto block1411;
  block1411: y := x; goto $$block1411~a;
  $$block1411~a: stack0i := 0; goto true1411to1445, false1411to1428;
  true1411to1445: assume (y > stack0i); goto block1445;
  false1411to1428: assume (y <= stack0i); goto block1428;
  block1445: assert ((0 <= y) && (y <= 20)); goto block1564;
  block1428: stack0i := x; goto $$block1428~b;
  $$block1428~b: stack0i := (0 - stack0i); goto $$block1428~a;
  $$block1428~a: y := stack0i; goto block1445;
  block1564: return;
...
procedure SimpleAssignment4..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  free ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == SimpleAssignment4)) && ($Heap[this, $localinv] == $typeof(this)));
  ...
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  free ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(SimpleAssignment4 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation SimpleAssignment4..ctor(this : ref) {
  entry: assume $IsNotNull(this, SimpleAssignment4); goto $$entry~d;
  ...
  $$block2023~f: call System.Object..ctor(this); goto $$block2023~e;
  $$block2023~e: assert (this != null); goto $$block2023~d;
  $$block2023~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2023~c;
  $$block2023~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == SimpleAssignment4)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2023~b;
  $$block2023~b: $Heap := $Heap[this, $inv := SimpleAssignment4]; goto $$block2023~a;
