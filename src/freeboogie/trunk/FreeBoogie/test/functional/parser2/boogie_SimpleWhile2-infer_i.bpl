...
const SimpleWhile2 : name;
const int#300476 : int;
axiom (100000 < int#300476);
axiom (SimpleWhile2 <: SimpleWhile2);
axiom ($BaseClass(SimpleWhile2) == System.Object);
axiom ((SimpleWhile2 <: $BaseClass(SimpleWhile2)) && (AsDirectSubClass(SimpleWhile2, $BaseClass(SimpleWhile2)) == SimpleWhile2));
axiom (!$IsImmutable(SimpleWhile2) && ($AsMutable(SimpleWhile2) == SimpleWhile2));
axiom (forall $U : name :: {($U <: SimpleWhile2)} (($U <: SimpleWhile2) ==> ($U == SimpleWhile2)));
procedure SimpleWhile2.AMethod(this : ref);
...
implementation SimpleWhile2.AMethod(this : ref) {
  ...
  var stack0o : ref;
  var $Heap$block1309$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, SimpleWhile2); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1275;
  block1275: goto block1292;
  block1292: i := int#300476; goto $$block1292~a;
  $$block1292~a: count := 0; goto block1309$LoopPreheader;
  block1309: assume (((forall $o : ref :: (($Heap$block1309$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1309$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1309$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1309$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1309$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1309$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1309~d;
  $$block1309~d: assume (forall $o : ref :: ((($Heap$block1309$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1309$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1309$LoopPreheader[$o, $allocated] != true))); goto $$block1309~c;
  $$block1309~c: assume (forall $o : ref :: ((($Heap$block1309$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1309~b;
  $$block1309~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block1309$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1309$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1309$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block1309~a;
  $$block1309~a: stack0i := 0; goto true1309to1343, false1309to1326;
  true1309to1343: assume (i <= stack0i); goto block1343;
  false1309to1326: assume (i > stack0i); goto block1326;
  block1343: assert (count <= 0); goto block1428;
  ...
  $$block1326~a: stack0i := local3; goto block1309;
  block1428: return;
  block1309$LoopPreheader: $Heap$block1309$LoopPreheader := $Heap; goto block1309;
...
procedure SimpleWhile2..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == SimpleWhile2)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(SimpleWhile2 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation SimpleWhile2..ctor(this : ref) {
  entry: assume $IsNotNull(this, SimpleWhile2); goto $$entry~c;
  $$entry~c: assume ($Heap[this, $allocated] == true); goto $$entry~b;
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block1921;
  block1921: goto block1938;
  block1938: assert (this != null); goto $$block1938~f;
  $$block1938~f: call System.Object..ctor(this); goto $$block1938~e;
  $$block1938~e: assert (this != null); goto $$block1938~d;
  $$block1938~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block1938~c;
  $$block1938~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == SimpleWhile2)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1938~b;
  $$block1938~b: $Heap := $Heap[this, $inv := SimpleWhile2]; goto $$block1938~a;
  $$block1938~a: assume IsHeap($Heap); return;
