...
implementation Test.Foo(this : ref) {
  var stack0i : int;
  var stack0o : ref;
  entry: assume $IsNotNull(this, Test); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2533;
  block2533: goto block2550;
  block2550: stack0i := 5; goto $$block2550~b;
  $$block2550~b: $Heap := $Heap[ClassRepr(Test), Test.x := stack0i]; goto $$block2550~a;
  $$block2550~a: assume IsHeap($Heap); goto block2567;
  block2567: assert ($Heap[ClassRepr(Test), Test.x] == 5); goto block2720;
...
implementation Test.Bar(this : ref) {
  ...
  $$entry~b: assume ($Heap[this, $allocated] == true); goto block3162;
  block3162: goto block3179;
  block3179: stack0i := 6; goto $$block3179~b;
  $$block3179~b: $Heap := $Heap[ClassRepr(Test), Test.x := stack0i]; goto $$block3179~a;
  $$block3179~a: assume IsHeap($Heap); goto block3196;
  block3196: assert ($Heap[ClassRepr(Test), Test.x] == 7); goto block3349;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~c: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3570;
  block3570: goto block3587;
  block3587: goto block3604;
  block3604: assert (this != null); goto $$block3604~a;
  $$block3604~a: call System.Object..ctor(this); goto block3621;
  block3621: goto block3638;
  block3638: assert (this != null); goto $$block3638~d;
  $$block3638~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3638~c;
  $$block3638~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3638~b;
  $$block3638~b: $Heap := $Heap[this, $inv := Test]; goto $$block3638~a;
  $$block3638~a: assume IsHeap($Heap); return;
