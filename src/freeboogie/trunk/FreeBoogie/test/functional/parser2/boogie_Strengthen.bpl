...
procedure T.M(this : ref) returns ($result : ref where $Is($result, System.String));
...
implementation T.M(this : ref) returns ($result : ref) {
  ...
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2975;
  block2975: goto block2992;
  block2992: return.value := null; goto block3009;
  block3009: goto block3196;
  block3196: goto block3213;
  block3213: SS$Display.Return.Local := return.value; goto $$block3213~b;
  $$block3213~b: stack0o := return.value; goto $$block3213~a;
  $$block3213~a: $result := stack0o; return;
...
implementation T..ctor(this : ref) {
  ...
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3451;
  block3451: goto block3468;
  block3468: goto block3485;
  block3485: assert (this != null); goto $$block3485~a;
  $$block3485~a: call System.Object..ctor(this); goto block3502;
  block3502: goto block3519;
  block3519: assert (this != null); goto $$block3519~d;
  $$block3519~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3519~c;
  $$block3519~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == T)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3519~b;
  $$block3519~b: $Heap := $Heap[this, $inv := T]; goto $$block3519~a;
...
procedure U.M(this : ref) returns ($result : ref where $Is($result, System.String));
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
...
implementation U.M(this : ref) returns ($result : ref) {
  var return.value : ref where $Is(return.value, System.String);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, System.String);
  var stack0o : ref;
  entry: assume $IsNotNull(this, U); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto block4029;
  block4029: goto block4046;
  block4046: return.value := $stringLiteral0; goto block4063;
  block4063: goto block4352;
...
implementation U..ctor(this : ref) {
  entry: assume $IsNotNull(this, U); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto $$entry~e;
  $$entry~e: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block4590;
  block4590: goto block4607;
  block4607: goto block4624;
  block4624: assert (this != null); goto $$block4624~a;
  $$block4624~a: call T..ctor(this); goto block4641;
  block4641: goto block4658;
  block4658: assert (this != null); goto $$block4658~d;
  $$block4658~d: assert (($Heap[this, $inv] == T) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4658~c;
  $$block4658~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == U)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4658~b;
  $$block4658~b: $Heap := $Heap[this, $inv := U]; goto $$block4658~a;
  $$block4658~a: assume IsHeap($Heap); return;
  
}

axiom (MainClass <: MainClass);
axiom ($BaseClass(MainClass) == System.Object);
axiom ((MainClass <: $BaseClass(MainClass)) && (AsDirectSubClass(MainClass, $BaseClass(MainClass)) == MainClass));
axiom (!$IsImmutable(MainClass) && ($AsMutable(MainClass) == MainClass));
procedure MainClass.Main();
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation MainClass.Main() {
  ...
  var u : ref where $Is(u, U);
  entry: goto block4845;
  block4845: goto block4862;
  block4862: havoc stack50000o; goto $$block4862~g;
  $$block4862~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == T)); goto $$block4862~f;
  $$block4862~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block4862~e;
  $$block4862~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block4862~d;
  $$block4862~d: assert (stack50000o != null); goto $$block4862~c;
  $$block4862~c: call T..ctor(stack50000o); goto $$block4862~b;
  $$block4862~b: stack0o := stack50000o; goto $$block4862~a;
  $$block4862~a: t := stack0o; goto block4879;
  block4879: havoc stack50000o; goto $$block4879~g;
  $$block4879~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == U)); goto $$block4879~f;
  $$block4879~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block4879~e;
  $$block4879~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block4879~d;
  $$block4879~d: assert (stack50000o != null); goto $$block4879~c;
  $$block4879~c: call U..ctor(stack50000o); goto $$block4879~b;
  $$block4879~b: stack0o := stack50000o; goto $$block4879~a;
  $$block4879~a: u := stack0o; goto block4896;
  block4896: goto block4913;
  block4913: assert (t != null); goto $$block4913~c;
  $$block4913~c: call stack0o := T.M$.Virtual.$(t); goto $$block4913~b;
  $$block4913~b: assert (u != null); goto $$block4913~a;
  $$block4913~a: call stack0o := U.M$.Virtual.$(u); goto block4930;
  block4930: goto block4947;
  block4947: return;
  
}

procedure T.M$.Virtual.$(this : ref) returns ($result : ref where $Is($result, System.String));
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
...
procedure U.M$.Virtual.$(this : ref) returns ($result : ref where $Is($result, System.String));
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
...
procedure MainClass.BoogieTest0$T$notnull(t$in : ref where $IsNotNull(t$in, T));
...
implementation MainClass.BoogieTest0$T$notnull(t$in : ref) {
  var t : ref where $IsNotNull(t, T);
  var o : ref where $Is(o, System.Object);
  var stack0o : ref;
  entry: t := t$in; goto block5542;
  block5542: goto block5746;
  block5746: goto block5763;
  block5763: assert (t != null); goto $$block5763~a;
  $$block5763~a: call o := T.M$.Virtual.$(t); goto block5780;
  block5780: assert (o != null); goto block5933;
...
procedure MainClass.BoogieTest0$U$notnull(u$in : ref where $IsNotNull(u$in, U));
  free requires ($Heap[u$in, $allocated] == true);
  requires (((($Heap[u$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[u$in, $ownerRef], $inv] <: $Heap[u$in, $ownerFrame])) || ($Heap[$Heap[u$in, $ownerRef], $localinv] == $BaseClass($Heap[u$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[u$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[u$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation MainClass.BoogieTest0$U$notnull(u$in : ref) {
  var u : ref where $IsNotNull(u, U);
  var o : ref where $Is(o, System.Object);
  var stack0o : ref;
  entry: u := u$in; goto block6647;
  block6647: goto block6851;
  block6851: goto block6868;
  block6868: assert (u != null); goto $$block6868~a;
  $$block6868~a: call o := U.M$.Virtual.$(u); goto block6885;
  block6885: assert (o != null); goto block7038;
...
procedure MainClass..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == MainClass)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(MainClass <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation MainClass..ctor(this : ref) {
  entry: assume $IsNotNull(this, MainClass); goto $$entry~h;
  $$entry~h: assume ($Heap[this, $allocated] == true); goto $$entry~g;
  $$entry~g: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block7310;
  block7310: goto block7327;
  block7327: goto block7344;
  block7344: assert (this != null); goto $$block7344~a;
  $$block7344~a: call System.Object..ctor(this); goto block7361;
  block7361: goto block7378;
  block7378: assert (this != null); goto $$block7378~d;
  $$block7378~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block7378~c;
  $$block7378~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == MainClass)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block7378~b;
  $$block7378~b: $Heap := $Heap[this, $inv := MainClass]; goto $$block7378~a;
