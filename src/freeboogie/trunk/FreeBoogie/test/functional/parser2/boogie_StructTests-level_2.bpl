...
axiom !IsStaticField(St.x);
axiom IsDirectlyModifiableField(St.x);
axiom (forall this : struct :: (0 <= $StructGet(this, St.x)));
axiom (forall $U : name :: {($U <: St)} (($U <: St) ==> ($U == St)));
axiom (forall $U : name :: {($U <: System.Boolean)} (($U <: System.Boolean) ==> ($U == System.Boolean)));
procedure St.SpecSharp.CheckInvariant$System.Boolean(this$in : struct, throwException$in : bool where true) returns (this$out : struct, $result : bool where true);
  free requires true;
...
implementation St.SpecSharp.CheckInvariant$System.Boolean(this$in : struct, throwException$in : bool) returns (this$out : struct, $result : bool) {
  ...
  $$entry~a: throwException := throwException$in; goto block1122;
  block1122: goto block1139;
  block1139: return.value := true; goto block1156;
  block1156: SS$Display.Return.Local := return.value; goto $$block1156~c;
  $$block1156~c: stack0b := return.value; goto $$block1156~b;
  $$block1156~b: this$out := this; goto $$block1156~a;
  $$block1156~a: $result := stack0b; return;
  
}

procedure St..ctor$System.Int32(this$in : struct, y$in : int where InRange(y$in, System.Int32)) returns (this$out : struct);
  free requires true;
  requires (0 <= y$in);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  ensures ($StructGet(this$out, St.x) == y$in);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
...
implementation St..ctor$System.Int32(this$in : struct, y$in : int) returns (this$out : struct) {
  var this : struct where true;
  var y : int where InRange(y, System.Int32);
  entry: this := this$in; goto $$entry~b;
  $$entry~b: y := y$in; goto block1564;
  block1564: goto block1666;
  block1666: this := $StructSet(this, St.x, y); goto $$block1666~a;
  $$block1666~a: assume IsHeap($Heap); goto block1768;
  block1768: this$out := this; return;
  
}

procedure St..ctor$System.Boolean(this$in : struct, b$in : bool where true) returns (this$out : struct);
  free requires true;
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
...
implementation St..ctor$System.Boolean(this$in : struct, b$in : bool) returns (this$out : struct) {
  var this : struct where true;
  var b : bool where true;
  var stack1b : bool;
  var stack1i : int;
  entry: this := this$in; goto $$entry~c;
  $$entry~c: b := b$in; goto block2091;
  block2091: goto block2108;
  block2108: stack1b := b; goto true2108to2142, false2108to2125;
  true2108to2142: assume !stack1b; goto block2142;
  false2108to2125: assume stack1b; goto block2125;
  block2142: stack1i := -2; goto block2159;
  block2125: stack1i := 2; goto block2159;
  block2159: this := $StructSet(this, St.x, stack1i); goto $$block2159~b;
  $$block2159~b: assume IsHeap($Heap); goto $$block2159~a;
  $$block2159~a: this$out := this; return;
  
}

procedure St.M$System.Int32.array$notnull(this$in : struct, a$in : ref where $IsNotNull(a$in, ValueArray(System.Int32, 1))) returns (this$out : struct);
  free requires ($Heap[a$in, $allocated] == true);
  requires ((0 <= $StructGet(this$in, St.x)) && ($StructGet(this$in, St.x) < $Length(a$in)));
  ...
  free requires ($BeingConstructed == null);
  modifies $Heap;
  ensures (old($StructGet(this$in, St.x)) < $StructGet(this$out, St.x));
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
...
implementation St.M$System.Int32.array$notnull(this$in : struct, a$in : ref) returns (this$out : struct) {
  var this : struct where true;
  var a : ref where $IsNotNull(a, ValueArray(System.Int32, 1));
  var stack0o : ref;
  var stack1i : int;
  var inc : int where InRange(inc, System.Int32);
  var stack0i : int;
  var stack0b : bool;
  entry: this := this$in; goto $$entry~d;
  $$entry~d: a := a$in; goto block3791;
  block3791: goto block3910;
  block3910: stack0o := a; goto $$block3910~f;
  $$block3910~f: stack1i := $StructGet(this, St.x); goto $$block3910~e;
  $$block3910~e: assert (stack0o != null); goto $$block3910~d;
  $$block3910~d: assert (0 <= stack1i); goto $$block3910~c;
  $$block3910~c: assert (stack1i < $Length(stack0o)); goto $$block3910~b;
  $$block3910~b: inc := ValueArrayGet($Heap[stack0o, $elements], stack1i); goto $$block3910~a;
  $$block3910~a: stack0i := 0; goto true3910to3944, false3910to3927;
  true3910to3944: assume (inc > stack0i); goto block3944;
  false3910to3927: assume (inc <= stack0i); goto block3927;
  block3944: stack0i := $StructGet(this, St.x); goto $$block3944~c;
  $$block3944~c: stack0i := (stack0i + inc); goto $$block3944~b;
  $$block3944~b: this := $StructSet(this, St.x, stack0i); goto $$block3944~a;
  $$block3944~a: assume IsHeap($Heap); goto block4046;
  block3927: inc := 1; goto block3944;
  block4046: this$out := this; return;
  
}

procedure St.N(this$in : struct) returns (this$out : struct);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation St.N(this$in : struct) returns (this$out : struct) {
  var this : struct where true;
  var stack0i : int;
  var stack1i : int;
  entry: this := this$in; goto block4471;
  block4471: goto block4488;
  block4488: stack0i := 1; goto $$block4488~g;
  $$block4488~g: stack1i := $StructGet(this, St.x); goto $$block4488~f;
  $$block4488~f: stack0i := (stack0i + stack1i); goto $$block4488~e;
  $$block4488~e: stack1i := 1; goto $$block4488~d;
  $$block4488~d: stack0i := (stack0i - stack1i); goto $$block4488~c;
  $$block4488~c: this := $StructSet(this, St.x, stack0i); goto $$block4488~b;
  $$block4488~b: assume IsHeap($Heap); goto $$block4488~a;
  $$block4488~a: this$out := this; return;
  
}

procedure St.P(this$in : struct) returns (this$out : struct);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation St.P(this$in : struct) returns (this$out : struct) {
  var this : struct where true;
  var stack0o : ref;
  entry: this := this$in; goto block4828;
  block4828: goto block4845;
  block4845: assert (0 <= $StructGet(this, St.x)); goto block4930;
  block4930: this$out := this; return;
...
procedure St.Q(this$in : struct) returns (this$out : struct);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation St.Q(this$in : struct) returns (this$out : struct) {
  var this : struct where true;
  var stack0i : int;
  var stack0o : ref;
  entry: this := this$in; goto block5253;
  block5253: goto block5270;
  block5270: stack0i := -2; goto $$block5270~c;
  $$block5270~c: this := $StructSet(this, St.x, stack0i); goto $$block5270~b;
  $$block5270~b: assume IsHeap($Heap); goto $$block5270~a;
  $$block5270~a: assert (0 <= $StructGet(this, St.x)); goto block5355;
  block5355: this$out := this; return;
  
}

procedure St.R(this$in : struct) returns (this$out : struct);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation St.R(this$in : struct) returns (this$out : struct) {
  var this : struct where true;
  var stack0i : int;
  entry: this := this$in; goto block5627;
  block5627: goto block5644;
  block5644: stack0i := -2; goto $$block5644~c;
  $$block5644~c: this := $StructSet(this, St.x, stack0i); goto $$block5644~b;
  $$block5644~b: assume IsHeap($Heap); goto $$block5644~a;
  $$block5644~a: this$out := this; return;
  
}

procedure St.S$System.Int32.ptr$System.Int32.ptr(this$in : struct, y$in : int where InRange(y$in, System.Int32)) returns (this$out : struct, y$out : int where InRange(y$out, System.Int32), z$out : int where InRange(z$out, System.Int32));
  free requires true;
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures true;
  free ensures InRange(y$out, System.Int32);
  free ensures true;
  free ensures InRange(z$out, System.Int32);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
...
implementation St.S$System.Int32.ptr$System.Int32.ptr(this$in : struct, y$in : int) returns (this$out : struct, y$out : int, z$out : int) {
  var this : struct where true;
  var y : int where InRange(y, System.Int32);
  var z : int where InRange(z, System.Int32);
  var stack1i : int;
  var stack0o : ref;
  entry: this := this$in; goto $$entry~e;
  $$entry~e: y := y$in; goto block5916;
  block5916: goto block5933;
  block5933: stack1i := y; goto $$block5933~b;
  $$block5933~b: z := stack1i; goto $$block5933~a;
  $$block5933~a: assert ($StructGet(this, St.x) == 8); goto block6018;
  block6018: this$out := this; goto $$block6018~b;
  $$block6018~b: y$out := y; goto $$block6018~a;
  $$block6018~a: z$out := z; return;
