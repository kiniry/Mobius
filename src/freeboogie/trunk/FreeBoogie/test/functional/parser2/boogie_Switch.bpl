...
const Switch : name;
function #Switch.M2$System.String$notnull$System.String$notnull($$unnamed~fd : <x>[ref, name]x, $$unnamed~fc : ref, $$unnamed~fb : ref, $$unnamed~fa : ref) returns ($$unnamed~fe : ref);
axiom (Switch <: Switch);
...
implementation Switch.FooString$System.String$notnull(this : ref, s$in : ref) {
  ...
  var stack0o : ref;
  var stack0b : bool;
  var local2 : ref where $Is(local2, System.String);
  entry: assume $IsNotNull(this, Switch); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: s := s$in; goto block1751;
  block1751: goto block1853;
  block1853: local1 := s; goto $$block1853~a;
  $$block1853~a: stack0o := null; goto true1853to2023, false1853to1870;
  true1853to2023: assume (local1 == stack0o); goto block2023;
  false1853to1870: assume (local1 != stack0o); goto block1870;
  block2023: return;
  block1870: stack0o := local1; goto $$block1870~b;
  $$block1870~b: call local2 := System.String.IsInterned$System.String$notnull(stack0o); goto $$block1870~a;
  $$block1870~a: stack0o := null; goto true1870to2023, false1870to1887;
  true1870to2023: assume (local2 == stack0o); goto block2023;
  false1870to1887: assume (local2 != stack0o); goto block1887;
  block1887: local1 := local2; goto $$block1887~a;
  $$block1887~a: stack0o := $stringLiteral0; goto true1887to1921, false1887to1904;
  true1887to1921: assume (local1 == stack0o); goto block1921;
  false1887to1904: assume (local1 != stack0o); goto block1904;
  block1921: assert #System.String.Equals$System.String$System.String(s, $stringLiteral0); goto block2006;
  block1904: goto block2023;
...
implementation Switch.M2$System.String$notnull$System.String$notnull(this : ref, s$in : ref, t$in : ref) returns ($result : ref) {
  var s : ref where $IsNotNull(s, System.String);
  var t : ref where $IsNotNull(t, System.String);
  var stack0o : ref;
  ...
  entry: assume $IsNotNull(this, Switch); goto $$entry~g;
  $$entry~g: assume ($Heap[this, $allocated] == true); goto $$entry~f;
  $$entry~f: s := s$in; goto $$entry~e;
  $$entry~e: t := t$in; goto block4233;
  block4233: goto block4437;
  block4437: assert #System.String.Equals$System.String$System.String(s, $stringLiteral0); goto block4522;
  block4522: assert (#System.String.Equals$System.String$System.String(s, t) == #System.String.Equals$System.String(s, t)); goto block4607;
  block4607: return.value := s; goto block4709;
  block4709: SS$Display.Return.Local := return.value; goto $$block4709~b;
  $$block4709~b: stack0o := return.value; goto $$block4709~a;
  $$block4709~a: $result := stack0o; return;
...
implementation Switch..ctor(this : ref) {
  entry: assume $IsNotNull(this, Switch); goto $$entry~i;
  $$entry~i: assume ($Heap[this, $allocated] == true); goto $$entry~h;
  $$entry~h: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block5202;
  block5202: goto block5219;
  block5219: assert (this != null); goto $$block5219~f;
  $$block5219~f: call System.Object..ctor(this); goto $$block5219~e;
  $$block5219~e: assert (this != null); goto $$block5219~d;
  $$block5219~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block5219~c;
  $$block5219~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Switch)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block5219~b;
  $$block5219~b: $Heap := $Heap[this, $inv := Switch]; goto $$block5219~a;
...
axiom (((forall heap : <x>[ref, name]x :: {heap[$stringLiteral0, $allocated]} (IsHeap(heap) ==> heap[$stringLiteral0, $allocated])) && $IsNotNull($stringLiteral0, System.String)) && ($StringLength($stringLiteral0) == 4));
