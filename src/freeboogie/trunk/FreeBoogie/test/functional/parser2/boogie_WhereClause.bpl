...
implementation C.foo(this : ref) {
  var x : ref where $Is(x, System.String);
  var stack0o : ref;
  var stack0b : bool;
  entry: assume $IsNotNull(this, C); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1462;
  block1462: goto block1479;
  block1479: x := null; goto block1496;
  block1496: goto block1564;
  block1564: stack0o := null; goto true1564to1768, false1564to1581;
  true1564to1768: assume (x == stack0o); goto block1768;
  false1564to1581: assume (x != stack0o); goto block1581;
  block1768: return;
  block1581: assert $IsNotNull(x, System.Object); goto block1666;
  block1666: assert $IsNotNull(x, System.String); goto block1751;
...
implementation C..ctor(this : ref) {
  ...
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2159;
  block2159: goto block2176;
  block2176: assert (this != null); goto $$block2176~f;
  $$block2176~f: call System.Object..ctor(this); goto $$block2176~e;
  $$block2176~e: assert (this != null); goto $$block2176~d;
  $$block2176~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2176~c;
  $$block2176~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == C)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2176~b;
  $$block2176~b: $Heap := $Heap[this, $inv := C]; goto $$block2176~a;
  $$block2176~a: assume IsHeap($Heap); return;
...
procedure D.foo$System.String$System.String.ptr$System.String.ptr(this : ref, x$in : ref where $Is(x$in, System.String), y$in : ref where $Is(y$in, System.String)) returns ($result : ref where $Is($result, System.String), y$out : ref where $Is(y$out, System.String), z$out : ref where $Is(z$out, System.String));
  ...
  requires ((y$in == null) || (((($Heap[y$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[y$in, $ownerRef], $inv] <: $Heap[y$in, $ownerFrame])) || ($Heap[$Heap[y$in, $ownerRef], $localinv] == $BaseClass($Heap[y$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[y$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[y$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
  free ensures $Is($result, System.String);
  free ensures ($Heap[y$out, $allocated] == true);
  free ensures $Is(y$out, System.String);
  free ensures ($Heap[z$out, $allocated] == true);
  free ensures $Is(z$out, System.String);
...
implementation D.foo$System.String$System.String.ptr$System.String.ptr(this : ref, x$in : ref, y$in : ref) returns ($result : ref, y$out : ref, z$out : ref) {
  var x : ref where $Is(x, System.String);
  var y : ref where $Is(y, System.String);
  var z : ref where $Is(z, System.String);
  var stack1o : ref;
  var stack0o : ref;
  var stack0b : bool;
  ...
  entry: assume $IsNotNull(this, D); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto $$entry~e;
  $$entry~e: x := x$in; goto $$entry~d;
  $$entry~d: y := y$in; goto block3128;
  block3128: goto block3145;
  block3145: stack1o := $stringLiteral2; goto $$block3145~a;
  $$block3145~a: z := stack1o; goto block3162;
  block3162: goto block3298;
  block3298: stack0o := null; goto true3298to3502, false3298to3315;
  true3298to3502: assume (x == stack0o); goto block3502;
  false3298to3315: assume (x != stack0o); goto block3315;
  block3502: stack0o := y; goto $$block3502~a;
  $$block3502~a: stack1o := null; goto true3502to3706, false3502to3519;
  block3315: assert $IsNotNull(x, System.Object); goto block3400;
  true3502to3706: assume (stack0o == stack1o); goto block3706;
  false3502to3519: assume (stack0o != stack1o); goto block3519;
  block3706: stack0o := z; goto $$block3706~a;
  $$block3706~a: stack1o := null; goto true3706to3910, false3706to3723;
  block3519: assert $IsNotNull(y, System.Object); goto block3604;
  true3706to3910: assume (stack0o == stack1o); goto block3910;
  false3706to3723: assume (stack0o != stack1o); goto block3723;
  block3910: z := x; goto $$block3910~a;
  $$block3910~a: return.value := x; goto block3927;
  block3723: assert $IsNotNull(z, System.Object); goto block3808;
  block3400: assert $IsNotNull(x, System.String); goto block3485;
  block3604: assert $IsNotNull(y, System.String); goto block3689;
  block3485: goto block3502;
  block3927: SS$Display.Return.Local := return.value; goto $$block3927~d;
  $$block3927~d: stack0o := return.value; goto $$block3927~c;
  $$block3927~c: y$out := y; goto $$block3927~b;
  $$block3927~b: z$out := z; goto $$block3927~a;
  $$block3927~a: $result := stack0o; return;
  block3808: assert $IsNotNull(z, System.String); goto block3893;
...
implementation D..ctor(this : ref) {
  entry: assume $IsNotNull(this, D); goto $$entry~h;
  $$entry~h: assume ($Heap[this, $allocated] == true); goto $$entry~g;
  $$entry~g: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block4964;
  block4964: goto block4981;
  block4981: assert (this != null); goto $$block4981~f;
  $$block4981~f: call System.Object..ctor(this); goto $$block4981~e;
  $$block4981~e: assert (this != null); goto $$block4981~d;
  $$block4981~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4981~c;
  $$block4981~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == D)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4981~b;
  $$block4981~b: $Heap := $Heap[this, $inv := D]; goto $$block4981~a;
  $$block4981~a: assume IsHeap($Heap); return;
