...
implementation Test.M(this : ref) {
  var $Heap$block2431$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, Test); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2414;
  block2414: goto block2431$LoopPreheader;
  block2431: assume (((forall $o : ref :: (($Heap$block2431$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block2431$LoopPreheader[$ot, $allocated] == true) && ($Heap$block2431$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block2431$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block2431$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block2431$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block2431~c;
  $$block2431~c: assume (forall $o : ref :: ((($Heap$block2431$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block2431$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block2431$LoopPreheader[$o, $allocated] != true))); goto $$block2431~b;
  $$block2431~b: assume (forall $o : ref :: ((($Heap$block2431$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block2431~a;
  $$block2431~a: assert (forall $o : ref :: ((($o != null) && ($Heap$block2431$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block2431$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block2431$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto block2448;
  block2448: goto block2431;
  block2431$LoopPreheader: $Heap$block2431$LoopPreheader := $Heap; goto block2431;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2703;
  block2703: goto block2720;
  block2720: goto block2737;
  block2737: assert (this != null); goto $$block2737~a;
  $$block2737~a: call System.Object..ctor(this); goto block2754;
  block2754: goto block2771;
  block2771: assert (this != null); goto $$block2771~d;
  $$block2771~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2771~c;
  $$block2771~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2771~b;
  $$block2771~b: $Heap := $Heap[this, $inv := Test]; goto $$block2771~a;
  $$block2771~a: assume IsHeap($Heap); return;
