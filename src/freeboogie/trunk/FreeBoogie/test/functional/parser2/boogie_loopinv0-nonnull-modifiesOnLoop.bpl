...
const TestEnumerable.field : name;
const F.X : name;
...
const F : name;
const TestEnumerable : name;
axiom !IsStaticField(F.X);
axiom IsDirectlyModifiableField(F.X);
axiom (DeclType(F.X) == F);
axiom (AsRangeField(F.X, System.Int32) == F.X);
axiom !IsStaticField(TestEnumerable.field);
axiom IsDirectlyModifiableField(TestEnumerable.field);
axiom (DeclType(TestEnumerable.field) == TestEnumerable);
axiom (AsRefField(TestEnumerable.field, F) == TestEnumerable.field);
axiom (F <: F);
...
implementation F.M(this : ref) {
  ...
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1513;
  block1513: goto block1581;
  block1581: local0 := this; goto $$block1581~j;
  $$block1581~j: stack0o := local0; goto $$block1581~i;
  $$block1581~i: havoc stack1s; goto $$block1581~h;
  $$block1581~h: assume $IsTokenForType(stack1s, F); goto $$block1581~g;
  $$block1581~g: stack1o := TypeObject(F); goto $$block1581~f;
  $$block1581~f: assert (stack0o != null); goto $$block1581~e;
  $$block1581~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: F)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block1581~d;
  $$block1581~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block1581~c;
  $$block1581~c: havoc temp0; goto $$block1581~b;
  $$block1581~b: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block1581~a;
  $$block1581~a: assume IsHeap($Heap); goto block1598;
  block1598: stack0i := 4; goto $$block1598~d;
  $$block1598~d: assert (this != null); goto $$block1598~c;
  $$block1598~c: assert (!($Heap[this, $inv] <: F) || ($Heap[this, $localinv] == System.Object)); goto $$block1598~b;
  $$block1598~b: $Heap := $Heap[this, F.X := stack0i]; goto $$block1598~a;
  $$block1598~a: assume IsHeap($Heap); goto block1649;
  block1649: stack0o := local0; goto $$block1649~h;
  $$block1649~h: havoc stack1s; goto $$block1649~g;
  $$block1649~g: assume $IsTokenForType(stack1s, F); goto $$block1649~f;
  $$block1649~f: stack1o := TypeObject(F); goto $$block1649~e;
  $$block1649~e: assert (stack0o != null); goto $$block1649~d;
  $$block1649~d: assert ($Heap[stack0o, $localinv] == System.Object); goto $$block1649~c;
  $$block1649~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == stack0o)) && ($Heap[$p, $ownerFrame] == F)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1649~b;
  $$block1649~b: $Heap := $Heap[stack0o, $localinv := $typeof(stack0o)]; goto $$block1649~a;
  $$block1649~a: assume IsHeap($Heap); goto block1615;
  block1615: return;
...
implementation F..ctor(this : ref) {
  var stack0i : int;
  entry: assume $IsNotNull(this, F); goto $$entry~d;
  ...
  $$entry~b: assume ($Heap[this, F.X] == 0); goto block2040;
  block2040: goto block2057;
  block2057: stack0i := 0; goto $$block2057~k;
  $$block2057~k: assert (this != null); goto $$block2057~j;
  $$block2057~j: assert (!($Heap[this, $inv] <: F) || ($Heap[this, $localinv] == System.Object)); goto $$block2057~i;
  $$block2057~i: $Heap := $Heap[this, F.X := stack0i]; goto $$block2057~h;
  $$block2057~h: assume IsHeap($Heap); goto $$block2057~g;
  $$block2057~g: assert (this != null); goto $$block2057~f;
  $$block2057~f: call System.Object..ctor(this); goto $$block2057~e;
  ...
  $$block2057~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == F)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2057~b;
  $$block2057~b: $Heap := $Heap[this, $inv := F]; goto $$block2057~a;
...
axiom (TestEnumerable <: TestEnumerable);
axiom ($BaseClass(TestEnumerable) == System.Object);
axiom ((TestEnumerable <: $BaseClass(TestEnumerable)) && (AsDirectSubClass(TestEnumerable, $BaseClass(TestEnumerable)) == TestEnumerable));
axiom (!$IsImmutable(TestEnumerable) && ($AsMutable(TestEnumerable) == TestEnumerable));
axiom (forall $U : name :: {($U <: TestEnumerable)} (($U <: TestEnumerable) ==> ($U == TestEnumerable)));
procedure TestEnumerable.Test1$F$notnull(this : ref, other$in : ref where $IsNotNull(other$in, F));
  ...
  free requires ($BeingConstructed == null);
  modifies $Heap;
  ensures ($Heap[this, TestEnumerable.field] != null);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(((($o != this) || ($f != TestEnumerable.field)) && (($o != other$in) || !($typeof(other$in) <: DeclType($f)))))) && old((($o != this) || ($f != $exposeVersion)))) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: (((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv])) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode]));
  

implementation TestEnumerable.Test1$F$notnull(this : ref, other$in : ref) {
  var other : ref where $IsNotNull(other, F);
  var local1 : ref where $Is(local1, TestEnumerable);
  var stack0o : ref;
  var stack1s : struct;
  var stack1o : ref;
  var temp0 : exposeVersionType;
  ...
  entry: assume $IsNotNull(this, TestEnumerable); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto $$entry~e;
  $$entry~e: other := other$in; goto block2550;
  block2550: goto block2703;
  block2703: local1 := this; goto $$block2703~j;
  $$block2703~j: stack0o := local1; goto $$block2703~i;
  $$block2703~i: havoc stack1s; goto $$block2703~h;
  $$block2703~h: assume $IsTokenForType(stack1s, TestEnumerable); goto $$block2703~g;
  $$block2703~g: stack1o := TypeObject(TestEnumerable); goto $$block2703~f;
  $$block2703~f: assert (stack0o != null); goto $$block2703~e;
  $$block2703~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: TestEnumerable)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block2703~d;
  $$block2703~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block2703~c;
  ...
  block2720: havoc stack50000o; goto $$block2720~j;
  $$block2720~j: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == F)); goto $$block2720~i;
  $$block2720~i: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block2720~h;
  $$block2720~h: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block2720~g;
  $$block2720~g: assert (stack50000o != null); goto $$block2720~f;
  $$block2720~f: call F..ctor(stack50000o); goto $$block2720~e;
  $$block2720~e: stack0o := stack50000o; goto $$block2720~d;
  $$block2720~d: assert (this != null); goto $$block2720~c;
  $$block2720~c: assert (!($Heap[this, $inv] <: TestEnumerable) || ($Heap[this, $localinv] == System.Object)); goto $$block2720~b;
  $$block2720~b: $Heap := $Heap[this, TestEnumerable.field := stack0o]; goto $$block2720~a;
  $$block2720~a: assume IsHeap($Heap); goto block2907;
  block2907: stack0o := local1; goto $$block2907~h;
  $$block2907~h: havoc stack1s; goto $$block2907~g;
  $$block2907~g: assume $IsTokenForType(stack1s, TestEnumerable); goto $$block2907~f;
  $$block2907~f: stack1o := TypeObject(TestEnumerable); goto $$block2907~e;
  $$block2907~e: assert (stack0o != null); goto $$block2907~d;
  $$block2907~d: assert ($Heap[stack0o, $localinv] == System.Object); goto $$block2907~c;
  $$block2907~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == stack0o)) && ($Heap[$p, $ownerFrame] == TestEnumerable)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2907~b;
  $$block2907~b: $Heap := $Heap[stack0o, $localinv := $typeof(stack0o)]; goto $$block2907~a;
  $$block2907~a: assume IsHeap($Heap); goto block2737;
  block2737: i := 0; goto block2754$LoopPreheader;
  block2754: assume (((forall $o : ref :: (($Heap$block2754$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block2754$LoopPreheader[$ot, $allocated] == true) && ($Heap$block2754$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block2754$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block2754$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block2754$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block2754~e;
  $$block2754~e: assume (forall $o : ref :: ((($Heap$block2754$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block2754$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block2754$LoopPreheader[$o, $allocated] != true))); goto $$block2754~d;
  $$block2754~d: assume (forall $o : ref :: ((($Heap$block2754$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block2754~c;
  $$block2754~c: assert (forall $o : ref :: ((($o != null) && ($Heap$block2754$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block2754$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block2754$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block2754~b;
  $$block2754~b: assert <$$tv~ah>(forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(((($o != this) || ($f != TestEnumerable.field)) && (($o != other) || !($typeof(other) <: DeclType($f)))))) && old((($o != this) || ($f != $exposeVersion)))) ==> ($Heap$block2754$LoopPreheader[$o, $f] == $Heap[$o, $f]))); goto $$block2754~a;
  $$block2754~a: stack0i := 10; goto true2754to2788, false2754to2771;
  true2754to2788: assume (i >= stack0i); goto block2788;
  false2754to2771: assume (i < stack0i); goto block2771;
  block2788: goto block2873;
  block2771: assert (other != null); goto $$block2771~f;
  $$block2771~f: call F.M(other); goto $$block2771~e;
  $$block2771~e: local3 := i; goto $$block2771~d;
  $$block2771~d: stack0i := 1; goto $$block2771~c;
  $$block2771~c: stack0i := (local3 + stack0i); goto $$block2771~b;
  $$block2771~b: i := stack0i; goto $$block2771~a;
  $$block2771~a: stack0i := local3; goto block2754;
  block2873: return;
  block2754$LoopPreheader: $Heap$block2754$LoopPreheader := $Heap; goto block2754;
  
}

procedure TestEnumerable..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == TestEnumerable)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(TestEnumerable <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation TestEnumerable..ctor(this : ref) {
  entry: assume $IsNotNull(this, TestEnumerable); goto $$entry~i;
  ...
  $$entry~g: assume ($Heap[this, TestEnumerable.field] == null); goto block3604;
  block3604: goto block3621;
  block3621: assert (this != null); goto $$block3621~f;
  $$block3621~f: call System.Object..ctor(this); goto $$block3621~e;
  $$block3621~e: assert (this != null); goto $$block3621~d;
  $$block3621~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3621~c;
  $$block3621~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == TestEnumerable)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3621~b;
  $$block3621~b: $Heap := $Heap[this, $inv := TestEnumerable]; goto $$block3621~a;
