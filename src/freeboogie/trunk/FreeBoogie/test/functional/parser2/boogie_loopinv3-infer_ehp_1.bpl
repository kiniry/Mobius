...
const Foreach : name;
axiom !IsStaticField(Foreach.x);
axiom IsDirectlyModifiableField(Foreach.x);
axiom (DeclType(Foreach.x) == Foreach);
axiom (AsRangeField(Foreach.x, System.Int32) == Foreach.x);
axiom (Foreach <: Foreach);
axiom ($BaseClass(Foreach) == System.Object);
axiom ((Foreach <: $BaseClass(Foreach)) && (AsDirectSubClass(Foreach, $BaseClass(Foreach)) == Foreach));
axiom (!$IsImmutable(Foreach) && ($AsMutable(Foreach) == Foreach));
axiom (forall $U : name :: {($U <: Foreach)} (($U <: Foreach) ==> ($U == Foreach)));
procedure Foreach.M$System.Int32.array$notnull(this : ref, a$in : ref where $IsNotNull(a$in, ValueArray(System.Int32, 1)));
  ...
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old((($o != this) || !(Foreach <: DeclType($f))))) && old((($o != this) || ($f != $exposeVersion)))) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: (((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv])) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode]));
  

implementation Foreach.M$System.Int32.array$notnull(this : ref, a$in : ref) {
  var a : ref where $IsNotNull(a, ValueArray(System.Int32, 1));
  var local1 : ref where $Is(local1, Foreach);
  var stack0o : ref;
  var stack1s : struct;
  var stack1o : ref;
  ...
  var local3 : ref where $Is(local3, ValueArray(System.Int32, 1));
  var stack0b : bool;
  var local4 : int where InRange(local4, System.Int32);
  var foreachIndex^.54267293 : int where InRange(foreachIndex^.54267293, System.Int32);
  var stack1i : int;
  var local6 : int where InRange(local6, System.Int32);
  var k : int where InRange(k, System.Int32);
  var $Heap$block1938$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, Foreach); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: a := a$in; goto block1717;
  block1717: goto block1870;
  block1870: local1 := this; goto $$block1870~j;
  $$block1870~j: stack0o := local1; goto $$block1870~i;
  $$block1870~i: havoc stack1s; goto $$block1870~h;
  $$block1870~h: assume $IsTokenForType(stack1s, Foreach); goto $$block1870~g;
  $$block1870~g: stack1o := TypeObject(Foreach); goto $$block1870~f;
  $$block1870~f: assert (stack0o != null); goto $$block1870~e;
  $$block1870~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: Foreach)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block1870~d;
  $$block1870~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block1870~c;
  $$block1870~c: havoc temp0; goto $$block1870~b;
  $$block1870~b: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block1870~a;
  $$block1870~a: assume IsHeap($Heap); goto block1887;
  block1887: stack0i := 42; goto $$block1887~e;
  $$block1887~e: assert (this != null); goto $$block1887~d;
  $$block1887~d: havoc temp1; goto $$block1887~c;
  $$block1887~c: $Heap := $Heap[this, $exposeVersion := temp1]; goto $$block1887~b;
  $$block1887~b: $Heap := $Heap[this, Foreach.x := stack0i]; goto $$block1887~a;
  $$block1887~a: assume IsHeap($Heap); goto block2091;
  block2091: stack0o := local1; goto $$block2091~h;
  $$block2091~h: havoc stack1s; goto $$block2091~g;
  $$block2091~g: assume $IsTokenForType(stack1s, Foreach); goto $$block2091~f;
  $$block2091~f: stack1o := TypeObject(Foreach); goto $$block2091~e;
  $$block2091~e: assert (stack0o != null); goto $$block2091~d;
  $$block2091~d: assert ($Heap[stack0o, $localinv] == System.Object); goto $$block2091~c;
  $$block2091~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == stack0o)) && ($Heap[$p, $ownerFrame] == Foreach)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2091~b;
  $$block2091~b: $Heap := $Heap[stack0o, $localinv := $typeof(stack0o)]; goto $$block2091~a;
  $$block2091~a: assume IsHeap($Heap); goto block1904;
  block1904: sum := 0; goto $$block1904~b;
  $$block1904~b: local3 := a; goto $$block1904~a;
  $$block1904~a: stack0o := local3; goto true1904to1972, false1904to1921;
  true1904to1972: assume (stack0o == null); goto block1972;
  false1904to1921: assume (stack0o != null); goto block1921;
  block1972: assert ($Heap[this, Foreach.x] == 42); goto block2057;
  block1921: stack0o := local3; goto $$block1921~c;
  $$block1921~c: stack0i := $Length(stack0o); goto $$block1921~b;
  $$block1921~b: local4 := stack0i; goto $$block1921~a;
  $$block1921~a: foreachIndex^.54267293 := 0; goto block1938$LoopPreheader;
  block1938: assume (((forall $o : ref :: (($Heap$block1938$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1938$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1938$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1938$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1938$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1938$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1938~d;
  $$block1938~d: assume (forall $o : ref :: ((($Heap$block1938$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1938$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1938$LoopPreheader[$o, $allocated] != true))); goto $$block1938~c;
  $$block1938~c: assume (forall $o : ref :: ((($Heap$block1938$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1938~b;
  $$block1938~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block1938$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1938$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1938$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block1938~a;
  $$block1938~a: assert (foreachIndex^.54267293 >= 0); goto true1938to1972, false1938to1955;
  true1938to1972: assume (foreachIndex^.54267293 >= local4); goto block1972;
  false1938to1955: assume (foreachIndex^.54267293 < local4); goto block1955;
  block1955: stack0o := local3; goto $$block1955~k;
  $$block1955~k: stack1i := foreachIndex^.54267293; goto $$block1955~j;
  $$block1955~j: assert (stack0o != null); goto $$block1955~i;
  $$block1955~i: assert (0 <= stack1i); goto $$block1955~h;
  $$block1955~h: assert (stack1i < $Length(stack0o)); goto $$block1955~g;
  $$block1955~g: local6 := ValueArrayGet($Heap[stack0o, $elements], stack1i); goto $$block1955~f;
  $$block1955~f: stack0i := 1; goto $$block1955~e;
  $$block1955~e: stack0i := (foreachIndex^.54267293 + stack0i); goto $$block1955~d;
  $$block1955~d: foreachIndex^.54267293 := stack0i; goto $$block1955~c;
  $$block1955~c: k := local6; goto $$block1955~b;
  $$block1955~b: stack0i := (sum + k); goto $$block1955~a;
  $$block1955~a: sum := stack0i; goto block1938;
  block2057: return;
  block1938$LoopPreheader: $Heap$block1938$LoopPreheader := $Heap; goto block1938;
...
procedure Foreach..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Foreach)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Foreach <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation Foreach..ctor(this : ref) {
  entry: assume $IsNotNull(this, Foreach); goto $$entry~e;
  ...
  $$entry~c: assume ($Heap[this, Foreach.x] == 0); goto block2992;
  block2992: goto block3009;
  block3009: assert (this != null); goto $$block3009~f;
  $$block3009~f: call System.Object..ctor(this); goto $$block3009~e;
  $$block3009~e: assert (this != null); goto $$block3009~d;
  $$block3009~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3009~c;
  $$block3009~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Foreach)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3009~b;
  $$block3009~b: $Heap := $Heap[this, $inv := Foreach]; goto $$block3009~a;
  $$block3009~a: assume IsHeap($Heap); return;
