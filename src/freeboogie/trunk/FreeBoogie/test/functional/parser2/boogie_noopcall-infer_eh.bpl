...
axiom !IsStaticField(NoOpCall.X);
axiom IsDirectlyModifiableField(NoOpCall.X);
axiom (DeclType(NoOpCall.X) == NoOpCall);
axiom (AsRangeField(NoOpCall.X, System.Int32) == NoOpCall.X);
axiom (NoOpCall <: NoOpCall);
axiom ($BaseClass(NoOpCall) == System.Object);
axiom ((NoOpCall <: $BaseClass(NoOpCall)) && (AsDirectSubClass(NoOpCall, $BaseClass(NoOpCall)) == NoOpCall));
axiom (!$IsImmutable(NoOpCall) && ($AsMutable(NoOpCall) == NoOpCall));
axiom (forall $U : name :: {($U <: NoOpCall)} (($U <: NoOpCall) ==> ($U == NoOpCall)));
procedure NoOpCall.NoOp(this : ref);
...
implementation NoOpCall.NoOp(this : ref) {
  entry: assume $IsNotNull(this, NoOpCall); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1156;
  block1156: goto block1173;
  block1173: return;
  
}

procedure NoOpCall.Method(this : ref);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  ensures ($Heap[this, NoOpCall.X] == 42);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) && old((($o != this) || ($f != $exposeVersion)))) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
...
implementation NoOpCall.Method(this : ref) {
  var local0 : ref where $Is(local0, NoOpCall);
  var stack0o : ref;
  var stack1s : struct;
  var stack1o : ref;
  var temp0 : exposeVersionType;
  var stack0i : int;
  entry: assume $IsNotNull(this, NoOpCall); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto block1768;
  block1768: goto block1836;
  block1836: local0 := this; goto $$block1836~j;
  $$block1836~j: stack0o := local0; goto $$block1836~i;
  $$block1836~i: havoc stack1s; goto $$block1836~h;
  $$block1836~h: assume $IsTokenForType(stack1s, NoOpCall); goto $$block1836~g;
  $$block1836~g: stack1o := TypeObject(NoOpCall); goto $$block1836~f;
  $$block1836~f: assert (stack0o != null); goto $$block1836~e;
  $$block1836~e: assert ((((($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame])) || ($Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame]))) && ($Heap[stack0o, $inv] <: NoOpCall)) && ($Heap[stack0o, $localinv] == $typeof(stack0o))); goto $$block1836~d;
  $$block1836~d: $Heap := $Heap[stack0o, $localinv := System.Object]; goto $$block1836~c;
  $$block1836~c: havoc temp0; goto $$block1836~b;
  $$block1836~b: $Heap := $Heap[stack0o, $exposeVersion := temp0]; goto $$block1836~a;
  $$block1836~a: assume IsHeap($Heap); goto block1853;
  block1853: stack0i := 42; goto $$block1853~d;
  $$block1853~d: assert (this != null); goto $$block1853~c;
  $$block1853~c: assert (!($Heap[this, $inv] <: NoOpCall) || ($Heap[this, $localinv] == System.Object)); goto $$block1853~b;
  $$block1853~b: $Heap := $Heap[this, NoOpCall.X := stack0i]; goto $$block1853~a;
  $$block1853~a: assume IsHeap($Heap); goto block2006;
  block2006: stack0o := local0; goto $$block2006~h;
  $$block2006~h: havoc stack1s; goto $$block2006~g;
  $$block2006~g: assume $IsTokenForType(stack1s, NoOpCall); goto $$block2006~f;
  $$block2006~f: stack1o := TypeObject(NoOpCall); goto $$block2006~e;
  $$block2006~e: assert (stack0o != null); goto $$block2006~d;
  $$block2006~d: assert ($Heap[stack0o, $localinv] == System.Object); goto $$block2006~c;
  $$block2006~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == stack0o)) && ($Heap[$p, $ownerFrame] == NoOpCall)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2006~b;
  $$block2006~b: $Heap := $Heap[stack0o, $localinv := $typeof(stack0o)]; goto $$block2006~a;
  $$block2006~a: assume IsHeap($Heap); goto block1870;
  block1870: assert (this != null); goto $$block1870~a;
  $$block1870~a: call NoOpCall.NoOp(this); goto block1972;
  block1972: return;
...
procedure NoOpCall..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == NoOpCall)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(NoOpCall <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation NoOpCall..ctor(this : ref) {
  var stack0i : int;
  entry: assume $IsNotNull(this, NoOpCall); goto $$entry~e;
  ...
  $$entry~c: assume ($Heap[this, NoOpCall.X] == 0); goto block2465;
  block2465: goto block2482;
  block2482: stack0i := 0; goto $$block2482~k;
  $$block2482~k: assert (this != null); goto $$block2482~j;
  $$block2482~j: assert (!($Heap[this, $inv] <: NoOpCall) || ($Heap[this, $localinv] == System.Object)); goto $$block2482~i;
  $$block2482~i: $Heap := $Heap[this, NoOpCall.X := stack0i]; goto $$block2482~h;
  $$block2482~h: assume IsHeap($Heap); goto $$block2482~g;
  $$block2482~g: assert (this != null); goto $$block2482~f;
  $$block2482~f: call System.Object..ctor(this); goto $$block2482~e;
  $$block2482~e: assert (this != null); goto $$block2482~d;
  $$block2482~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2482~c;
  $$block2482~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == NoOpCall)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2482~b;
  $$block2482~b: $Heap := $Heap[this, $inv := NoOpCall]; goto $$block2482~a;
