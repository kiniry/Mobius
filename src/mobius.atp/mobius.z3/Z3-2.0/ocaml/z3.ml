...
external mk_forall_const : context -> int -> int -> app -> int -> pattern -> ast -> ast
	= "camlidl_z3_Z3_mk_forall_const_bytecode" "camlidl_z3_Z3_mk_forall_const"

external mk_exists_const : context -> int -> int -> app -> int -> pattern -> ast -> ast
	= "camlidl_z3_Z3_mk_exists_const_bytecode" "camlidl_z3_Z3_mk_exists_const"
