...
value camlidl_z3_Z3_mk_forall_const_bytecode(value * argv, int argn)
{
  return camlidl_z3_Z3_mk_forall_const(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6]);
}
...
value camlidl_z3_Z3_mk_exists_const_bytecode(value * argv, int argn)
{
  return camlidl_z3_Z3_mk_exists_const(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6]);
}
