...
public interface IInstructionVisitor {
  ...
  void visitLLoadInstruction(LLoadInstruction insn);

  void visitALoadInstruction(ALoadInstruction insn);

  void visitIStoreInstruction(IStoreInstruction insn);

  void visitLStoreInstruction(LStoreInstruction insn);

  void visitAStoreInstruction(AStoreInstruction insn);

  void visitVConstantInstruction(VConstantInstruction insn);
  ...
  void visitLBinArithInstruction(LBinArithInstruction insn);

  void visitIBitwiseInstruction(IBitwiseInstruction insn);

  void visitLBitwiseInstruction(LBitwiseInstruction insn);

  void visitINegInstruction(INegInstruction insn);

  void visitLNegInstruction(LNegInstruction insn);
  ...
  void visitLCmpInstruction(LCmpInstruction insn);
  ...
  void visitLReturnInstruction(LReturnInstruction insn);
