...
//	public static final boolean SIMPLIFY = true;
	...
	private void setPriority() {
		...
		case Connector.NOTEQUIV: priority = 14; break;
		case Connector.IMPLIES: priority = 13; break;
		}
	}

	public Formula(Expression f1, Expression f2, byte conn) {
		super(f1, f2);
		connector = conn;
		setPriority();
	}
...
////	}
	...
	public String printCode1(BMLConfig conf) {
		...
		if (connector == Connector.NOTEQUIV) {
			con = " <=!=> ";
		}
		Expression[] subformulas = getSubExpressions();
