/*
 * @(#)$Id: ThisLiteralAST.java,v 1.2 2004/04/02 05:48:48 james Exp $
 *
...
/**
 * An AST node that represents the literal <code>this</code>
 *
...
public final class ThisLiteralAST extends IdentifierAST {
    ...
    /**
     * Create a new literal <code>this</code> AST
     *
	...
	return typeAST.retrieveType();	// JLS 15.8.3
    }
