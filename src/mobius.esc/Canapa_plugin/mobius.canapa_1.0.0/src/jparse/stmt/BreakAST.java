/*
 * @(#)$Id: BreakAST.java,v 1.2 2004/04/02 05:48:48 james Exp $
 *
...
public final class BreakAST extends StatementAST {
	...
	if (maybeLabel instanceof IdentifierAST) {
	    ...
	    // There is no label, so the closest inclosing for, while,
	    // do-while, or switch statement is the target of this break.
	    // Actually, the break will take us to the statement *following*
	    // that, so move the pointer ahead.  If this makes control[0]
	    // null, that means that the break will terminate the method.
