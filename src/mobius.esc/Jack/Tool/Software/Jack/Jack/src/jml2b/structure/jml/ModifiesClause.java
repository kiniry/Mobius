...
public abstract class ModifiesClause
	...
	/**
	 * Returns the proof modified in manner to take into account the modifies
	 * clause of a called method.
	 * @param s current proof
	 * @return the proof where modified variable have been replaced with new
	 * variable and where properties concerning those new variables have been
	 * added in hypothesis.
	 * @throws PogException
	 **/
	public abstract Proofs modifies(
		IJml2bConfiguration config,
		IModifiesField m,
		Proofs s)
		throws PogException;
	...
	/**
	 * Returns the lemmas concerning the proof of the modifies clause for the
	 * current method.
	 * @param config The current configuration
	 * @param fields set of modifiable fields.
	 * @param nonModifiedFields The set of formula representing the name of the 
	 * non modified fields.
	 * @param nonModifiedxxxElements The array of Formula representing the
	 * name of non modified xxxelements function.
	 * @return goals corresponding to the fact that non declared as modified 
	 * field are not modifies (<code>a == \old(a)</code>) and that partially 
	 * declared as modified fields are only partially modified.
	 * @throws PogException
	 **/
	public abstract SimpleLemma modifiesLemmas(
		IJml2bConfiguration config,
		Vector fields,
