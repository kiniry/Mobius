...
public class TTypeExp extends Expression {
	...
	/**
	 * Substitute in the normal behaviour proof the resulting temporary 
	...
	public Proofs wp(
		...
		return ((Proofs) normalBehaviour.clone()).sub(
			new SubTmpVar(result, exprToForm(config).getFormula()));
	}
