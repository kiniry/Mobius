...
public class SubTypeofSet extends SubTypeof {
     ...
     **/
    public SubTypeofSet(IJml2bConfiguration config, IJmlFile fi, JpoInputStream s)
    ...
    public void save(IJml2bConfiguration config, JpoOutputStream s, IJmlFile jf) throws IOException {
        s.writeByte(jml2b.pog.substitution.Substitution.TYPEOF_SET);
    ...
    public String getInfo() {
        return "typeof <- " + getF().toLangDefault(3) + " " + getT().toLangDefault(6);
    }
}
