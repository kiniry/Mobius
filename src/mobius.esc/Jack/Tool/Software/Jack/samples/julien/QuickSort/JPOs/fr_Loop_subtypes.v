...
Lemma subtypes_160: forall c: Types, subtypes c (class c_fr_Loop) -> subtypes c (class c_Object).
Proof (fun (c:Types) (h1: subtypes c (class c_fr_Loop)) => 
        subtypes_trans (class c_Object) (class c_fr_Loop)  I c h1).
