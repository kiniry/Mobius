...
Open Scope J_Scope.
Section JackProof.
Variable intelements_17 : REFERENCES -> t_int.
...
Variable newObject_24 : REFERENCES.
...
Hypothesis req1 : ((((f_tab this <> null /\ 0 <= l_lo) /\
            ...
            true = true.
Hypothesis hyp1 : ~ instances newObject_24.
Hypothesis hyp2 : newObject_24 <> null.
Hypothesis hyp3 : f_tab this <> null.
Hypothesis hyp4 : ~ interval 0 (j_sub (arraylength (f_tab this)) 1) l_left40_1.
...
Hypothesis hyp7 : l_left40_1 < l_right40_2.
Hypothesis hyp8 : l_left40_2 < l_right40_2.
Hypothesis hyp9 : f_tab this <> null.
Hypothesis hyp10 : ((l_lo <= l_left40_1 /\ l_left40_2 <= l_left40_1) /\
