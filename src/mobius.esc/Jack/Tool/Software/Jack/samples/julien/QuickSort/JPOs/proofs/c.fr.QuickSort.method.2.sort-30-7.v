...
Hypothesis hyp20 : (((l_left40_1 <= l_right40_1 /\ l_right40_1 <= l_right40_2) /\
               l_right40_1 <= l_hi) /\
              (forall l_k69 : t_int,
...
Hypothesis hyp21 : ((l_lo <= l_left40_1 /\ l_left40_2 <= l_left40_1) /\
              l_left40_1 <= l_right40_2) /\
             (forall l_k62 : t_int,
              l_lo <= l_k62 /\ l_k62 < l_left40_1 ->
              intelements_19 (f_tab this) l_k62 <=
              intelements (f_tab this) l_hi).
Hypothesis hyp22 : (((((l_lo <= l_left40_2 /\ l_left40_2 <= l_right40_2) /\
                 l_right40_2 <= l_hi) /\
                (forall l_m : t_int,
...
startJack.
subst.
destruct (classic (l_i = l_right40_2)).
subst; rewrite H21.
elim (H4 l_right40_1); [intros x [[h1 h2] h3]| split; j_omega].
exists x...
destruct (classic (l_i = l_right40_1)).
subst; rewrite H22.
elim (H4 l_right40_2); [intros x [[h1 h2] h3]| split; j_omega].
exists x...
rewrite hyp3...
rewrite hyp9...
