...
startJack.
subst.
assert(l_right40_3 <= l_lo); j_omega.
destrJlt(l_right40_3 <= l_lo); subst.
elim (H23 l_i106); repeat split; j_omega.
intros.
destruct H24.
rewrite <- H25.
elim (H16 x); repeat split; j_omega.
intros.
exists x0; repeat split; j_omega.
intros.
destruct H27.
rewrite <- H30.
apply refl_equal.
