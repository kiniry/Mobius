 ...
 ** $Id: ImportDeclVec.j 1928 2006-05-19 12:43:10Z chalin $
 **
 ** DO NOT EDIT!!<p>
 **/
 ...
 *
 *
 * By Default, ImportDeclVec's may not contain nulls.  If the ability to
...
public class  ImportDeclVec {
    ...
    private /*@ spec_public non_null*/ ImportDecl[] elements;
    //@ invariant (\forall int i; (0<=i && i<count) ==> elements[i]!=null);
    //@ invariant \typeof(elements) == \type(ImportDecl[]);
    ...
    //@ ensures \result!=null;
    //@ ensures \fresh(\result);
    public static ImportDeclVec make(Vector vec) {
	int sz = vec.size();
    ...
    public static ImportDeclVec popFromStackVector(/*@non_null*/ StackVector s) {
