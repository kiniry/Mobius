...
public class RequiresModifierPragma extends ModifierPragma {
    ...
    protected RequiresModifierPragma(/* @ non_null @ */ExprVec expressions,
        int loc) {
    ...
    public final/* @non_null */String toString() {
        return "[RequiresModifierPragma" + " expressions = " + this.expressions
            + " loc = " + this.loc + "]";
    }
    ...
    public final void accept(javafe.ast.Visitor v) {
        if (v instanceof Visitor)
            ((Visitor) v).visitRequiresModifierPragma(this);
    }

    public final Object accept(javafe.ast.VisitorArgResult v, Object o) {
        if (v instanceof VisitorArgResult)
            return ((VisitorArgResult) v).visitRequiresModifierPragma(this, o);
        else
            return null;
    }
    ...
    // @ ensures \result != null;
    public static RequiresModifierPragma make(
