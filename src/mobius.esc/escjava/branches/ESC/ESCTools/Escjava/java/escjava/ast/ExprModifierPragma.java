...
// Generated boilerplate constructors:
  ...
  /**
   ** Construct a raw ExprModifierPragma whose class invariant(s) have not
   ** yet been established.  It is the caller's job to
   ** initialize the returned node's fields so that any
   ** class invariants hold.
   **/
  //@ requires I_will_establish_invariants_afterwards
  protected ExprModifierPragma() {}    //@ nowarn Invariant,NonNullInit
...
// Generated boilerplate methods:
  ...
  public final void accept(javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitExprModifierPragma(this);
  }

  public final Object accept(javafe.ast.VisitorArgResult v, Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitExprModifierPragma(this, o); else return null;
  }
  ...
  //@ ensures \result!=null
  public static ExprModifierPragma make(int tag, /*@non_null*/ Expr expr, int loc) {
     //@ set I_will_establish_invariants_afterwards = true
     ExprModifierPragma result = new ExprModifierPragma();
     result.tag = tag;
     result.expr = expr;
     result.loc = loc;
     return result;
