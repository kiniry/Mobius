 ...
 ** been encountered, forcing all further processing to be abandoned.<p>
 ** 
 ** The cause and existence of a fatal error will already have been
 ** reported to the user by the time the <code>FatalError</code> has
 ** been thrown.<p>
 **
 ** <code>FatalError</code> must be caught by the top level of the
 ...
 ** anywhere else only for local cleanup purposes.<p>
 **/
