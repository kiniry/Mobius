...
class PragmaInstr extends Instr {
  ...
  static public final int PREVLINECOMMAOK = 5;
  //@ invariant BEFORE <= placement && placement <= PREVLINECOMMAOK;
  ...
  //@ requires BEFORE <= placement && placement <= PREVLINECOMMAOK;
  ...
  //@ ensures BEFORE <= RES && RES <= NEXTLINE;
  ...
  static int indexOfNonWhite(/*@ non_null */ String s, int start,
    ...
    /*@ defined_if inTraditionalComment || inSingleLineComment */
