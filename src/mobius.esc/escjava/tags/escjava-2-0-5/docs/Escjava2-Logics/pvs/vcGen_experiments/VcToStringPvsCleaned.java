...
public class VcToStringPvsCleaned {
  ...
  public static void compute(/*@  non_null */Expr e,
      ...
      VcToStringPvsCleaned vts = new VcToStringPvsCleaned();
...
//        */
      ...
      */
	  ...
	  while(i.hasNext() && j.hasNext()){
		  ...
		  System.out.println("VcToStringPvsCleaned::add2Decl *** error *** "+ex);
	      }
  ...
  protected static/*@  non_null */Hashtable integralPrintNames;
    ...
    protected VcToStringPvsCleaned() {}
  ...
  protected void printFormula(/*@ non_null */PrintStream out, Hashtable subst,
	...
	//++
// 	System.out.println("VcToStringPvsCleaned::reallyPrintFormula");
	//++
...
// 	    out.print(")");
	...
	case TagConstants.METHODCALL: {
	    ...
	    //++
//	    System.out.println("VcToStringPvsCleaned::reallyPrintFormula::MethodCall");
	    //++
  ...
  protected boolean insideNoPats = false;
	...
	//++
// 	System.out.println("VcToStringPvsCleaned::printTerm");
	//++
...
// 		out.print("real_to_S("+s+")");
	...
	case TagConstants.VARIABLEACCESS: {
	    ...
	    //++
//	    System.out.println("VcToStringPvsCleaned::printTerm::VariableAccess");
	    //++
...
static private int add2Decl(String s){
	...
	while(i.hasNext()){
		...
		System.out.println("VcToStringPvsCleaned::add2Decl *** error *** "+e);
	    }
...
//	System.out.println("Adding "+s+" to the listOfDecl");
	...
	while(i.hasNext()){
		...
		System.out.println("VcToStringPvsCleaned::add2AdditionalDecl *** error *** "+e);
	    }
