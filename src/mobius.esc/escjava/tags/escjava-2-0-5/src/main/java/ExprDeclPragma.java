...
// Generated boilerplate constructors:
  ...
  protected ExprDeclPragma(int tag, /*@ non_null @*/ Expr expr, int modifiers, int loc) {
     this.tag = tag;
     this.expr = expr;
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ExprDeclPragma make(int tag, /*@ non_null @*/ Expr expr, int modifiers, int loc) {
     ExprDeclPragma result = new ExprDeclPragma(tag, expr, modifiers, loc);
     return result;
  }
}
