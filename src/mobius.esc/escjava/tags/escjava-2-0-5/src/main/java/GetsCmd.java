...
// Generated boilerplate constructors:
   ...
   protected GetsCmd(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs) {
      super(v, rhs);
   }
...
// Generated boilerplate methods:
   ...
   //@ ensures \result != null;
   public static /*@ non_null */ GetsCmd make(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs) {
      GetsCmd result = new GetsCmd(v, rhs);
      return result;
   }
}
