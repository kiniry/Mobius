...
// Generated boilerplate constructors:
  ...
  //@ ensures this.positive == positive;
  //@ ensures this.label == label;
  //@ ensures this.expr == expr;
  protected LabelExpr(int sloc, int eloc, boolean positive, /*@ non_null @*/ Identifier label, /*@ non_null @*/ Expr expr) {
     super(sloc, eloc);
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ LabelExpr make(int sloc, int eloc, boolean positive, /*@ non_null @*/ Identifier label, /*@ non_null @*/ Expr expr) {
     LabelExpr result = new LabelExpr(sloc, eloc, positive, label, expr);
     return result;
  }
}
