...
// Generated boilerplate constructors:
  ...
  protected NotSpecifiedExpr(int loc) {
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.NOTSPECIFIEDEXPR;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitNotSpecifiedExpr(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitNotSpecifiedExpr(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ NotSpecifiedExpr make(int loc) {
     NotSpecifiedExpr result = new NotSpecifiedExpr(loc);
     return result;
  }
}
