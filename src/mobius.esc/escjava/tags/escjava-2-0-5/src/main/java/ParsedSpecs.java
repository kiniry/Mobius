...
{
  public /*@ non_null @*/ RoutineDecl decl;

  public /*@ non_null @*/ ParsedRoutineSpecs specs;
...
// Generated boilerplate constructors:
  ...
  //@ ensures this.specs == specs;
  protected ParsedSpecs(/*@ non_null @*/ RoutineDecl decl, /*@ non_null @*/ ParsedRoutineSpecs specs) {
     this.decl = decl;
     this.specs = specs;
  }
...
// Generated boilerplate methods:
  ...
  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitParsedSpecs(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitParsedSpecs(this, o); else return null;
  }

  public void check() {
     if (this.decl == null) throw new RuntimeException();
     if (this.specs == null) throw new RuntimeException();
  }

  //@ ensures \result != null;
  public static /*@ non_null */ ParsedSpecs make(/*@ non_null @*/ RoutineDecl decl, /*@ non_null @*/ ParsedRoutineSpecs specs) {
     ParsedSpecs result = new ParsedSpecs(decl, specs);
     return result;
  }
}
