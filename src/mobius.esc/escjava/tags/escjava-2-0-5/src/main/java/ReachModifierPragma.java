...
public class ReachModifierPragma extends ModifierPragma
{
    ...
    public /*@ non_null @*/ IdentifierVec storerefs;
...
// Generated boilerplate constructors:
    ...
    protected ReachModifierPragma(/*@ non_null @*/ Expr expr, /*@ non_null @*/ Identifier id, /*@ non_null @*/ IdentifierVec storerefs, int loc) {
       this.expr = expr;
       this.id = id;
...
// Generated boilerplate methods:
    ...
    public final int childCount() {
       int sz = 0;
       if (this.storerefs != null) sz += this.storerefs.size();
       return sz + 2;
    }
    ...
    public final /*@ non_null */ Object childAt(int index) {
       ...
       sz = (this.storerefs == null ? 0 : this.storerefs.size());
       if (0 <= index && index < sz)
          return this.storerefs.elementAt(index);
       else index -= sz;
    ...
    public final int getTag() {
       return TagConstants.REACHMODIFIERPRAGMA;
    }

    public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
        if (v instanceof Visitor) ((Visitor)v).visitReachModifierPragma(this);
    }

    public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
        if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitReachModifierPragma(this, o); else return null;
    }
    ...
    public void check() {
       ...
       for(int i = 0; i < this.storerefs.size(); i++)
          this.storerefs.elementAt(i).check();
    }

    //@ ensures \result != null;
    public static /*@ non_null */ ReachModifierPragma make(/*@ non_null @*/ Expr expr, /*@ non_null @*/ Identifier id, /*@ non_null @*/ IdentifierVec storerefs, int loc) {
       ReachModifierPragma result = new ReachModifierPragma(expr, id, storerefs, loc);
       return result;
    }
}
