...
// Generated boilerplate constructors:
   ...
   protected RestoreFromCmd(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs) {
      super(v, rhs);
   }
...
// Generated boilerplate methods:
   ...
   //@ ensures \result != null;
   public static /*@ non_null */ RestoreFromCmd make(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs) {
      RestoreFromCmd result = new RestoreFromCmd(v, rhs);
      return result;
   }
}
