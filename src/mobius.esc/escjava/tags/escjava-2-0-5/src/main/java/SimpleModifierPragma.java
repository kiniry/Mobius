...
// Generated boilerplate constructors:
  ...
  protected SimpleModifierPragma(int tag, int loc) {
     this.tag = tag;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SimpleModifierPragma make(int tag, int loc) {
     SimpleModifierPragma result = new SimpleModifierPragma(tag, loc);
     return result;
  }
}
