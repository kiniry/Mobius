...
// Generated boilerplate constructors:
  ...
  protected StillDeferredDeclPragma(/*@ non_null @*/ Identifier var, int loc, int locId) {
     this.var = var;
     this.loc = loc;
     this.locId = locId;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ StillDeferredDeclPragma make(/*@ non_null @*/ Identifier var, int loc, int locId) {
     StillDeferredDeclPragma result = new StillDeferredDeclPragma(var, loc, locId);
     return result;
  }
}
