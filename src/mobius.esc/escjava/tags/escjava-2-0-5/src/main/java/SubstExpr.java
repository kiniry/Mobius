...
// Generated boilerplate constructors:
  ...
  protected SubstExpr(int sloc, int eloc, /*@ non_null @*/ GenericVarDecl var, /*@ non_null @*/ Expr val, /*@ non_null @*/ Expr target) {
     super(sloc, eloc);
     this.var = var;
     this.val = val;
     this.target = target;
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SubstExpr make(int sloc, int eloc, /*@ non_null @*/ GenericVarDecl var, /*@ non_null @*/ Expr val, /*@ non_null @*/ Expr target) {
     SubstExpr result = new SubstExpr(sloc, eloc, var, val, target);
     return result;
  }
}
