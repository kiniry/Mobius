...
public class VcToString
{
  ...
  /**
   * Prints <code>e</code> as a simple-expression string to
   * <code>to</code>.  Any symbolic names created for integral
   * literals in <code>e</code> are added to a static place (variable
   * <code>integralPrintNames</code>) so that successive calls to
   * <code>compute</code> can produce properties about these names.
   **/
   ...
   * <code>to</code>.  Any symbolic names of integral literals stored
   * by the most recent call to <code>computeTypeBackPred</code>, if
   * any, will be considered when producing properties about such
   * symbolic literals.
   **/
