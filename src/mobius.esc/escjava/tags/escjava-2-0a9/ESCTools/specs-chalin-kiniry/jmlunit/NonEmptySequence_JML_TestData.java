// This file was generated by jmlunit on Fri Jun 03 20:32:08 EDT 2005.
 ...
 */
public abstract class NonEmptySequence_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public NonEmptySequence_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for NonEmptySequence");
    }
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        ...
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
          ...
          Cons a, b, c, d, e;
          a = new Cons(null, null);
          b = new Cons("a", null);
          c = new Cons(null, new Integer(0));
          d = new Cons(null, a);
          e = new Cons(c, d);
                    switch (n) {
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vNonEmptySequenceIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vNonEmptySequenceStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * NonEmptySequence. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vNonEmptySequenceStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    // replace this comment with test data if desired
           case 0:
            return EmptySequence.make().append(null);
          case 1:
            return EmptySequence.make().append("");
                   default:
                        break;
                    }
                    throw new java.util.NoSuchElementException();
