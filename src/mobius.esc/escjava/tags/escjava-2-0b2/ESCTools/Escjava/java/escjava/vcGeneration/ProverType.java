...
abstract public class ProverType {
     ...
     */
    abstract public void getProof(Writer out, String name, TNode term);
     ...
     */
    abstract protected void generateDeclarations(/*@ non_null @*/Writer out, HashMap variablesName);
     ...
     */
    final public void generateDeclarations(Writer out, TNode term) {
     ...
     */
    final public void generateTerm(Writer out, TNode term) {
