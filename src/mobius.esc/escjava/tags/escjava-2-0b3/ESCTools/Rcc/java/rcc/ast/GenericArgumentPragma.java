...
public class GenericArgumentPragma extends TypeModifierPragma {
    ...
    protected GenericArgumentPragma(/* @ non_null @ */ExprVec expressions,
        int loc) {
    ...
    public final/* @non_null */String toString() {
        return "[GenericArgumentPragma" + " expressions = " + this.expressions
            + " loc = " + this.loc + "]";
    }
    ...
    public final void accept(javafe.ast.Visitor v) {
        if (v instanceof Visitor)
            ((Visitor) v).visitGenericArgumentPragma(this);
    }

    public final Object accept(javafe.ast.VisitorArgResult v, Object o) {
        if (v instanceof VisitorArgResult)
            return ((VisitorArgResult) v).visitGenericArgumentPragma(this, o);
        else
            return null;
    }
    ...
    // @ ensures \result != null;
    public static GenericArgumentPragma make(
