...
class DirectCharBufferU extends CharBuffer implements DirectBuffer {
    /*synthetic*/ static final boolean $assertionsDisabled = !DirectCharBufferU.class.desiredAssertionStatus();
    ...
    public CharBuffer put(CharBuffer src) {
        if (src instanceof DirectCharBufferU) {
            ...
            DirectCharBufferU sb = (DirectCharBufferU)(DirectCharBufferU)src;
