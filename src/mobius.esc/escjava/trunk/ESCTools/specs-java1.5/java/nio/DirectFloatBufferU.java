...
class DirectFloatBufferU extends FloatBuffer implements DirectBuffer {
    /*synthetic*/ static final boolean $assertionsDisabled = !DirectFloatBufferU.class.desiredAssertionStatus();
    ...
    public FloatBuffer put(FloatBuffer src) {
        if (src instanceof DirectFloatBufferU) {
            ...
            DirectFloatBufferU sb = (DirectFloatBufferU)(DirectFloatBufferU)src;
