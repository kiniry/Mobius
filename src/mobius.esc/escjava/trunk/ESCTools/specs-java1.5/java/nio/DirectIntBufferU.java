...
class DirectIntBufferU extends IntBuffer implements DirectBuffer {
    /*synthetic*/ static final boolean $assertionsDisabled = !DirectIntBufferU.class.desiredAssertionStatus();
    ...
    public IntBuffer put(IntBuffer src) {
        if (src instanceof DirectIntBufferU) {
            ...
            DirectIntBufferU sb = (DirectIntBufferU)(DirectIntBufferU)src;
