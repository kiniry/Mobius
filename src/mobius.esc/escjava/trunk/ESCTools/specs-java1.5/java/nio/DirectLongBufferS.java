...
class DirectLongBufferS extends LongBuffer implements DirectBuffer {
    /*synthetic*/ static final boolean $assertionsDisabled = !DirectLongBufferS.class.desiredAssertionStatus();
    ...
    public LongBuffer put(LongBuffer src) {
        if (src instanceof DirectLongBufferS) {
            ...
            DirectLongBufferS sb = (DirectLongBufferS)(DirectLongBufferS)src;
