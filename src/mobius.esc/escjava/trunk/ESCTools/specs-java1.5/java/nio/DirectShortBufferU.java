...
class DirectShortBufferU extends ShortBuffer implements DirectBuffer {
    /*synthetic*/ static final boolean $assertionsDisabled = !DirectShortBufferU.class.desiredAssertionStatus();
    ...
    public ShortBuffer put(ShortBuffer src) {
        if (src instanceof DirectShortBufferU) {
            ...
            DirectShortBufferU sb = (DirectShortBufferU)(DirectShortBufferU)src;
