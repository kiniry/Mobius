...
class DirectByteBuffer extends MappedByteBuffer implements DirectBuffer {
    ...
    DirectByteBuffer(int cap) {
        ...
        cleaner = Cleaner.create(this, new DirectByteBuffer$Deallocator(base, cap, null));
    }
    ...
    public ByteBuffer put(ByteBuffer src) {
        if (src instanceof DirectByteBuffer) {
            ...
            DirectByteBuffer sb = (DirectByteBuffer)(DirectByteBuffer)src;
    ...
    public CharBuffer asCharBuffer() {
        ...
        int lim = this.limit();
        if (!$assertionsDisabled && !(off <= lim)) throw new AssertionError();
