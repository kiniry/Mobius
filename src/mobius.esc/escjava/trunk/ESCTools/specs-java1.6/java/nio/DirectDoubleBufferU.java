...
class DirectDoubleBufferU extends DoubleBuffer implements DirectBuffer {
    /*synthetic*/ static final boolean $assertionsDisabled = !DirectDoubleBufferU.class.desiredAssertionStatus();
    ...
    public DoubleBuffer put(DoubleBuffer src) {
        if (src instanceof DirectDoubleBufferU) {
            ...
            DirectDoubleBufferU sb = (DirectDoubleBufferU)(DirectDoubleBufferU)src;
