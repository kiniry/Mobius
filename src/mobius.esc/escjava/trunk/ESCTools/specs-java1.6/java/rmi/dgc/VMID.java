...
public final class VMID implements java.io.Serializable {
    ...
    public String toString() {
        ...
        if (addr != null) for (int i = 0; i < addr.length; ++i) {
            int x = (int)(addr[i] & 255);
    ...
    private static byte[] computeAddressHash() {
        byte[] addr = (byte[])(byte[])java.security.AccessController.doPrivileged(new VMID$1());
        byte[] addrHash;
