...
class StyleSheet$BoxPainter$HorizontalMargin extends Enum {
    public static final StyleSheet$BoxPainter$HorizontalMargin LEFT = new StyleSheet$BoxPainter$HorizontalMargin("LEFT", 0);
    public static final StyleSheet$BoxPainter$HorizontalMargin RIGHT = new StyleSheet$BoxPainter$HorizontalMargin("RIGHT", 1);
