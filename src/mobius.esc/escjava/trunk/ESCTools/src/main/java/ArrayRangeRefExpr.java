...
// Generated boilerplate constructors:
  ...
  //@ ensures this.lowIndex == lowIndex;
  //@ ensures this.highIndex == highIndex;
  protected ArrayRangeRefExpr(int locOpenBracket, /*@ non_null @*/ Expr array, Expr lowIndex, Expr highIndex) {
...
// Generated boilerplate methods:
  ...
  public final /*@ non_null */ Object childAt(int index) {
     ...
     if (index == 0) return this.lowIndex;
     else index--;

     if (index == 0) return this.highIndex;
     else index--;
  ...
  public final int getTag() {
     return TagConstants.ARRAYRANGEREFEXPR;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitArrayRangeRefExpr(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitArrayRangeRefExpr(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ArrayRangeRefExpr make(int locOpenBracket, /*@ non_null @*/ Expr array, Expr lowIndex, Expr highIndex) {
     ArrayRangeRefExpr result = new ArrayRangeRefExpr(locOpenBracket, array, lowIndex, highIndex);
     return result;
  }
}
