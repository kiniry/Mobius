...
// Generated boilerplate constructors:
  ...
  //@ ensures this.cmd == cmd;
  //@ ensures this.g1 == g1;
  //@ ensures this.g2 == g2;
  protected CmdCmdCmd(int cmd, /*@ non_null @*/ GuardedCmd g1, /*@ non_null @*/ GuardedCmd g2) {
     super();
     this.cmd = cmd;
     this.g1 = g1;
     this.g2 = g2;
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ CmdCmdCmd make(int cmd, /*@ non_null @*/ GuardedCmd g1, /*@ non_null @*/ GuardedCmd g2) {
     CmdCmdCmd result = new CmdCmdCmd(cmd, g1, g2);
     return result;
  }
}
