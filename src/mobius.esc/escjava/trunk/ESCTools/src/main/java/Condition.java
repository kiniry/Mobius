...
// Generated boilerplate constructors:
  ...
  //@ ensures this.locPragmaDecl == locPragmaDecl;
  protected Condition(int label, /*@ non_null @*/ Expr pred, int locPragmaDecl) {
     this.label = label;
     this.pred = pred;
     this.locPragmaDecl = locPragmaDecl;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ Condition make(int label, /*@ non_null @*/ Expr pred, int locPragmaDecl) {
     Condition result = new Condition(label, pred, locPragmaDecl);
     return result;
  }
}
