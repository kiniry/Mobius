...
// Generated boilerplate constructors:
  ...
  protected DependsPragma(int tag, /*@ non_null @*/ Expr target, /*@ non_null @*/ ExprVec exprs, int loc) {
     this.tag = tag;
     this.target = target;
     this.exprs = exprs;
     this.loc = loc;
...
// Generated boilerplate methods:
  ...
  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitDependsPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitDependsPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ DependsPragma make(int tag, /*@ non_null @*/ Expr target, /*@ non_null @*/ ExprVec exprs, int loc) {
     DependsPragma result = new DependsPragma(tag, target, exprs, loc);
     return result;
  }
}
