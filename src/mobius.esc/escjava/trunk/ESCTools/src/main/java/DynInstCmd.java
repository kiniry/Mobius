...
// Generated boilerplate constructors:
  ...
  //@ ensures this.s == s;
  //@ ensures this.g == g;
  protected DynInstCmd(/*@ non_null @*/ String s, /*@ non_null @*/ GuardedCmd g) {
     super();
     this.s = s;
     this.g = g;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ DynInstCmd make(/*@ non_null @*/ String s, /*@ non_null @*/ GuardedCmd g) {
     DynInstCmd result = new DynInstCmd(s, g);
     return result;
  }
}
