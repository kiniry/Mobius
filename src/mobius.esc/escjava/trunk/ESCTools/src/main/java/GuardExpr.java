...
// Generated boilerplate constructors:
  ...
  protected GuardExpr(/*@ non_null @*/ Expr expr, int locPragmaDecl) {
     this.expr = expr;
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ GuardExpr make(/*@ non_null @*/ Expr expr, int locPragmaDecl) {
     GuardExpr result = new GuardExpr(expr, locPragmaDecl);
     return result;
  }
}
