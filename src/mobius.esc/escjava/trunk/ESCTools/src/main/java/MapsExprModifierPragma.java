...
// Generated boilerplate constructors:
    ...
    //@ ensures this.id == id;
    //@ ensures this.mapsexpr == mapsexpr;
    //@ ensures this.loc == loc;
    //@ ensures this.expr == expr;
    protected MapsExprModifierPragma(int tag, /*@ non_null @*/ Identifier id, /*@ non_null @*/ Expr mapsexpr, int loc, /*@ non_null @*/ Expr expr) {
       this.tag = tag;
       this.id = id;
       this.mapsexpr = mapsexpr;
       this.loc = loc;
       this.expr = expr;
    }
...
// Generated boilerplate methods:
    ...
    public final /*@ non_null */ Object childAt(int index) {
       ...
       if (index == 0) return this.mapsexpr;
       else index--;
    ...
    public final /*@non_null*/String toString() {
       return "[MapsExprModifierPragma"
          + " tag = " + this.tag
          + " id = " + this.id
          + " mapsexpr = " + this.mapsexpr
          + " loc = " + this.loc
          + " expr = " + this.expr
          + "]";
    }
    ...
    public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
        if (v instanceof Visitor) ((Visitor)v).visitMapsExprModifierPragma(this);
    }

    public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
        if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitMapsExprModifierPragma(this, o); else return null;
    }
    ...
    //@ ensures \result != null;
    public static /*@ non_null */ MapsExprModifierPragma make(int tag, /*@ non_null @*/ Identifier id, /*@ non_null @*/ Expr mapsexpr, int loc, /*@ non_null @*/ Expr expr) {
       MapsExprModifierPragma result = new MapsExprModifierPragma(tag, id, mapsexpr, loc, expr);
       return result;
    }
}
