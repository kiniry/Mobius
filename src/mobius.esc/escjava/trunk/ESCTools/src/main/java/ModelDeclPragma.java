...
// Generated boilerplate constructors:
  ...
  protected ModelDeclPragma(/*@ non_null @*/ FieldDecl decl, int loc) {
     this.decl = decl;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.MODELDECLPRAGMA;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitModelDeclPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitModelDeclPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ModelDeclPragma make(/*@ non_null @*/ FieldDecl decl, int loc) {
     ModelDeclPragma result = new ModelDeclPragma(decl, loc);
     return result;
  }
}
