...
{
  public /*@ non_null @*/ MethodDecl decl;
...
// Generated boilerplate constructors:
  ...
  protected ModelMethodDeclPragma(/*@ non_null @*/ MethodDecl decl, int loc) {
     this.decl = decl;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.MODELMETHODDECLPRAGMA;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitModelMethodDeclPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitModelMethodDeclPragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ModelMethodDeclPragma make(/*@ non_null @*/ MethodDecl decl, int loc) {
     ModelMethodDeclPragma result = new ModelMethodDeclPragma(decl, loc);
     return result;
  }
}
