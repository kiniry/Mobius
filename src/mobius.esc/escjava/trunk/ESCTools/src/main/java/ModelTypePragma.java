...
// Generated boilerplate constructors:
  ...
  protected ModelTypePragma(/*@ non_null @*/ TypeDecl decl, int loc) {
     this.decl = decl;
     this.loc = loc;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.MODELTYPEPRAGMA;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitModelTypePragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitModelTypePragma(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ ModelTypePragma make(/*@ non_null @*/ TypeDecl decl, int loc) {
     ModelTypePragma result = new ModelTypePragma(decl, loc);
     return result;
  }
}
