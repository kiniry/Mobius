...
public class NestedModifierPragma extends ModifierPragma
{
  ...
  public /*@ non_null @*/ ArrayList list;
...
// Generated boilerplate constructors:
  ...
  protected NestedModifierPragma(/*@ non_null @*/ ArrayList list) {
     this.list = list;
  }
...
// Generated boilerplate methods:
  ...
  public final /*@non_null*/String toString() {
     return "[NestedModifierPragma"
        + " list = " + this.list
        + "]";
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitNestedModifierPragma(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitNestedModifierPragma(this, o); else return null;
  }

  public void check() {
     if (this.list == null) throw new RuntimeException();
  }

  //@ ensures \result != null;
  public static /*@ non_null */ NestedModifierPragma make(/*@ non_null @*/ ArrayList list) {
     NestedModifierPragma result = new NestedModifierPragma(list);
     return result;
  }
}
