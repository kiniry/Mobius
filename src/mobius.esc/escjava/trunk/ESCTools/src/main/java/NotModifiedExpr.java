...
// Generated boilerplate constructors:
  ...
  protected NotModifiedExpr(int loc, /*@ non_null @*/ Expr expr) {
     this.loc = loc;
     this.expr = expr;
  }
...
// Generated boilerplate methods:
  ...
  public final int getTag() {
     return TagConstants.NOTMODIFIEDEXPR;
  }

  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitNotModifiedExpr(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitNotModifiedExpr(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ NotModifiedExpr make(int loc, /*@ non_null @*/ Expr expr) {
     NotModifiedExpr result = new NotModifiedExpr(loc, expr);
     return result;
  }
}
