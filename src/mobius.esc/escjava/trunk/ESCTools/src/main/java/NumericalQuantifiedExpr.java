...
// Generated boilerplate constructors:
  ...
  protected NumericalQuantifiedExpr(int sloc, int eloc, int quantifier, /*@ non_null @*/ GenericVarDeclVec vars, /*@ non_null @*/ Expr rangeExpr, /*@ non_null @*/ Expr expr, ExprVec nopats) {
     super(sloc, eloc);
...
// Generated boilerplate methods:
  ...
  public final /*@non_null*/String toString() {
     return "[NumericalQuantifiedExpr"
        + " sloc = " + this.sloc
        + " eloc = " + this.eloc
  ...
  public final void accept(/*@ non_null */ javafe.ast.Visitor v) { 
    if (v instanceof Visitor) ((Visitor)v).visitNumericalQuantifiedExpr(this);
  }

  public final /*@ non_null */ Object accept(/*@ non_null */ javafe.ast.VisitorArgResult v, /*@ nullable */ Object o) { 
    if (v instanceof VisitorArgResult) return ((VisitorArgResult)v).visitNumericalQuantifiedExpr(this, o); else return null;
  }
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ NumericalQuantifiedExpr make(int sloc, int eloc, int quantifier, /*@ non_null @*/ GenericVarDeclVec vars, /*@ non_null @*/ Expr rangeExpr, /*@ non_null @*/ Expr expr, ExprVec nopats) {
     NumericalQuantifiedExpr result = new NumericalQuantifiedExpr(sloc, eloc, quantifier, vars, rangeExpr, expr, nopats);
     return result;
  }
}
