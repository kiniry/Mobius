...
// Generated boilerplate constructors:
  ...
  //@ ensures this.pats == pats;
  protected QuantifiedExpr(int sloc, int eloc, int quantifier, /*@ non_null @*/ GenericVarDeclVec vars, /*@ non_null @*/ Expr rangeExpr, /*@ non_null @*/ Expr expr, ExprVec nopats, ExprVec pats) {
     super(sloc, eloc);
...
// Generated boilerplate methods:
  ...
  public final int childCount() {
     ...
     if (this.pats != null) sz += this.pats.size();
     return sz + 2;
  }
  ...
  public final /*@ non_null */ Object childAt(int index) {
     ...
     sz = (this.pats == null ? 0 : this.pats.size());
     if (0 <= index && index < sz)
        return this.pats.elementAt(index);
     else index -= sz;
  ...
  public void check() {
     ...
     if (this.pats != null)
        for(int i = 0; i < this.pats.size(); i++)
           this.pats.elementAt(i).check();
     postCheck();
  }

  //@ ensures \result != null;
  public static /*@ non_null */ QuantifiedExpr make(int sloc, int eloc, int quantifier, /*@ non_null @*/ GenericVarDeclVec vars, /*@ non_null @*/ Expr rangeExpr, /*@ non_null @*/ Expr expr, ExprVec nopats, ExprVec pats) {
     QuantifiedExpr result = new QuantifiedExpr(sloc, eloc, quantifier, vars, rangeExpr, expr, nopats, pats);
     return result;
  }
}
