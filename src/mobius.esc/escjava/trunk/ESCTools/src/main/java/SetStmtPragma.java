...
// Generated boilerplate constructors:
  ...
  protected SetStmtPragma(/*@ non_null @*/ Expr target, int locOp, /*@ non_null @*/ Expr value, int loc) {
     this.target = target;
     this.locOp = locOp;
     this.value = value;
     this.loc = loc;
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SetStmtPragma make(/*@ non_null @*/ Expr target, int locOp, /*@ non_null @*/ Expr value, int loc) {
     SetStmtPragma result = new SetStmtPragma(target, locOp, value, loc);
     return result;
  }
}
