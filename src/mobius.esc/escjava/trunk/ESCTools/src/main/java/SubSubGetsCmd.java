...
// Generated boilerplate constructors:
  ...
  //@ ensures this.index1 == index1;
  //@ ensures this.index2 == index2;
  protected SubSubGetsCmd(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs, /*@ non_null @*/ Expr index1, /*@ non_null @*/ Expr index2) {
     super(v, rhs);
     this.index1 = index1;
     this.index2 = index2;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ SubSubGetsCmd make(/*@ non_null @*/ VariableAccess v, /*@ non_null @*/ Expr rhs, /*@ non_null @*/ Expr index1, /*@ non_null @*/ Expr index2) {
     SubSubGetsCmd result = new SubSubGetsCmd(v, rhs, index1, index2);
     return result;
  }
}
