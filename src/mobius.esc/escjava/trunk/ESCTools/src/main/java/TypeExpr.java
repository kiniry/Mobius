...
// Generated boilerplate constructors:
  ...
  protected TypeExpr(int sloc, int eloc, /*@ non_null @*/ Type type) {
     super(sloc, eloc);
     this.type = type;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ TypeExpr make(int sloc, int eloc, /*@ non_null @*/ Type type) {
     TypeExpr result = new TypeExpr(sloc, eloc, type);
     return result;
  }
}
