...
// Generated boilerplate constructors:
  ...
  //@ ensures this.od == od;
  protected WildRefExpr(/*@ non_null @*/ Expr var, /*@ non_null @*/ ObjectDesignator od) {
     this.var = var;
     this.od = od;
  }
...
// Generated boilerplate methods:
  ...
  //@ ensures \result != null;
  public static /*@ non_null */ WildRefExpr make(/*@ non_null @*/ Expr var, /*@ non_null @*/ ObjectDesignator od) {
     WildRefExpr result = new WildRefExpr(var, od);
     return result;
  }
}
