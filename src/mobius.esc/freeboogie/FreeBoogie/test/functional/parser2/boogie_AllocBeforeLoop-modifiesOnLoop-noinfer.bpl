...
implementation Test.Method(this : ref) {
  ...
  var $Heap$block1224$LoopPreheader : <x>[ref, name]x;
  ...
  block1207: stack0i := 10; goto $$block1207~j;
  $$block1207~j: assert (0 <= stack0i); goto $$block1207~i;
  $$block1207~i: havoc arr; goto $$block1207~h;
  $$block1207~h: assume (($Heap[arr, $allocated] == false) && ($Length(arr) == stack0i)); goto $$block1207~g;
  $$block1207~g: assume $IsNotNull(arr, ValueArray(System.Int32, 1)); goto $$block1207~f;
  $$block1207~f: assume (($Heap[arr, $ownerRef] == arr) && ($Heap[arr, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block1207~e;
  $$block1207~e: assume ((($Heap[arr, $inv] == ValueArray(System.Int32, 1)) && ($Heap[arr, $localinv] == ValueArray(System.Int32, 1))) && ((($Heap[arr, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[arr, $ownerRef], $inv] <: $Heap[arr, $ownerFrame])) || ($Heap[$Heap[arr, $ownerRef], $localinv] == $BaseClass($Heap[arr, $ownerFrame])))); goto $$block1207~d;
  $$block1207~d: assume (forall $i : int :: (ValueArrayGet($Heap[arr, $elements], $i) == 0)); goto $$block1207~c;
  $$block1207~c: $Heap := $Heap[arr, $allocated := true]; goto $$block1207~b;
  $$block1207~b: assume IsHeap($Heap); goto $$block1207~a;
  $$block1207~a: i := 0; goto block1224$LoopPreheader;
  block1224: assume (((forall $o : ref :: (($Heap$block1224$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1224$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1224$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1224$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1224$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1224$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1224~e;
  $$block1224~e: assume (forall $o : ref :: ((($Heap$block1224$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1224$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1224$LoopPreheader[$o, $allocated] != true))); goto $$block1224~d;
  $$block1224~d: assume (forall $o : ref :: ((($Heap$block1224$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1224~c;
  $$block1224~c: assert (forall $o : ref :: ((($o != null) && ($Heap$block1224$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1224$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1224$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block1224~b;
  $$block1224~b: assert <$$tv~q>(forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) && old((($o != this) || ($f != $exposeVersion)))) ==> ($Heap$block1224$LoopPreheader[$o, $f] == $Heap[$o, $f]))); goto $$block1224~a;
  $$block1224~a: stack0i := 10; goto true1224to1258, false1224to1241;
  true1224to1258: assume (i >= stack0i); goto block1258;
  false1224to1241: assume (i < stack0i); goto block1241;
  block1258: return;
  block1241: stack0o := arr; goto $$block1241~k;
  $$block1241~k: stack1i := i; goto $$block1241~j;
  $$block1241~j: assert (stack0o != null); goto $$block1241~i;
  $$block1241~i: assert (0 <= stack1i); goto $$block1241~h;
  $$block1241~h: assert (stack1i < $Length(stack0o)); goto $$block1241~g;
  $$block1241~g: $Heap := $Heap[stack0o, $elements := ValueArraySet($Heap[stack0o, $elements], stack1i, i)]; goto $$block1241~f;
  $$block1241~f: assume IsHeap($Heap); goto $$block1241~e;
  $$block1241~e: local2 := i; goto $$block1241~d;
  $$block1241~d: stack0i := 1; goto $$block1241~c;
  $$block1241~c: stack0i := (local2 + stack0i); goto $$block1241~b;
  $$block1241~b: i := stack0i; goto $$block1241~a;
  $$block1241~a: stack0i := local2; goto block1224;
  block1224$LoopPreheader: $Heap$block1224$LoopPreheader := $Heap; goto block1224;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block1649;
  block1649: goto block1666;
  block1666: assert (this != null); goto $$block1666~f;
  $$block1666~f: call System.Object..ctor(this); goto $$block1666~e;
  $$block1666~e: assert (this != null); goto $$block1666~d;
  $$block1666~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block1666~c;
  $$block1666~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1666~b;
  $$block1666~b: $Heap := $Heap[this, $inv := Test]; goto $$block1666~a;
  $$block1666~a: assume IsHeap($Heap); return;
