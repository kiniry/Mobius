...
const test3.MyClass : name;
const System.Collections.IList : name;
const System.IComparable`1...System.String : name;
axiom (test3.MyClass <: test3.MyClass);
axiom ($BaseClass(test3.MyClass) == System.Object);
axiom ((test3.MyClass <: $BaseClass(test3.MyClass)) && (AsDirectSubClass(test3.MyClass, $BaseClass(test3.MyClass)) == test3.MyClass));
axiom (!$IsImmutable(test3.MyClass) && ($AsMutable(test3.MyClass) == test3.MyClass));
procedure test3.MyClass.M0$test3.MyClass.array$notnull(this : ref, a$in : ref where $IsNotNull(a$in, RefArray(test3.MyClass, 1)));
...
implementation test3.MyClass.M0$test3.MyClass.array$notnull(this : ref, a$in : ref) {
  var a : ref where $IsNotNull(a, RefArray(test3.MyClass, 1));
  var stack0o : ref;
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: a := a$in; goto block2992;
  block2992: goto block3094;
  block3094: assert ($Length(a) >= 0); goto block3179;
  block3179: assert ($Rank(a) == 1); goto block3264;
  block3264: assert $IsNotNull(a, RefArray(test3.MyClass, 1)); goto block3349;
  block3349: assert $IsNotNull(a, RefArray(test3.MyClass, 1)); goto block3434;
  block3434: assert $IsNotNull(a, System.Array); goto block3519;
  block3519: assert $IsNotNull(a, System.Array); goto block3604;
  block3604: return;
...
procedure test3.MyClass.M1$test3.MyClass.array.array$notnull(this : ref, a$in : ref where $IsNotNull(a$in, RefArray(RefArray(test3.MyClass, 1), 1)));
  free requires ($Heap[a$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires (((($Heap[a$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[a$in, $ownerRef], $inv] <: $Heap[a$in, $ownerFrame])) || ($Heap[$Heap[a$in, $ownerRef], $localinv] == $BaseClass($Heap[a$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[a$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[a$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
...
implementation test3.MyClass.M1$test3.MyClass.array.array$notnull(this : ref, a$in : ref) {
  var a : ref where $IsNotNull(a, RefArray(RefArray(test3.MyClass, 1), 1));
  var stack0o : ref;
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: a := a$in; goto block4658;
  block4658: goto block4760;
  block4760: assert ($Length(a) >= 0); goto block4845;
  block4845: assert ($Rank(a) == 1); goto block4930;
  block4930: assert $IsNotNull(a, System.Array); goto block5015;
  block5015: return;
  
}

procedure test3.MyClass.M2$test3.MyClass.array2$notnull(this : ref, a$in : ref where $IsNotNull(a$in, RefArray(test3.MyClass, 2)));
  free requires ($Heap[a$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires (((($Heap[a$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[a$in, $ownerRef], $inv] <: $Heap[a$in, $ownerFrame])) || ($Heap[$Heap[a$in, $ownerRef], $localinv] == $BaseClass($Heap[a$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[a$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[a$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
...
implementation test3.MyClass.M2$test3.MyClass.array2$notnull(this : ref, a$in : ref) {
  var a : ref where $IsNotNull(a, RefArray(test3.MyClass, 2));
  var stack0o : ref;
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~f;
  $$entry~f: assume ($Heap[this, $allocated] == true); goto $$entry~e;
  $$entry~e: a := a$in; goto block5814;
  block5814: goto block5916;
  block5916: assert ($Length(a) >= 0); goto block6001;
  block6001: assert ($Rank(a) == 2); goto block6086;
  block6086: assert $IsNotNull(a, System.Array); goto block6171;
  block6171: return;
  
}

procedure test3.MyClass.M3$System.Array$notnull(this : ref, a$in : ref where $IsNotNull(a$in, System.Array));
  free requires ($Heap[a$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires (((($Heap[a$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[a$in, $ownerRef], $inv] <: $Heap[a$in, $ownerFrame])) || ($Heap[$Heap[a$in, $ownerRef], $localinv] == $BaseClass($Heap[a$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[a$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[a$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
...
implementation test3.MyClass.M3$System.Array$notnull(this : ref, a$in : ref) {
  var a : ref where $IsNotNull(a, System.Array);
  var stack0o : ref;
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~h;
  $$entry~h: assume ($Heap[this, $allocated] == true); goto $$entry~g;
  $$entry~g: a := a$in; goto block6885;
  block6885: goto block6987;
  block6987: assert ($Length(a) >= 0); goto block7072;
  block7072: assert ($Rank(a) >= 1); goto block7157;
  block7157: return;
  
}

procedure test3.MyClass.Allocate0$System.Int32(this : ref, howMany$in : int where InRange(howMany$in, System.Int32));
  free requires true;
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation test3.MyClass.Allocate0$System.Int32(this : ref, howMany$in : int) {
  var howMany : int where InRange(howMany, System.Int32);
  var stack0i : int;
  var arr : ref where $Is(arr, ValueArray(System.Int32, 1));
  var stack0o : ref;
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~j;
  $$entry~j: assume ($Heap[this, $allocated] == true); goto $$entry~i;
  $$entry~i: howMany := howMany$in; goto block7786;
  block7786: goto block7803;
  block7803: stack0i := howMany; goto $$block7803~j;
  $$block7803~j: assert (0 <= stack0i); goto $$block7803~i;
  $$block7803~i: havoc arr; goto $$block7803~h;
  $$block7803~h: assume (($Heap[arr, $allocated] == false) && ($Length(arr) == stack0i)); goto $$block7803~g;
  $$block7803~g: assume $IsNotNull(arr, ValueArray(System.Int32, 1)); goto $$block7803~f;
  $$block7803~f: assume (($Heap[arr, $ownerRef] == arr) && ($Heap[arr, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block7803~e;
  $$block7803~e: assume ((($Heap[arr, $inv] == ValueArray(System.Int32, 1)) && ($Heap[arr, $localinv] == ValueArray(System.Int32, 1))) && ((($Heap[arr, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[arr, $ownerRef], $inv] <: $Heap[arr, $ownerFrame])) || ($Heap[$Heap[arr, $ownerRef], $localinv] == $BaseClass($Heap[arr, $ownerFrame])))); goto $$block7803~d;
  $$block7803~d: assume (forall $i : int :: (ValueArrayGet($Heap[arr, $elements], $i) == 0)); goto $$block7803~c;
  $$block7803~c: $Heap := $Heap[arr, $allocated := true]; goto $$block7803~b;
  $$block7803~b: assume IsHeap($Heap); goto $$block7803~a;
  $$block7803~a: assert ($Length(arr) == howMany); goto block7888;
  block7888: assert ($Rank(arr) == 1); goto block7973;
  block7973: assert $IsNotNull(arr, System.Array); goto block8058;
  block8058: return;
  
}

procedure test3.MyClass.Allocate1$System.Int32(this : ref, howMany$in : int where InRange(howMany$in, System.Int32));
  free requires true;
...
implementation test3.MyClass.Allocate1$System.Int32(this : ref, howMany$in : int) {
  var howMany : int where InRange(howMany, System.Int32);
  var stack0i : int;
  var arr : ref where $Is(arr, ValueArray(System.Int32, 1));
  var stack0o : ref;
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~l;
  $$entry~l: assume ($Heap[this, $allocated] == true); goto $$entry~k;
  $$entry~k: howMany := howMany$in; goto block8840;
  block8840: goto block8942;
  block8942: stack0i := howMany; goto $$block8942~j;
  $$block8942~j: assert (0 <= stack0i); goto $$block8942~i;
  $$block8942~i: havoc arr; goto $$block8942~h;
  $$block8942~h: assume (($Heap[arr, $allocated] == false) && ($Length(arr) == stack0i)); goto $$block8942~g;
  $$block8942~g: assume $IsNotNull(arr, ValueArray(System.Int32, 1)); goto $$block8942~f;
  $$block8942~f: assume (($Heap[arr, $ownerRef] == arr) && ($Heap[arr, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block8942~e;
  $$block8942~e: assume ((($Heap[arr, $inv] == ValueArray(System.Int32, 1)) && ($Heap[arr, $localinv] == ValueArray(System.Int32, 1))) && ((($Heap[arr, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[arr, $ownerRef], $inv] <: $Heap[arr, $ownerFrame])) || ($Heap[$Heap[arr, $ownerRef], $localinv] == $BaseClass($Heap[arr, $ownerFrame])))); goto $$block8942~d;
  $$block8942~d: assume (forall $i : int :: (ValueArrayGet($Heap[arr, $elements], $i) == 0)); goto $$block8942~c;
  $$block8942~c: $Heap := $Heap[arr, $allocated := true]; goto $$block8942~b;
  $$block8942~b: assume IsHeap($Heap); goto $$block8942~a;
  $$block8942~a: assert ($Length(arr) == howMany); goto block9027;
  block9027: assert ($Rank(arr) == 1); goto block9112;
  block9112: assert $IsNotNull(arr, System.Array); goto block9197;
  block9197: return;
  
}

procedure test3.MyClass.DimLengthRank1$System.String.array$notnull(this : ref, a$in : ref where $IsNotNull(a$in, RefArray(System.String, 1))) returns ($result : int where InRange($result, System.Int32));
  free requires ($Heap[a$in, $allocated] == true);
  requires ($Length(a$in) == 173);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires (((($Heap[a$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[a$in, $ownerRef], $inv] <: $Heap[a$in, $ownerFrame])) || ($Heap[$Heap[a$in, $ownerRef], $localinv] == $BaseClass($Heap[a$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[a$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[a$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation test3.MyClass.DimLengthRank1$System.String.array$notnull(this : ref, a$in : ref) returns ($result : int) {
  var a : ref where $IsNotNull(a, RefArray(System.String, 1));
  var stack0i : int;
  ...
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~n;
  $$entry~n: assume ($Heap[this, $allocated] == true); goto $$entry~m;
  $$entry~m: a := a$in; goto block9928;
  block9928: goto block10081;
  block10081: stack0i := 0; goto $$block10081~b;
  $$block10081~b: assert (a != null); goto $$block10081~a;
  $$block10081~a: return.value := $DimLength(a, stack0i); goto block10183;
  block10183: SS$Display.Return.Local := return.value; goto $$block10183~b;
  $$block10183~b: stack0i := return.value; goto $$block10183~a;
  $$block10183~a: $result := stack0i; return;
  
}

procedure test3.MyClass.DimLengthRank1$System.String.array2$notnull(this : ref, a$in : ref where $IsNotNull(a$in, RefArray(System.String, 2))) returns ($result : int where InRange($result, System.Int32));
  free requires ($Heap[a$in, $allocated] == true);
  requires ($Length(a$in) == 173);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires (((($Heap[a$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[a$in, $ownerRef], $inv] <: $Heap[a$in, $ownerFrame])) || ($Heap[$Heap[a$in, $ownerRef], $localinv] == $BaseClass($Heap[a$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[a$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[a$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
...
implementation test3.MyClass.DimLengthRank1$System.String.array2$notnull(this : ref, a$in : ref) returns ($result : int) {
  var a : ref where $IsNotNull(a, RefArray(System.String, 2));
  var stack0i : int;
  var return.value : int where InRange(return.value, System.Int32);
  var SS$Display.Return.Local : int where InRange(SS$Display.Return.Local, System.Int32);
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~p;
  $$entry~p: assume ($Heap[this, $allocated] == true); goto $$entry~o;
  $$entry~o: a := a$in; goto block10761;
  block10761: goto block10914;
  block10914: stack0i := 0; goto $$block10914~b;
  $$block10914~b: assert (a != null); goto $$block10914~a;
  $$block10914~a: return.value := $DimLength(a, stack0i); goto block11016;
  block11016: SS$Display.Return.Local := return.value; goto $$block11016~b;
  $$block11016~b: stack0i := return.value; goto $$block11016~a;
  $$block11016~a: $result := stack0i; return;
  
}

procedure test3.MyClass..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == test3.MyClass)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(test3.MyClass <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation test3.MyClass..ctor(this : ref) {
  entry: assume $IsNotNull(this, test3.MyClass); goto $$entry~r;
  $$entry~r: assume ($Heap[this, $allocated] == true); goto $$entry~q;
  $$entry~q: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block11356;
  block11356: goto block11373;
  block11373: assert (this != null); goto $$block11373~f;
  $$block11373~f: call System.Object..ctor(this); goto $$block11373~e;
  $$block11373~e: assert (this != null); goto $$block11373~d;
  $$block11373~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block11373~c;
  $$block11373~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == test3.MyClass)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block11373~b;
  $$block11373~b: $Heap := $Heap[this, $inv := test3.MyClass]; goto $$block11373~a;
  $$block11373~a: assume IsHeap($Heap); return;
