...
implementation Test.Other(this : ref) {
...
implementation Test.Method(this : ref) {
  var $Heap$block1377$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, Test); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto block1360;
  block1360: goto block1377$LoopPreheader;
  block1377: assume (((forall $o : ref :: (($Heap$block1377$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1377$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1377$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1377$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1377$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1377$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1377~d;
  $$block1377~d: assume (forall $o : ref :: ((($Heap$block1377$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1377$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1377$LoopPreheader[$o, $allocated] != true))); goto $$block1377~c;
  $$block1377~c: assume (forall $o : ref :: ((($Heap$block1377$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1377~b;
  $$block1377~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block1377$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1377$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1377$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block1377~a;
  $$block1377~a: assert <$$tv~v>(forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) && old((($o != this) || ($f != $exposeVersion)))) ==> ($Heap$block1377$LoopPreheader[$o, $f] == $Heap[$o, $f]))); goto block1394;
  block1394: assert (this != null); goto $$block1394~a;
  $$block1394~a: call Test.Other(this); goto block1377;
  block1377$LoopPreheader: $Heap$block1377$LoopPreheader := $Heap; goto block1377;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~c: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block1581;
  block1581: goto block1598;
  block1598: assert (this != null); goto $$block1598~f;
  $$block1598~f: call System.Object..ctor(this); goto $$block1598~e;
  ...
  $$block1598~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1598~b;
  $$block1598~b: $Heap := $Heap[this, $inv := Test]; goto $$block1598~a;
