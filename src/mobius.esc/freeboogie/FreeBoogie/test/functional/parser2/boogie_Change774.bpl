...
const S : name;
const Test1 : name;
axiom !IsStaticField(Test1.s);
axiom IsDirectlyModifiableField(Test1.s);
axiom (DeclType(Test1.s) == Test1);
...
implementation Test1..ctor(this : ref) {
  ...
  $$entry~a: assume ZeroInit($Heap[this, Test1.s], S); goto block2448;
  block2448: goto block2465;
  block2465: goto block2482;
  block2482: goto block2499;
  block2499: assert (this != null); goto $$block2499~a;
  $$block2499~a: call System.Object..ctor(this); goto block2516;
  block2516: goto block2533;
  block2533: goto block2550;
  block2550: assert (this != null); goto $$block2550~d;
  $$block2550~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2550~c;
  $$block2550~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test1)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2550~b;
  $$block2550~b: $Heap := $Heap[this, $inv := Test1]; goto $$block2550~a;
  $$block2550~a: assume IsHeap($Heap); return;
