...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this : ref, throwException$in : bool) returns ($result : bool) {
  ...
  $$entry~a: throwException := throwException$in; goto block3859;
  block3859: goto block3876;
  block3876: stack0i := 0; goto $$block3876~b;
  $$block3876~b: assert (this != null); goto $$block3876~a;
  $$block3876~a: stack1i := $Heap[this, Chunker.ChunkSize]; goto true3876to3995, false3876to3893;
  true3876to3995: assume (stack0i < stack1i); goto block3995;
  false3876to3893: assume (stack0i >= stack1i); goto block3893;
  block3995: goto block4012;
  block3893: stack0b := throwException; goto true3893to3944, false3893to3910;
  true3893to3944: assume !stack0b; goto block3944;
  false3893to3910: assume stack0b; goto block3910;
  block3944: return.value := false; goto block4250;
  block3910: assume false; goto $$block3910~i;
  $$block3910~i: havoc stack50000o; goto $$block3910~h;
  $$block3910~h: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException)); goto $$block3910~g;
  $$block3910~g: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3910~f;
  $$block3910~f: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3910~e;
  $$block3910~e: assert (stack50000o != null); goto $$block3910~d;
  $$block3910~d: call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o); goto $$block3910~c;
  $$block3910~c: stack0o := stack50000o; goto $$block3910~b;
  $$block3910~b: assert (stack0o != null); goto $$block3910~a;
  $$block3910~a: assume false; return;
  block4012: goto block4029;
  block4250: goto block4267;
  block4029: stack0i := 0; goto $$block4029~b;
  $$block4029~b: assert (this != null); goto $$block4029~a;
  $$block4029~a: stack1i := $Heap[this, Chunker.n]; goto true4029to4080, false4029to4046;
  true4029to4080: assume (stack0i > stack1i); goto block4080;
  false4029to4046: assume (stack0i <= stack1i); goto block4046;
  block4080: goto block4097;
  block4046: assert (this != null); goto $$block4046~e;
  $$block4046~e: stack0i := $Heap[this, Chunker.n]; goto $$block4046~d;
  $$block4046~d: assert (this != null); goto $$block4046~c;
  $$block4046~c: stack1o := $Heap[this, Chunker.src]; goto $$block4046~b;
  $$block4046~b: assert (stack1o != null); goto $$block4046~a;
  $$block4046~a: stack1i := $StringLength(stack1o); goto true4046to4080, false4046to4063;
  block4267: SS$Display.Return.Local := return.value; goto $$block4267~b;
  $$block4267~b: stack0b := return.value; goto $$block4267~a;
  $$block4267~a: $result := stack0b; return;
  true4046to4080: assume (stack0i > stack1i); goto block4080;
  false4046to4063: assume (stack0i <= stack1i); goto block4063;
  block4063: goto block4199;
  block4097: stack0b := throwException; goto true4097to4148, false4097to4114;
  true4097to4148: assume !stack0b; goto block4148;
  false4097to4114: assume stack0b; goto block4114;
  block4148: return.value := false; goto block4250;
  block4114: assume false; goto $$block4114~i;
  $$block4114~i: havoc stack50000o; goto $$block4114~h;
  $$block4114~h: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException)); goto $$block4114~g;
  $$block4114~g: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block4114~f;
  $$block4114~f: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block4114~e;
  $$block4114~e: assert (stack50000o != null); goto $$block4114~d;
  $$block4114~d: call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o); goto $$block4114~c;
  $$block4114~c: stack0o := stack50000o; goto $$block4114~b;
  $$block4114~b: assert (stack0o != null); goto $$block4114~a;
  $$block4114~a: assume false; return;
  block4199: goto block4216;
  block4216: goto block4233;
  block4233: return.value := true; goto block4250;
...
procedure Chunker.NextChunk(this : ref) returns ($result : ref where $IsNotNull($result, System.String));
  requires ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Chunker)) && ($Heap[this, $localinv] == $typeof(this)));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation Chunker.NextChunk(this : ref) returns ($result : ref) {
  ...
  var local6732 : ref where $Is(local6732, System.Exception);
  var stack0i : int;
  var stack1i : int;
  var stack1o : ref;
  var stack0b : bool;
  ...
  $$entry~c: assume ($Heap[this, $allocated] == true); goto block5406;
  block5406: goto block5661;
  block5661: goto block5678;
  block5678: temp0 := this; goto $$block5678~g;
  $$block5678~g: assert (temp0 != null); goto $$block5678~f;
  $$block5678~f: assert ((((($Heap[temp0, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[temp0, $ownerRef], $inv] <: $Heap[temp0, $ownerFrame])) || ($Heap[$Heap[temp0, $ownerRef], $localinv] == $BaseClass($Heap[temp0, $ownerFrame]))) && ($Heap[temp0, $inv] == Chunker)) && ($Heap[temp0, $localinv] == $typeof(temp0))); goto $$block5678~e;
  $$block5678~e: $Heap := $Heap[temp0, $inv := System.Object]; goto $$block5678~d;
  $$block5678~d: havoc temp1; goto $$block5678~c;
  $$block5678~c: $Heap := $Heap[temp0, $exposeVersion := temp1]; goto $$block5678~b;
  $$block5678~b: assume IsHeap($Heap); goto $$block5678~a;
  $$block5678~a: local6732 := null; goto block5695;
  block5695: goto block5712;
  block5712: assert (this != null); goto $$block5712~h;
  $$block5712~h: stack0i := $Heap[this, Chunker.n]; goto $$block5712~g;
  $$block5712~g: assert (this != null); goto $$block5712~f;
  $$block5712~f: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block5712~e;
  $$block5712~e: stack0i := (stack0i + stack1i); goto $$block5712~d;
  $$block5712~d: assert (this != null); goto $$block5712~c;
  $$block5712~c: stack1o := $Heap[this, Chunker.src]; goto $$block5712~b;
  $$block5712~b: assert (stack1o != null); goto $$block5712~a;
  $$block5712~a: stack1i := $StringLength(stack1o); goto true5712to5763, false5712to5729;
  true5712to5763: assume (stack0i > stack1i); goto block5763;
  false5712to5729: assume (stack0i <= stack1i); goto block5729;
  block5763: assert (this != null); goto $$block5763~e;
  $$block5763~e: stack0o := $Heap[this, Chunker.src]; goto $$block5763~d;
  $$block5763~d: assert (this != null); goto $$block5763~c;
  $$block5763~c: stack1i := $Heap[this, Chunker.n]; goto $$block5763~b;
  $$block5763~b: assert (stack0o != null); goto $$block5763~a;
  $$block5763~a: call s := System.String.Substring$System.Int32(stack0o, stack1i); goto block5780;
  block5729: assert (this != null); goto $$block5729~g;
  $$block5729~g: stack0o := $Heap[this, Chunker.src]; goto $$block5729~f;
  $$block5729~f: assert (this != null); goto $$block5729~e;
  $$block5729~e: stack1i := $Heap[this, Chunker.n]; goto $$block5729~d;
  $$block5729~d: assert (this != null); goto $$block5729~c;
  $$block5729~c: stack2i := $Heap[this, Chunker.ChunkSize]; goto $$block5729~b;
  $$block5729~b: assert (stack0o != null); goto $$block5729~a;
  $$block5729~a: call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i); goto block5746;
  block5746: goto block5780;
  block5780: goto block5797;
  block5797: assert (this != null); goto $$block5797~h;
  $$block5797~h: stack0i := $Heap[this, Chunker.n]; goto $$block5797~g;
  $$block5797~g: assert (this != null); goto $$block5797~f;
  $$block5797~f: stack1i := $Heap[this, Chunker.ChunkSize]; goto $$block5797~e;
  $$block5797~e: stack0i := (stack0i + stack1i); goto $$block5797~d;
  $$block5797~d: assert (this != null); goto $$block5797~c;
  $$block5797~c: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block5797~b;
  $$block5797~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block5797~a;
  $$block5797~a: assume IsHeap($Heap); goto block5814;
  block5814: stack0o := s; goto $$block5814~b;
  $$block5814~b: assert (stack0o != null); goto $$block5814~a;
  $$block5814~a: return.value := stack0o; goto block6205;
  block6205: stack0o := null; goto true6205to6307, false6205to6222;
  true6205to6307: assume (local6732 == stack0o); goto block6307;
  false6205to6222: assume (local6732 != stack0o); goto block6222;
  block6307: goto block6324;
  block6222: goto true6222to6307, false6222to6239;
  true6222to6307: assume ($As(local6732, Microsoft.Contracts.ICheckedException) != null); goto block6307;
  false6222to6239: assume ($As(local6732, Microsoft.Contracts.ICheckedException) == null); goto block6239;
  block6239: goto block6256;
  block6324: assert (temp0 != null); goto $$block6324~f;
  $$block6324~f: assert (($Heap[temp0, $inv] == System.Object) && ($Heap[temp0, $localinv] == $typeof(temp0))); goto $$block6324~e;
  $$block6324~e: assert (0 < $Heap[temp0, Chunker.ChunkSize]); goto $$block6324~d;
  $$block6324~d: assert ((0 <= $Heap[temp0, Chunker.n]) && ($Heap[temp0, Chunker.n] <= $StringLength($Heap[temp0, Chunker.src]))); goto $$block6324~c;
  $$block6324~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == temp0)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6324~b;
  $$block6324~b: $Heap := $Heap[temp0, $inv := Chunker]; goto $$block6324~a;
  $$block6324~a: assume IsHeap($Heap); goto block6256;
  block6256: goto block6273;
  block6273: goto block6290;
  block6290: goto block5967;
  block5967: goto block6171;
  block6171: goto block6188;
  block6188: SS$Display.Return.Local := return.value; goto $$block6188~b;
  $$block6188~b: stack0o := return.value; goto $$block6188~a;
  $$block6188~a: $result := stack0o; return;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this : ref, source$in : ref, chunkSize$in : int) {
  ...
  $$entry~d: assume ($Heap[this, Chunker.n] == 0); goto block7480;
  block7480: goto block7786;
  block7786: goto block7803;
  block7803: goto block7820;
  block7820: goto block7837;
  block7837: goto block7854;
  block7854: assert (this != null); goto $$block7854~l;
  $$block7854~l: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block7854~k;
  $$block7854~k: $Heap := $Heap[this, Chunker.src := source]; goto $$block7854~j;
  $$block7854~j: assume IsHeap($Heap); goto $$block7854~i;
  $$block7854~i: assert (this != null); goto $$block7854~h;
  $$block7854~h: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block7854~g;
  $$block7854~g: $Heap := $Heap[this, Chunker.ChunkSize := chunkSize]; goto $$block7854~f;
  $$block7854~f: assume IsHeap($Heap); goto $$block7854~e;
  $$block7854~e: stack0i := 0; goto $$block7854~d;
  $$block7854~d: assert (this != null); goto $$block7854~c;
  $$block7854~c: assert (!($Heap[this, $inv] <: Chunker) || ($Heap[this, $localinv] == System.Object)); goto $$block7854~b;
  $$block7854~b: $Heap := $Heap[this, Chunker.n := stack0i]; goto $$block7854~a;
  $$block7854~a: assume IsHeap($Heap); goto block7871;
  block7871: assert (this != null); goto $$block7871~a;
  $$block7871~a: call System.Object..ctor(this); goto block7990;
  ...
  $$block8041~e: assert (0 < $Heap[temp0, Chunker.ChunkSize]); goto $$block8041~d;
  $$block8041~d: assert ((0 <= $Heap[temp0, Chunker.n]) && ($Heap[temp0, Chunker.n] <= $StringLength($Heap[temp0, Chunker.src]))); goto $$block8041~c;
  $$block8041~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == temp0)) && ($Heap[$p, $ownerFrame] == Chunker)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block8041~b;
  $$block8041~b: $Heap := $Heap[temp0, $inv := Chunker]; goto $$block8041~a;
...
implementation Chunker..cctor() {
  entry: goto block8738;
  block8738: goto block8857;
