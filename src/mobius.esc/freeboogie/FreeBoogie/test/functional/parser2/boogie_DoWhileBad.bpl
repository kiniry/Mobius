...
implementation Test.Copy$System.Int32(n$in : int) returns ($result : int) {
  ...
  var stack0o : ref;
  var local3774 : int where InRange(local3774, System.Int32);
  var stack0i : int;
  var stack0b : bool;
  ...
  var $Heap$block3264$LoopPreheader : <x>[ref, name]x;
  entry: n := n$in; goto block3009;
  block3009: goto block3213;
  block3213: goto block3230;
  block3230: m := 0; goto block3247;
  block3247: i := 0; goto block3264$LoopPreheader;
  block3264: assume (((forall $o : ref :: (($Heap$block3264$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block3264$LoopPreheader[$ot, $allocated] == true) && ($Heap$block3264$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block3264$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block3264$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block3264$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block3264~d;
  $$block3264~d: assume (forall $o : ref :: ((($Heap$block3264$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block3264$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block3264$LoopPreheader[$o, $allocated] != true))); goto $$block3264~c;
  $$block3264~c: assume (forall $o : ref :: ((($Heap$block3264$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block3264~b;
  $$block3264~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block3264$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block3264$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block3264$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block3264~a;
  $$block3264~a: assert (m == i); goto block3417;
  block3417: goto block3434;
  block3434: m := i; goto block3451;
  block3451: local3774 := i; goto $$block3451~d;
  $$block3451~d: stack0i := 1; goto $$block3451~c;
  $$block3451~c: stack0i := (local3774 + stack0i); goto $$block3451~b;
  $$block3451~b: i := stack0i; goto $$block3451~a;
  $$block3451~a: stack0i := local3774; goto block3468;
  block3468: goto block3485;
  block3485: goto block3502;
  block3502: goto true3502to3264, false3502to3519;
  true3502to3264: assume (i != n); goto block3264;
  false3502to3519: assume (i == n); goto block3519;
  block3519: goto block3536;
  block3536: return.value := m; goto block3553;
  block3553: goto block3570;
  block3570: SS$Display.Return.Local := return.value; goto $$block3570~b;
  $$block3570~b: stack0i := return.value; goto $$block3570~a;
  $$block3570~a: $result := stack0i; return;
  block3264$LoopPreheader: $Heap$block3264$LoopPreheader := $Heap; goto block3264;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3927;
