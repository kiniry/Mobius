...
implementation Test.Copy$System.Int32(n$in : int) returns ($result : int) {
  ...
  var stack0o : ref;
  var local4318 : int where InRange(local4318, System.Int32);
  var stack0i : int;
  var local4335 : int where InRange(local4335, System.Int32);
  var stack0b : bool;
  ...
  var $Heap$block3570$LoopPreheader : <x>[ref, name]x;
  entry: n := n$in; goto block3315;
  block3315: goto block3519;
  block3519: goto block3536;
  block3536: m := 0; goto block3553;
  block3553: i := 0; goto block3570$LoopPreheader;
  block3570: assume (((forall $o : ref :: (($Heap$block3570$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block3570$LoopPreheader[$ot, $allocated] == true) && ($Heap$block3570$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block3570$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block3570$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block3570$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block3570~d;
  $$block3570~d: assume (forall $o : ref :: ((($Heap$block3570$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block3570$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block3570$LoopPreheader[$o, $allocated] != true))); goto $$block3570~c;
  $$block3570~c: assume (forall $o : ref :: ((($Heap$block3570$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block3570~b;
  $$block3570~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block3570$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block3570$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block3570$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block3570~a;
  $$block3570~a: assert (m == i); goto block3723;
  block3723: goto block3740;
  block3740: local4318 := m; goto $$block3740~d;
  $$block3740~d: stack0i := 1; goto $$block3740~c;
  $$block3740~c: stack0i := (local4318 + stack0i); goto $$block3740~b;
  $$block3740~b: m := stack0i; goto $$block3740~a;
  $$block3740~a: stack0i := local4318; goto block3757;
  block3757: goto block3774;
  block3774: local4335 := i; goto $$block3774~d;
  $$block3774~d: stack0i := 1; goto $$block3774~c;
  $$block3774~c: stack0i := (local4335 + stack0i); goto $$block3774~b;
  $$block3774~b: i := stack0i; goto $$block3774~a;
  $$block3774~a: stack0i := local4335; goto block3791;
  block3791: goto block3808;
  block3808: goto block3825;
  block3825: goto true3825to3570, false3825to3842;
  true3825to3570: assume (i != n); goto block3570;
  false3825to3842: assume (i == n); goto block3842;
  block3842: goto block3859;
  block3859: return.value := m; goto block3876;
  block3876: goto block4080;
  block4080: goto block4097;
  block4097: SS$Display.Return.Local := return.value; goto $$block4097~b;
  $$block4097~b: stack0i := return.value; goto $$block4097~a;
  $$block4097~a: $result := stack0i; return;
  block3570$LoopPreheader: $Heap$block3570$LoopPreheader := $Heap; goto block3570;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block4488;
  block4488: goto block4505;
  block4505: goto block4522;
  block4522: assert (this != null); goto $$block4522~a;
  $$block4522~a: call System.Object..ctor(this); goto block4539;
  block4539: goto block4556;
  block4556: assert (this != null); goto $$block4556~d;
  $$block4556~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4556~c;
  $$block4556~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4556~b;
  $$block4556~b: $Heap := $Heap[this, $inv := Test]; goto $$block4556~a;
  $$block4556~a: assume IsHeap($Heap); return;
