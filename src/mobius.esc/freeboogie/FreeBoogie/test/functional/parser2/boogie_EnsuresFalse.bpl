...
implementation C.foo(this : ref) returns ($result : int) {
  ...
  block1309: stack0o := $stringLiteral0; goto $$block1309~a;
  $$block1309~a: call System.Console.WriteLine$System.String(stack0o); return;
...
implementation C..ctor(this : ref) {
  ...
  $$block1666~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == C)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1666~b;
  $$block1666~b: $Heap := $Heap[this, $inv := C]; goto $$block1666~a;
