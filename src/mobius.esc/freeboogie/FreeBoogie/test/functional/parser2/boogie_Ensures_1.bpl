...
procedure Test.FooGood() returns ($result : int where InRange($result, System.Int32));
...
implementation Test.FooGood() returns ($result : int) {
  ...
  var stack0i : int;
  entry: goto block2720;
  block2720: goto block2737;
  block2737: return.value := 1; goto block2754;
  block2754: goto block2958;
  block2958: goto block2975;
  block2975: SS$Display.Return.Local := return.value; goto $$block2975~b;
  $$block2975~b: stack0i := return.value; goto $$block2975~a;
  $$block2975~a: $result := stack0i; return;
  
}

procedure Test.FooBad() returns ($result : int where InRange($result, System.Int32));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures true;
  free ensures InRange($result, System.Int32);
...
implementation Test.FooBad() returns ($result : int) {
  var return.value : int where InRange(return.value, System.Int32);
  var SS$Display.Return.Local : int where InRange(SS$Display.Return.Local, System.Int32);
  var stack0i : int;
  entry: goto block3451;
  block3451: goto block3468;
  block3468: return.value := 2; goto block3485;
  block3485: goto block3689;
  block3689: goto block3706;
  block3706: SS$Display.Return.Local := return.value; goto $$block3706~b;
  $$block3706~b: stack0i := return.value; goto $$block3706~a;
  $$block3706~a: $result := stack0i; return;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3893;
  block3893: goto block3910;
  block3910: goto block3927;
  block3927: assert (this != null); goto $$block3927~a;
  $$block3927~a: call System.Object..ctor(this); goto block3944;
  block3944: goto block3961;
  block3961: assert (this != null); goto $$block3961~d;
  $$block3961~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3961~c;
  $$block3961~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3961~b;
  $$block3961~b: $Heap := $Heap[this, $inv := Test]; goto $$block3961~a;
