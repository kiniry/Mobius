...
const ForLoop0 : name;
axiom (ForLoop0 <: ForLoop0);
axiom ($BaseClass(ForLoop0) == System.Object);
axiom ((ForLoop0 <: $BaseClass(ForLoop0)) && (AsDirectSubClass(ForLoop0, $BaseClass(ForLoop0)) == ForLoop0));
axiom (!$IsImmutable(ForLoop0) && ($AsMutable(ForLoop0) == ForLoop0));
axiom (forall $U : name :: {($U <: ForLoop0)} (($U <: ForLoop0) ==> ($U == ForLoop0)));
procedure ForLoop0.AForLoop$System.Int32(this : ref, N$in : int where InRange(N$in, System.Int32));
  free requires true;
...
implementation ForLoop0.AForLoop$System.Int32(this : ref, N$in : int) {
  ...
  entry: assume $IsNotNull(this, ForLoop0); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: N := N$in; goto block1275;
  block1275: goto block1292;
  block1292: i := 0; goto block1309$LoopPreheader;
  block1309: assume (((forall $o : ref :: (($Heap$block1309$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1309$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1309$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1309$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1309$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1309$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1309~c;
  $$block1309~c: assume (forall $o : ref :: ((($Heap$block1309$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1309$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1309$LoopPreheader[$o, $allocated] != true))); goto $$block1309~b;
  $$block1309~b: assume (forall $o : ref :: ((($Heap$block1309$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1309~a;
  $$block1309~a: assert (forall $o : ref :: ((($o != null) && ($Heap$block1309$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1309$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1309$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto true1309to1428, false1309to1326;
  true1309to1428: assume (i >= N); goto block1428;
  false1309to1326: assume (i < N); goto block1326;
  block1428: return;
  block1326: assert (i >= 0); goto block1411;
  block1411: local2 := i; goto $$block1411~d;
  $$block1411~d: stack0i := 1; goto $$block1411~c;
  $$block1411~c: stack0i := (local2 + stack0i); goto $$block1411~b;
  $$block1411~b: i := stack0i; goto $$block1411~a;
  $$block1411~a: stack0i := local2; goto block1309;
...
procedure ForLoop0..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == ForLoop0)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(ForLoop0 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation ForLoop0..ctor(this : ref) {
  entry: assume $IsNotNull(this, ForLoop0); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block1802;
  block1802: goto block1819;
  block1819: assert (this != null); goto $$block1819~f;
  $$block1819~f: call System.Object..ctor(this); goto $$block1819~e;
  $$block1819~e: assert (this != null); goto $$block1819~d;
  $$block1819~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block1819~c;
  $$block1819~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == ForLoop0)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block1819~b;
  $$block1819~b: $Heap := $Heap[this, $inv := ForLoop0]; goto $$block1819~a;
  $$block1819~a: assume IsHeap($Heap); return;
