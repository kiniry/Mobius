...
const System.Collections.Generic.IList`1...System.Int32 : name;
const Test : name;
const System.Collections.Generic.ICollection`1...System.Int32 : name;
...
const System.Collections.Generic.List`1...System.Int32 : name;
axiom (Test <: Test);
...
implementation Test.Main() {
  var stack50000o : ref;
  var stack0o : ref;
  var l : ref where $Is(l, System.Collections.Generic.List`1...System.Int32);
  var stack0i : int;
  entry: goto block8245;
  block8245: goto block8262;
  block8262: havoc stack50000o; goto $$block8262~g;
  $$block8262~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == System.Collections.Generic.List`1...System.Int32)); goto $$block8262~f;
  $$block8262~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block8262~e;
  $$block8262~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block8262~d;
  $$block8262~d: assert (stack50000o != null); goto $$block8262~c;
  $$block8262~c: call System.Collections.Generic.List`1...System.Int32..ctor(stack50000o); goto $$block8262~b;
  $$block8262~b: stack0o := stack50000o; goto $$block8262~a;
  $$block8262~a: l := stack0o; goto block8279;
  block8279: stack0i := 5; goto $$block8279~b;
  $$block8279~b: assert (l != null); goto $$block8279~a;
  $$block8279~a: call System.Collections.Generic.List`1...System.Int32.Add$System.Int32$.Virtual.$(l, stack0i); goto block8296;
  block8296: goto block8313;
  block8313: return;
  
}

axiom (System.Collections.Generic.List`1...System.Int32 <: System.Collections.Generic.List`1...System.Int32);
axiom ($BaseClass(System.Collections.Generic.List`1...System.Int32) == System.Object);
axiom ((System.Collections.Generic.List`1...System.Int32 <: $BaseClass(System.Collections.Generic.List`1...System.Int32)) && (AsDirectSubClass(System.Collections.Generic.List`1...System.Int32, $BaseClass(System.Collections.Generic.List`1...System.Int32)) == System.Collections.Generic.List`1...System.Int32));
axiom (!$IsImmutable(System.Collections.Generic.List`1...System.Int32) && ($AsMutable(System.Collections.Generic.List`1...System.Int32) == System.Collections.Generic.List`1...System.Int32));
axiom (System.Collections.Generic.IList`1...System.Int32 <: System.Object);
axiom (System.Collections.Generic.ICollection`1...System.Int32 <: System.Object);
...
axiom (System.Collections.Generic.ICollection`1...System.Int32 <: System.Collections.Generic.IEnumerable`1...System.Int32);
axiom (System.Collections.Generic.ICollection`1...System.Int32 <: System.Collections.IEnumerable);
axiom $IsMemberlessType(System.Collections.Generic.ICollection`1...System.Int32);
axiom (System.Collections.Generic.IList`1...System.Int32 <: System.Collections.Generic.ICollection`1...System.Int32);
axiom (System.Collections.Generic.IList`1...System.Int32 <: System.Collections.Generic.IEnumerable`1...System.Int32);
axiom (System.Collections.Generic.IList`1...System.Int32 <: System.Collections.IEnumerable);
axiom $IsMemberlessType(System.Collections.Generic.IList`1...System.Int32);
axiom (System.Collections.Generic.List`1...System.Int32 <: System.Collections.Generic.IList`1...System.Int32);
axiom (System.Collections.Generic.List`1...System.Int32 <: System.Collections.Generic.ICollection`1...System.Int32);
axiom (System.Collections.Generic.List`1...System.Int32 <: System.Collections.Generic.IEnumerable`1...System.Int32);
...
axiom (System.Collections.Generic.List`1...System.Int32 <: System.Collections.IList);
axiom (System.Collections.Generic.List`1...System.Int32 <: System.Collections.ICollection);
axiom (System.Collections.Generic.List`1...System.Int32 <: System.Collections.IEnumerable);
procedure System.Collections.Generic.List`1...System.Int32..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Collections.Generic.List`1...System.Int32)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(System.Collections.Generic.List`1...System.Int32 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

procedure System.Collections.Generic.List`1...System.Int32.Add$System.Int32$.Virtual.$(this : ref, item$in : int where InRange(item$in, System.Int32));
  free requires true;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block8772;
  block8772: goto block8789;
  block8789: goto block8806;
  block8806: assert (this != null); goto $$block8806~a;
  $$block8806~a: call System.Object..ctor(this); goto block8823;
  block8823: goto block8840;
  block8840: assert (this != null); goto $$block8840~d;
  $$block8840~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block8840~c;
  $$block8840~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block8840~b;
  $$block8840~b: $Heap := $Heap[this, $inv := Test]; goto $$block8840~a;
  $$block8840~a: assume IsHeap($Heap); return;
