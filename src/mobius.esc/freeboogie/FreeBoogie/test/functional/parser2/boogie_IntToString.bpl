...
implementation Test.Main() {
  var local2550 : int where InRange(local2550, System.Int32);
  var stack0o : ref;
  entry: goto block2414;
  block2414: goto block2431;
  block2431: local2550 := 5; goto $$block2431~a;
  $$block2431~a: havoc stack0o; goto block2448;
  block2448: call local2550, stack0o := System.Int32.ToString(local2550); goto $$block2448~a;
  $$block2448~a: call System.Console.WriteLine$System.String(stack0o); goto block2465;
...
procedure System.Int32.ToString(this$in : int) returns (this$out : int, $result : ref where $IsNotNull($result, System.String));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2686;
  block2686: goto block2703;
  block2703: goto block2720;
  block2720: assert (this != null); goto $$block2720~a;
  $$block2720~a: call System.Object..ctor(this); goto block2737;
  block2737: goto block2754;
  block2754: assert (this != null); goto $$block2754~d;
  $$block2754~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2754~c;
  $$block2754~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2754~b;
  $$block2754~b: $Heap := $Heap[this, $inv := Test]; goto $$block2754~a;
  $$block2754~a: assume IsHeap($Heap); return;
