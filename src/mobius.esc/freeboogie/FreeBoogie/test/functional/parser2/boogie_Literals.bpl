...
const int#4294967296 : int;
function #Test.Foo$System.String$notnull($$unnamed~fb : <x>[ref, name]x, $$unnamed~fa : ref) returns ($$unnamed~fc : bool);
function #Test.Quux$System.Int64($$unnamed~fe : <x>[ref, name]x, $$unnamed~fd : int) returns ($$unnamed~ff : bool);
axiom (100000 < int#4294967296);
axiom (Test <: Test);
...
axiom (forall $Heap : <x>[ref, name]x, s$in : ref :: {#Test.Foo$System.String$notnull($Heap, s$in)} (((IsHeap($Heap) && $IsNotNull(s$in, System.String)) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[s$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[s$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))) ==> (true && (#Test.Foo$System.String$notnull($Heap, s$in) == true))));
procedure Test.Foo$System.String$notnull(s$in : ref where $IsNotNull(s$in, System.String)) returns ($result : bool where true);
  ...
  free ensures ($result == #Test.Foo$System.String$notnull($Heap, s$in));
...
implementation Test.Foo$System.String$notnull(s$in : ref) returns ($result : bool) {
  var s : ref where $IsNotNull(s, System.String);
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  var stack0b : bool;
  entry: s := s$in; goto block2499;
  block2499: goto block2516;
  block2516: return.value := true; goto block2533;
  block2533: goto block2550;
  block2550: SS$Display.Return.Local := return.value; goto $$block2550~b;
  $$block2550~b: stack0b := return.value; goto $$block2550~a;
  $$block2550~a: $result := stack0b; return;
  
}

axiom (forall $Heap : <x>[ref, name]x, l$in : int :: {#Test.Quux$System.Int64($Heap, l$in)} ((IsHeap($Heap) && InRange(l$in, System.Int64)) ==> (true && (#Test.Quux$System.Int64($Heap, l$in) == true))));
procedure Test.Quux$System.Int64(l$in : int where InRange(l$in, System.Int64)) returns ($result : bool where true);
  free requires true;
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures true;
  ...
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures ($Heap == old($Heap));
  free ensures ($result == #Test.Quux$System.Int64($Heap, l$in));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} ((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: (((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv])) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode]));
...
implementation Test.Quux$System.Int64(l$in : int) returns ($result : bool) {
  var l : int where InRange(l, System.Int64);
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  var stack0b : bool;
  entry: l := l$in; goto block2788;
  block2788: goto block2805;
  block2805: return.value := true; goto block2822;
  block2822: goto block2839;
  block2839: SS$Display.Return.Local := return.value; goto $$block2839~b;
  $$block2839~b: stack0b := return.value; goto $$block2839~a;
  $$block2839~a: $result := stack0b; return;
  
}

procedure Test.Bar();
  requires #Test.Foo$System.String$notnull($Heap, $stringLiteral0);
  requires #Test.Quux$System.Int64($Heap, 0);
  requires #Test.Quux$System.Int64($Heap, int#4294967296);
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation Test.Bar() {
  entry: goto block3434;
  block3434: goto block3842;
  block3842: goto block3859;
  block3859: goto block3876;
  block3876: goto block3893;
  block3893: return;
  
}

axiom (forall $U : name :: {($U <: System.Double)} (($U <: System.Double) ==> ($U == System.Double)));
procedure Test.Quiz$System.Double$System.Double(x$in : real where true, y$in : real where true) returns ($result : real where true);
  free requires true;
  free requires true;
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation Test.Quiz$System.Double$System.Double(x$in : real, y$in : real) returns ($result : real) {
  var x : real where true;
  var y : real where true;
  var stack0r : real;
  var return.value : real where true;
  var SS$Display.Return.Local : real where true;
  entry: x := x$in; goto $$entry~a;
  $$entry~a: y := y$in; goto block4080;
  block4080: goto block4097;
  block4097: stack0r := #rdiv(x, y); goto $$block4097~a;
  $$block4097~a: return.value := stack0r; goto block4114;
  block4114: goto block4131;
  block4131: SS$Display.Return.Local := return.value; goto $$block4131~b;
  $$block4131~b: stack0r := return.value; goto $$block4131~a;
  $$block4131~a: $result := stack0r; return;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block4335;
  block4335: goto block4352;
  block4352: goto block4369;
  block4369: assert (this != null); goto $$block4369~a;
  $$block4369~a: call System.Object..ctor(this); goto block4386;
  block4386: goto block4403;
  block4403: assert (this != null); goto $$block4403~d;
  $$block4403~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4403~c;
  $$block4403~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4403~b;
  $$block4403~b: $Heap := $Heap[this, $inv := Test]; goto $$block4403~a;
  $$block4403~a: assume IsHeap($Heap); return;
