...
const Tools.Range_Enumerator.Values : name;
...
function #SeqOfInt.get_Count($$unnamed~fa : struct) returns ($$unnamed~fb : int);
axiom (forall this : struct :: (0 <= #SeqOfInt.get_Count(this)));
function #Tools.Range_Enumerable.a($$unnamed~fc : ref) returns ($$unnamed~fd : int);
axiom (forall $r : ref :: InRange(#Tools.Range_Enumerable.a($r), System.Int32));
function #Tools.Range_Enumerable.b($$unnamed~fe : ref) returns ($$unnamed~ff : int);
axiom (forall $r : ref :: InRange(#Tools.Range_Enumerable.b($r), System.Int32));
function #SeqOfInt.get_Item$System.Int32($$unnamed~fh : struct, $$unnamed~fg : int) returns ($$unnamed~fi : int);
function #Tools.Range_Enumerator.a($$unnamed~fj : ref) returns ($$unnamed~fk : int);
axiom (forall $r : ref :: InRange(#Tools.Range_Enumerator.a($r), System.Int32));
function #Tools.Range_Enumerator.b($$unnamed~fl : ref) returns ($$unnamed~fm : int);
axiom (forall $r : ref :: InRange(#Tools.Range_Enumerator.b($r), System.Int32));
axiom !IsStaticField(Tools.Range_Enumerator.Values);
axiom IsDirectlyModifiableField(Tools.Range_Enumerator.Values);
axiom (DeclType(Tools.Range_Enumerator.Values) == Tools.Range_Enumerator);
function #Tools.Range_Enumerator.get_Current($$unnamed~fo : <x>[ref, name]x, $$unnamed~fn : ref) returns ($$unnamed~fp : int);
function ##Tools.Range_Enumerator.get_Current($$unnamed~fq : exposeVersionType) returns ($$unnamed~fr : int);
axiom (forall $U : name :: {($U <: SeqOfInt)} (($U <: SeqOfInt) ==> ($U == SeqOfInt)));
axiom (forall this$in : struct :: {#SeqOfInt.get_Count(this$in)} (true ==> InRange(#SeqOfInt.get_Count(this$in), System.Int32)));
axiom (Tools <: Tools);
...
axiom (forall $oi : ref, $h : <x>[ref, name]x :: {($h[$oi, $inv] <: Tools.Range_Enumerable)} (((IsHeap($h) && ($h[$oi, $inv] <: Tools.Range_Enumerable)) && ($h[$oi, $localinv] != System.Object)) ==> (#Tools.Range_Enumerable.a($oi) <= #Tools.Range_Enumerable.b($oi))));
procedure Tools.Range_Body$System.Int32$System.Int32(a$in : int where InRange(a$in, System.Int32), b$in : int where InRange(b$in, System.Int32));
  free requires true;
  free requires true;
  requires (a$in <= b$in);
...
implementation Tools.Range_Body$System.Int32$System.Int32(a$in : int, b$in : int) {
  var a : int where InRange(a, System.Int32);
  var b : int where InRange(b, System.Int32);
  var stack0o : ref;
  var temp0 : struct;
  var values : struct where true;
  var x : int where InRange(x, System.Int32);
  var stack0b : bool;
  var stack1i : int;
  var local28560 : int where InRange(local28560, System.Int32);
  var stack0i : int;
  var $Heap$block26571$LoopPreheader : <x>[ref, name]x;
  entry: a := a$in; goto $$entry~a;
  $$entry~a: b := b$in; goto block25517;
  block25517: goto block25721;
  block25721: goto block25738;
  block25738: havoc stack0o; goto $$block25738~c;
  $$block25738~c: havoc temp0; goto $$block25738~b;
  $$block25738~b: assume ZeroInit(temp0, SeqOfInt); goto $$block25738~a;
  $$block25738~a: values := temp0; goto block25755;
  block25755: assume (#SeqOfInt.get_Count(values) == 0); goto block25908;
  block25908: goto block25925;
  block25925: assert (#SeqOfInt.get_Count(values) <= (b - a)); goto block26078;
  block26078: goto block26095;
  block26095: assert (forall ^i : int :: (((0 <= ^i) && (^i <= (#SeqOfInt.get_Count(values) - 1))) ==> (#SeqOfInt.get_Item$System.Int32(values, ^i) == (a + ^i)))); goto block26537;
  block26537: goto block26554;
  block26554: x := a; goto block26571$LoopPreheader;
  block26571: assume (((forall $o : ref :: (($Heap$block26571$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block26571$LoopPreheader[$ot, $allocated] == true) && ($Heap$block26571$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block26571$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block26571$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block26571$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block26571~f;
  $$block26571~f: assume (forall $o : ref :: ((($Heap$block26571$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block26571$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block26571$LoopPreheader[$o, $allocated] != true))); goto $$block26571~e;
  $$block26571~e: assume (forall $o : ref :: ((($Heap$block26571$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block26571~d;
  $$block26571~d: assert (forall $o : ref :: ((($o != null) && ($Heap$block26571$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block26571$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block26571$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block26571~c;
  $$block26571~c: assert (#SeqOfInt.get_Count(values) <= (b - a)); goto $$block26571~b;
  $$block26571~b: assert (forall ^i : int :: (((0 <= ^i) && (^i <= (#SeqOfInt.get_Count(values) - 1))) ==> (#SeqOfInt.get_Item$System.Int32(values, ^i) == (a + ^i)))); goto $$block26571~a;
  $$block26571~a: assert (x == (a + #SeqOfInt.get_Count(values))); goto block27115;
  block27115: goto block27132;
  block27132: goto true27132to27846, false27132to27149;
  true27132to27846: assume (x >= b); goto block27846;
  false27132to27149: assume (x < b); goto block27149;
  block27846: goto block27863;
  block27149: havoc stack0o; goto $$block27149~b;
  $$block27149~b: stack1i := x; goto $$block27149~a;
  $$block27149~a: call values := SeqOfInt.Add$System.Int32(values, stack1i); goto block27166;
  block27166: assert (#SeqOfInt.get_Count(values) <= (b - a)); goto block27319;
  block27863: assert (#SeqOfInt.get_Count(values) == (b - a)); goto block28016;
  block27319: goto block27336;
  block28016: goto block28033;
  block27336: assert (forall ^i : int :: (((0 <= ^i) && (^i <= (#SeqOfInt.get_Count(values) - 1))) ==> (#SeqOfInt.get_Item$System.Int32(values, ^i) == (a + ^i)))); goto block27778;
  block28033: goto block28050;
  block27778: goto block27795;
  block28050: return;
  block27795: local28560 := x; goto $$block27795~d;
  $$block27795~d: stack0i := 1; goto $$block27795~c;
  $$block27795~c: stack0i := (local28560 + stack0i); goto $$block27795~b;
  $$block27795~b: x := stack0i; goto $$block27795~a;
  $$block27795~a: stack0i := local28560; goto block27812;
  block27812: goto block27829;
  block27829: goto block26571;
  block26571$LoopPreheader: $Heap$block26571$LoopPreheader := $Heap; goto block26571;
...
axiom (forall this$in : struct, index$in : int :: {#SeqOfInt.get_Item$System.Int32(this$in, index$in)} (InRange(index$in, System.Int32) ==> InRange(#SeqOfInt.get_Item$System.Int32(this$in, index$in), System.Int32)));
procedure SeqOfInt.Add$System.Int32(this$in : struct, value$in : int where InRange(value$in, System.Int32)) returns (this$out : struct);
  free requires true;
  free requires ($BeingConstructed == null);
  modifies $Heap;
  ensures (#SeqOfInt.get_Count(this$out) == (old(#SeqOfInt.get_Count(this$in)) + 1));
  ensures (forall ^i : int :: (((0 <= ^i) && (^i <= (#SeqOfInt.get_Count(this$out) - 1))) ==> (#SeqOfInt.get_Item$System.Int32(this$out, ^i) == $IfThenElse((^i == (#SeqOfInt.get_Count(this$out) - 1)), value$in, #SeqOfInt.get_Item$System.Int32(old(this$in), ^i)))));
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
...
implementation Test.Main() {
  ...
  var stack0o : ref;
  var stack0b : bool;
  var $Heap$block29580$LoopPreheader : <x>[ref, name]x;
  entry: goto block29512;
  block29512: goto block29529;
  block29529: sum := 0; goto block29546;
  block29546: stack0i := 1; goto $$block29546~b;
  $$block29546~b: stack1i := 3; goto $$block29546~a;
  $$block29546~a: call c := Tools.Range$System.Int32$System.Int32(stack0i, stack1i); goto block29563;
  block29563: assert (c != null); goto $$block29563~a;
  $$block29563~a: call e := Tools.Range_Enumerable.GetEnumerator(c); goto block29580$LoopPreheader;
  block29580: assume (((forall $o : ref :: (($Heap$block29580$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block29580$LoopPreheader[$ot, $allocated] == true) && ($Heap$block29580$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block29580$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block29580$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block29580$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block29580~g;
  $$block29580~g: assume (forall $o : ref :: ((($Heap$block29580$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block29580$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block29580$LoopPreheader[$o, $allocated] != true))); goto $$block29580~f;
  $$block29580~f: assume (forall $o : ref :: ((($Heap$block29580$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block29580~e;
  $$block29580~e: assert (forall $o : ref :: ((($o != null) && ($Heap$block29580$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block29580$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block29580$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block29580~d;
  $$block29580~d: assert ((#SeqOfInt.get_Count($Heap[e, Tools.Range_Enumerator.Values]) == 0) ==> (sum == 0)); goto $$block29580~c;
  $$block29580~c: assert ((#SeqOfInt.get_Count($Heap[e, Tools.Range_Enumerator.Values]) == 1) ==> (sum == 1)); goto $$block29580~b;
  $$block29580~b: assert ((#SeqOfInt.get_Count($Heap[e, Tools.Range_Enumerator.Values]) == 2) ==> (sum == 3)); goto $$block29580~a;
  $$block29580~a: assert (((($Heap[e, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[e, $ownerRef], $inv] <: $Heap[e, $ownerFrame])) || ($Heap[$Heap[e, $ownerRef], $localinv] == $BaseClass($Heap[e, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[e, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[e, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))); goto block30396;
  block30396: goto block30413;
  block30413: assert (e != null); goto $$block30413~a;
  $$block30413~a: call stack0b := Tools.Range_Enumerator.MoveNext(e); goto true30413to30464, false30413to30430;
  true30413to30464: assume !stack0b; goto block30464;
  false30413to30430: assume stack0b; goto block30430;
  block30464: goto block30481;
  block30430: assert (e != null); goto $$block30430~c;
  $$block30430~c: call stack0i := Tools.Range_Enumerator.get_Current(e); goto $$block30430~b;
  $$block30430~b: stack0i := (sum + stack0i); goto $$block30430~a;
  $$block30430~a: sum := stack0i; goto block30447;
  block30447: goto block29580;
  block30481: assert (sum == 3); goto block30634;
  block30634: goto block30651;
  block30651: goto block30668;
  block30668: return;
  block29580$LoopPreheader: $Heap$block29580$LoopPreheader := $Heap; goto block29580;
...
procedure Tools.Range$System.Int32$System.Int32(a$in : int where InRange(a$in, System.Int32), b$in : int where InRange(b$in, System.Int32)) returns ($result : ref where $IsNotNull($result, Tools.Range_Enumerable));
  ...
  ensures ((#Tools.Range_Enumerable.a($result) == a$in) && (#Tools.Range_Enumerable.b($result) == b$in));
...
procedure Tools.Range_Enumerable.GetEnumerator(this : ref) returns ($result : ref where $IsNotNull($result, Tools.Range_Enumerator));
  ...
  ensures (#Tools.Range_Enumerator.a($result) == #Tools.Range_Enumerable.a(this));
  ensures (#Tools.Range_Enumerator.b($result) == #Tools.Range_Enumerable.b(this));
  ensures (#SeqOfInt.get_Count($Heap[$result, Tools.Range_Enumerator.Values]) == 0);
  ensures (($Heap[$result, $ownerFrame] == $PeerGroupPlaceholder) && (forall $fpc : ref :: ((($fpc != null) && (old($Heap)[$fpc, $allocated] == true)) ==> !(($Heap[$fpc, $ownerRef] == $Heap[$result, $ownerRef]) && ($Heap[$fpc, $ownerFrame] == $Heap[$result, $ownerFrame])))));
  ensures (((($Heap[$result, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[$result, $ownerRef], $inv] <: $Heap[$result, $ownerFrame])) || ($Heap[$Heap[$result, $ownerRef], $localinv] == $BaseClass($Heap[$result, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[$result, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[$result, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
procedure Tools.Range_Enumerator.MoveNext(this : ref) returns ($result : bool where true);
  ...
  free ensures true;
  free ensures true;
  ensures (#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values]) <= (#Tools.Range_Enumerator.b(this) - #Tools.Range_Enumerator.a(this)));
  ensures (forall ^i : int :: (((0 <= ^i) && (^i <= (#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values]) - 1))) ==> (#SeqOfInt.get_Item$System.Int32($Heap[this, Tools.Range_Enumerator.Values], ^i) == (#Tools.Range_Enumerator.a(this) + ^i))));
  ensures (($result == true) ==> (#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values]) == (old(#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values])) + 1)));
  ensures (($result == false) ==> (#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values]) == old(#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values]))));
  ensures (($result == false) ==> (#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values]) == (#Tools.Range_Enumerator.b(this) - #Tools.Range_Enumerator.a(this))));
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && old(true)) && old((($o != this) || ($f != $exposeVersion)))) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
...
axiom (forall $Heap : <x>[ref, name]x, this : ref :: {#Tools.Range_Enumerator.get_Current($Heap, this)} ((IsHeap($Heap) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))) ==> InRange(#Tools.Range_Enumerator.get_Current($Heap, this), System.Int32)));
...
procedure Tools.Range_Enumerator.get_Current(this : ref) returns ($result : int where InRange($result, System.Int32));
  ...
  ensures ($result == #SeqOfInt.get_Item$System.Int32($Heap[this, Tools.Range_Enumerator.Values], (#SeqOfInt.get_Count($Heap[this, Tools.Range_Enumerator.Values]) - 1)));
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
