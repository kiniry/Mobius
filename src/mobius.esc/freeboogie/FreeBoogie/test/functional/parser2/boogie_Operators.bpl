...
const Operators : name;
axiom (Operators <: Operators);
axiom ($BaseClass(Operators) == System.Object);
axiom ((Operators <: $BaseClass(Operators)) && (AsDirectSubClass(Operators, $BaseClass(Operators)) == Operators));
axiom (!$IsImmutable(Operators) && ($AsMutable(Operators) == Operators));
axiom (forall $U : name :: {($U <: System.Boolean)} (($U <: System.Boolean) ==> ($U == System.Boolean)));
procedure Operators.M$System.Int32$System.Int32$System.Boolean$System.Object.array$notnull(this : ref, x$in : int where InRange(x$in, System.Int32), y$in : int where InRange(y$in, System.Int32), c$in : bool where true, a$in : ref where $IsNotNull(a$in, RefArray(System.Object, 1))) returns ($result : bool where true);
  free requires true;
  free requires true;
  free requires true;
  free requires ($Heap[a$in, $allocated] == true);
  requires ((0 - x$in) < x$in);
  requires (c$in <==> (x$in < y$in));
  requires ((#or(x$in, y$in) == 0) || c$in);
  requires ((#and(x$in, y$in) == 0) && c$in);
  requires ((#xor(x$in, y$in) == x$in) <==> !c$in);
  requires ((#shl(x$in, y$in) == 6) ==> (#shr(x$in, y$in) == 8));
...
implementation Operators.M$System.Int32$System.Int32$System.Boolean$System.Object.array$notnull(this : ref, x$in : int, y$in : int, c$in : bool, a$in : ref) returns ($result : bool) {
  var x : int where InRange(x, System.Int32);
  var y : int where InRange(y, System.Int32);
  var c : bool where true;
  var a : ref where $IsNotNull(a, RefArray(System.Object, 1));
  var stack0i : int;
  var stack0b : bool;
  ...
  entry: assume $IsNotNull(this, Operators); goto $$entry~e;
  $$entry~e: assume ($Heap[this, $allocated] == true); goto $$entry~d;
  $$entry~d: x := x$in; goto $$entry~c;
  $$entry~c: y := y$in; goto $$entry~b;
  $$entry~b: c := c$in; goto $$entry~a;
  $$entry~a: a := a$in; goto block3587;
  block3587: goto block4403;
  block4403: stack0i := x; goto $$block4403~a;
  $$block4403~a: stack0i := (0 - stack0i); goto true4403to4437, false4403to4420;
  true4403to4437: assume (stack0i < x); goto block4437;
  false4403to4420: assume (stack0i >= x); goto block4420;
  block4437: stack0b := true; goto block4454;
  block4420: stack0b := false; goto block4454;
  block4454: b := stack0b; goto $$block4454~a;
  $$block4454~a: stack0b := c; goto true4454to4488, false4454to4471;
  true4454to4488: assume (x < y); goto block4488;
  false4454to4471: assume (x >= y); goto block4471;
  block4488: stack1b := true; goto block4505;
  block4471: stack1b := false; goto block4505;
  block4505: goto true4505to4539, false4505to4522;
  true4505to4539: assume (stack0b == stack1b); goto block4539;
  false4505to4522: assume (stack0b != stack1b); goto block4522;
  block4539: stack0b := true; goto block4556;
  block4522: stack0b := false; goto block4556;
  block4556: b := stack0b; goto $$block4556~b;
  $$block4556~b: stack0i := #or(x, y); goto $$block4556~a;
  $$block4556~a: stack1i := 0; goto true4556to4590, false4556to4573;
  true4556to4590: assume (stack0i == stack1i); goto block4590;
  false4556to4573: assume (stack0i != stack1i); goto block4573;
  block4590: stack0b := true; goto block4607;
  block4573: stack0b := false; goto block4607;
  block4607: stack0b := (stack0b || c); goto $$block4607~c;
  $$block4607~c: b := stack0b; goto $$block4607~b;
  $$block4607~b: stack0i := #and(x, y); goto $$block4607~a;
  $$block4607~a: stack1i := 0; goto true4607to4641, false4607to4624;
  true4607to4641: assume (stack0i == stack1i); goto block4641;
  false4607to4624: assume (stack0i != stack1i); goto block4624;
  block4641: stack0b := true; goto block4658;
  block4624: stack0b := false; goto block4658;
  block4658: stack0b := (stack0b && c); goto $$block4658~b;
  $$block4658~b: b := stack0b; goto $$block4658~a;
  $$block4658~a: stack0i := #xor(x, y); goto true4658to4692, false4658to4675;
  true4658to4692: assume (stack0i == x); goto block4692;
  false4658to4675: assume (stack0i != x); goto block4675;
  block4692: stack0b := true; goto block4709;
  block4675: stack0b := false; goto block4709;
  block4709: b := stack0b; goto $$block4709~b;
  $$block4709~b: stack0i := #shl(x, y); goto $$block4709~a;
  $$block4709~a: stack1i := 6; goto true4709to4794, false4709to4726;
  true4709to4794: assume (stack0i != stack1i); goto block4794;
  false4709to4726: assume (stack0i == stack1i); goto block4726;
  block4794: stack0b := true; goto block4811;
  block4726: stack0i := #shr(x, y); goto $$block4726~a;
  $$block4726~a: stack1i := 8; goto true4726to4760, false4726to4743;
  true4726to4760: assume (stack0i == stack1i); goto block4760;
  false4726to4743: assume (stack0i != stack1i); goto block4743;
  block4760: stack0b := true; goto block4777;
  block4743: stack0b := false; goto block4777;
  block4811: b := stack0b; goto $$block4811~c;
  $$block4811~c: assert (a != null); goto $$block4811~b;
  $$block4811~b: stack0i := $Length(a); goto $$block4811~a;
  $$block4811~a: stack1i := 12; goto true4811to4845, false4811to4828;
  true4811to4845: assume (stack0i == stack1i); goto block4845;
  false4811to4828: assume (stack0i != stack1i); goto block4828;
  block4845: stack0b := true; goto block4862;
  block4828: stack0b := false; goto block4862;
  block4777: goto block4811;
  block4862: goto true4862to4896, false4862to4879;
  true4862to4896: assume stack0b; goto block4896;
  false4862to4879: assume !stack0b; goto block4879;
  block4896: stack0b := false; goto block4913;
  block4879: stack0b := true; goto block4913;
  block4913: b := stack0b; goto $$block4913~a;
  $$block4913~a: return.value := b; goto block4930;
  block4930: SS$Display.Return.Local := return.value; goto $$block4930~b;
  $$block4930~b: stack0b := return.value; goto $$block4930~a;
  $$block4930~a: $result := stack0b; return;
  
}

procedure Operators.P$System.Boolean$System.Boolean(this : ref, b$in : bool where true, c$in : bool where true) returns ($result : bool where true);
  free requires true;
  free requires true;
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
...
implementation Operators.P$System.Boolean$System.Boolean(this : ref, b$in : bool, c$in : bool) returns ($result : bool) {
  var b : bool where true;
  var c : bool where true;
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  var stack0b : bool;
  entry: assume $IsNotNull(this, Operators); goto $$entry~h;
  $$entry~h: assume ($Heap[this, $allocated] == true); goto $$entry~g;
  $$entry~g: b := b$in; goto $$entry~f;
  $$entry~f: c := c$in; goto block6545;
  block6545: goto block6562;
  block6562: return.value := b; goto block6579;
  block6579: SS$Display.Return.Local := return.value; goto $$block6579~b;
  $$block6579~b: stack0b := return.value; goto $$block6579~a;
  $$block6579~a: $result := stack0b; return;
  
}

procedure Operators..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Operators)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Operators <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation Operators..ctor(this : ref) {
  entry: assume $IsNotNull(this, Operators); goto $$entry~j;
  $$entry~j: assume ($Heap[this, $allocated] == true); goto $$entry~i;
  $$entry~i: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block6800;
  block6800: goto block6817;
  block6817: assert (this != null); goto $$block6817~f;
  $$block6817~f: call System.Object..ctor(this); goto $$block6817~e;
  $$block6817~e: assert (this != null); goto $$block6817~d;
  $$block6817~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block6817~c;
  $$block6817~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Operators)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6817~b;
  $$block6817~b: $Heap := $Heap[this, $inv := Operators]; goto $$block6817~a;
