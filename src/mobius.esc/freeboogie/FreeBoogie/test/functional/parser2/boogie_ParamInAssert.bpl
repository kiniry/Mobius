...
procedure Test.Foo$System.Int32(x$in : int where InRange(x$in, System.Int32));
  free requires true;
  requires (0 <= x$in);
...
implementation Test.Foo$System.Int32(x$in : int) {
  var x : int where InRange(x, System.Int32);
  var local3468 : int where InRange(local3468, System.Int32);
  var stack0i : int;
  var stack0o : ref;
  entry: x := x$in; goto block2873;
  block2873: goto block3077;
  block3077: goto block3094;
  block3094: local3468 := x; goto $$block3094~d;
  $$block3094~d: stack0i := 1; goto $$block3094~c;
  $$block3094~c: stack0i := (local3468 + stack0i); goto $$block3094~b;
  $$block3094~b: x := stack0i; goto $$block3094~a;
  $$block3094~a: stack0i := local3468; goto block3111;
  block3111: goto block3128;
  block3128: assert (1 <= x); goto block3281;
...
procedure Test.Bar$System.Int32(x$in : int where InRange(x$in, System.Int32));
  free requires true;
  requires (0 <= x$in);
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation Test.Bar$System.Int32(x$in : int) {
  var x : int where InRange(x, System.Int32);
  var local4607 : int where InRange(local4607, System.Int32);
  var stack0i : int;
  var stack0o : ref;
  entry: x := x$in; goto block4029;
  block4029: goto block4233;
  block4233: goto block4250;
  block4250: local4607 := x; goto $$block4250~d;
  $$block4250~d: stack0i := 1; goto $$block4250~c;
  $$block4250~c: stack0i := (local4607 - stack0i); goto $$block4250~b;
  $$block4250~b: x := stack0i; goto $$block4250~a;
  $$block4250~a: stack0i := local4607; goto block4267;
  block4267: goto block4284;
  block4284: assert (0 <= x); goto block4437;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block4709;
  block4709: goto block4726;
  block4726: goto block4743;
  block4743: assert (this != null); goto $$block4743~a;
  $$block4743~a: call System.Object..ctor(this); goto block4760;
  block4760: goto block4777;
  block4777: assert (this != null); goto $$block4777~d;
  $$block4777~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4777~c;
  $$block4777~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4777~b;
  $$block4777~b: $Heap := $Heap[this, $inv := Test]; goto $$block4777~a;
  $$block4777~a: assume IsHeap($Heap); return;
