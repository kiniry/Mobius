...
const MyInterface`2...System.String`~`System.String : name;
const MyInterface`2..type.parameter.TValue : name;
const MyInterface`2..type.parameter.TKey : name;
const MyInterface`2 : name;
const System.IConvertible : name;
axiom (MyInterface`2 <: System.Object);
axiom $IsMemberlessType(MyInterface`2);
axiom (forall $U : name :: {($U <: System.Boolean)} (($U <: System.Boolean) ==> ($U == System.Boolean)));
axiom (MyInterface`2..type.parameter.TKey <: MyInterface`2..type.parameter.TKey);
axiom $IsMemberlessType(MyInterface`2..type.parameter.TKey);
axiom (MyInterface`2..type.parameter.TValue <: MyInterface`2..type.parameter.TValue);
axiom $IsMemberlessType(MyInterface`2..type.parameter.TValue);
procedure MyInterface`2.TryGetValue$MyInterface`2..type.parameter.TKey$type.parameter.TValue.ptr(this : ref, key$in : ref where $Is(key$in, MyInterface`2..type.parameter.TKey)) returns ($result : bool where true, val$out : ref where $Is(val$out, MyInterface`2..type.parameter.TValue));
  free requires ($Heap[key$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires ((key$in == null) || (((($Heap[key$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[key$in, $ownerRef], $inv] <: $Heap[key$in, $ownerFrame])) || ($Heap[$Heap[key$in, $ownerRef], $localinv] == $BaseClass($Heap[key$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[key$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[key$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures true;
  free ensures true;
  free ensures ($Heap[val$out, $allocated] == true);
  free ensures $Is(val$out, MyInterface`2..type.parameter.TValue);
  ensures ($result ==> (val$out != null));
...
implementation Test.Main() {
  entry: goto block1224;
  block1224: goto block1241;
  block1241: return;
  
}

axiom (MyInterface`2...System.String`~`System.String <: System.Object);
axiom $IsMemberlessType(MyInterface`2...System.String`~`System.String);
procedure Test.foo$MyInterface`2...System.String`~`System.String$notnull(this : ref, bar$in : ref where $IsNotNull(bar$in, MyInterface`2...System.String`~`System.String));
  free requires ($Heap[bar$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires (((($Heap[bar$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[bar$in, $ownerRef], $inv] <: $Heap[bar$in, $ownerFrame])) || ($Heap[$Heap[bar$in, $ownerRef], $localinv] == $BaseClass($Heap[bar$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[bar$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[bar$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation Test.foo$MyInterface`2...System.String`~`System.String$notnull(this : ref, bar$in : ref) {
  var bar : ref where $IsNotNull(bar, MyInterface`2...System.String`~`System.String);
  var stack0o : ref;
  var stack1o : ref;
  var stack0b : bool;
  ...
  $$entry~a: bar := bar$in; goto block2244;
  block2244: goto block2346;
  block2346: stack0o := $stringLiteral0; goto $$block2346~c;
  $$block2346~c: havoc stack1o; goto $$block2346~b;
  $$block2346~b: assert (bar != null); goto $$block2346~a;
  $$block2346~a: call stack0b, s := MyInterface`2...System.String`~`System.String.TryGetValue$System.String$System.String.ptr$.Virtual.$(bar, stack0o); goto true2346to2380, false2346to2363;
  true2346to2380: assume stack0b; goto block2380;
  false2346to2363: assume !stack0b; goto block2363;
  block2380: stack0o := s; goto $$block2380~e;
  $$block2380~e: assert (stack0o != null); goto $$block2380~d;
  $$block2380~d: stack0o := stack0o; goto $$block2380~c;
  $$block2380~c: assert (stack0o != null); goto $$block2380~b;
  $$block2380~b: stack0i := $StringLength(stack0o); goto $$block2380~a;
  $$block2380~a: call System.Console.WriteLine$System.Int32(stack0i); return;
  block2363: s := $stringLiteral1; goto block2380;
...
procedure MyInterface`2...System.String`~`System.String.TryGetValue$System.String$System.String.ptr$.Virtual.$(this : ref, key$in : ref where $Is(key$in, System.String)) returns ($result : bool where true, val$out : ref where $Is(val$out, System.String));
  free requires ($Heap[key$in, $allocated] == true);
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires ((key$in == null) || (((($Heap[key$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[key$in, $ownerRef], $inv] <: $Heap[key$in, $ownerFrame])) || ($Heap[$Heap[key$in, $ownerRef], $localinv] == $BaseClass($Heap[key$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[key$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[key$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
  ...
  free ensures true;
  free ensures ($Heap[val$out, $allocated] == true);
  free ensures $Is(val$out, System.String);
  ensures ($result ==> (val$out != null));
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~c: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2805;
  block2805: goto block2822;
  block2822: assert (this != null); goto $$block2822~f;
  $$block2822~f: call System.Object..ctor(this); goto $$block2822~e;
  $$block2822~e: assert (this != null); goto $$block2822~d;
  $$block2822~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2822~c;
  $$block2822~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2822~b;
  $$block2822~b: $Heap := $Heap[this, $inv := Test]; goto $$block2822~a;
  $$block2822~a: assume IsHeap($Heap); return;
...
axiom (((forall heap : <x>[ref, name]x :: {heap[$stringLiteral0, $allocated]} (IsHeap(heap) ==> heap[$stringLiteral0, $allocated])) && $IsNotNull($stringLiteral0, System.String)) && ($StringLength($stringLiteral0) == 3));
