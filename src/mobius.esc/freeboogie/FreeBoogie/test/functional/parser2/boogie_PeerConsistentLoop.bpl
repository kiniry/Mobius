...
axiom (Coll <: Coll);
axiom ($BaseClass(Coll) == System.Object);
axiom ((Coll <: $BaseClass(Coll)) && (AsDirectSubClass(Coll, $BaseClass(Coll)) == Coll));
axiom (!$IsImmutable(Coll) && ($AsMutable(Coll) == Coll));
procedure C.M0$System.Int32(this : ref, n$in : int where InRange(n$in, System.Int32)) returns ($result : ref where $Is($result, Coll));
  free requires true;
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
  free ensures $Is($result, Coll);
...
implementation C.M0$System.Int32(this : ref, n$in : int) returns ($result : ref) {
  var n : int where InRange(n, System.Int32);
  var stack50000o : ref;
  var stack0o : ref;
  var coll : ref where $Is(coll, Coll);
  var i : int where InRange(i, System.Int32);
  var stack0b : bool;
  var local3757 : int where InRange(local3757, System.Int32);
  var stack0i : int;
  var return.value : ref where $Is(return.value, Coll);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, Coll);
  var $Heap$block3230$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, C); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: n := n$in; goto block3179;
  block3179: goto block3196;
  block3196: havoc stack50000o; goto $$block3196~g;
  $$block3196~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Coll)); goto $$block3196~f;
  $$block3196~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block3196~e;
  $$block3196~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block3196~d;
  $$block3196~d: assert (stack50000o != null); goto $$block3196~c;
  $$block3196~c: call Coll..ctor(stack50000o); goto $$block3196~b;
  $$block3196~b: stack0o := stack50000o; goto $$block3196~a;
  $$block3196~a: coll := stack0o; goto block3213;
  block3213: i := 0; goto block3230$LoopPreheader;
  block3230: assume (((forall $o : ref :: (($Heap$block3230$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block3230$LoopPreheader[$ot, $allocated] == true) && ($Heap$block3230$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block3230$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block3230$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block3230$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block3230~d;
  $$block3230~d: assume (forall $o : ref :: ((($Heap$block3230$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block3230$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block3230$LoopPreheader[$o, $allocated] != true))); goto $$block3230~c;
  $$block3230~c: assume (forall $o : ref :: ((($Heap$block3230$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block3230~b;
  $$block3230~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block3230$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block3230$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block3230$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block3230~a;
  $$block3230~a: assert (((($Heap[coll, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[coll, $ownerRef], $inv] <: $Heap[coll, $ownerFrame])) || ($Heap[$Heap[coll, $ownerRef], $localinv] == $BaseClass($Heap[coll, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[coll, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[coll, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))); goto block3383;
  block3383: goto block3400;
  block3400: goto true3400to3485, false3400to3417;
  true3400to3485: assume (i >= n); goto block3485;
  false3400to3417: assume (i < n); goto block3417;
  block3485: goto block3502;
  block3417: assert (coll != null); goto $$block3417~a;
  $$block3417~a: call Coll.P(coll); goto block3434;
  block3434: local3757 := i; goto $$block3434~d;
  $$block3434~d: stack0i := 1; goto $$block3434~c;
  $$block3434~c: stack0i := (local3757 + stack0i); goto $$block3434~b;
  $$block3434~b: i := stack0i; goto $$block3434~a;
  $$block3434~a: stack0i := local3757; goto block3451;
  block3502: return.value := coll; goto block3519;
  block3451: goto block3468;
  block3519: goto block3536;
  block3468: goto block3230;
  block3536: SS$Display.Return.Local := return.value; goto $$block3536~b;
  $$block3536~b: stack0o := return.value; goto $$block3536~a;
  $$block3536~a: $result := stack0o; return;
  block3230$LoopPreheader: $Heap$block3230$LoopPreheader := $Heap; goto block3230;
  
}

procedure Coll..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Coll)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Coll <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
...
procedure C.M1$System.Int32(this : ref, n$in : int where InRange(n$in, System.Int32)) returns ($result : ref where $Is($result, Coll));
  free requires true;
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation C.M1$System.Int32(this : ref, n$in : int) returns ($result : ref) {
  var n : int where InRange(n, System.Int32);
  var stack50000o : ref;
  var stack0o : ref;
  var coll : ref where $Is(coll, Coll);
  var i : int where InRange(i, System.Int32);
  var stack0b : bool;
  var local4437 : int where InRange(local4437, System.Int32);
  var stack0i : int;
  var return.value : ref where $Is(return.value, Coll);
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, Coll);
  var $Heap$block4131$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, C); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: n := n$in; goto block4080;
  block4080: goto block4097;
  block4097: havoc stack50000o; goto $$block4097~g;
  $$block4097~g: assume ((($Heap[stack50000o, $allocated] == false) && (stack50000o != null)) && ($typeof(stack50000o) == Coll)); goto $$block4097~f;
  $$block4097~f: assume (($Heap[stack50000o, $ownerRef] == stack50000o) && ($Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder)); goto $$block4097~e;
  $$block4097~e: $Heap := $Heap[stack50000o, $allocated := true]; goto $$block4097~d;
  $$block4097~d: assert (stack50000o != null); goto $$block4097~c;
  $$block4097~c: call Coll..ctor(stack50000o); goto $$block4097~b;
  $$block4097~b: stack0o := stack50000o; goto $$block4097~a;
  $$block4097~a: coll := stack0o; goto block4114;
  block4114: i := 0; goto block4131$LoopPreheader;
  block4131: assume (((forall $o : ref :: (($Heap$block4131$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block4131$LoopPreheader[$ot, $allocated] == true) && ($Heap$block4131$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block4131$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block4131$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block4131$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block4131~c;
  $$block4131~c: assume (forall $o : ref :: ((($Heap$block4131$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block4131$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block4131$LoopPreheader[$o, $allocated] != true))); goto $$block4131~b;
  $$block4131~b: assume (forall $o : ref :: ((($Heap$block4131$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block4131~a;
  $$block4131~a: assert (forall $o : ref :: ((($o != null) && ($Heap$block4131$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block4131$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block4131$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto true4131to4216, false4131to4148;
  true4131to4216: assume (i >= n); goto block4216;
  false4131to4148: assume (i < n); goto block4148;
  block4216: goto block4233;
  block4148: assert (coll != null); goto $$block4148~a;
  $$block4148~a: call Coll.P(coll); goto block4165;
  block4165: local4437 := i; goto $$block4165~d;
  $$block4165~d: stack0i := 1; goto $$block4165~c;
  $$block4165~c: stack0i := (local4437 + stack0i); goto $$block4165~b;
  $$block4165~b: i := stack0i; goto $$block4165~a;
  $$block4165~a: stack0i := local4437; goto block4182;
  block4233: return.value := coll; goto block4250;
  block4182: goto block4199;
  block4250: goto block4267;
  block4199: goto block4131;
  block4267: SS$Display.Return.Local := return.value; goto $$block4267~b;
  $$block4267~b: stack0o := return.value; goto $$block4267~a;
  $$block4267~a: $result := stack0o; return;
  block4131$LoopPreheader: $Heap$block4131$LoopPreheader := $Heap; goto block4131;
  
}

procedure C.M$Coll$System.Int32(this : ref, coll$in : ref where $Is(coll$in, Coll), n$in : int where InRange(n$in, System.Int32)) returns ($result : ref where $Is($result, Coll));
  free requires ($Heap[coll$in, $allocated] == true);
  free requires true;
  requires (((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[this, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  requires ((coll$in == null) || (((($Heap[coll$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[coll$in, $ownerRef], $inv] <: $Heap[coll$in, $ownerFrame])) || ($Heap[$Heap[coll$in, $ownerRef], $localinv] == $BaseClass($Heap[coll$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[coll$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[coll$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures ($Heap[$result, $allocated] == true);
  free ensures $Is($result, Coll);
...
implementation C.M$Coll$System.Int32(this : ref, coll$in : ref, n$in : int) returns ($result : ref) {
  var coll : ref where $Is(coll, Coll);
  var n : int where InRange(n, System.Int32);
  var stack0o : ref;
  var i : int where InRange(i, System.Int32);
  var stack0b : bool;
  var return.value : ref where $Is(return.value, Coll);
  var local5389 : int where InRange(local5389, System.Int32);
  var stack0i : int;
  var SS$Display.Return.Local : ref where $Is(SS$Display.Return.Local, Coll);
  var $Heap$block5049$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, C); goto $$entry~g;
  $$entry~g: assume ($Heap[this, $allocated] == true); goto $$entry~f;
  $$entry~f: coll := coll$in; goto $$entry~e;
  $$entry~e: n := n$in; goto block4845;
  block4845: goto block4862;
  block4862: assume (coll != null); goto block5015;
  block5015: goto block5032;
  block5032: i := 0; goto block5049$LoopPreheader;
  block5049: assume (((forall $o : ref :: (($Heap$block5049$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block5049$LoopPreheader[$ot, $allocated] == true) && ($Heap$block5049$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block5049$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block5049$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block5049$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block5049~c;
  $$block5049~c: assume (forall $o : ref :: ((($Heap$block5049$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block5049$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block5049$LoopPreheader[$o, $allocated] != true))); goto $$block5049~b;
  $$block5049~b: assume (forall $o : ref :: ((($Heap$block5049$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block5049~a;
  $$block5049~a: assert (forall $o : ref :: ((($o != null) && ($Heap$block5049$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block5049$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block5049$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto true5049to5134, false5049to5066;
  true5049to5134: assume (i >= n); goto block5134;
  false5049to5066: assume (i < n); goto block5066;
  block5134: goto block5151;
  block5066: assert (coll != null); goto $$block5066~a;
  $$block5066~a: call Coll.P(coll); goto block5083;
  block5151: return.value := coll; goto block5168;
  block5083: local5389 := i; goto $$block5083~d;
  $$block5083~d: stack0i := 1; goto $$block5083~c;
  $$block5083~c: stack0i := (local5389 + stack0i); goto $$block5083~b;
  $$block5083~b: i := stack0i; goto $$block5083~a;
  $$block5083~a: stack0i := local5389; goto block5100;
  block5168: goto block5185;
  block5100: goto block5117;
  block5185: SS$Display.Return.Local := return.value; goto $$block5185~b;
  $$block5185~b: stack0o := return.value; goto $$block5185~a;
  $$block5185~a: $result := stack0o; return;
  block5117: goto block5049;
  block5049$LoopPreheader: $Heap$block5049$LoopPreheader := $Heap; goto block5049;
...
implementation C..ctor(this : ref) {
  ...
  $$entry~h: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block5491;
  block5491: goto block5508;
  block5508: goto block5525;
  block5525: assert (this != null); goto $$block5525~a;
  $$block5525~a: call System.Object..ctor(this); goto block5542;
  block5542: goto block5559;
  block5559: assert (this != null); goto $$block5559~d;
  $$block5559~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block5559~c;
  $$block5559~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == C)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block5559~b;
  $$block5559~b: $Heap := $Heap[this, $inv := C]; goto $$block5559~a;
...
implementation T..ctor(this : ref) {
  ...
  $$entry~j: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block5729;
  block5729: goto block5746;
  block5746: goto block5763;
  block5763: assert (this != null); goto $$block5763~a;
  $$block5763~a: call System.Object..ctor(this); goto block5780;
  block5780: goto block5797;
  block5797: assert (this != null); goto $$block5797~d;
  $$block5797~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block5797~c;
  $$block5797~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == T)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block5797~b;
  $$block5797~b: $Heap := $Heap[this, $inv := T]; goto $$block5797~a;
  $$block5797~a: assume IsHeap($Heap); return;
  
}

implementation Coll.P(this : ref) {
  entry: assume $IsNotNull(this, Coll); goto $$entry~l;
...
implementation Coll..ctor(this : ref) {
  entry: assume $IsNotNull(this, Coll); goto $$entry~n;
  $$entry~n: assume ($Heap[this, $allocated] == true); goto $$entry~m;
  $$entry~m: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block6120;
  block6120: goto block6137;
  block6137: goto block6154;
  block6154: assert (this != null); goto $$block6154~a;
  $$block6154~a: call System.Object..ctor(this); goto block6171;
  block6171: goto block6188;
  block6188: assert (this != null); goto $$block6188~d;
  $$block6188~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block6188~c;
  $$block6188~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Coll)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block6188~b;
  $$block6188~b: $Heap := $Heap[this, $inv := Coll]; goto $$block6188~a;
