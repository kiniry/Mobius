...
const SimpleWhile0 : name;
axiom (SimpleWhile0 <: SimpleWhile0);
axiom ($BaseClass(SimpleWhile0) == System.Object);
axiom ((SimpleWhile0 <: $BaseClass(SimpleWhile0)) && (AsDirectSubClass(SimpleWhile0, $BaseClass(SimpleWhile0)) == SimpleWhile0));
axiom (!$IsImmutable(SimpleWhile0) && ($AsMutable(SimpleWhile0) == SimpleWhile0));
axiom (forall $U : name :: {($U <: SimpleWhile0)} (($U <: SimpleWhile0) ==> ($U == SimpleWhile0)));
procedure SimpleWhile0.CC77(this : ref);
...
implementation SimpleWhile0.CC77(this : ref) {
  var i : int where InRange(i, System.Int32);
  var counter : int where InRange(counter, System.Int32);
  var stack0i : int;
  var stack0b : bool;
  var stack0o : ref;
  var $Heap$block1394$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, SimpleWhile0); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1360;
  block1360: goto block1377;
  block1377: i := 0; goto $$block1377~a;
  $$block1377~a: counter := 0; goto block1394$LoopPreheader;
  block1394: assume (((forall $o : ref :: (($Heap$block1394$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1394$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1394$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1394$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1394$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1394$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1394~d;
  $$block1394~d: assume (forall $o : ref :: ((($Heap$block1394$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1394$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1394$LoopPreheader[$o, $allocated] != true))); goto $$block1394~c;
  $$block1394~c: assume (forall $o : ref :: ((($Heap$block1394$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1394~b;
  $$block1394~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block1394$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1394$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1394$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block1394~a;
  $$block1394~a: stack0i := 100; goto true1394to1513, false1394to1411;
  true1394to1513: assume (counter >= stack0i); goto block1513;
  false1394to1411: assume (counter < stack0i); goto block1411;
  block1513: assert (i >= 0); goto block1598;
  block1411: assert (counter >= 0); goto block1496;
  block1496: stack0i := 1; goto $$block1496~e;
  $$block1496~e: stack0i := (counter + stack0i); goto $$block1496~d;
  $$block1496~d: counter := stack0i; goto $$block1496~c;
  $$block1496~c: stack0i := 1; goto $$block1496~b;
  $$block1496~b: stack0i := (i + stack0i); goto $$block1496~a;
  $$block1496~a: i := stack0i; goto block1394;
  block1598: return;
  block1394$LoopPreheader: $Heap$block1394$LoopPreheader := $Heap; goto block1394;
...
procedure SimpleWhile0..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == SimpleWhile0)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(SimpleWhile0 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation SimpleWhile0..ctor(this : ref) {
  entry: assume $IsNotNull(this, SimpleWhile0); goto $$entry~c;
  $$entry~c: assume ($Heap[this, $allocated] == true); goto $$entry~b;
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2108;
  block2108: goto block2125;
  block2125: assert (this != null); goto $$block2125~f;
  $$block2125~f: call System.Object..ctor(this); goto $$block2125~e;
  $$block2125~e: assert (this != null); goto $$block2125~d;
  $$block2125~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2125~c;
  $$block2125~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == SimpleWhile0)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2125~b;
  $$block2125~b: $Heap := $Heap[this, $inv := SimpleWhile0]; goto $$block2125~a;
  $$block2125~a: assume IsHeap($Heap); return;
