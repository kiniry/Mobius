...
axiom (SimpleWhile1 <: SimpleWhile1);
axiom ($BaseClass(SimpleWhile1) == System.Object);
axiom ((SimpleWhile1 <: $BaseClass(SimpleWhile1)) && (AsDirectSubClass(SimpleWhile1, $BaseClass(SimpleWhile1)) == SimpleWhile1));
axiom (!$IsImmutable(SimpleWhile1) && ($AsMutable(SimpleWhile1) == SimpleWhile1));
axiom (forall $U : name :: {($U <: SimpleWhile1)} (($U <: SimpleWhile1) ==> ($U == SimpleWhile1)));
procedure SimpleWhile1.Example(this : ref);
...
implementation SimpleWhile1.Example(this : ref) {
  var counter : int where InRange(counter, System.Int32);
  ...
  var $Heap$block1360$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, SimpleWhile1); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1326;
  block1326: goto block1343;
  block1343: counter := 12; goto $$block1343~a;
  $$block1343~a: i := 0; goto block1360$LoopPreheader;
  block1360: assume (((forall $o : ref :: (($Heap$block1360$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1360$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1360$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1360$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1360$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1360$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1360~d;
  $$block1360~d: assume (forall $o : ref :: ((($Heap$block1360$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1360$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1360$LoopPreheader[$o, $allocated] != true))); goto $$block1360~c;
  $$block1360~c: assume (forall $o : ref :: ((($Heap$block1360$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1360~b;
  $$block1360~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block1360$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1360$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1360$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block1360~a;
  $$block1360~a: stack0i := 100; goto true1360to1445, false1360to1377;
  true1360to1445: assume (i >= stack0i); goto block1445;
  false1360to1377: assume (i < stack0i); goto block1377;
  block1445: assert (counter >= -12); goto block1530;
  block1377: stack0i := 5; goto $$block1377~c;
  $$block1377~c: assert (stack0i != 0); goto $$block1377~b;
  $$block1377~b: stack0i := (i % stack0i); goto $$block1377~a;
  $$block1377~a: stack1i := 0; goto true1377to1411, false1377to1394;
  true1377to1411: assume (stack0i != stack1i); goto block1411;
  false1377to1394: assume (stack0i == stack1i); goto block1394;
  block1411: local2 := counter; goto $$block1411~d;
  $$block1411~d: stack0i := 1; goto $$block1411~c;
  $$block1411~c: stack0i := (local2 + stack0i); goto $$block1411~b;
  $$block1411~b: counter := stack0i; goto $$block1411~a;
  $$block1411~a: stack0i := local2; goto block1428;
  block1394: stack0i := 11; goto $$block1394~b;
  $$block1394~b: stack0i := (counter - stack0i); goto $$block1394~a;
  $$block1394~a: counter := stack0i; goto block1428;
  block1530: return;
  block1428: local3 := i; goto $$block1428~d;
  $$block1428~d: stack0i := 1; goto $$block1428~c;
  $$block1428~c: stack0i := (local3 + stack0i); goto $$block1428~b;
  $$block1428~b: i := stack0i; goto $$block1428~a;
  $$block1428~a: stack0i := local3; goto block1360;
  block1360$LoopPreheader: $Heap$block1360$LoopPreheader := $Heap; goto block1360;
...
procedure SimpleWhile1..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == SimpleWhile1)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(SimpleWhile1 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation SimpleWhile1..ctor(this : ref) {
  entry: assume $IsNotNull(this, SimpleWhile1); goto $$entry~c;
  ...
  $$block2176~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == SimpleWhile1)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2176~b;
  $$block2176~b: $Heap := $Heap[this, $inv := SimpleWhile1]; goto $$block2176~a;
