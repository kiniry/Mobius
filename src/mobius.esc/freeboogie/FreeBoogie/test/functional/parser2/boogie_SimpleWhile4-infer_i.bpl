...
axiom (SimpleWhile4 <: SimpleWhile4);
axiom ($BaseClass(SimpleWhile4) == System.Object);
axiom ((SimpleWhile4 <: $BaseClass(SimpleWhile4)) && (AsDirectSubClass(SimpleWhile4, $BaseClass(SimpleWhile4)) == SimpleWhile4));
axiom (!$IsImmutable(SimpleWhile4) && ($AsMutable(SimpleWhile4) == SimpleWhile4));
axiom (forall $U : name :: {($U <: SimpleWhile4)} (($U <: SimpleWhile4) ==> ($U == SimpleWhile4)));
procedure SimpleWhile4.AMethod(this : ref);
...
implementation SimpleWhile4.AMethod(this : ref) {
  ...
  var $Heap$block1343$LoopPreheader : <x>[ref, name]x;
  entry: assume $IsNotNull(this, SimpleWhile4); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block1292;
  block1292: goto block1309;
  block1309: i := 30; goto $$block1309~b;
  $$block1309~b: count := 0; goto $$block1309~a;
  $$block1309~a: stack0i := 0; goto true1309to1343, false1309to1326;
  true1309to1343: assume (i <= stack0i); goto block1343$LoopPreheader;
  false1309to1326: assume (i > stack0i); goto block1326;
  block1343: assume (((forall $o : ref :: (($Heap$block1343$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block1343$LoopPreheader[$ot, $allocated] == true) && ($Heap$block1343$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block1343$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block1343$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block1343$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block1343~d;
  $$block1343~d: assume (forall $o : ref :: ((($Heap$block1343$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block1343$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block1343$LoopPreheader[$o, $allocated] != true))); goto $$block1343~c;
  $$block1343~c: assume (forall $o : ref :: ((($Heap$block1343$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block1343~b;
  $$block1343~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block1343$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block1343$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block1343$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block1343~a;
  $$block1343~a: stack0i := 0; goto true1343to1377, false1343to1360;
  block1326: local2 := i; goto $$block1326~i;
  $$block1326~i: stack0i := 1; goto $$block1326~h;
  $$block1326~h: stack0i := (local2 - stack0i); goto $$block1326~g;
  $$block1326~g: i := stack0i; goto $$block1326~f;
  $$block1326~f: stack0i := local2; goto $$block1326~e;
  $$block1326~e: local3 := count; goto $$block1326~d;
  $$block1326~d: stack0i := 1; goto $$block1326~c;
  $$block1326~c: stack0i := (local3 - stack0i); goto $$block1326~b;
  $$block1326~b: count := stack0i; goto $$block1326~a;
  $$block1326~a: stack0i := local3; goto block1343$LoopPreheader;
  true1343to1377: assume (i <= stack0i); goto block1377;
  false1343to1360: assume (i > stack0i); goto block1360;
  block1377: assert (count < 0); goto block1462;
  block1360: local4 := i; goto $$block1360~i;
  $$block1360~i: stack0i := 1; goto $$block1360~h;
  $$block1360~h: stack0i := (local4 - stack0i); goto $$block1360~g;
  $$block1360~g: i := stack0i; goto $$block1360~f;
  $$block1360~f: stack0i := local4; goto $$block1360~e;
  $$block1360~e: local5 := count; goto $$block1360~d;
  $$block1360~d: stack0i := 1; goto $$block1360~c;
  $$block1360~c: stack0i := (local5 - stack0i); goto $$block1360~b;
  $$block1360~b: count := stack0i; goto $$block1360~a;
  $$block1360~a: stack0i := local5; goto block1343;
  block1462: return;
  block1343$LoopPreheader: $Heap$block1343$LoopPreheader := $Heap; goto block1343;
...
procedure SimpleWhile4..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == SimpleWhile4)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(SimpleWhile4 <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation SimpleWhile4..ctor(this : ref) {
  entry: assume $IsNotNull(this, SimpleWhile4); goto $$entry~c;
  $$entry~c: assume ($Heap[this, $allocated] == true); goto $$entry~b;
  $$entry~b: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2176;
  block2176: goto block2193;
  block2193: assert (this != null); goto $$block2193~f;
  $$block2193~f: call System.Object..ctor(this); goto $$block2193~e;
  $$block2193~e: assert (this != null); goto $$block2193~d;
  $$block2193~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2193~c;
  $$block2193~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == SimpleWhile4)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2193~b;
  $$block2193~b: $Heap := $Heap[this, $inv := SimpleWhile4]; goto $$block2193~a;
  $$block2193~a: assume IsHeap($Heap); return;
