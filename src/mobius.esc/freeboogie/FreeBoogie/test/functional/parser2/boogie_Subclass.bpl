...
axiom !IsStaticField(Sub.x);
axiom IsDirectlyModifiableField(Sub.x);
axiom (DeclType(Sub.x) == Sub);
axiom (AsRangeField(Sub.x, System.Int32) == Sub.x);
axiom (Super <: Super);
axiom ($BaseClass(Super) == System.Object);
axiom ((Super <: $BaseClass(Super)) && (AsDirectSubClass(Super, $BaseClass(Super)) == Super));
axiom (!$IsImmutable(Super) && ($AsMutable(Super) == Super));
procedure Super..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Super)) && ($Heap[this, $localinv] == $typeof(this)));
  ...
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Super <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation Super..ctor(this : ref) {
  entry: assume $IsNotNull(this, Super); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto $$entry~a;
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block2414;
  block2414: goto block2431;
  block2431: goto block2448;
  block2448: assert (this != null); goto $$block2448~a;
  $$block2448~a: call System.Object..ctor(this); goto block2465;
  block2465: goto block2482;
  block2482: assert (this != null); goto $$block2482~d;
  $$block2482~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block2482~c;
  $$block2482~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Super)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block2482~b;
  $$block2482~b: $Heap := $Heap[this, $inv := Super]; goto $$block2482~a;
  $$block2482~a: assume IsHeap($Heap); return;
...
implementation Sub..ctor(this : ref) {
  ...
  var stack0o : ref;
  entry: assume $IsNotNull(this, Sub); goto $$entry~e;
  ...
  $$entry~c: assume ($Heap[this, Sub.x] == 0); goto block2924;
  block2924: goto block2941;
  block2941: goto block2958;
  block2958: goto block2975;
  block2975: goto block2992;
  block2992: stack0i := 10; goto $$block2992~g;
  $$block2992~g: assert (this != null); goto $$block2992~f;
  $$block2992~f: havoc temp0; goto $$block2992~e;
  $$block2992~e: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block2992~d;
  $$block2992~d: $Heap := $Heap[this, Sub.x := stack0i]; goto $$block2992~c;
  $$block2992~c: assume IsHeap($Heap); goto $$block2992~b;
  $$block2992~b: assert (this != null); goto $$block2992~a;
  $$block2992~a: call Super..ctor(this); goto block3009;
  block3009: assert ($Heap[this, Sub.x] == 10); goto block3162;
  block3162: goto block3179;
  block3179: goto block3196;
  block3196: assert (this != null); goto $$block3196~d;
  $$block3196~d: assert (($Heap[this, $inv] == Super) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3196~c;
  $$block3196~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Sub)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3196~b;
  $$block3196~b: $Heap := $Heap[this, $inv := Sub]; goto $$block3196~a;
  $$block3196~a: assume IsHeap($Heap); return;
...
procedure Sub..ctor$System.Boolean(this : ref, b$in : bool where true);
  free requires true;
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
...
implementation Sub..ctor$System.Boolean(this : ref, b$in : bool) {
  ...
  $$entry~f: assume ($Heap[this, Sub.x] == 0); goto block3621;
  block3621: goto block3638;
  block3638: goto block3655;
  block3655: goto block3672;
  block3672: goto block3689;
  block3689: stack0i := 10; goto $$block3689~g;
  $$block3689~g: assert (this != null); goto $$block3689~f;
  $$block3689~f: havoc temp0; goto $$block3689~e;
  $$block3689~e: $Heap := $Heap[this, $exposeVersion := temp0]; goto $$block3689~d;
  $$block3689~d: $Heap := $Heap[this, Sub.x := stack0i]; goto $$block3689~c;
  $$block3689~c: assume IsHeap($Heap); goto $$block3689~b;
  $$block3689~b: assert (this != null); goto $$block3689~a;
  $$block3689~a: call Super..ctor(this); goto block3706;
  block3706: assert false; goto $$block3706~e;
  $$block3706~e: assert (this != null); goto $$block3706~d;
  $$block3706~d: assert (($Heap[this, $inv] == Super) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3706~c;
  $$block3706~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Sub)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3706~b;
  $$block3706~b: $Heap := $Heap[this, $inv := Sub]; goto $$block3706~a;
  $$block3706~a: assume IsHeap($Heap); return;
  
}

procedure Sub.Ty(this : ref);
...
implementation Sub.Ty(this : ref) {
  var stack0s : struct;
  var t : ref where $Is(t, System.Object);
  var stack0o : ref;
  entry: assume $IsNotNull(this, Sub); goto $$entry~j;
  $$entry~j: assume ($Heap[this, $allocated] == true); goto block4437;
  block4437: goto block4454;
  block4454: havoc stack0s; goto $$block4454~b;
  $$block4454~b: assume $IsTokenForType(stack0s, Sub); goto $$block4454~a;
  $$block4454~a: t := TypeObject(Sub); goto block4471;
  block4471: assert (t != null); goto block4624;
  block4624: goto block4641;
  block4641: assert $IsNotNull(t, System.Object); goto block4794;
