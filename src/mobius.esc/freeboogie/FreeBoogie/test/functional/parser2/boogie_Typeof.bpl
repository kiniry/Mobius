...
axiom (Typeof <: Typeof);
axiom ($BaseClass(Typeof) == System.Object);
axiom ((Typeof <: $BaseClass(Typeof)) && (AsDirectSubClass(Typeof, $BaseClass(Typeof)) == Typeof));
axiom (!$IsImmutable(Typeof) && ($AsMutable(Typeof) == Typeof));
procedure Typeof.M(this : ref);
...
implementation Typeof.M(this : ref) {
  var stack0s : struct;
  var t : ref where $Is(t, System.Object);
  var stack0o : ref;
  entry: assume $IsNotNull(this, Typeof); goto $$entry~a;
  $$entry~a: assume ($Heap[this, $allocated] == true); goto block2924;
  block2924: goto block2941;
  block2941: havoc stack0s; goto $$block2941~b;
  $$block2941~b: assume $IsTokenForType(stack0s, Typeof); goto $$block2941~a;
  $$block2941~a: t := TypeObject(Typeof); goto block2958;
  block2958: assert (t != null); goto block3111;
  block3111: goto block3128;
  block3128: assert $IsNotNull(t, System.Type); goto block3281;
  block3281: goto block3298;
  block3298: assert $IsNotNull(t, System.Object); goto block3451;
...
implementation Typeof.N(this : ref) {
  var stack0s : struct;
  var t : ref where $Is(t, System.Object);
  var stack0o : ref;
  entry: assume $IsNotNull(this, Typeof); goto $$entry~b;
  $$entry~b: assume ($Heap[this, $allocated] == true); goto block4012;
  block4012: goto block4029;
  block4029: havoc stack0s; goto $$block4029~b;
  $$block4029~b: assume $IsTokenForType(stack0s, Typeof); goto $$block4029~a;
  $$block4029~a: t := TypeObject(Typeof); goto block4046;
  block4046: assert $IsNotNull(t, System.String); goto block4199;
...
procedure Typeof..ctor(this : ref);
  free requires (forall $o : ref :: (($o != this) ==> ($Heap[$o, $ownerRef] != this)));
  free requires (($Heap[this, $ownerRef] == this) && ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder));
  free requires (forall $o : ref :: ((($Heap[$o, $ownerRef] == $Heap[this, $ownerRef]) && ($Heap[$o, $ownerFrame] == $Heap[this, $ownerFrame])) ==> ($o == this)));
  free requires ($BeingConstructed == this);
  modifies $Heap;
  ensures ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == Typeof)) && ($Heap[this, $localinv] == $typeof(this)));
  ensures (($Heap[this, $ownerRef] == old($Heap)[this, $ownerRef]) && ($Heap[this, $ownerFrame] == old($Heap)[this, $ownerFrame]));
  ensures ($Heap[this, $sharingMode] == $SharingMode_Unshared);
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
  ensures (forall $o : ref :: ((($o != null) && (old($Heap)[$o, $allocated] == true)) ==> ((old($Heap)[$o, $ownerRef] == $Heap[$o, $ownerRef]) && (old($Heap)[$o, $ownerFrame] == $Heap[$o, $ownerFrame]))));
  free ensures (forall $o : ref, $f : name :: {$Heap[$o, $f]} (((((((((($f != $inv) && ($f != $localinv)) && ($f != $FirstConsistentOwner)) && (!IsStaticField($f) || !IsDirectlyModifiableField($f))) && ($o != null)) && (old($Heap)[$o, $allocated] == true)) && (((old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder) || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame])) || (old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])))) && (($o != this) || !(Typeof <: DeclType($f)))) && old(true)) ==> (old($Heap)[$o, $f] == $Heap[$o, $f])));
  free ensures (forall $o : ref :: ((($o == this) || ((old($Heap)[$o, $inv] == $Heap[$o, $inv]) && (old($Heap)[$o, $localinv] == $Heap[$o, $localinv]))) || (old($Heap)[$o, $allocated] != true)));
  free ensures (((forall $o : ref :: ((old($Heap)[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: (((old($Heap)[$ot, $allocated] == true) && (old($Heap)[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == old($Heap)[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == old($Heap)[$ot, $ownerFrame]))))) && (old($Heap)[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized]));
  free ensures (forall $o : ref :: (($o == this) || (old($Heap[$o, $sharingMode]) == $Heap[$o, $sharingMode])));
  

implementation Typeof..ctor(this : ref) {
  entry: assume $IsNotNull(this, Typeof); goto $$entry~d;
  $$entry~d: assume ($Heap[this, $allocated] == true); goto $$entry~c;
  $$entry~c: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block4437;
  block4437: goto block4454;
  block4454: goto block4471;
  block4471: assert (this != null); goto $$block4471~a;
  $$block4471~a: call System.Object..ctor(this); goto block4488;
  block4488: goto block4505;
  block4505: assert (this != null); goto $$block4505~d;
  $$block4505~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4505~c;
  $$block4505~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Typeof)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4505~b;
  $$block4505~b: $Heap := $Heap[this, $inv := Typeof]; goto $$block4505~a;
  $$block4505~a: assume IsHeap($Heap); return;
