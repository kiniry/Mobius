...
implementation Test.Copy$System.Int32(n$in : int) returns ($result : int) {
  ...
  var stack0o : ref;
  var stack0b : bool;
  var local3791 : int where InRange(local3791, System.Int32);
  var stack0i : int;
  ...
  var $Heap$block3060$LoopPreheader : <x>[ref, name]x;
  entry: n := n$in; goto block3009;
  block3009: goto block3026;
  block3026: m := 0; goto block3043;
  block3043: i := 0; goto block3060$LoopPreheader;
  block3060: assume (((forall $o : ref :: (($Heap$block3060$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block3060$LoopPreheader[$ot, $allocated] == true) && ($Heap$block3060$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block3060$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block3060$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block3060$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block3060~d;
  $$block3060~d: assume (forall $o : ref :: ((($Heap$block3060$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block3060$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block3060$LoopPreheader[$o, $allocated] != true))); goto $$block3060~c;
  $$block3060~c: assume (forall $o : ref :: ((($Heap$block3060$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block3060~b;
  $$block3060~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block3060$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block3060$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block3060$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block3060~a;
  $$block3060~a: assert (m == i); goto block3213;
  block3213: goto block3230;
  block3230: goto true3230to3315, false3230to3247;
  true3230to3315: assume (i == n); goto block3315;
  false3230to3247: assume (i != n); goto block3247;
  block3315: goto block3332;
  block3247: m := i; goto block3264;
  block3264: local3791 := m; goto $$block3264~d;
  $$block3264~d: stack0i := 1; goto $$block3264~c;
  $$block3264~c: stack0i := (local3791 + stack0i); goto $$block3264~b;
  $$block3264~b: m := stack0i; goto $$block3264~a;
  $$block3264~a: stack0i := local3791; goto block3281;
  block3332: return.value := m; goto block3349;
  block3281: goto block3298;
  block3349: goto block3553;
  block3298: goto block3060;
  ...
  block3060$LoopPreheader: $Heap$block3060$LoopPreheader := $Heap; goto block3060;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3910;
  block3910: goto block3927;
  block3927: goto block3944;
  block3944: assert (this != null); goto $$block3944~a;
  $$block3944~a: call System.Object..ctor(this); goto block3961;
  block3961: goto block3978;
  block3978: assert (this != null); goto $$block3978~d;
  $$block3978~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block3978~c;
  $$block3978~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block3978~b;
  $$block3978~b: $Heap := $Heap[this, $inv := Test]; goto $$block3978~a;
  $$block3978~a: assume IsHeap($Heap); return;
