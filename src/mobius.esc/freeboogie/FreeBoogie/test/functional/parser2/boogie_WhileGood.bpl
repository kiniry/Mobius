...
procedure Test.Copy$System.Int32(n$in : int where InRange(n$in, System.Int32)) returns ($result : int where InRange($result, System.Int32));
  free requires true;
...
implementation Test.Copy$System.Int32(n$in : int) returns ($result : int) {
  ...
  var local3842 : int where InRange(local3842, System.Int32);
  var SS$Display.Return.Local : int where InRange(SS$Display.Return.Local, System.Int32);
  var $Heap$block3077$LoopPreheader : <x>[ref, name]x;
  entry: n := n$in; goto block3026;
  block3026: goto block3043;
  block3043: m := 0; goto block3060;
  block3060: i := 0; goto block3077$LoopPreheader;
  block3077: assume (((forall $o : ref :: (($Heap$block3077$LoopPreheader[$o, $allocated] == true) ==> ($Heap[$o, $allocated] == true))) && (forall $ot : ref :: ((($Heap$block3077$LoopPreheader[$ot, $allocated] == true) && ($Heap$block3077$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder)) ==> (($Heap[$ot, $ownerRef] == $Heap$block3077$LoopPreheader[$ot, $ownerRef]) && ($Heap[$ot, $ownerFrame] == $Heap$block3077$LoopPreheader[$ot, $ownerFrame]))))) && ($Heap$block3077$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized])); goto $$block3077~d;
  $$block3077~d: assume (forall $o : ref :: ((($Heap$block3077$LoopPreheader[$o, $inv] == $Heap[$o, $inv]) && ($Heap$block3077$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv])) || ($Heap$block3077$LoopPreheader[$o, $allocated] != true))); goto $$block3077~c;
  $$block3077~c: assume (forall $o : ref :: ((($Heap$block3077$LoopPreheader[$o, $allocated] != true) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o))))); goto $$block3077~b;
  $$block3077~b: assert (forall $o : ref :: ((($o != null) && ($Heap$block3077$LoopPreheader[$o, $allocated] == true)) ==> (($Heap$block3077$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef]) && ($Heap$block3077$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame])))); goto $$block3077~a;
  $$block3077~a: assert (m == i); goto block3230;
  block3230: goto block3247;
  block3247: goto true3247to3349, false3247to3264;
  true3247to3349: assume (i == n); goto block3349;
  false3247to3264: assume (i != n); goto block3264;
  block3349: goto block3366;
  block3264: local3825 := m; goto $$block3264~d;
  $$block3264~d: stack0i := 1; goto $$block3264~c;
  $$block3264~c: stack0i := (local3825 + stack0i); goto $$block3264~b;
  $$block3264~b: m := stack0i; goto $$block3264~a;
  $$block3264~a: stack0i := local3825; goto block3281;
  block3366: return.value := m; goto block3383;
  block3281: goto block3298;
  block3383: goto block3587;
  block3298: local3842 := i; goto $$block3298~d;
  $$block3298~d: stack0i := 1; goto $$block3298~c;
  $$block3298~c: stack0i := (local3842 + stack0i); goto $$block3298~b;
  $$block3298~b: i := stack0i; goto $$block3298~a;
  $$block3298~a: stack0i := local3842; goto block3315;
  block3587: goto block3604;
  block3315: goto block3332;
  block3604: SS$Display.Return.Local := return.value; goto $$block3604~b;
  $$block3604~b: stack0i := return.value; goto $$block3604~a;
  $$block3604~a: $result := stack0i; return;
  block3332: goto block3077;
  block3077$LoopPreheader: $Heap$block3077$LoopPreheader := $Heap; goto block3077;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block3961;
  block3961: goto block3978;
  block3978: goto block3995;
  block3995: assert (this != null); goto $$block3995~a;
  $$block3995~a: call System.Object..ctor(this); goto block4012;
  block4012: goto block4029;
  block4029: assert (this != null); goto $$block4029~d;
  $$block4029~d: assert (($Heap[this, $inv] == System.Object) && ($Heap[this, $localinv] == $typeof(this))); goto $$block4029~c;
  $$block4029~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block4029~b;
  $$block4029~b: $Heap := $Heap[this, $inv := Test]; goto $$block4029~a;
