...
function #Test.Blah$System.Int32($$unnamed~fb : <x>[ref, name]x, $$unnamed~fa : int) returns ($$unnamed~fc : bool);
axiom (Test <: Test);
...
axiom (forall $Heap : <x>[ref, name]x, i$in : int :: {#Test.Blah$System.Int32($Heap, i$in)} ((IsHeap($Heap) && InRange(i$in, System.Int32)) ==> (true && (#Test.Blah$System.Int32($Heap, i$in) == true))));
procedure Test.Blah$System.Int32(i$in : int where InRange(i$in, System.Int32)) returns ($result : bool where true);
  free requires true;
  ...
  free ensures ($result == #Test.Blah$System.Int32($Heap, i$in));
...
implementation Test.Blah$System.Int32(i$in : int) returns ($result : bool) {
  var i : int where InRange(i, System.Int32);
  var return.value : bool where true;
  var SS$Display.Return.Local : bool where true;
  var stack0b : bool;
  entry: i := i$in; goto block1241;
  block1241: goto block1258;
  block1258: return.value := true; goto block1275;
  block1275: SS$Display.Return.Local := return.value; goto $$block1275~b;
  $$block1275~b: stack0b := return.value; goto $$block1275~a;
  $$block1275~a: $result := stack0b; return;
  
}

procedure Test.Foo();
  requires (forall ^i : int :: (((0 <= ^i) && (^i <= 9)) ==> #Test.Blah$System.Int32($Heap, ^i)));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation Test.Foo() {
  entry: goto block1666;
  block1666: goto block1853;
  block1853: return;
...
procedure Test.Main$System.String.array(args$in : ref where $Is(args$in, RefArray(System.String, 1)));
  free requires ($Heap[args$in, $allocated] == true);
  requires ((args$in == null) || (((($Heap[args$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[args$in, $ownerRef], $inv] <: $Heap[args$in, $ownerFrame])) || ($Heap[$Heap[args$in, $ownerRef], $localinv] == $BaseClass($Heap[args$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[args$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[args$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc)))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation Test.Main$System.String.array(args$in : ref) {
  var args : ref where $Is(args, RefArray(System.String, 1));
  var stack0o : ref;
  entry: args := args$in; goto block2227;
  block2227: goto block2329;
  block2329: assume (args != null); goto block2414;
  block2414: stack0o := args; goto $$block2414~a;
  $$block2414~a: call Test.MainX$System.optional...NonNullType.String.array$notnull(stack0o); return;
  
}

procedure Test.MainX$System.optional...NonNullType.String.array$notnull(args$in : ref where $IsNotNull(args$in, NonNullRefArray(System.String, 1)));
  free requires ($Heap[args$in, $allocated] == true);
  requires (((($Heap[args$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[args$in, $ownerRef], $inv] <: $Heap[args$in, $ownerFrame])) || ($Heap[$Heap[args$in, $ownerRef], $localinv] == $BaseClass($Heap[args$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[args$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[args$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
  free ensures (forall $o : ref :: (((($o != null) && (old($Heap)[$o, $allocated] != true)) && ($Heap[$o, $allocated] == true)) ==> (($Heap[$o, $inv] == $typeof($o)) && ($Heap[$o, $localinv] == $typeof($o)))));
  free ensures (forall $o : ref :: {$Heap[$o, $FirstConsistentOwner]} ((old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion]) ==> (old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner])));
...
implementation Test.MainX$System.optional...NonNullType.String.array$notnull(args$in : ref) {
  var args : ref where $IsNotNull(args, NonNullRefArray(System.String, 1));
  var stack0o : ref;
  entry: args := args$in; goto block4148;
  block4148: goto block4250;
  block4250: assert (forall ^i : int :: (((0 <= ^i) && (^i <= ($Length(args) - 1))) ==> (RefArrayGet($Heap[args, $elements], ^i) != null))); goto block4471;
  block4471: return;
  
}

procedure Test.DeprivedMain$System.String.array$notnull(args$in : ref where $IsNotNull(args$in, RefArray(System.String, 1)));
  free requires ($Heap[args$in, $allocated] == true);
  requires (((($Heap[args$in, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[args$in, $ownerRef], $inv] <: $Heap[args$in, $ownerFrame])) || ($Heap[$Heap[args$in, $ownerRef], $localinv] == $BaseClass($Heap[args$in, $ownerFrame]))) && (forall $pc : ref :: ((((($pc != null) && ($Heap[$pc, $allocated] == true)) && ($Heap[$pc, $ownerRef] == $Heap[args$in, $ownerRef])) && ($Heap[$pc, $ownerFrame] == $Heap[args$in, $ownerFrame])) ==> (($Heap[$pc, $inv] == $typeof($pc)) && ($Heap[$pc, $localinv] == $typeof($pc))))));
  free requires ($BeingConstructed == null);
  modifies $Heap;
...
implementation Test.DeprivedMain$System.String.array$notnull(args$in : ref) {
  var args : ref where $IsNotNull(args, RefArray(System.String, 1));
  var stack0o : ref;
  entry: args := args$in; goto block5083;
  block5083: goto block5185;
  block5185: assert (forall ^i : int :: (((0 <= ^i) && (^i <= ($Length(args) - 1))) ==> (RefArrayGet($Heap[args, $elements], ^i) != null))); goto block5406;
  block5406: return;
...
implementation Test..ctor(this : ref) {
  ...
  $$entry~a: assume ((((($Heap[this, $ownerFrame] == $PeerGroupPlaceholder) || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame])) || ($Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame]))) && ($Heap[this, $inv] == System.Object)) && ($Heap[this, $localinv] == $typeof(this))); goto block5712;
  ...
  $$block5729~c: assert (forall $p : ref :: ((((($p != null) && ($Heap[$p, $allocated] == true)) && ($Heap[$p, $ownerRef] == this)) && ($Heap[$p, $ownerFrame] == Test)) ==> (($Heap[$p, $inv] == $typeof($p)) && ($Heap[$p, $localinv] == $typeof($p))))); goto $$block5729~b;
  $$block5729~b: $Heap := $Heap[this, $inv := Test]; goto $$block5729~a;
