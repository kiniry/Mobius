 ...
 *
 */
public interface IJmlListener {
		void jmlStartedMultiple();
		void jmlStarted(IFile file);
		void jmlFinished(IFile file, List<JmlErrorElement> result);
		void jmlFinishedMultiple();
}
