...
import ch.ethz.inf.pm.jml.plugin.internal.core.JmlExecRunner;

/**
 * @author WMD
 *
 */
public class RunJmlExecAction extends RunAction {
	@Override
	...
	protected void runAction(IProgressMonitor monitor) throws CoreException {
		// JmlPlugin.getDefault().runExec(getFiles(), monitor);
		new JmlExecRunner().run(getFiles(), monitor);
	}
}
