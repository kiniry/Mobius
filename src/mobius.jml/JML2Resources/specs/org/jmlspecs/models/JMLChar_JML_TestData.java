 ...
 *
 */
public abstract class JMLChar_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public JMLChar_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for JMLChar");
    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_models_JMLCharIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_models_JMLCharStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.models.JMLChar. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_models_JMLCharStrategy
        = new org.jmlspecs.jmlunit.strategies.ImmutableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.models.JMLChar[] {
                        new JMLChar(),
                        new JMLChar('a'),
                        new JMLChar((char) 6170),
                        new JMLChar('y'),
                    };
                }
            };
