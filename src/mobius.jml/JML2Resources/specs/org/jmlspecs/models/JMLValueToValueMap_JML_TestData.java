// @(#)$Id: JMLValueToValueMap_JML_TestData.java,v 1.7 2005/07/07 21:03:09 leavens Exp $
    ...
    extends junit.framework.TestCase
{
    ...
    public JMLValueToValueMap_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for JMLValueToValueMap");
    }
    ...
    {
        return vorg_jmlspecs_models_JMLObjectToValueMapStrategy.iterator();
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.ImmutableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.models.JMLObjectToValueMap[] {
                        new JMLObjectToValueMap(),
                        new JMLObjectToValueMap(new Short((short)3),
                                                new JMLShort((short)4)),
                        new JMLObjectToValueMap(new Short((short)3),
                                                new JMLShort((short)4))
                        .add(new Short((short)2), new JMLShort((short)1))
                        .toFunction(),
                        new JMLObjectToValueMap(new Short((short)4),
                                                new JMLShort((short)3))
                        .add(new Short((short)1),
                             new JMLShort((short)2)).toFunction(),
                    };
                }
            };
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        ...
        = new org.jmlspecs.jmlunit.strategies.ImmutableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.models.JMLValueSet[] {
                        new JMLValueSet(),
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        ...
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_models_JMLValueToValueMapStrategy.iterator();
    }
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        ...
        = new org.jmlspecs.jmlunit.strategies.ImmutableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.models.JMLValueToValueMap[] {
                        new JMLValueToValueMap(),
                        new JMLValueToValueMap(new JMLShort((short)3),
                                               new JMLShort((short)4)),
                        new JMLValueToValueMap(new JMLShort((short)3),
                                               new JMLShort((short)4))
                        .add(new JMLShort((short)2),
                             new JMLShort((short)1))
                        .toFunction(),
                        new JMLValueToValueMap(new JMLShort((short)3),
                                               new JMLShort((short)4))
                        .add(new JMLShort((short)2),
    ...
    /** Return a new, freshly allocated indefinite iterator that
     * produces test data of type 
     * org.jmlspecs.models.JMLValueValuePair
     * for testing the method named by the String methodName in
     * a loop that encloses loopsThisSurrounds many other loops.
     * @param methodName name of the method for which this
     *                      test data will be used.
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        ...
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_models_JMLValueValuePairStrategy.iterator();
    }
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.models.JMLValueValuePair[] {
                        new JMLValueValuePair(new JMLShort((short)3),
                                              new JMLShort((short)3)),
                        new JMLValueValuePair(new JMLShort((short)4),
                                              new JMLShort((short)3)),
                        new JMLValueValuePair(new JMLShort((short)3),
                                              new JMLShort((short)4)),
                        new JMLValueValuePair(new JMLShort((short)2),
                                              new JMLShort((short)1)),
                    };
                }
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.models.JMLValueValuePair down$
                        = (org.jmlspecs.models.JMLValueValuePair) o$;
                    return down$.clone();
                }
            };
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        ...
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_models_JMLValueToValueRelationStrategy.iterator();
    }
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        ...
        = new org.jmlspecs.jmlunit.strategies.ImmutableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.models.JMLValueToValueRelation[] {
    ...
    /** Return a new, freshly allocated indefinite iterator that
     * produces test data of type 
     * org.jmlspecs.models.JMLObjectToValueRelation
     * for testing the method named by the String methodName in
     * a loop that encloses loopsThisSurrounds many other loops.
     * @param methodName name of the method for which this
     *                      test data will be used.
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        ...
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_models_JMLObjectToValueRelationStrategy.iterator();
    }
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        ...
        = new org.jmlspecs.jmlunit.strategies.ImmutableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.models.JMLObjectToValueRelation[] {
