...
public class GraderNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(GraderBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(GraderBuilder.BUILDER_ID);
